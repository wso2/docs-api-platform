...
??? note "Egress API Management Capability with support for LLM/AI"
    ...
    **[Learn more](../design/create-api/create-ai-api/create-an-ai-api.md)**
...
??? note "WSO2 Identity Server 7.0 Authorization Server Support"
    ...
    **[Learn more](../administer/key-managers/configure-wso2is7-connector.md)**
...
??? note "Support for Consuming APIs without Subscriptions"
    ...
    **[Learn more](../design/advanced-topics/disable-subscriptions-for-an-api.md)**
...
??? note "Dynamic API Flow Orchestration Support"
    ...
    **[Learn more](../tutorials/create-and-publish-a-sequencebackend-api.md)**
...
??? note "Application Level Throttle Policy Reset Support"
    ...
    **[Learn more](../design/rate-limiting/resetting-application-throttling-policies.md)**
...
??? note "Audience Validation Support for JWTs"
    ...
    **[Learn more](../design/api-security/oauth2/access-token-types/jwt-tokens.md#audience-validation)**
