...
description: "Why rate limiting matters for backends, gateway-hosted APIs, and consumers: throughput, tiers, burst control, and token quotas."
...
[![rate limiting types](../../assets/img/learn/throttling-types.png)](../../assets/img/learn/throttling-types.png)
...
[![Advanced Rate Limit policy](../../assets/img/learn/new-allow-specific-ip.png)](../../assets/img/learn/new-allow-specific-ip.png)
...
[![New header condition regex](../../assets/img/learn/new-header-condition-regex.png)](../../assets/img/learn/new-header-condition-regex.png)
...
[![New JWT condition regex](../../assets/img/learn/new-jwt-condition-regex.png)](../../assets/img/learn/new-jwt-condition-regex.png)
##### Query parameters
