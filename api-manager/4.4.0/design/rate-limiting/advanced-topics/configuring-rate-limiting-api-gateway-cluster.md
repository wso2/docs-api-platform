...
description: "Configure a Redis cluster to synchronize burst control and backend rate limiting counters across Gateway nodes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/rate-limiting/advanced-topics/configuring-rate-limiting-api-gateway-cluster/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/rate-limiting/advanced-topics/configuring-rate-limiting-api-gateway-cluster.md
tags:
  - api-manager
  - rate-limiting
  - clustering
