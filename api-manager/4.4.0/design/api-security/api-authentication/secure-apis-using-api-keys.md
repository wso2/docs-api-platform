...
description: "Secure an API with API key authentication: generate a JWT API key from the Developer Portal, validate it, and restrict it by IP or referrer."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/api-authentication/secure-apis-using-api-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/api-authentication/secure-apis-using-api-keys.md
tags:
  - api-manager
  - api-authentication
  - api-keys
...
--8<-- "api-manager/4.4.0/includes/design/create-publish-api.md"

### Step 2 - Generate the API Key

--8<-- "api-manager/4.4.0/includes/design/generate-api-key.md"
...
--8<-- "api-manager/4.4.0/includes/design/additional-api-key.md"