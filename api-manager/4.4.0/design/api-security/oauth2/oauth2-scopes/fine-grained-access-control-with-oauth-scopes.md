...
description: "Restrict API resource access by role using shared and local OAuth2 scopes: create, attach, define, and obtain scoped tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md
tags:
  - api-manager
  - oauth2
  - access-control
...
2. Start creating an API as described [here](../../../../design/create-api/create-rest-api/create-a-rest-api.md).
...
Both [Shared Scopes](../../../../design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md#shared-scopes) 
and [Local Scopes](../../../../design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md#local-scopes) should be defined in same way in the OpenAPI definition as follows.
