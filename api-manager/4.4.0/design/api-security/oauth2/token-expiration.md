---
title: "Configure OAuth2 Token Expiration"
description: "Configure default OAuth2 token expiration and timestamp skew via deployment.toml, and see how skew affects token lifespan."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/oauth2/token-expiration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/oauth2/token-expiration.md
tags:
  - api-manager
  - oauth2
  - key-managers
