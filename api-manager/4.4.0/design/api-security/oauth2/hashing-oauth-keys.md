...
description: "Enable OAuth2 token hashing to store tokens, secrets, and authorization codes as hashes, protecting them if the database is breached."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/oauth2/hashing-oauth-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-security/oauth2/hashing-oauth-keys.md
tags:
  - api-manager
  - oauth2
  - api-security
