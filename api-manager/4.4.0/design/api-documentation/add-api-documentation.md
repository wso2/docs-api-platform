...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-documentation/add-api-documentation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/api-documentation/add-api-documentation.md
tags:
  - api-manager
  - api-documentation
  - developer-portal
...
3. Add the specific documentation.
    ...
    4.  Click **Add Content** to open an embedded editor.
        ...
        [![Edit content in a API document](../../assets/img/learn/add-docs-edit-content.png)](../../assets/img/learn/add-docs-edit-content.png)
