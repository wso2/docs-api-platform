...
description: "Add a custom state, such as Rejected, to the default API lifecycle by editing the LifeCycle configuration and its transitions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/lifecycle-management/customize-api-life-cycle/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/lifecycle-management/customize-api-life-cycle.md
tags:
  - api-manager
...
APIs created in WSO2 API Manager have their own life cycle consisting of the following: a set of life cycle states, specific actions for each state transition, and a checklist of items before a state transition occurs. An API has a predefined life cycle consists of [six states](../../design/lifecycle-management/api-lifecycle.md#api-lifecycle-states). This tutorial demonstrates how you can edit the default API lifecycle and customize it according to your requirements.
