...
description: "Try out a WebSub/WebHook API from the Developer Portal by generating a token, creating a callback URL, and (un)subscribing to a topic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/create-api/create-streaming-api/test-a-websub-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/design/create-api/create-streaming-api/test-a-websub-api.md
tags:
  - api-manager
  - websub
  - streaming-apis
