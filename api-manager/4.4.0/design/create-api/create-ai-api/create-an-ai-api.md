...
2. Click **Create API** and then click **AI API**.
    ...
    [![Select AI API](../../../assets/img/learn/select-ai-api.png){: style="width:90%"}](../../../assets/img/learn/select-ai-api.png)

3. Select the desired **AI Provider** and the relevant **AI Provider API Version** and click Next.

    [![Select AI Service Provider and Version](../../../assets/img/learn/create-ai-api.png){: style="width:90%"}](../../../assets/img/learn/create-ai-api.png)

    <div class="admonition note">
    <p class="admonition-title">Note</p>
    <p>The available <b>AI service providers and versions</b> will appear on relevant dropdowns. In adition to inbuild AI service vendors, you can also <a href='../../../../administer/ai-vendors/custom-ai-vendor/'>configure custom AI service vendors</a>.</p>
    </div>
...
[![Get Mistral API Key](../../../assets/img/learn/mistral-api-key.png){: style="width:90%"}](../../../assets/img/learn/mistral-api-key.png)
</div>
</html>
...
2. Fill **API Key** for Production and Sandbox Endpoints using the key which was obtained from Step 2.
    ...
    [![API Key Configurations](../../../assets/img/learn/ai-api-auth.png){: style="width:90%"}](../../../assets/img/learn/ai-api-auth.png)
...
-   [Rate Limiting for AI APIs](../../../design/rate-limiting/rate-limiting-for-ai-apis.md)
