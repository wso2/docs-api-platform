...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/deploy-and-publish/deploy-on-gateway/api-gateway/api-gateways-with-dedicated-backends/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/deploy-and-publish/deploy-on-gateway/api-gateway/api-gateways-with-dedicated-backends.md
tags:
  - api-manager
  - api-gateway
  - deployment
...
3.  Save and [publish](../../../deploy-and-publish/publish-on-dev-portal/publish-an-api.md) the API.
