---
title: "Pass end-user attributes to the backend via the API Gateway"
description: "Configure the Gateway to send end-user attributes to the backend as a signed JWT, customize the claims generator, and validate via JWKS."
...
--8<-- "api-manager/4.4.0/includes/deploy/backend-jwt-intro.md"
...
--8<-- "api-manager/4.4.0/includes/deploy/backend-jwt-note.md"
...
--8<-- "api-manager/4.4.0/includes/deploy/backend-jwt-gw-note.md"
