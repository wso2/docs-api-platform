...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/deploy-and-publish/deploy-on-gateway/deploy-api/exposing-apis-via-custom-hostnames/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/deploy-and-publish/deploy-on-gateway/deploy-api/exposing-apis-via-custom-hostnames.md
tags:
  - api-manager
...
--8<-- "api-manager/4.4.0/includes/deploy/assign-custom-hostname.md"
...
--8<-- "api-manager/4.4.0/includes/deploy/view-custom-hostname.md"
