...
description: "Start and stop the WSO2 API Manager runtime, access the Management Console, Publisher, and Developer Portal, and troubleshoot startup errors."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/install-and-setup/install/installing-the-product/running-the-api-m/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/install-and-setup/install/installing-the-product/running-the-api-m.md
tags:
  - api-manager
  - installation
  - troubleshooting
...
!!! Info  
    ...
    - [Changing the API-M hostname](../../../install-and-setup/setup/deployment-best-practices/changing-the-hostname.md#changing-the-api-m-hostname)
    - [Changing the default API-M ports](../../../install-and-setup/setup/deployment-best-practices/changing-the-default-ports-with-offset.md#changing-the-default-api-m-ports)
...
-   [Running API-M as a Windows Service](../../../install-and-setup/install/installing-the-product/installing-api-m-as-a-windows-service.md)
-   [Running API-M as a Linux Service](../../../install-and-setup/install/installing-the-product/installing-api-m-as-a-linux-service.md)