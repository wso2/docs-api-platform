...
description: "Design, publish, and invoke a GraphQL API in WSO2 API Manager, including its query, mutation, and subscription operations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/tutorials/create-and-publish-a-graphql-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/tutorials/create-and-publish-a-graphql-api.md
tags:
  - api-manager
  - graphql
  - developer-portal
...
--8<-- "api-manager/4.4.0/includes/design/create-graphql-api.md"
