...
!!! Note
    Moesif Analytics integration is supported starting from WSO2 API Manager 4.4.0 Update Level 55 and onwards. Ensure that you are using a compatible update level of WSO2 API Manager 4.4.0.
