...
description: "Guidelines for designing and deploying APIs with API Manager, covering resource naming conventions and API versioning strategy."
...
-   Identify potential error-prone situations and define corresponding error messages .
