---
title: "Working with the API Manager Source Code"
description: "Find the GitHub repositories for WSO2 API Manager source code, along with links for building WSO2 products with Maven and contributing to the code base."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/reference/working-with-the-source-code/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/reference/working-with-the-source-code.md
tags:
  - api-manager
  - source-code
  - contributing
