...
description: "Configure the custom.tagCloud.active attribute in userTheme.json to enable or disable the tag cloud, and set colorOptions and leftMenu styling."
