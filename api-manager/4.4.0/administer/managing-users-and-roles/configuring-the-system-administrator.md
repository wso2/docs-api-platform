...
description: "Configure the admin user, stored in the primary user store, that is assigned full permissions in WSO2 API Manager by default."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/administer/managing-users-and-roles/configuring-the-system-administrator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/administer/managing-users-and-roles/configuring-the-system-administrator.md
tags:
  - api-manager
  - administer
