...
2. Select `IP Addresses`, add the IP addresses in the text input as shown below, and generate the key.
   ...
   [![IP Restricted API key]({BASE_URL}/api-manager/4.4.0/assets/img/learn/ip-api-key.png)]({BASE_URL}/api-manager/4.4.0/assets/img/learn/ip-api-key.png)
...
2. Select `HTTP Referrers (Web Sites)` and add the referrers in the text input as shown below and generate the key.
   ...
   [![HTTP Referer Restricted API key]({BASE_URL}/api-manager/4.4.0/assets/img/learn/http-referer-api-key.png)]({BASE_URL}/api-manager/4.4.0/assets/img/learn/http-referer-api-key.png)