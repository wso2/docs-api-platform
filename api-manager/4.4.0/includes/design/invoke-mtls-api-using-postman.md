...
1. Navigate to the certificates tab in Postman settings.
     ...
     [![Add the certificate to Postman]({BASE_URL}/api-manager/4.4.0/assets/img/learn/add-certificate-to-postman.png)]({BASE_URL}/api-manager/4.4.0/assets/img/learn/add-certificate-to-postman.png)
    
2. Add the certificate and private key.

     [![Provide certificate and private key]({BASE_URL}/api-manager/4.4.0/assets/img/learn/provide-crt-and-private-key.png)]({BASE_URL}/api-manager/4.4.0/assets/img/learn/provide-crt-and-private-key.png)
