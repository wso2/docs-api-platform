...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/consume/manage-application/create-application/
md_url: https://wso2.com/api-platform/docs/api-manager/4.4.0/consume/manage-application/create-application.md
tags:
  - api-manager
  - developer-portal
  - applications
