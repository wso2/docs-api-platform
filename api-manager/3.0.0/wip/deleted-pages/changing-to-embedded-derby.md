...
description: "Set up an embedded Apache Derby database and configure datasources and tables to replace the default H2 database in WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/wip/deleted-pages/changing-to-embedded-derby/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/wip/deleted-pages/changing-to-embedded-derby.md
tags:
  - api-manager
  - wip
  - deleted-pages
