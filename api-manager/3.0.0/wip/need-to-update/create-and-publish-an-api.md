...
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/wip/need-to-update/create-and-publish-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/wip/need-to-update/create-and-publish-an-api.md
tags:
  - api-manager
  - wip
  - need-to-update
