...
description: "Configure allowed CORS origins as system parameters for the Publisher, Developer Portal, and Gateway REST APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/develop/product-apis/advanced-configurations/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/develop/product-apis/advanced-configurations.md
tags:
  - api-manager
  - develop
  - product-apis
