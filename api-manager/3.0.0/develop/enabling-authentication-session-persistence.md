...
description: "Enable authentication session persistence in WSO2 API Manager by configuring session data persistence settings in identity.xml."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/develop/enabling-authentication-session-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/develop/enabling-authentication-session-persistence.md
tags:
  - api-manager
  - develop
