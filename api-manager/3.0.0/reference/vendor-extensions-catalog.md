...
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/reference/vendor-extensions-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/reference/vendor-extensions-catalog.md
tags:
  - api-manager
  - reference
...
In OpenAPI version 2.0 (Swagger)
       ```
        securityDefinitions:
            default:
                type: "oauth2"
                flows:
                    implicit:
                        ...
                        x-scopes-bindings: {}
       ```
In OpenAPI version 3.0 (OpenAPI)
       ```
        securitySchemes:
            default:
                type: "oauth2"
...
The following examples associate the internal/subscriber role with the given scope for Swagger definition and OpenAPI definition.
