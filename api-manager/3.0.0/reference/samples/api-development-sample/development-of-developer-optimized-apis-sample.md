...
description: "Explains a sample scenario for developing APIs optimized for different client devices, such as mobile, PC, and TV."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/reference/samples/api-development-sample/development-of-developer-optimized-apis-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/reference/samples/api-development-sample/development-of-developer-optimized-apis-sample.md
tags:
  - api-manager
  - reference
  - samples
...
-   [Business APIs accessed by different parties via different devices](#business-apis-accessed-by-different-parties-via-different-devices)
-   [Same API accessed by different clients](#same-api-accessed-by-different-clients)
-   [API developer optimizing the API output by identifying the client](#api-developer-optimizing-the-api-output-by-identifying-the-client)

<a name="business-apis-accessed-by-different-parties-via-different-devices"></a>
...
<a name="same-api-accessed-by-different-clients"></a>
...
<a name="api-developer-optimizing-the-api-output-by-identifying-the-client"></a>
