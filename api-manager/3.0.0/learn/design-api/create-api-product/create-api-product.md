...
description: "Create an API Product that bundles resources from multiple existing APIs into one interface."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api-product/create-api-product/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api-product/create-api-product.md
tags:
  - api-manager
  - learn
  - design-api
...
9. Sign in to the Developer Portal to subscribe and consume the API Product in the same way that you would do so for an API. 
     ...
     For more information on how to subscribe to an API, see [Subscribe to an API](../../consume-api/manage-subscription/subscribe-to-an-api).
