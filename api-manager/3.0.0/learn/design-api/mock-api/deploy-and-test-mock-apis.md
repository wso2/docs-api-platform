...
description: "Deploy an existing API as a prototype and test it before publishing to gather early feedback from subscribers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/mock-api/deploy-and-test-mock-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/mock-api/deploy-and-test-mock-apis.md
tags:
  - api-manager
  - learn
  - design-api
...
!!! note
    ...
    [Create a New API Version](../api-versioning/create-a-new-api-version).
...
1.  Sign in to the WSO2 API Publisher `https://<hostname>:9443/publisher` and click on the API (e.g., `PizzaShackAPI 2.0.0`) that you want to prototype.
     ...
     [![PizzaShack API in the Publisher](../../../assets/img/learn/prototype-api-pizzashack-publisher.png)](../../../assets/img/learn/prototype-api-pizzashack-publisher.png)
...
4.  Click **View in Dev Portal** in the API Publisher to navigate to the Developer Portal.
    ...
    [![Prototyped API in Developer Portal](../../../assets/img/learn/prototype-api-in-dev-portal.png)](../../../assets/img/learn/prototype-api-in-dev-portal.png)
