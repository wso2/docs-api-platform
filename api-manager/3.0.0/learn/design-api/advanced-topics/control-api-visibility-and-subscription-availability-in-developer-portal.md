...
description: "Control which user roles can view and subscribe to APIs published in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal.md
tags:
  - api-manager
  - learn
  - design-api
...
2.  [Create a new API](../create-api/create-a-rest-api) or edit an existing API.
