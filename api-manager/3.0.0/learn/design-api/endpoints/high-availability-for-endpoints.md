...
description: "Configure load balancing and failover endpoints for an API to distribute traffic and improve availability."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/endpoints/high-availability-for-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/endpoints/high-availability-for-endpoints.md
tags:
  - api-manager
  - learn
  - design-api
...
1. When you [create an API](../create-api/create-a-rest-api), to configure load balancing endpoints go to the edit view of the API, click **Endpoint** to view the Endpoint page.
...
1. When you [create an API](../create-api/create-a-rest-api), to configure failover endpoints go to the edit view of the API, click **Endpoint** to view the Endpoint page.
