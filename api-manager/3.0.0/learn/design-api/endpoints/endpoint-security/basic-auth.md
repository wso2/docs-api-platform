...
description: "Secure an API endpoint with Basic Authentication by configuring credentials in the Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/endpoints/endpoint-security/basic-auth/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/endpoints/endpoint-security/basic-auth.md
tags:
  - api-manager
  - learn
  - design-api
