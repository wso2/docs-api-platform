...
description: "Upload a self-signed backend certificate to the Gateway truststore through the Publisher without restarting the server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/endpoints/certificates/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/endpoints/certificates.md
tags:
  - api-manager
  - learn
  - design-api
...
2. [Create a new API](../create-api/create-a-rest-api) or click on an existing API.
