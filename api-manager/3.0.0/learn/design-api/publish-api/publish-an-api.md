...
description: "Publish an API from the CREATED lifecycle state to make it visible and available for subscription in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/publish-api/publish-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/publish-api/publish-an-api.md
tags:
  - api-manager
  - learn
  - design-api
...
1.  Sign in to the API Publisher (`https://localhost:9443/publisher`). 
     ...
     The list of APIs in the API Publisher appears. If there are no APIs created, [create an API](../create-api/create-a-rest-api) before starting.
