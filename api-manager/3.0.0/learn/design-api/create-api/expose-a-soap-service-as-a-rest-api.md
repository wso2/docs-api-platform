...
description: "Expose an existing SOAP or WSDL-based service as a REST API using the Pass Through option in the Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/expose-a-soap-service-as-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/expose-a-soap-service-as-a-rest-api.md
tags:
  - api-manager
  - learn
  - design-api
...
For more information on API publishing, see [Publish API](../publish-api/publish-an-api).
