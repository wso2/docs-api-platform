...
description: "Design and expose a WebSocket backend as a secured, throttled API through the API Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/create-a-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/create-a-websocket-api.md
tags:
  - api-manager
  - learn
  - design-api
...
[OAuth security](../../api-security/api-authentication/secure-apis-using-oauth2-tokens), [Throttling](../../rate-limiting/introducing-throttling-use-cases), [Analytics](../../analytics/overview-of-api-analytics), etc.
...
Now, you have successfully created and configured a WebSocket API. Next, let's [Publish your API](../publish-api/publish-an-api).
