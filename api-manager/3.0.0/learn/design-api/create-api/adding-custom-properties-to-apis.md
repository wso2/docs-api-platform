...
description: "Add custom properties to an API via the Publisher or REST API and search APIs using those properties."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/adding-custom-properties-to-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/adding-custom-properties-to-apis.md
tags:
  - api-manager
  - learn
  - design-api
...
2.  [Create a new API](create-a-rest-api) or edit an existing API.
