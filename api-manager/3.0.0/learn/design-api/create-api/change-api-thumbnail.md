...
description: "Change an API's thumbnail image by uploading a new image or designing one in the Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/change-api-thumbnail/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/create-api/change-api-thumbnail.md
tags:
  - api-manager
  - learn
  - design-api
...
5. Click  **SAVE** to save the thumbnail.
     [![change thumbnail design icon](../../../assets/img/learn/change-thumbnail-design-icon.png)](../../../assets/img/learn/change-thumbnail-design-icon.png) 
