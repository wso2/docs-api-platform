...
description: "Create a new version of a published API to change its behavior, resources, or security without disrupting subscribers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/api-versioning/create-a-new-api-version/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/design-api/api-versioning/create-a-new-api-version.md
tags:
  - api-manager
  - learn
  - design-api
...
authentication mechanism, resources, [throttling tiers](../../rate-limiting/introducing-throttling-use-cases), target audiences, etc. WSO2 does not recommend to modify a published API that has subscribers plugged into it.
...
!!! note
    ...
    [Create a REST API](../create-api/create-a-rest-api) section and Published in the [Publish an API](../publish-api/publish-an-api) section.
...
1.  Sign in to the WSO2 API Publisher.
     ...
     Create and publish an API. For more information, see [Create a REST API](../create-api/create-a-rest-api) and [Publish an API](../publish-api/publish-an-api).
...
!!! note
    For more details on the default version, see [Backward Compatibility](backward-compatibility) section.
...
[publish the new version and deprecate old API versions](deprecate-the-old-version).
