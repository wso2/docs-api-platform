...
8.  Include the access token as a header in the API client object, to invoke the API. If the access token you generated above is a JWT access token, you can replace the ```accessToken``` string with the JWT obtained.
