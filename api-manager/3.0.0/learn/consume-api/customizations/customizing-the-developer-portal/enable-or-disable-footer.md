...
description: "Hide or customize the Developer Portal footer text and colors by editing the defaultTheme.js file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/consume-api/customizations/customizing-the-developer-portal/enable-or-disable-footer/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/consume-api/customizations/customizing-the-developer-portal/enable-or-disable-footer.md
tags:
  - api-manager
  - learn
  - consume-api
