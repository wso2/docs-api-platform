...
description: "Integrate Facebook login with WSO2 Identity Server so users can sign in to the Developer Portal using social media."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/consume-api/customizations/log-in-to-the-dev-portal-using-social-media/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/consume-api/customizations/log-in-to-the-dev-portal-using-social-media.md
tags:
  - api-manager
  - learn
  - consume-api
...
!!! note
        You have to allow the usage of email addresses as usernames, to use email addresses. For instructions, see [Setting up an e-mail login](../../../administer/product-security/logins-and-passwords/maintaining-logins-and-passwords#setting-up-an-e-mail-login).
