...
description: "Explains the Developer Portal's community features for searching APIs and rating and commenting on published API versions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/consume-api/collaboration/use-the-community-features/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/consume-api/collaboration/use-the-community-features.md
tags:
  - api-manager
  - learn
  - consume-api
