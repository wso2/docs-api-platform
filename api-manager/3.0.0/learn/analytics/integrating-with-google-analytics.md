...
description: "Configure API Manager to feed runtime API invocation statistics into a Google Analytics account."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/integrating-with-google-analytics/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/integrating-with-google-analytics.md
tags:
  - api-manager
  - learn
  - analytics
