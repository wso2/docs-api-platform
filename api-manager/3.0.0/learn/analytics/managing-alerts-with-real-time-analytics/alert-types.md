---
title: "Alert types"
description: "Lists the alert types supported by WSO2 API Manager analytics, such as abnormal response time, tier limit hitting, and API availability."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/managing-alerts-with-real-time-analytics/alert-types/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/managing-alerts-with-real-time-analytics/alert-types.md
tags:
  - api-manager
  - learn
  - analytics
...
!!! info
     For more information on API status changing over availability of APIs, see [Viewing Availability Of APIs](../analyzing-apim-statistics-with-batch-analytics/viewing-api-statistics#availability-of-apis).
