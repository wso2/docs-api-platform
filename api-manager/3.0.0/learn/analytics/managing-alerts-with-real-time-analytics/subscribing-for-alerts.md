...
description: "Subscribe administrators, API publishers, and subscribers to alert types to receive email notifications from API Manager analytics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/managing-alerts-with-real-time-analytics/subscribing-for-alerts/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/managing-alerts-with-real-time-analytics/subscribing-for-alerts.md
tags:
  - api-manager
  - learn
  - analytics
