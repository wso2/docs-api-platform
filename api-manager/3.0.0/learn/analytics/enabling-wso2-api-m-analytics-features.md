...
description: "Enable API-M Analytics features by updating the deployment.yaml file across the Stream Processor profiles."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/enabling-wso2-api-m-analytics-features/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/analytics/enabling-wso2-api-m-analytics-features.md
tags:
  - api-manager
  - learn
  - analytics
