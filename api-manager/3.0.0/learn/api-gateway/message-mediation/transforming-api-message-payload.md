...
description: "Explains how the API Gateway's message builders and formatters transform request and response payloads between content types."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/message-mediation/transforming-api-message-payload/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/message-mediation/transforming-api-message-payload.md
tags:
  - api-manager
  - learn
  - api-gateway
...
!!! tip
    ...
    [engaging <code>In/Out</code> sequences](changing-the-default-mediation-flow-of-api-requests).
