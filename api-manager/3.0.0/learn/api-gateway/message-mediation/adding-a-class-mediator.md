...
description: "Write a Java class mediator that extends AbstractMediator to customize the API Gateway's message mediation flow."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/message-mediation/adding-a-class-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/message-mediation/adding-a-class-mediator.md
tags:
  - api-manager
  - learn
  - api-gateway
