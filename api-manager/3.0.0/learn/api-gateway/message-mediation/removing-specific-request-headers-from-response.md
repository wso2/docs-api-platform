...
description: "Remove sensitive HTTP headers from API responses per API or globally, including for error responses handled by main.xml."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/message-mediation/removing-specific-request-headers-from-response/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/message-mediation/removing-specific-request-headers-from-response.md
tags:
  - api-manager
  - learn
  - api-gateway
...
!!! example
    ...
    ```
Check out [Changing the Default Mediation Flow of API Requests](changing-the-default-mediation-flow-of-api-requests) to learn on how to
