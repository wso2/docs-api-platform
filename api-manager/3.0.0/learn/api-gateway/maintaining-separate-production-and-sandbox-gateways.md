...
description: "Explains how to set up single or multiple API Gateway instances to separately handle production and sandbox traffic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/maintaining-separate-production-and-sandbox-gateways/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/maintaining-separate-production-and-sandbox-gateways.md
tags:
  - api-manager
  - learn
  - api-gateway
