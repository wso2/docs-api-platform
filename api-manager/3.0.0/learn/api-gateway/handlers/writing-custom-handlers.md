...
description: "Write a custom handler for the API Gateway synapse configuration to extend the mediation flow of an API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/handlers/writing-custom-handlers/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/handlers/writing-custom-handlers.md
tags:
  - api-manager
  - learn
  - api-gateway
...
WSO2 API Manager provides the OAuth2 bearer token as its default authentication mechanism. A sample implementation is <a href="../../../../assets/attachments/learn/api-authentication-handler.java" download>here</a>. Similarly, you can extend the API Manager to 
