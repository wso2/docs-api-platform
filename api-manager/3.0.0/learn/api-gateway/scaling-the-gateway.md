...
description: "Explains capacity planning considerations and key caching strategies for clustering Gateways with Key Managers at scale."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/scaling-the-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/scaling-the-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
