...
description: "Configure regex-based threat protection to detect and block SQL, JavaScript, and XPath injection attempts in API traffic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/threat-protectors/regular-expression-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/threat-protectors/regular-expression-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
...
4.  Select `regex_policy` from the drop-down menu for Common Policies.
    ...
    [ ![](../../../assets/img/learn/mediation-regex-policy.png) ](../../../assets/img/learn/mediation-regex-policy.png)
