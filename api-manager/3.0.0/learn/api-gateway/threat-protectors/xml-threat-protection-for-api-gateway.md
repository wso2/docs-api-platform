...
description: "Configure the XML threat protector's validation limits and schema validation to guard the Gateway against XML-based attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/threat-protectors/xml-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/threat-protectors/xml-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
