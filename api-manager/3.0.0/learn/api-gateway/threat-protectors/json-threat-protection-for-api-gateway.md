...
description: "Configure the JSON threat protector's validation limits and apply the json_validator policy to guard against payload attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/threat-protectors/json-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/threat-protectors/json-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
