...
description: "Configure parameterized endpoints so each API Gateway environment points to a different dedicated backend endpoint."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/api-gateways-with-dedicated-backends/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-gateway/api-gateways-with-dedicated-backends.md
tags:
  - api-manager
  - learn
  - api-gateway
