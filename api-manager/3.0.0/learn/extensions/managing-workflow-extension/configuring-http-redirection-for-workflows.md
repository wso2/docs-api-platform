...
description: "Configure a custom workflow extension to redirect subscribers to a third-party URL, such as a payment collector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/extensions/managing-workflow-extension/configuring-http-redirection-for-workflows/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/extensions/managing-workflow-extension/configuring-http-redirection-for-workflows.md
tags:
  - api-manager
  - learn
  - extensions
...
The API Manager can be invoked from a third party entity through the [update workflow status method](../../../develop/product-apis/admin-apis/admin-v0.15/admin-v0.15#/Workflows (Individual)/post_workflows_update_workflow_status). Refer the [Admin REST APIs](../../../develop/product-apis/admin-apis/admin-v0.15/admin-v0.15#/Workflows (Individual)/post_workflows_update_workflow_status) to learn how to invoke it.  Note that the Admin REST API resources require authentication before invocation.