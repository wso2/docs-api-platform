...
description: "Walk through designing and publishing an API with a WebSocket backend, then invoking it using the wscat client."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/tutorials/create-and-publish-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/tutorials/create-and-publish-websocket-api.md
tags:
  - api-manager
  - learn
  - tutorials
...
<p>For more information on WebSocket APIs, see <a href="../../design-api/create-api/create-a-websocket-api.md">Create a WebSocket API</a>.</p>
</div> 
</html>
...
5.  Optionally, enter the endpoint configurations.
     ...
     2. Click the **Endpoint Advanced Configurations** link as shown below and update the endpoint related configurations as required.
         ...
         - [Endpoint Timeouts](../design-api/endpoints/resiliency/endpoint-timeouts)
         - [Endpoint Suspension](../design-api/endpoints/resiliency/endpoint-suspension)
         - [Prevent API Suspension](../design-api/endpoints/resiliency/prevent-api-suspension)
