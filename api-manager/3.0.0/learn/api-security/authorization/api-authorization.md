...
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/authorization/api-authorization/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/authorization/api-authorization.md
tags:
  - api-manager
  - learn
  - api-security
...
[Fine Grained Access Control Using Scopes](../oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes)

[Fine Grained Access Control Using XACML](role-based-access-control-using-xacml)