...
description: "Secure an API with mutual SSL in addition to OAuth2 by uploading a client certificate through the Publisher Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-authentication/secure-apis-using-mutual-ssl/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-authentication/secure-apis-using-mutual-ssl.md
tags:
  - api-manager
  - learn
  - api-security
...
1.  Import the certificate and private key to Postman. Navigate to the certificates tab in Postman settings.
    ...
    [![](../../../assets/img/learn/add-certificate-to-postman.png)](../../../assets/img/learn/add-certificate-to-postman.png)
    
    Add the certificate and private key.
    [![](../../../assets/img/learn/provide-crt-and-private-key.png)](../../../assets/img/learn/provide-crt-and-private-key.png)
...
![](../../../assets/img/learn/mtls-loadbalancer.png)
