...
description: "Change the default 60-minute expiration time of application access tokens by editing identity.xml."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-authentication/advanced-topics/changing-the-default-token-expiration-time/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-authentication/advanced-topics/changing-the-default-token-expiration-time.md
tags:
  - api-manager
  - learn
  - api-security
