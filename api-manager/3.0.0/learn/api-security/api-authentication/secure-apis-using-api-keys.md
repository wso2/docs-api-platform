...
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-authentication/secure-apis-using-api-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-authentication/secure-apis-using-api-keys.md
tags:
  - api-manager
  - learn
  - api-security
...
WSO2 API Manager uses a self-contained JWT access token as the API key, and this JWT access token is generated via the Developer Portal without communicating with the Key Manager.
