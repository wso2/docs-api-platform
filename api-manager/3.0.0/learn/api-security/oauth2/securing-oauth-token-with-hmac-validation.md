...
description: "Use HMAC and timestamp verification to validate OAuth tokens issued by API Manager and WSO2 Identity Server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/securing-oauth-token-with-hmac-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/securing-oauth-token-with-hmac-validation.md
tags:
  - api-manager
  - learn
  - api-security
