...
description: "Create an OAuth2 application in the Developer Portal and use an opaque reference access token to invoke an API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/access-token-types/opaque-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/access-token-types/opaque-tokens.md
tags:
  - api-manager
  - learn
  - api-security
