...
description: "Create a JWT-type application in the Developer Portal and use a self-contained JWT access token to invoke an API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/access-token-types/jwt-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/access-token-types/jwt-tokens.md
tags:
  - api-manager
  - learn
  - api-security
...
2. The consumer key needs to be mapped to the application. For that, you can use [Provisioning Out-of-Band OAuth2 Clients](../provisioning-out-of-band-oauth-clients#provisioning-out-of-band-oauth2-clients).
...
3. Click **Inbound Authentication Configuration**. Expand **OAuth/OpenID Connect Configuration** and click **Edit** for the relevant OAuth Client Key.
      ...
      ![edit service providers](../../../../assets/img/learn/service-providers.png)
   
4. Change the token issuer to **JWT**. Click **Update** to save the changes.
      
      ![update token](../../../../assets/img/learn/update-token.png)
