---
title: "NTLM grant"
description: "Obtain an OAuth2 access token on a Windows API Manager instance by presenting a valid NTLM token as the authorization grant."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/grant-types/ntlm-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/oauth2/grant-types/ntlm-grant.md
tags:
  - api-manager
  - learn
  - api-security
