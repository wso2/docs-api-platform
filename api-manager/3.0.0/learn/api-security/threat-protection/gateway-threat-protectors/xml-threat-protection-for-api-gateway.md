...
description: "Edit, apply, and test the XML validator and schema validation policy in the registry to protect against XML-based attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/threat-protection/gateway-threat-protectors/xml-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/threat-protection/gateway-threat-protectors/xml-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-security
