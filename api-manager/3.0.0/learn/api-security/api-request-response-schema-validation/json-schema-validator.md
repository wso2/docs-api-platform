...
description: "Explains how the JSON Schema Validator checks API request and response payloads against the schema defined in swagger.json."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-request-response-schema-validation/json-schema-validator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-security/api-request-response-schema-validation/json-schema-validator.md
tags:
  - api-manager
  - learn
  - api-security
