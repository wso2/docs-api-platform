...
description: "Build a Jenkins CI/CD pipeline with GitHub and Postman to test and deploy APIs to WSO2 API Manager using a developer-first approach."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-controller/building-jenkins-ci-cd-pipeline-for-dev-first-approach/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/api-controller/building-jenkins-ci-cd-pipeline-for-dev-first-approach.md
tags:
  - api-manager
  - learn
  - api-controller
...
in your Jenkins server.  
     ...
     [![install node-npm-jenkins](../../assets/img/learn/api-controller/install-node-npm-jenkins.png)](../../assets/img/learn/api-controller/install-node-npm-jenkins.png)   
...
[![](../../assets/img/learn/api-controller/ci-cd-for-dev-first-approach.png)](../../assets/img/learn/api-controller/ci-cd-for-dev-first-approach.png)
...
!!! warning
    **Before you begin...**   
    ...
    if not follow the steps in [Download and Initialize the CTL Tool](getting-started-with-wso2-api-controller#download-and-initialize-the-ctl-tool).
    
    
Run the following sample command to initialize an API Project using the CTL by providing the OpenAPI specification and API Definition template. For more information, see [Initialize an API Project](importing-apis-via-dev-first-approach#initialize-an-api-project).

!!! example
    ``` bash
    apictl init SampleStore --oas store.yaml --definition api_template.yaml -k
    ```
    [![init samplestore api project](../../assets/img/learn/api-controller/init-samplestore-api-project.png)](../../assets/img/learn/api-controller/init-samplestore-api-project.png)  
...
!!! info
    ...
    -   For more information on using an environment template, see [Configuring Environment Specific Parameters](advanced-topics/configuring-environment-specific-parameters).
...
[![](../../assets/img/learn/api-controller/commit-api-project-github.png)](../../assets/img/learn/api-controller/commit-api-project-github.png)  
...
2. Add the two environments using the following sample `apictl` commands.
    ...
    !!! warning
        Make sure you have already installed `apictl` to the Jenkins server and set the Path variable. For more information, see [Download and Initialize the CTL Tool](getting-started-with-wso2-api-controller#download-and-initialize-the-ctl-tool).
...
3. Store the credentials for the two environments as Jenkins credentials.  
     ...
     [![](../../assets/img/learn/api-controller/jenkins-credentials.png)](../../assets/img/learn/api-controller/jenkins-credentials.png) 
...
4. Add the Jenkins pipeline configuration defined in [here](https://github.com/dushaniw/wso2-apim-cicd-apis/blob/master/jenkinsfile).
     ...
     [![](../../assets/img/learn/api-controller/jenkins-pipeline-build.png)](../../assets/img/learn/api-controller/jenkins-pipeline-build.png) 

     [![](../../assets/img/learn/api-controller/pipeline-config.png)](../../assets/img/learn/api-controller/pipeline-config.png) 
...
[![](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-1.png)](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-1.png) 

[![](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-2.png)](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-2.png) 

[![](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-3.png)](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-3.png) 

[![](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-4.png)](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-4.png) 

[![](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-5.png)](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-5.png) 

[![](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-6.png)](../../assets/img/learn/api-controller/jenkins-cicd-pipeline-output-6.png) 
...
[![](../../assets/img/learn/api-controller/dev-samplestoreapi.png)](../../assets/img/learn/api-controller/dev-samplestoreapi.png)

[![](../../assets/img/learn/api-controller/prod-samplestoreapi.png)](../../assets/img/learn/api-controller/prod-samplestoreapi.png) 
...
[![](../../assets/img/learn/api-controller/dev-advanced-config.png)](../../assets/img/learn/api-controller/dev-advanced-config.png) 

[![](../../assets/img/learn/api-controller/prod-advanced-config.png)](../../assets/img/learn/api-controller/prod-advanced-config.png) 
