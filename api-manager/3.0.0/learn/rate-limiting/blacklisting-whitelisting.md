...
description: "Configure IP whitelisting and blacklisting policies to control which requests are allowed to access an API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/rate-limiting/blacklisting-whitelisting/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/rate-limiting/blacklisting-whitelisting.md
tags:
  - api-manager
  - learn
  - rate-limiting
