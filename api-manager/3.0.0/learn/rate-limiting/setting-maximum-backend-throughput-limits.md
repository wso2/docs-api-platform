...
description: "Set a maximum backend throughput limit to protect an API's backend from being overwhelmed by requests."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/rate-limiting/setting-maximum-backend-throughput-limits/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/learn/rate-limiting/setting-maximum-backend-throughput-limits.md
tags:
  - api-manager
  - learn
  - rate-limiting
