...
description: "Encrypt plain text passwords in configuration files using the Cipher Tool's automated or manual encryption process."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-security/logins-and-passwords/encrypting-passwords-with-cipher-tool/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-security/logins-and-passwords/encrypting-passwords-with-cipher-tool.md
tags:
  - api-manager
  - administer
  - product-security
