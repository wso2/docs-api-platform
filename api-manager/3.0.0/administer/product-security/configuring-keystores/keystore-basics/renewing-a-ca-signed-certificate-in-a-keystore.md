...
description: "Check a certificate's validity, generate a CSR, and import the renewed CA-signed certificate into a keystore."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-security/configuring-keystores/keystore-basics/renewing-a-ca-signed-certificate-in-a-keystore/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-security/configuring-keystores/keystore-basics/renewing-a-ca-signed-certificate-in-a-keystore.md
tags:
  - api-manager
  - administer
  - product-security
