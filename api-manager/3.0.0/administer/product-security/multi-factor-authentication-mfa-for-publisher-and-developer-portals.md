---
title: "MFA for the Publisher and Developer Portal"
description: "Configure multi-factor authentication for the Publisher and Developer Portal by integrating single sign-on with WSO2 Identity Server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-security/multi-factor-authentication-mfa-for-publisher-and-developer-portals/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-security/multi-factor-authentication-mfa-for-publisher-and-developer-portals.md
tags:
  - api-manager
  - administer
  - product-security
...
1.  Configure Single Sign-On (SSO) with WSO2 Identity Server. 
     ...
     For more information, see [Configuring Identity Server as IDP for SSO](../../learn/extensions/saml2-sso/configuring-identity-server-as-idp-for-sso).
