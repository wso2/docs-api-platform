...
description: "Add a new tenant using the management console or the TenantMgtAdminService and RemoteTenantManagerService admin services."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/multitenancy/adding-new-tenants/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/multitenancy/adding-new-tenants.md
tags:
  - api-manager
  - administer
