...
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/multitenancy/managing-tenants/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/multitenancy/managing-tenants.md
tags:
  - api-manager
  - administer
...
3.  Anonymous users can browse all developer portals and all public APIs that are published to them. However, in order to subscribe to an API, the user must log in.
    ...
    !!! info
        ...
        [![](../../../assets/img/administer/tenant-admin-service-wsdl-list.png)](../../../assets/img/administer/tenant-admin-service-wsdl-list.png)
        ...
        [![](../../../assets/img/administer/tenant-admin-service-wsdl-service.png)](../../../assets/img/administer/tenant-admin-service-wsdl-service.png)
