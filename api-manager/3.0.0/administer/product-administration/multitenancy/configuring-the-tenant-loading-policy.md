...
description: "Configure lazy loading or eager loading of tenants in WSO2 API Manager, including tenant idle timeout and artifact synchronization."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/multitenancy/configuring-the-tenant-loading-policy/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/multitenancy/configuring-the-tenant-loading-policy.md
tags:
  - api-manager
  - administer
