...
description: "Enable log masking and define patterns to hide sensitive data such as credit card numbers or tokens from API Manager log files."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/monitoring/logging/masking-sensitive-information-in-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-administration/monitoring/logging/masking-sensitive-information-in-logs.md
tags:
  - api-manager
  - administer
