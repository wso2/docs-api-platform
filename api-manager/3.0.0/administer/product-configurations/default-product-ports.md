...
description: "Lists the default ports used by WSO2 API Manager and other WSO2 products, and explains how to disable HTTP transports."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-configurations/default-product-ports/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/administer/product-configurations/default-product-ports.md
tags:
  - api-manager
  - administer
