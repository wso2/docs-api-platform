...
description: "Lists the startup options and system properties you can pass to WSO2 API Manager's server startup scripts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/installation-guide/admin-product-startup-options/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/installation-guide/admin-product-startup-options.md
tags:
  - api-manager
  - install-and-setup
  - installation-guide
