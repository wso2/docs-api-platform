...
description: "Compares options for setting up a small to medium scale WSO2 API Manager deployment using single node instances."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/deploying-wso2-api-manager/single-node/deploying-api-manager-using-single-node-instances/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/deploying-wso2-api-manager/single-node/deploying-api-manager-using-single-node-instances.md
tags:
  - api-manager
  - install-and-setup
...
-   If you are interested in setting up a single node API Manager instance, which has all the API-M components in one instance,  on-premise, you can [download](https://wso2.com/api-management/previous-releases/) API Manager 3.0.0 distribution and follow the instructions given below to set up the instance.
