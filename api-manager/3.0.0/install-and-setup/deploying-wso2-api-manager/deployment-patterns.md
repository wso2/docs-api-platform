...
description: "Compares WSO2 API Manager deployment patterns, from a single all-in-one node to fully distributed component setups."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/deploying-wso2-api-manager/deployment-patterns/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/deploying-wso2-api-manager/deployment-patterns.md
tags:
  - api-manager
  - install-and-setup
