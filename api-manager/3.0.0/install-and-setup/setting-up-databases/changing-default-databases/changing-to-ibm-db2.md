...
description: "Replace the default H2 database with IBM DB2 by setting up the database, users, drivers, and running the db scripts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/setting-up-databases/changing-default-databases/changing-to-ibm-db2/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/setting-up-databases/changing-default-databases/changing-to-ibm-db2.md
tags:
  - api-manager
  - install-and-setup
