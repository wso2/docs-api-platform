...
description: "Replace the default H2 database with Microsoft SQL Server by enabling TCP/IP, creating the database, and running db scripts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/setting-up-databases/changing-default-databases/changing-to-mssql/
md_url: https://wso2.com/api-platform/docs/api-manager/3.0.0/install-and-setup/setting-up-databases/changing-default-databases/changing-to-mssql.md
tags:
  - api-manager
  - install-and-setup
...
1.  Restart the server.
    ...
    !!! note
        To give the Key Manager, Publisher, and Developer Portal components access to the user management data with shared permissions, JDBCUserStoreManager has been configured by default. For more information, see [Configuring Userstores](../../../administer/product-administration/managing-users-and-roles/managing-user-stores/configure-primary-user-store/configuring-a-jdbc-user-store).