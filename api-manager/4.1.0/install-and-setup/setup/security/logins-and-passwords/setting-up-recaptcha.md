...
description: "Register reCaptcha API keys with Google and configure the widget to protect API Manager login forms from bots."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/security/logins-and-passwords/setting-up-recaptcha/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/security/logins-and-passwords/setting-up-recaptcha.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
-   [Configuring Google reCaptcha for single
    sign-on](configuring-recaptcha-for-single-sign-on.md)
