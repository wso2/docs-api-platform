---
title: "Customizing the secure vault"
description: "Explains the Secure Vault implementation elements, including secret repository, manager, callback, and resolver."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/security/logins-and-passwords/carbon-secure-vault-implementation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/security/logins-and-passwords/carbon-secure-vault-implementation.md
tags:
  - api-manager
  - install-and-setup
  - setup
