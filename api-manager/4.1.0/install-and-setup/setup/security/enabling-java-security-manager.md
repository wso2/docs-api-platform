...
description: "Steps to enable the Java Security Manager and configure Java security permissions for WSO2 products."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/security/enabling-java-security-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/security/enabling-java-security-manager.md
tags:
  - api-manager
  - install-and-setup
  - setup
