...
description: "Learn how the Gateway, Control Plane, and Traffic Manager profiles work together to form a distributed API-M deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/distributed-deployment/understanding-the-distributed-deployment-of-wso2-api-m/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/distributed-deployment/understanding-the-distributed-deployment-of-wso2-api-m.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
According to the recommended [deployment patterns](../deployment-overview.md#simple-scalable-deployment), a distributed deployment includes API-M server nodes that separately run the [API-M profiles](product-profiles.md). An API-M profile is a server instance that only runs specific components of the API-M server.
...
-   Find out more about [running API-M profiles](product-profiles.md).
-   See the instructions on [configuring a distributed API-M deployment](deploying-wso2-api-m-in-a-distributed-setup.md).
-   See the instructions on [configuring a distributed API-M deployment with Traffic Manager separated](deploying-wso2-api-m-in-a-distributed-setup-with-tm-separated.md).