...
description: "Review WSO2 API Manager performance test results for GraphQL APIs under varying concurrent user loads."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/deployment-best-practices/performance-tests-results-graphql/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/deployment-best-practices/performance-tests-results-graphql.md
tags:
  - api-manager
  - install-and-setup
  - setup
