...
description: "Plan database and server backups and follow recovery strategies to restore a WSO2 API Manager deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/deployment-best-practices/backup-recovery/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/deployment-best-practices/backup-recovery.md
tags:
  - api-manager
  - install-and-setup
  - setup
