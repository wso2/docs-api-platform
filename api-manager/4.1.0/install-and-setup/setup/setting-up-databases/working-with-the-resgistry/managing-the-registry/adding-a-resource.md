...
description: "Add a resource to a registry collection by uploading a file, importing from a URL, or creating text or custom content."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/adding-a-resource/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/adding-a-resource.md
tags:
  - api-manager
  - install-and-setup
  - setup
