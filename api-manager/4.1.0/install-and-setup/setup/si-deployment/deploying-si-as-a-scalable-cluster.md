...
description: "Scale the Streaming Integrator horizontally using stateless or stateful high availability deployment approaches."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-deployment/deploying-si-as-a-scalable-cluster/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-deployment/deploying-si-as-a-scalable-cluster.md
tags:
  - api-manager
  - install-and-setup
  - setup
