...
description: "Encrypt plain-text secrets with apictl for use as environment variables, Docker, or Kubernetes secrets."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/api-controller/encrypting-secrets-with-ctl/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/api-controller/encrypting-secrets-with-ctl.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
-   **Command** 
    ...
    !!! example
        ```go
        apictl secret init
        Enter Key Store location: /home/wso2mi-4.1.0-SNAPSHOT/repository/resources/security/wso2carbon.jks
