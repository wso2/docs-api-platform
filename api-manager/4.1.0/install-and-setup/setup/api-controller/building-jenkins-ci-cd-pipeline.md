...
description: "Build a CI/CD pipeline for APIs using WSO2 API Controller with GitHub, JFrog Artifactory, and Jenkins webhooks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/api-controller/building-jenkins-ci-cd-pipeline/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/api-controller/building-jenkins-ci-cd-pipeline.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
2. Install the [apictl tool](getting-started-with-wso2-api-controller.md#download-and-initialize-the-apictl). Extract to a location that is henceforth referred to as `CTL_HOME`.
...
Download the WSO2 API Manager 4.1.0 [here](getting-started-with-wso2-api-controller.md#download-and-initialize-the-apictl) and start the instance. Set this in a separate instance as the `dev` instance. 
