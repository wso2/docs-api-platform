...
description: "Enable project deletion, externalize the VCS configuration file, and optimize apictl's Git integration for deploying API projects."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/api-controller/advanced-topics/configuring-git-integration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/api-controller/advanced-topics/configuring-git-integration.md
tags:
  - api-manager
  - install-and-setup
  - setup
