...
description: "Change the default Micro Integrator ports to avoid conflicts when running multiple instances on one server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/changing_default_ports/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/changing_default_ports.md
tags:
  - api-manager
  - install-and-setup
  - setup
