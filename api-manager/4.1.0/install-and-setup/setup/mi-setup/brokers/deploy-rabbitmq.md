...
description: "Set up a single-node RabbitMQ deployment for testing and review production deployment guidelines."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/brokers/deploy-rabbitmq/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/brokers/deploy-rabbitmq.md
tags:
  - api-manager
  - install-and-setup
  - setup
