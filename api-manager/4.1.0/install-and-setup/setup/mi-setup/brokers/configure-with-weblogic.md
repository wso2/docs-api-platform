...
description: "Configure WSO2 Micro Integrator to connect with Oracle WebLogic Server and exchange messages over JMS queues."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/brokers/configure-with-weblogic/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/brokers/configure-with-weblogic.md
tags:
  - api-manager
  - install-and-setup
  - setup
