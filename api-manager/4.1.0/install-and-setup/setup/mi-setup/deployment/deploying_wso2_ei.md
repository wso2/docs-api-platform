...
For detailed information on configuring RDBMS coordination parameters, including heartbeat configuration and rolling updates, see [RDBMS Coordination Configuration](../feature_configs/configuring_rdbms_coordination.md).
