...
description: "Configure NGINX as a load balancer to distribute HTTP and HTTPS traffic across a clustered Micro Integrator deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/deployment/setting_up_lb/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/deployment/setting_up_lb.md
tags:
  - api-manager
  - install-and-setup
  - setup
