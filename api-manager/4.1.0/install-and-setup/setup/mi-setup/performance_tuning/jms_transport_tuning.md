...
To increase the JMS listener performance, add the following parameters to the [JMS listener configuration](../../../../reference/config-catalog-mi.md#jms-transport-listener) in the `deployment.toml` file (stored in the `MI_HOME/conf`):
...
To increase the JMS sender performance, add the following parameters to the [JMS listener configuration](../../../../reference/config-catalog-mi.md#jms-transport-sender) in the `deployment.toml` file (stored in the `MI_HOME/conf`):
