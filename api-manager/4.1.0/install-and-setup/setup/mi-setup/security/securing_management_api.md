...
description: "Secure the Micro Integrator management API with JWT-based authentication for login, logout, and access control."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/securing_management_api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/securing_management_api.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
The [API Controller](../../api-controller/getting-started-with-wso2-api-controller.md) and the [Micro Integrator dashboard](../../../../observe/mi-observe/working-with-monitoring-dashboard.md) communicates with this service to
obtain administrative information of the server instance and to perform various administration tasks. If required, you can [directly access the management API](../../../../observe/mi-observe/working-with-management-api.md) without using the dashboard or CLI.
...
!!! Info
    User authentication in the management API uses the file-based user store by default. If required, you can configure an [LDAP](../user_stores/setting_up_a_userstore.md#configuring-an-ldap-user-store) or [RDBMS](../user_stores/setting_up_a_userstore.md#configuring-an-rdbms-user-store) user store.
...
When you [access the management API directly](../../../../observe/mi-observe/working-with-management-api.md), you must first acquire a JWT token with your valid username and password. To log out of the management API, this token must be revoked. See [securely invoking the management API](../../../../observe/mi-observe/working-with-management-api.md#securely-invoking-the-api) for more information.

When you use the [Micro Integrator Dashboard](../../../../observe/mi-observe/working-with-monitoring-dashboard.md) or the [API Controller](../../api-controller/getting-started-with-wso2-api-controller.md), JWT token-based authentication is handled internally.

### Disable user authentication

!!! Note
    The [management API](../../../../observe/mi-observe/working-with-management-api.md) and related tools (the [CLI](../../api-controller/getting-started-with-wso2-api-controller.md) and the [dashboard](../../../../observe/mi-observe/working-with-monitoring-dashboard.md) will not be accessible if authentication is disabled.
...
!!! Note
    Authorization does not apply to users in the default file-based user store. Therefore, be sure to configure an [LDAP](../user_stores/setting_up_a_userstore.md#configuring-an-ldap-user-store) or [RDBMS](../user_stores/setting_up_a_userstore.md#configuring-an-rdbms-user-store) user store if you want authorization to be effective.
