...
description: "Configure the default primary keystore and internal keystore used by the Micro Integrator for encryption and signing."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/configuring_keystores/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/configuring_keystores.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
1. [Create a new keystore](creating_keystores.md). 
...
3. Open the `deployment.toml` file and add the relevant configurations as described below.
    ...
    Find more details about [keystore parameters](../../../../reference/config-catalog-mi.md).
    
3. [Import the required CA-signed certificates](importing_ssl_certificate.md) to the key store.
...
3.  Open the `deployment.toml` file and add the relevant configurations as described below.
    ...
    -   If you are using a Micro Integrator <b>without</b> updates, use the following configuration and change the values. 
        ...
        key_password="wso2carbon"
        ```
    Find more details about [internal keystore parameters](../../../../reference/config-catalog-mi.md#internal-keystore).
...
3. [Import the required certificates](importing_ssl_certificate.md#importing-ssl-certificates-to-a-truststore) to the truststore.