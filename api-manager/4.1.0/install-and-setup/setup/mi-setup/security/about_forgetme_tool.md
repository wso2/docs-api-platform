...
description: "Build and run the Forget Me identity anonymization tool in standalone mode to remove a user's PII from WSO2 products."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/about_forgetme_tool/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/about_forgetme_tool.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
> WSO2 Micro Integrator is shipped with the **Forget Me** tool, which is used for anonymizing personally identifiable information (PII) that are stored in the Micro Integrator. See [GDPR Compliance in the WSO2 Micro Integrator](gdpr_ei.md) for instructions.
