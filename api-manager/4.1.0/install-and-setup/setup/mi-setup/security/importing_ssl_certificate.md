...
description: "Generate a certificate signing request and import a CA-signed SSL certificate into a Micro Integrator keystore and trust store."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/importing_ssl_certificate/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/security/importing_ssl_certificate.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
Follow the steps given below to add a new [CA-signed certificate](../../../../reference/mi-security-reference/using_keystores.md) to your [keystores](../../../../reference/mi-security-reference/using_keystores.md). Note that you do not need to create a new keystore every time you need a CA-signed certificate.
...
If required, [renew the CA-signed certificate](renewing_ca_signed_certificate_in_keystore.md) in your keystore and trust store.