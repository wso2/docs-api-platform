...
description: "Apply the latest bug fixes and security patches to WSO2 Micro Integrator using the in-place update tools."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/updating-mi/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/mi-setup/updating-mi.md
tags:
  - api-manager
  - install-and-setup
  - setup
