...
description: "Lists secure cipher suites supported for TLSv1.2 and TLSv1.3 in Tomcat and links to disabling weak ciphers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/reference/supported-cipher-suites/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/reference/supported-cipher-suites.md
tags:
  - api-manager
  - install-and-setup
  - setup
