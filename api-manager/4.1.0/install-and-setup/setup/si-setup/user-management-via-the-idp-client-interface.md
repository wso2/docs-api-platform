...
description: "Switch between local and external IdP clients to manage user authentication in Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-setup/user-management-via-the-idp-client-interface/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-setup/user-management-via-the-idp-client-interface.md
tags:
  - api-manager
  - install-and-setup
  - setup
