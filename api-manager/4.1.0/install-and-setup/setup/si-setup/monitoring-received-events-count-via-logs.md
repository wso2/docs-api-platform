...
description: "Configure WSO2 Streaming Integrator to log the total number of received events over a specified time interval."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-setup/monitoring-received-events-count-via-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-setup/monitoring-received-events-count-via-logs.md
tags:
  - api-manager
  - install-and-setup
  - setup
