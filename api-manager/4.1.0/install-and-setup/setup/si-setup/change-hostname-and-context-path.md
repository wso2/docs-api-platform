---
title: "Changing the host name and context path"
description: "Configure the host name and context path shown in the URL for Streaming Integrator web UI applications."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-setup/change-hostname-and-context-path/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/si-setup/change-hostname-and-context-path.md
tags:
  - api-manager
  - install-and-setup
  - setup
