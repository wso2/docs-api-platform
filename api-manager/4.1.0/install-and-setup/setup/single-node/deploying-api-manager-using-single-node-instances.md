...
description: "Deploy API Manager as a single node instance with all components combined, instead of a distributed setup."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/single-node/deploying-api-manager-using-single-node-instances/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/single-node/deploying-api-manager-using-single-node-instances.md
tags:
  - api-manager
  - install-and-setup
  - setup
