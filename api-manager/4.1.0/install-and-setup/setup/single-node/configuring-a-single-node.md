...
description: "Manually configure and deploy WSO2 API Manager as a single standalone instance without HA or clustering."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/single-node/configuring-a-single-node/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/setup/single-node/configuring-a-single-node.md
tags:
  - api-manager
  - install-and-setup
  - setup
