---
title: "Running API Manager 3.2.0 analytics as a Windows service"
description: "Explains how to set up API Manager Analytics 3.2.0 to run as a Windows service using the YAJSW wrapper."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/install/installing-the-product/installing-api-m-analytics-as-a-windows-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/install/installing-the-product/installing-api-m-analytics-as-a-windows-service.md
tags:
  - api-manager
  - install-and-setup
  - install
...
!!! info
    ...
    If you want to set additional properties from an external registry at runtime, store sensitive information like usernames and passwords for connecting to the registry in a properties file and secure it with [secure vault](../../setup/security/logins-and-passwords/carbon-secure-vault-implementation.md).
