...
description: "Explains how to configure the Streaming Integrator to run as a Windows service using the YAJSW wrapper."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/install/installing-the-product/installing-si-as-windows-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/install-and-setup/install/installing-the-product/installing-si-as-windows-service.md
tags:
  - api-manager
  - install-and-setup
  - install
