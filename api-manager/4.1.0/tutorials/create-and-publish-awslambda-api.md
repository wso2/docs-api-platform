...
description: "Create a REST API, add an AWS Lambda endpoint, and publish it to invoke AWS Lambda functions through the API Gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/create-and-publish-awslambda-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/create-and-publish-awslambda-api.md
tags:
  - api-manager
  - tutorials
