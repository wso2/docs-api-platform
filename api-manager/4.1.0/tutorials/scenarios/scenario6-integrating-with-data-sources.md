...
description: "Expose an employee database as a REST API using Micro Integrator Data Services and API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/scenarios/scenario6-integrating-with-data-sources/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/scenarios/scenario6-integrating-with-data-sources.md
tags:
  - api-manager
  - tutorials
  - scenarios
