...
description: "Design, publish, and invoke a WebSocket API backed chat application using the wscat WebSocket client."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/create-and-publish-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/create-and-publish-websocket-api.md
tags:
  - api-manager
  - tutorials
