...
description: "Design, publish, and invoke a server sent events API backed by a memory-monitoring SSE server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/streaming-api/create-and-publish-sse-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/tutorials/streaming-api/create-and-publish-sse-api.md
tags:
  - api-manager
  - tutorials
  - streaming-api
