...
1.  Open **WSO2 Integration Studio** and click **New Maven Multi Module Project** in 
    ...
    [![Create a Maven Multi Module Project](../../assets/img/integrate/create_project/create_mmm_project.png)](../../assets/img/integrate/create_project/create_mmm_project.png)
...
!!!	tip
    Alternatively, you can generate a data service from a datasource. For more information, refer [Generate Data Services](../../integrate/develop/creating-artifacts/data-services/creating-data-services.md#generate-data-service-from-a-datasource).
