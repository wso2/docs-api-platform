...
description: "Configure WSO2 Streaming Integrator to receive key-value events over JMS using ActiveMQ and log the output."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-jms-in-keyvalue-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-jms-in-keyvalue-format.md
tags:
  - api-manager
  - use-cases
  - examples
