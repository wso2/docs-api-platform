...
description: "Configure WSO2 Streaming Integrator with the siddhi-io-email extension to receive XML events from emails."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-email-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-email-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
