...
description: "Configure WSO2 Streaming Integrator to receive XML events via WebSocket transport and log low production alerts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-web-socket-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-web-socket-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
