...
description: "Capture MySQL insert and update events with the CDC source in polling mode, and adapt the sample for Oracle, H2, or PostgreSQL databases."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/cdc-with-polling-mode/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/cdc-with-polling-mode.md
tags:
  - api-manager
  - use-cases
  - examples
...
![Polling Log](../../../assets/img/streaming/cdc-with-polling-mode-sample/cdc-with-polling-mode.png)
