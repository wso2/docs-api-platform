...
description: "Use a Siddhi function to find sub-sequences in an input sequence that match a given regex pattern."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/regex-execution-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/regex-execution-sample.md
tags:
  - api-manager
  - use-cases
  - examples
