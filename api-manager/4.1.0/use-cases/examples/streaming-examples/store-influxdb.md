...
description: "Perform insert, search, delete, and update-or-insert operations on stream data in an InfluxDB store using Siddhi queries."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/store-influxdb/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/store-influxdb.md
tags:
  - api-manager
  - use-cases
  - examples
