...
description: "Use the Siddhi string extension to convert string attribute values to lowercase in a stream."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/string-extension-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/string-extension-sample.md
tags:
  - api-manager
  - use-cases
  - examples
