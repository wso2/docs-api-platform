...
description: "Train a Hoeffding classifier and predict the sweet category from a streaming sweet production data sample."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/hoeffding-adaptive-tree-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/hoeffding-adaptive-tree-sample.md
tags:
  - api-manager
  - use-cases
  - examples
