...
description: "Perform Cassandra insert, search, update, delete, and upsert operations on stream data using Siddhi queries."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/store-cassandra/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/store-cassandra.md
tags:
  - api-manager
  - use-cases
  - examples
