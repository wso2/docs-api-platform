...
description: "Configure the Streaming Integrator to send production events over JMS transport in key-value format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-jms-in-keyvalue-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-jms-in-keyvalue-format.md
tags:
  - api-manager
  - use-cases
  - examples
