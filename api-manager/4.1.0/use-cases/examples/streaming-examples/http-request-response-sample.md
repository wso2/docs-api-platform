---
title: "Publishing HTTP requests and processing responses"
description: "Configure Siddhi to send events over HTTP, receive the response, and process it in a sample application."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/http-request-response-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/http-request-response-sample.md
tags:
  - api-manager
  - use-cases
  - examples
