...
description: "Configure WSO2 Streaming Integrator to consume text-format events from a Google Pub/Sub topic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-google-pubsub-messages-in-text-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-google-pubsub-messages-in-text-format.md
tags:
  - api-manager
  - use-cases
  - examples
