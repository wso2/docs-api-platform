...
description: "Run and test a Siddhi sample that uses the siddhi-execution-extrema extension's bottomK function."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/extrema-bottom-k/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/extrema-bottom-k.md
tags:
  - api-manager
  - use-cases
  - examples
