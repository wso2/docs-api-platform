...
description: "Publish aggregated stock quote events from Siddhi to an Amazon AWS S3 bucket using the s3 sink extension."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/amazon-s3-sink-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/amazon-s3-sink-sample.md
tags:
  - api-manager
  - use-cases
  - examples
...
3. In the new panel that opens, enter information as follows.
    ...
    ![Feed Simulation](../../../assets/img/streaming/amazon-s3-sink-sample/amazon-s3-sink-sample-feed-simulation.png)
    ...
    8. Save the simulator configuration by clicking **Save**. The simulation is added to the list of saved feed simulations as shown below.
        ...
        ![saved simulation](../../../assets/img/streaming/amazon-s3-sink-sample/simulation-list.png)
