...
description: "Train a regression model on CSV data and use it to predict spending from streaming events."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/streaming-regressor/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/streaming-regressor.md
tags:
  - api-manager
  - use-cases
  - examples
