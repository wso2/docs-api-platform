...
description: "Perform search, insert, update, delete, and upsert operations on stream data in an RDBMS store using Siddhi queries."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/store-rdbms/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/store-rdbms.md
tags:
  - api-manager
  - use-cases
  - examples
