...
description: "Perform unsupervised streaming learning on a set of data points using a Clustree model in Siddhi."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/clus-tree-test-app/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/clus-tree-test-app.md
tags:
  - api-manager
  - use-cases
  - examples
