...
description: "Configure the Streaming Integrator to send events over HTTP in XML format using a custom mapping."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-in-xml-format-with-custom-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-in-xml-format-with-custom-mapping.md
tags:
  - api-manager
  - use-cases
  - examples
