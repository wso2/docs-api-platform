...
description: "Configure a Siddhi sample to receive HL7 events in ER7 format over MLLP and log acknowledgements."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-hl7-in-er7-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-hl7-in-er7-format.md
tags:
  - api-manager
  - use-cases
  - examples
