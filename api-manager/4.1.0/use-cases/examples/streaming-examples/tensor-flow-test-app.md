...
description: "Import a pretrained TensorFlow model into Streaming Integrator to perform regression on streaming data."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/tensor-flow-test-app/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/tensor-flow-test-app.md
tags:
  - api-manager
  - use-cases
  - examples
