---
title: "Receiving JSON events via TCP"
description: "Configure WSO2 Streaming Integrator to receive JSON events via TCP transport using default mapping and log alerts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-tcp-in-json-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-tcp-in-json-format.md
tags:
  - api-manager
  - use-cases
  - examples
