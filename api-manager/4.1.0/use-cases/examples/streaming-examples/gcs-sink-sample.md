...
description: "Configure and run a Siddhi sample that publishes events to a Google Cloud Storage bucket using the GCS sink."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/gcs-sink-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/gcs-sink-sample.md
tags:
  - api-manager
  - use-cases
  - examples
