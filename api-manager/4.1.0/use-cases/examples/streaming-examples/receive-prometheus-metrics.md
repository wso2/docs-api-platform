...
description: "Use the prometheus-source to retrieve Prometheus metrics exported at an HTTP endpoint in WSO2 Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-prometheus-metrics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-prometheus-metrics.md
tags:
  - api-manager
  - use-cases
  - examples
