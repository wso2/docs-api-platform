---
title: "Publishing HTTP events with an OAuth refresh token grant"
description: "Configure the Streaming Integrator to send HTTP events to an OAuth-protected endpoint using a refresh token grant."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-oauth-request-with-refresh-token/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-oauth-request-with-refresh-token.md
tags:
  - api-manager
  - use-cases
  - examples
