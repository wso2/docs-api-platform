...
description: "Configure the Streaming Integrator to send production events over Kafka transport in binary format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-kafka-in-binary-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-kafka-in-binary-format.md
tags:
  - api-manager
  - use-cases
  - examples
