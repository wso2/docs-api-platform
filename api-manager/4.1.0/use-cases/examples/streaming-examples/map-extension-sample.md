...
description: "Run a Siddhi sample that creates a map, inserts values, and checks whether the values are available."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/map-extension-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/map-extension-sample.md
tags:
  - api-manager
  - use-cases
  - examples
