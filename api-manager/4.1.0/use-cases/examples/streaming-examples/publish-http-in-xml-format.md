...
description: "Configure the Streaming Integrator to send production events over HTTP in default XML format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
