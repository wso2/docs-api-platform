...
description: "Run a Siddhi sample that consumes events from an IBM MQ queue and publishes messages back to it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/ibm-message-queue/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/ibm-message-queue.md
tags:
  - api-manager
  - use-cases
  - examples
