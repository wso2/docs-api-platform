...
description: "Configure the Streaming Integrator to send production events over Kafka transport in JSON format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-kafka-in-json-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-kafka-in-json-format.md
tags:
  - api-manager
  - use-cases
  - examples
