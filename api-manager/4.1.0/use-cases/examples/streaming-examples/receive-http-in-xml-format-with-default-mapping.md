...
description: "Configure WSO2 Streaming Integrator to receive XML events over HTTP using default mapping and log the output."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-http-in-xml-format-with-default-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-http-in-xml-format-with-default-mapping.md
tags:
  - api-manager
  - use-cases
  - examples
