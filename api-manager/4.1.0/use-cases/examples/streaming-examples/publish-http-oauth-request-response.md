...
description: "Configure the Streaming Integrator to send an HTTP event to an OAuth-protected endpoint and capture the response."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-oauth-request-response/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/publish-http-oauth-request-response.md
tags:
  - api-manager
  - use-cases
  - examples
