...
description: "Configure WSO2 Streaming Integrator to receive JSON-format events over JMS using ActiveMQ and log the output."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-jms-in-json-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/examples/streaming-examples/receive-jms-in-json-format.md
tags:
  - api-manager
  - use-cases
  - examples
