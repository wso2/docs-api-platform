...
description: "Handle streaming data errors by storing, logging, dropping, streaming, or waiting on events with errors."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-usecase/handling-errors/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-usecase/handling-errors.md
tags:
  - api-manager
  - use-cases
  - streaming-usecase
