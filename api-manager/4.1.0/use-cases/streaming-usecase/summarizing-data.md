...
description: "Shows how to perform clock-time and length/time window based data summarization using WSO2 Streaming Integrator aggregations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-usecase/summarizing-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-usecase/summarizing-data.md
tags:
  - api-manager
  - use-cases
  - streaming-usecase
...
2. Define a query that specifies the criteria for retrieving data as follows.
    ...
    - The join
        ...
        For more information about how to perform joins, see [Enriching Data](enriching-data.md#enriching-data).
...
3. Simulate eight events for the `ProductionStream` input stream of the above Siddhi application as follows. For instructions to simulate events, see [Testing Siddhi Applications - Simulating Events](../../develop/streaming-apps/testing-a-siddhi-application.md).
