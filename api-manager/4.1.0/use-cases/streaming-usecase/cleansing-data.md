...
description: "Filter streaming data by exact match, regex pattern, or multiple criteria to remove unwanted records."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-usecase/cleansing-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-usecase/cleansing-data.md
tags:
  - api-manager
  - use-cases
  - streaming-usecase
