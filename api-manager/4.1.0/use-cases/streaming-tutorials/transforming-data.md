...
description: "Convert streaming data from one format to another, such as CSV to JSON, using the Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/transforming-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/transforming-data.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
