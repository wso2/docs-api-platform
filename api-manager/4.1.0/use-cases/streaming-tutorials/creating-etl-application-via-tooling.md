...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/creating-etl-application-via-tooling/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/creating-etl-application-via-tooling.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
...
7. In **Step 6 Finalize**, deploy the Siddhi application you just completed by clicking **Deploy to Worker**.
    ...
    1. In the **Add New Server** section, enter the host, port, user name and the password of your Streaming Integrator server as shown below.
        ...
        ![Adding a New Server](../../assets/img/streaming/create-etl-application-via-tooling/add-a-new-server.png)
