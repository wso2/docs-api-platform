...
description: "Extract, transform, and load data from files in real time using WSO2 Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/performing-real-time-etl-with-files/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/performing-real-time-etl-with-files.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
