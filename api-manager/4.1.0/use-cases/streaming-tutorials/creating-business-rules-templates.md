...
description: "Create business rules from templates or from scratch using the Streaming Integrator Business Rules Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/creating-business-rules-templates/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/use-cases/streaming-tutorials/creating-business-rules-templates.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
