...
description: "Explains how Choreo Connect detects revoked JWT tokens before expiry using real-time and persistent notifiers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/revoked-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/revoked-tokens.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
