...
description: "Configure Choreo Connect to connect with a specific tenant's Control Plane and rate limiting endpoints."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/choreo-connect-with-tenants/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/choreo-connect-with-tenants.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
