...
description: "Explains how Choreo Connect validates API subscriptions against WSO2 API Manager for JWT and API key tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/subscription-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/subscription-validation.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
