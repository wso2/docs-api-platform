...
description: "Configure multiple Choreo Connect gateway environments with WSO2 API Manager using the Distributed Adapter pattern."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configure-multiple-gateways-with-choreo-connect/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configure-multiple-gateways-with-choreo-connect.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
