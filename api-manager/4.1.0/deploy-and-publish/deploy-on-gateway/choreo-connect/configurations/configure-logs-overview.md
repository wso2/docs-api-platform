...
- [Adapter Log Configurations](configure-logs-adapter.md)
    - [Adapter root level configurations](configure-logs-adapter.md#adapter-root-level-configurations)
    - [Adapter package level configurations](configure-logs-adapter.md#adapter-package-level-configurations)

- [Enforcer Log Configurations](configure-logs-enforcer.md)
    - [Configuring Log4j2 Properties](configure-logs-enforcer.md#configuring-log4j2-properties)
        - [Setting the Log Level](configure-logs-enforcer.md#setting-the-log-level)
        - [Setting the Threshold](configure-logs-enforcer.md#setting-the-threshold)
        - [Configuring Log4j2 Appenders](configure-logs-enforcer.md#configuring-log4j2-appenders)
        - [Configuring Log4j2 Loggers](configure-logs-enforcer.md#configuring-log4j2-loggers)
    - [Enforcer Access Logs](configure-logs-enforcer.md#enforcer-access-logs)
    - [Setting the log format](configure-logs-enforcer.md#setting-the-log-format)
        - [Plain Text format](configure-logs-enforcer.md#plain-text-format)
        - [JSON format](configure-logs-enforcer.md#json-format)

- [Router Log Configurations](configure-logs-router.md#router-log-configurations)
    - [Router Access Logging](configure-logs-router.md#router-access-logging)
    - [Router Debug Logs](configure-logs-router.md#router-debug-logs)