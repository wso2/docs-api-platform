...
description: "Configure API key authentication for APIs secured through Choreo Connect, in control plane or standalone mode."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authentication/api-key-authentication/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authentication/api-key-authentication.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
!!! info
    ...
    - validateSubscription 
        ...
        - For [Choreo Connect with WSO2 API Manager as a Control Plane](../../concepts/apim-as-control-plane.md)   - Check against the subscriptions received from the Control Plane in order to validate the mapping between the invoked API and application info in the API key JWT claims.

        - For [Choreo Connect as a Standalone Gateway](../../concepts/as-a-standalone-gateway.md) -  Check the metadata of the invoked API against the API details included in the API key claims. 
