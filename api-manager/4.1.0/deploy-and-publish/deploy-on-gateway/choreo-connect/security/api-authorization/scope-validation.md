...
description: "Define OAuth2 scopes in an API definition and configure Choreo Connect to enforce scope-based authorization on API resources."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authorization/scope-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authorization/scope-validation.md
tags:
  - scope-validation
  - oauth2
