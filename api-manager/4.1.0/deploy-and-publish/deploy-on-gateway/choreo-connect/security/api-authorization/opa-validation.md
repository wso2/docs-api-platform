...
Please refer the documentation on [Validate Request with Open Policy Agent (OPA)](../../../../../design/api-security/opa-validation/overview.md) to learn how to attach and configure OPA policies to APIs.