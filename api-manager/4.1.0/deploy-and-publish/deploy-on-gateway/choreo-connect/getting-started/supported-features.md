...
description: "Review which WSO2 API Manager functionalities Choreo Connect supports as a lightweight API gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/getting-started/supported-features/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/getting-started/supported-features.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
