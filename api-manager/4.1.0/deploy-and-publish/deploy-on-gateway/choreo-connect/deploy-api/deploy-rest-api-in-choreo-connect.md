...
!!! info "Before you begin"
    ...
    This guide assumes that you already have a Choreo Connect instance that is up and running. If not, checkout the [Using Choreo Connect Deployed on Docker with WSO2 API Controller Guide](../getting-started/deploy/cc-as-a-standalone-gateway-on-docker.md) on how to install and run Choreo Connect. To learn more about Choreo Connect, have a look at the [Overview of Choreo Connect](../getting-started/choreo-connect-overview.md). 
...
!!! info 
    ...
    - [Generate a Test JWT](../security/generate-a-test-jwt.md)