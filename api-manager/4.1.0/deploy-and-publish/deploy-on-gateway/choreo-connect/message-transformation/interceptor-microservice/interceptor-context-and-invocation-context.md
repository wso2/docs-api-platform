---
title: "Interceptor context and invocation context"
description: "Reference for the interceptor context and invocation context objects shared with Choreo Connect request and response interceptors."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/message-transformation/interceptor-microservice/interceptor-context-and-invocation-context/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/choreo-connect/message-transformation/interceptor-microservice/interceptor-context-and-invocation-context.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
