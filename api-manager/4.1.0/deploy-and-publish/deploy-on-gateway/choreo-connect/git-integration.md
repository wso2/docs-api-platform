...
[![Git Integration](../../../assets/img/deploy/mgw/git-integration.png)](../../../assets/img/deploy/mgw/git-integration.png)
...
1. Initialize the API project(s).
     ...
     For more information, see [Choreo Connect Deployed on Docker Compose with WSO2 API Controller Guide](getting-started/deploy/cc-as-a-standalone-gateway-on-docker.md#step-2-initialize-an-api-project).
...
- [Using Username and Access Token](git-integration.md#using-username-and-access-token)
- [Using SSH Key file](git-integration.md#using-ssh-key-file)
...
5. Create a Dockerfile.
    ...
    ```dockerfile tab='Example'
      FROM wso2/choreo-connect-adapter:1.2.0
...
Let's use WSO2 Choreo Connect's test key endpoint to obtain a test key in order to access the API. For more information, see [Generate a Test JWT](security/generate-a-test-jwt.md).
