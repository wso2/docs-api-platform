...
description: "Export certificates and configure dynamic SSL profiles to enable mutual SSL between the API Gateway and backend."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/mutual-ssl-between-api-gateway-and-backend/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/mutual-ssl-between-api-gateway-and-backend.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
2.  [Publish the API](../../publish-on-dev-portal/publish-an-api.md)
