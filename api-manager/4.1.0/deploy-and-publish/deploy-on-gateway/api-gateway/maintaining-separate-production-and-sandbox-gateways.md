...
description: "Configure single or separate production and sandbox Gateway instances to handle PRODUCTION and SANDBOX token traffic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/maintaining-separate-production-and-sandbox-gateways/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/maintaining-separate-production-and-sandbox-gateways.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
