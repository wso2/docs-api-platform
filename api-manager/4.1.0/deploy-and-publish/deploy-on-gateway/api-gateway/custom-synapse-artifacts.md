...
description: "Configure the Gateway to retain custom runtime Synapse artifacts using the skip_list deployment.toml settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/custom-synapse-artifacts/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/custom-synapse-artifacts.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
