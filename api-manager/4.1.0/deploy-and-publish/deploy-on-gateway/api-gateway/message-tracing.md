...
description: "Configure the deprecated Message Tracer feature to log message flow, content, and direction for Gateway transactions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/message-tracing/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/deploy-on-gateway/api-gateway/message-tracing.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
