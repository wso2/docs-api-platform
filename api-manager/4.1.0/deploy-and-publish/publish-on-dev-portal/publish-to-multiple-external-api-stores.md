...
description: "Configure an API Publisher to advertise and publish an API to Developer Portals of other tenants and instances."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/publish-on-dev-portal/publish-to-multiple-external-api-stores/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/publish-on-dev-portal/publish-to-multiple-external-api-stores.md
tags:
  - api-manager
  - deploy-and-publish
