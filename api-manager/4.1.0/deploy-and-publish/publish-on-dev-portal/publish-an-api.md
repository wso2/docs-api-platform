...
description: "Publish an API from the CREATED to PUBLISHED lifecycle state to make it visible for subscription in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/publish-on-dev-portal/publish-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/deploy-and-publish/publish-on-dev-portal/publish-an-api.md
tags:
  - api-manager
  - deploy-and-publish
