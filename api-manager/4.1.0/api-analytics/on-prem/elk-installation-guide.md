...
description: "Configure WSO2 API Manager to publish analytics logs to an external ELK stack using Filebeat, Logstash, and Kibana."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/api-analytics/on-prem/elk-installation-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/api-analytics/on-prem/elk-installation-guide.md
tags:
  - api-manager
  - api-analytics
  - on-prem
