...
description: "Build, deploy, and configure a custom event publisher to send API analytics data to an external system."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/api-analytics/samples/publishing-analytics-events-to-external-systems/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/api-analytics/samples/publishing-analytics-events-to-external-systems.md
tags:
  - api-manager
  - api-analytics
  - samples
