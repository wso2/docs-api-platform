...
description: "Configure CORS settings and add a custom header as a parameter when testing a REST API in the API Console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/invoke-apis/invoke-apis-using-tools/include-additional-headers-in-the-api-console/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/invoke-apis/invoke-apis-using-tools/include-additional-headers-in-the-api-console.md
tags:
  - api-manager
  - consume
  - invoke-apis
