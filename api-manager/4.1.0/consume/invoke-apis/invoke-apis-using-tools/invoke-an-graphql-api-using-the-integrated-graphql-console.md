...
description: "Subscribe to a GraphQL API, generate OAuth2 keys, and invoke it using the integrated GraphiQL console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/invoke-apis/invoke-apis-using-tools/invoke-an-graphql-api-using-the-integrated-graphql-console/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/invoke-apis/invoke-apis-using-tools/invoke-an-graphql-api-using-the-integrated-graphql-console.md
tags:
  - api-manager
  - consume
  - invoke-apis
