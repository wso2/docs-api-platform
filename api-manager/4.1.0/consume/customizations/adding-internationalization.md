...
description: "Change the browser language and add new languages to localize the API Publisher and Developer Portal interfaces."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/customizations/adding-internationalization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/customizations/adding-internationalization.md
tags:
  - api-manager
  - consume
  - customizations
