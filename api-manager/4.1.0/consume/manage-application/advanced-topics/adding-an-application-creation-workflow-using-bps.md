...
description: "Attach a custom Business Process Server workflow to control application creation in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/manage-application/advanced-topics/adding-an-application-creation-workflow-using-bps/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/manage-application/advanced-topics/adding-an-application-creation-workflow-using-bps.md
tags:
  - api-manager
  - consume
  - manage-application
