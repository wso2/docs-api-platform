...
description: "Attach an approval workflow to subscription tier changes so an admin approves or rejects tier update requests."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/manage-subscription/advanced-topics/adding-an-api-subscription-tier-update-workflow/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/manage-subscription/advanced-topics/adding-an-api-subscription-tier-update-workflow.md
tags:
  - api-manager
  - consume
  - manage-subscription
