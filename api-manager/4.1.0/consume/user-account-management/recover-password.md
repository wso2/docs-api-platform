...
description: "Reset a forgotten Developer Portal password using the Forgot Password link on the sign-in page."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/user-account-management/recover-password/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/consume/user-account-management/recover-password.md
tags:
  - api-manager
  - consume
