...
description: "Download, configure, and use the API Governance CLI tool to validate APIs against rules and generate violation reports."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/advanced-topics/api-governance-cli-tool/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/advanced-topics/api-governance-cli-tool.md
tags:
  - api-manager
  - design
  - advanced-topics
...
You can download the tool for apim 4.1.0 from [here](../../assets/attachments/governance/governance.cli.4.1.0.zip).
