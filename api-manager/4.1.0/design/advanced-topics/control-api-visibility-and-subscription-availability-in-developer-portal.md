---
title: "Control API visibility and subscription in dev portal"
description: "Control who can view, subscribe to, and see documentation for an API in the Developer Portal using visibility settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal.md
tags:
  - api-manager
  - design
  - advanced-topics
...
You can use the [existing REST API](../../reference/product-apis/publisher-apis/publisher-v3/publisher-v3.md) to control the visibility of the API. Add the following element to the request body, including the relevant visibility,
...
You can use the [existing REST API](../../reference/product-apis/publisher-apis/publisher-v3/publisher-v3.md) to control the subscription availability of the API. Add the following element to the request body including the relevant subscription availability.
