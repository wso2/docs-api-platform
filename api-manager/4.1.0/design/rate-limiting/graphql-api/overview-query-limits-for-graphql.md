...
description: "Learn how the Static Query Analyzer protects GraphQL APIs from complex queries using depth and complexity limits."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/rate-limiting/graphql-api/overview-query-limits-for-graphql/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/rate-limiting/graphql-api/overview-query-limits-for-graphql.md
tags:
  - api-manager
  - design
  - rate-limiting
