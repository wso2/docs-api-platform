...
description: "Add new advanced, application-level, and subscription-level rate limiting policies in the Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/rate-limiting/adding-new-throttling-policies/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/rate-limiting/adding-new-throttling-policies.md
tags:
  - api-manager
  - design
  - rate-limiting
