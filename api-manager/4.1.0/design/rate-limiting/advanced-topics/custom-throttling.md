...
description: "Write custom Siddhi queries to define rate limiting policies applied globally across tenants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/rate-limiting/advanced-topics/custom-throttling/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/rate-limiting/advanced-topics/custom-throttling.md
tags:
  - api-manager
  - design
  - rate-limiting
