...
description: "Add a new state to the default API lifecycle by editing the lifecycle configuration in the management console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/lifecycle-management/customize-api-life-cycle/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/lifecycle-management/customize-api-life-cycle.md
tags:
  - api-manager
  - design
