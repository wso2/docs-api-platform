 ...
 3.  Enable Connect and create a [connected account](https://stripe.com/docs/connect/quickstart#create-account) in Stripe.  
      ...
      1. Sign in to the Tenant Admin's Stripe account.
         ...
         1. Click on **Settings** and then select **Settings** in **Connect** section.
            [![Select 'Settings'](../../assets/img/learn/monetization_connect_settings.png)](../../assets/img/learn/monetization_connect_settings.png)

         2. Edit **Appearance** section in **Branding** section and click on **Save Branding Changes**.
            [![Save Branding Changes](../../assets/img/learn/monetization_save_branding_changes.png)](../../assets/img/learn/monetization_save_branding_changes.png)
         
      2. Enable OAuth for Standard Accounts by scrolling further.
            [![Enable Oauth for Standard Accounts](../../assets/img/learn/monetization_enable_oauth_for_standard_accounts.png)](../../assets/img/learn/monetization_enable_oauth_for_standard_accounts.png)
      
      3. Click `Connect` and then click on `Create`.
         [![Click 'Connect' and Create](../../assets/img/learn/monetization_click_connect_and_create.png)](../../assets/img/learn/monetization_click_connect_and_create.png)
      ...
      4. In the prompted screen select the Account type as Standard and select the Country. If you haven't enabled OAuth for standard accounts, the **Continue** button will be disabled. Click **enable OAuth for Standard Accounts** in the pop-up that appears on **Continue** button.
        ...
        [![Select Type and Country](../../assets/img/learn/monetization_select_type_and_country.png){: style="width:60%"}](../../assets/img/learn/monetization_select_type_and_country.png)
      
      5. Copy the URL which appears in the next popup.
     
         [![Copy URL](../../assets/img/learn/monetization_copy_url.png){: style="width:60%"}](../../assets/img/learn/monetization_copy_url.png)
      ...
      6. Enter the URL which was copied in previous step in the browser to onboard the application and click on `Skip this form` if you are on test mode.
         ...
         [![Onboard Application](../../assets/img/learn/monetization_onboard_application.png){: style="width:60%"}](../../assets/img/learn/monetization_onboard_application.png)

      7. Refresh [the page](https://dashboard.stripe.com/test/connect/accounts/overview) to see the newly created account.

         [![View Created Account](../../assets/img/learn/monetization_created_account.png){: style="width:60%"}](../../assets/img/learn/monetization_created_account.png)
...
2.  Create a subscription policy.  
    ...
    [![Create Subscription Policy](../../assets/img/learn/monetization_create_subscription_policy.png){: style="width:60%"}](../../assets/img/learn/monetization_create_subscription_policy.png)

     After you save the policy, a plan gets created in the Stripe account of the Tenant Admin.  

     ![Stripe account after creating a paid business plan](../../assets/img/learn/monetization_subscription.png)
...
3. Click on `Subscriptions` and select the policy created in **step 1** and click save.
   [![Select Subscription](../../assets/img/learn/monetization_select_subscription_policy.png){: style="width:60%"}](../../assets/img/learn/monetization_create_subscription_policy.png)
...
5. Enter the connect ID as the connected account key and click
   ...
   [![Copy Connect ID](../../assets/img/learn/monetization_copy_id.png){: style="width:60%"}](../../assets/img/learn/monetization_copy_id.png)
...
6. Additionally, if you refresh the page **Policy** section has to be shown as below.
      ...
      [![Updated Policy Section](../../assets/img/learn/monetization_updated_policy_section.png){: style="width:60%"}](../../assets/img/learn/monetization_updated_policy_section.png)


### Step 3 - Subscribe to a monetized API

[Subscribe to an API](../../consume/manage-subscription/subscribe-to-an-api.md) and invoke the API. The price of the business plan appears when subscribing to an API. Therefore, the Subscriber can select an appropriate plan and subscribe to it. 
...
![Customer created in stripe](../../assets/img/learn/monetization_customer_created.png)

The following screenshot depicts the details of the newly created customer in the platform Stripe account.

![New customer details](../../assets/img/learn/monetization_new_customer_details.png)

Thereafter, the customer details are copied to the Stripe account of the API Publisher, which is the connected account.

![Shared customer in connected account](../../assets/img/learn/monetization_shared_customer.png)

The following are the details of the shared customer that appears in the
Stripe UI.

![Shared customer details](../../assets/img/learn/monetization_shared_customer_details.png)
...
1.  Obtain the consumer key and secret key pair by calling the dynamic client registration endpoint.  
     ...
     For more information, see [Admin REST API v3.0](../../reference/product-apis/admin-apis/admin-v3/admin-v3.md).
...
2.  Obtain a token with the monetization usage scope (`scope=apim:monetization_usage_publish`).
    ...
    ``` java
    curl -X POST https://localhost:9443/oauth2/token -H 'Authorization: Basic <base64encoded-registration-credentials>' -d 'grant_type=password&username=admin&password=admin&scope=apim:monetization_usage_publish'
    ```
...
3.  Publish usage data to the Stripe billing engine.
    ...
    ![Pricing](../../assets/img/learn/monetization_pricing_bill.png) The charging process takes place at the end of the billing cycle. As this example scenario uses a usage-based business plan, the payment that the subscribers make for their bills are sent to the API Publisher via the billing engine.
...
2. Click **Applications** and click **Subscriptions**.
     ...
     ![Subscription details via the API Publisher Portal](../../assets/img/learn/subscription-dev-portal.png)
