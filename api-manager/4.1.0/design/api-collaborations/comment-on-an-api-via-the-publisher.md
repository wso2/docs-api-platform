...
description: "Add, view, and reply to comments on an API from the Publisher portal to collaborate with consumers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-collaborations/comment-on-an-api-via-the-publisher/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-collaborations/comment-on-an-api-via-the-publisher.md
tags:
  - api-manager
  - design
  - api-collaborations
...
2. Click on an API.
    ...
    [![Select an API](../../assets/img/learn/select-api.png)](../../assets/img/learn/select-api.png)
