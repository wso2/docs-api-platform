...
description: "Introduces the fine-grained access control mechanisms WSO2 API Manager offers to restrict API access to authorized users."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/authorization/api-authorization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/authorization/api-authorization.md
tags:
  - api-manager
  - design
  - api-security
