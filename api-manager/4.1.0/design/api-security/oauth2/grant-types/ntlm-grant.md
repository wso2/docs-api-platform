---
title: "NTLM grant"
description: "Obtain an OAuth2 access token on a Windows API Manager instance using an NTLM token as the authorization grant."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/oauth2/grant-types/ntlm-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/oauth2/grant-types/ntlm-grant.md
tags:
  - api-manager
  - design
  - api-security
