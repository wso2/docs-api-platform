...
description: "Allowlist OAuth2 scopes to skip role validation when marking access tokens with those scopes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/oauth2/oauth2-scopes/scope-whitelisting/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/oauth2/oauth2-scopes/scope-whitelisting.md
tags:
  - api-manager
  - design
  - api-security
