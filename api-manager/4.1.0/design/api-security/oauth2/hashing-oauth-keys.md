...
description: "Enable OAuth2 token hashing to protect access tokens, refresh tokens, and consumer secrets stored in the database."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/oauth2/hashing-oauth-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/oauth2/hashing-oauth-keys.md
tags:
  - api-manager
  - design
  - api-security
