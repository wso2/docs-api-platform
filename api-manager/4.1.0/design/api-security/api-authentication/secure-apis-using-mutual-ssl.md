...
description: "Shows how to secure APIs with mutual SSL so the Gateway validates client certificates alongside OAuth2."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/api-authentication/secure-apis-using-mutual-ssl/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/api-authentication/secure-apis-using-mutual-ssl.md
tags:
  - api-manager
  - design
  - api-security
