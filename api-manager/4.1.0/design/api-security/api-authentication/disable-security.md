...
description: "Shows how to disable OAuth2 security for a single API resource or for all resources of an API during testing."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/api-authentication/disable-security/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-security/api-authentication/disable-security.md
tags:
  - api-manager
  - design
  - api-security
...
- [Get an internal test key from Publisher](../../create-api/create-rest-api/test-a-rest-api.md)
