...
description: "Reference for the default message builder and formatter classes used by the API Gateway per content type."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-policies/regular-gateway-policies/configuring-message-builders-formatters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-policies/regular-gateway-policies/configuring-message-builders-formatters.md
tags:
  - api-manager
  - design
  - api-policies
