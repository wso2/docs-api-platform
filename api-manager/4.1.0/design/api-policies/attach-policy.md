...
description: "Attach one or more Gateway policies to an API operation's request, response, or fault flow."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-policies/attach-policy/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-policies/attach-policy.md
tags:
  - api-manager
  - design
  - api-policies
...
3. Under the `API Gateway` section, make sure to select the correct Gateway. API Manager supports the following two Gateway types: `Regular Gateway (Synapse Gateway)` and `Choreo Connect`. Select the Gateway depending on the Gateway that your API is deployed in.
    ...
    [![Select Gateway](../../assets/img/design/api-policies/attach-policies-1.png){: style="width:90%"}](../../assets/img/design/api-policies/attach-policies-1.png)
