...
!!! note
    You can create a custom request generator and define it in the parameter `requestGenerator`. For a detailed description on creating a custom request generator, visit [Custom OPA Policy for Choreo Connect](../../api-security/opa-validation/custom-opa-policy-for-choreo-connect.md).
