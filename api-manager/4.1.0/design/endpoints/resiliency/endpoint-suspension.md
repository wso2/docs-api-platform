...
description: "Understand how the gateway suspends an unreachable API endpoint for 30 seconds and the resulting error response."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/endpoints/resiliency/endpoint-suspension/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/endpoints/resiliency/endpoint-suspension.md
tags:
  - api-manager
  - design
  - endpoints
