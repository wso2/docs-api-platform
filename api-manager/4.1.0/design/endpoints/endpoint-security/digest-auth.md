...
description: "Configure Digest Authentication as the endpoint security type for an API backend in the API Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/endpoints/endpoint-security/digest-auth/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/endpoints/endpoint-security/digest-auth.md
tags:
  - api-manager
  - design
  - endpoints
