...
description: "Configure load balancing and failover endpoints in the API Publisher for high availability of API backends."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/endpoints/high-availability-for-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/endpoints/high-availability-for-endpoints.md
tags:
  - api-manager
  - design
  - endpoints
