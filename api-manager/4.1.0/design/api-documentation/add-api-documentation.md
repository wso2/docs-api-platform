...
description: "Add in-line, URL, file, or Markdown documentation to an API in the API Publisher to help subscribers understand its functionality."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-documentation/add-api-documentation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/api-documentation/add-api-documentation.md
tags:
  - api-manager
  - design
  - api-documentation
