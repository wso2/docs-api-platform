...
description: "Add custom properties to an API via the API Publisher or REST API and search APIs using those values."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/create-api/adding-custom-properties-to-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/create-api/adding-custom-properties-to-apis.md
tags:
  - api-manager
  - design
  - create-api
...
Use the [existing REST API](../../reference/product-apis/publisher-apis/publisher-v3/publisher-v3.md) to add a new API and in order to add the API with custom properties make sure to add the following element to the request body including the relevant properties.
