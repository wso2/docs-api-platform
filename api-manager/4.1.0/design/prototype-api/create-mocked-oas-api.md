...
!!! important
    This is currently supported only when [Choreo Connect](../../deploy-and-publish/deploy-on-gateway/choreo-connect/getting-started/choreo-connect-overview.md) is used as the Gateway.
