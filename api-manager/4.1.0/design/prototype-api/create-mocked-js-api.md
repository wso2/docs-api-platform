...
description: "Create a prototype API with a JavaScript mock implementation auto-generated from the OpenAPI specification."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/prototype-api/create-mocked-js-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/design/prototype-api/create-mocked-js-api.md
tags:
  - api-manager
  - design
  - prototype-api
  - create-mocked-js-api
...
!!! note
    This is not supported when [Choreo Connect](../../deploy-and-publish/deploy-on-gateway/choreo-connect/getting-started/choreo-connect-overview.md) is used as the Gateway.
...
3. If you have enabled security, you can either use the access token that you got from the above step or use the **GET TEST KEY** option.
    ...
    !!! note
        Skip this step if you have [disabled security for the API](../api-security/api-authentication/disable-security.md), and leave the **Access Token** field empty.
