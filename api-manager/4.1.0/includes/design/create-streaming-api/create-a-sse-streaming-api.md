...
3.  Enter API details.
     ...
     <a href="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/create-sse-api-form.png"><img src="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/create-sse-api-form.png" width="80%" alt="SE Create API Page"></a>

4.  Click **CREATE** to create the API.

     The overview page of the newly created API appears.

    [![SSE API overview page]({BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-overview-page.png)]({BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-overview-page.png)
...
2. Modify the topics as follows and click **Save** to update them.
    ...
    1. Optionally, click delete, as shown below, to delete an existing topic.
         ...
         <a href="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-delete-default-topic.png"><img src="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-delete-default-topic.png" width="80%" alt="SSE API Delete Existing Topic"></a>

    2. Select **sub** under **Types**, enter the **Topic Name**, and click **+** as shown below, to add a new topic.

         <a href="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-create-new-topic.png"><img src="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-create-new-topic.png" width="80%" alt="SSE API Add Topic"></a>

         The newly added topic is displayed as follows.

         <a href="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-newly-added-topic.png"><img src="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-newly-added-topic.png" width="80%" alt="SSE API Newly Added Topic"></a>
...
<a href="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-asyncapi.png"><img src="{BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-asyncapi.png" width="80%" alt="SSE API AsyncAPI Definition"></a>
...
1. Click **Runtime** under **API Configurations**.
    ...
    [![SSE API Runtime Configurations Page]({BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-runtime-configurations-page.png)]({BASE_URL}/api-manager/4.1.0/assets/img/design/create-api/streaming-api/sse-api-runtime-configurations-page.png)
...
Learn more by trying out an end-to-end tutorial on <a href="{BASE_URL}/api-manager/4.1.0/tutorials/streaming-api/create-and-publish-sse-api/">Creating and Publishing a SSE API</a>, which uses the default Streaming Provider that works with WSO2 API Manager, namely the WSO2 Streaming Integrator.
