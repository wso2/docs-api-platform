...
**WSO2 API Manager 4.1.0** is the successor of **WSO2 API Manager 4.0.0**.
...
??? note "Management of real-time APIs on Solace"
    ...
    **[Learn more](../tutorials/integrating-with-solace.md)**
...
??? note "Develop an integration from a managed API"
    ...
    **[Learn more](../tutorials/develop-an-integration-with-a-managed-api.md)**
...
??? note "Publishing third-party APIs on the Developer Portal"
    ...
    **[Learn more](../deploy-and-publish/publish-on-dev-portal/third-party-api-support.md)**
...
??? note "A read-only mode for API Publisher"
    ...
    **[Learn more](../design/api-security/authorization/publisher-portal-in-read-only-mode.md)**
...
??? note "Mock API implementation support considering API definition in Choreo Connect"
    ...
    **[Learn more](../deploy-and-publish/deploy-on-gateway/choreo-connect/deploy-api/deploy-rest-api-with-mock-impl.md)**
...
??? note "API consumer authorization with Open Policy Agent (OPA)"
    ...
    **[Learn more](../design/api-security/opa-validation/overview.md)**
...
??? note "Authentication support for API invocation using the Token Exchange approach"
    ...
    **[Learn more](../administer/key-managers/configure-custom-connector.md)**
...
??? note "Operation level policy support for APIs"
    ...
    **[Learn more](../design/api-policies/overview.md)**
...
??? note "WSDL to REST conversion support in Integration Studio"
    ...
    **[Learn more](../integrate/develop/creating-artifacts/creating-an-api.md)**
...
??? note "Exposing an integration SOAP service as a managed API"
    ...
    **[Learn more](../tutorials/integration-tutorials/service-catalog-tutorial-for-proxy-services.md)**
...
??? note "Authorization support via secondary user stores in Micro Integrator"
    ...
    **[Learn more](../administer/managing-users-and-roles/managing-user-stores/configuring-secondary-user-stores-mi.md#configuring-secondary-user-stores)**
...
??? note "Auto-generation support for data services using a given data source in Integration Studio"
    ...
    **[Learn more](../integrate/develop/creating-artifacts/data-services/creating-data-services.md#generate-data-service-from-a-datasource)**
...
??? note "Support for GraphQL subscription operations"
    ...
    **[Learn more](../tutorials/create-and-publish-a-graphql-api.md#5.2)**
...
??? note "Publishing analytics events to external systems"
    ...
    **[Learn more](../api-analytics/samples/publishing-analytics-events-to-external-systems.md)**
...
??? note "Logging messages per API"
    ...
    **[Learn more](../observe/api-manager/monitoring-api-logs.md)**
...
??? note "Maintaining audit logs for the Micro Integrator Management API"
    ...
    **[Learn more](../observe/micro-integrator/classic-observability-logs/monitoring-mi-audit-logs.md)**
...
??? note "GitHub integration for Choreo Connect"
    ...
    **[Learn more](../deploy-and-publish/deploy-on-gateway/choreo-connect/git-integration.md)**
...
??? note "Lifecycle support for API Products"
    ...
    **[Learn more](../design/create-api-product/create-api-product.md)**

??? note "Authentication support for Prototype APIs"

    Authentication for [Prototype APIs](../design/prototype-api/overview.md) is available by default so that the client apps can also be created using authentication to test out the APIs. If needed you can disable authentication for Prototype APIs at the resource level or API level.

    **[Learn more](../design/api-security/api-authentication/disable-security.md)**
...
??? note "Single Sign-On support for the monitoring dashboard using OpenID Connect"
    ...
    **[Learn more](../install-and-setup/install/installing-the-product/running-the-mi-dashboard.md#configuring-single-sign-on-with-openid-connect)**
...
??? note "Support for admin privileges in the file-based user store"
    ...
    **[Learn more](../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore.md#file-based-user-store-default)**
...
??? note "Monitoring deployed data sources in Micro Integrator runtimes"
    ...
    **[Learn more](../observe/mi-observe/working-with-monitoring-dashboard.md#step-6-monitor-mi-artifacts-and-logs)**
...
??? note "PKCE support when generating application keys"
    ...
    **[Learn more](../consume/manage-application/generate-keys/generate-api-keys.md#generating-application-keys-with-pkce-enabled)**
...
??? note "Ability to configure Rate Limiting for an API Gateway cluster"
    ...
    **[Learn more](../design/rate-limiting/advanced-topics/configuring-rate-limiting-api-gateway-cluster.md)**
...
??? note "Tenant configurations migration from the registry to the database"
    ...
    **[Learn more](../administer/advanced-configurations.md)**
...
??? note "File Inbound Endpoint subdirectory processing capability"
    ...
    **[Learn more](../reference/synapse-properties/inbound-endpoints/polling-inbound-endpoints/file-inbound-endpoint-properties.md)**
...
??? note "Improve Service Catalog to work with Hot Deployments"
    ...
    **[Learn more](../tutorials/integration-tutorials/service-catalog-tutorial.md)**
...
??? note "Support to change lifecycle state of API Products using apictl"
    ...
    **[Learn more](../install-and-setup/setup/api-controller/managing-apis-api-products/managing-apis-and-api-products.md#change-status-of-an-api-or-api-product-in-an-environment)**
...
??? note "Exposing proxy services via the Service Catalog"
    ...
    **[Learn more](../integrate/develop/generate-service-catalog-metadata.md)**
...
- **[Generate REST API from SOAP Backend](../design/create-api/create-rest-api/generate-rest-api-from-soap-backend.md)**
...
- WSO2 API Manager 4.1.0 is compatible with Choreo Connect 1.2.0.
