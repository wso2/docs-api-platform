...
2. [Download WSO2 API-M](https://wso2.com/api-management/).
...
3. Click on the API thumbnail to view the overview of the API.
     ...
     [![API overview](../assets/img/get_started/try-out.png)](../assets/img/get_started/try-out.png)
...
1. [Make sure that you run WSO2 API Manager (WSO2 API-M) 4.1.0](api-manager-quick-start-guide.md#before-you-begin).
