...
- Try out the entire developer guide on [Exposing an Integration SOAP Service as a Managed API](../tutorials/integration-tutorials/service-catalog-tutorial-for-proxy-services.md).