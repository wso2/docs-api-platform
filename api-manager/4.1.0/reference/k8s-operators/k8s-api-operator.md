...
description: "Deploy and manage APIs and integrations as Kubernetes custom resources using the WSO2 API Operator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/k8s-operators/k8s-api-operator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/k8s-operators/k8s-api-operator.md
tags:
  - api-manager
  - reference
  - k8s-operators
