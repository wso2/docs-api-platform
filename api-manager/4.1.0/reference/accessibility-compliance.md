...
description: "Learn how the WSO2 API Manager Developer Portal complies with WCAG 2.1 Level A and AA accessibility standards."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/accessibility-compliance/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/accessibility-compliance.md
tags:
  - api-manager
  - reference
