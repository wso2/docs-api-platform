...
description: "Lists the operations and parameters available to configure and use the Email Connector for SMTP, IMAP, and POP3."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/email-connector/email-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/email-connector/email-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
