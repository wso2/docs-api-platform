...
description: "Reference for SalesforceBulk connector operations, including init parameters for connecting to the Salesforce Bulk API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/salesforce-connectors/salesforcebulk-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/salesforce-connectors/salesforcebulk-reference.md
tags:
  - api-manager
  - reference
  - connectors
...
??? note "createJobToUploadBatchFile"
    ...
    **Sample request**
    ...
    ```xml
    http://localhost:8280/services/salesforcebulk_uploadBatchFile?apiUrl=https://ap2.salesforce.com&accessToken=YOUR_ACCESS_TOKEN&apiVersion=34.0&refreshToken=YOUR_REFRESH_TOKEN&clientId=YOUR_CLIENT_ID&clientSecret=YOUR_CLIENT_SECRET&intervalTime=1000000&jobId=75028000000MCv9AAG
    ```
