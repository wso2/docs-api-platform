...
description: "Overview of the Gmail connector, its compatibility with WSO2 products, and links to setup, example, and reference documentation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/gmail-connector/gmail-connector-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/gmail-connector/gmail-connector-overview.md
tags:
  - api-manager
  - reference
  - connectors
...
<img src="../../../../assets/img/integrate/connectors/gmail-store.png" title="Gmail Connector Store" width="200" alt="Gmail Connector Store"/>
