...
See [ISO8583 connector configuration](iso8583-connector-configuration.md) for more information. However, for simplicity of this example, we will just log the message. You can extend the sample as required using WSO2 [ mediators](../../mediators/about-mediators.md). 
