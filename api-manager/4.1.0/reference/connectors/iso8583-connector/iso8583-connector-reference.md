...
description: "Lists the ISO8583 connector operations, including init, with parameters and required fields for each."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/iso8583-connector/iso8583-connector-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/iso8583-connector/iso8583-connector-reference.md
tags:
  - api-manager
  - reference
  - connectors
