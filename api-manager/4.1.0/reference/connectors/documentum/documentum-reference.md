...
description: "Lists the operations, parameters, and sample requests for working with the Documentum Connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/documentum/documentum-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/documentum/documentum-reference.md
tags:
  - api-manager
  - reference
  - connectors
