...
description: "Reference for the SMPP connector init operation, listing parameters used to bind with the SMSC."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/smpp-connector/smpp-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/smpp-connector/smpp-connector-config.md
tags:
  - esb-connector
  - sms
