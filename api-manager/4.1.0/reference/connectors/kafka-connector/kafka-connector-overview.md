...
description: "Introduces the Kafka connector for publishing and consuming messages through Kafka topics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/kafka-connector/kafka-connector-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/kafka-connector/kafka-connector-overview.md
tags:
  - api-manager
  - reference
  - connectors
