...
description: "Lists Kafka connector 3.0.x operations and parameters for setting up a Kafka producer with or without security."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/kafka-connector/3.0.x/kafka-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/kafka-connector/3.0.x/kafka-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
