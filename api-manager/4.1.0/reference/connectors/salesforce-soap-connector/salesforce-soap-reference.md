...
description: "Reference for Salesforce SOAP connector operations, including init parameters such as username and password."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/salesforce-soap-connector/salesforce-soap-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/salesforce-soap-connector/salesforce-soap-reference.md
tags:
  - api-manager
  - reference
  - connectors
