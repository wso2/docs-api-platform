...
description: "Reference for the Google Pub/Sub connector init operation and the parameters used to authenticate with Google Cloud Pub/Sub."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/google-pubsub-connector/googlepubsub-connector-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/google-pubsub-connector/googlepubsub-connector-reference.md
tags:
  - api-manager
  - reference
  - connectors
