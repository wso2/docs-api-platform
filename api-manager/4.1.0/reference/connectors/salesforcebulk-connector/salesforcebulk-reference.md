...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/salesforcebulk-connector/salesforcebulk-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/salesforcebulk-connector/salesforcebulk-reference.md
tags:
  - api-manager
  - reference
  - connectors
