...
description: "Sign up for an AWS account and get the access key ID and secret access key needed to use the Amazon S3 connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/amazons3-connector/amazons3-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/amazons3-connector/amazons3-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
