...
description: "Lists Redis connector v2.4.x operations and parameters, including connection pooling options, for interacting with Redis."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/redis-connector/2.4.x/redis-connector-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/redis-connector/2.4.x/redis-connector-reference.md
tags:
  - api-manager
  - reference
  - connectors
