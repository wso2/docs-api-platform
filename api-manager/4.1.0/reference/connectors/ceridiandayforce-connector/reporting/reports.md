...
description: "Use the GET Reports operation to run a report and receive its results through web services."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/ceridiandayforce-connector/reporting/reports/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/ceridiandayforce-connector/reporting/reports.md
tags:
  - api-manager
  - reference
  - connectors
