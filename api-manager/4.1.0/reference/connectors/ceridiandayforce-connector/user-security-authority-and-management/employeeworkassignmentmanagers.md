...
description: "Retrieve, assign, or update managers an employee has through Direct Management using this connector operation set."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/ceridiandayforce-connector/user-security-authority-and-management/employeeworkassignmentmanagers/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/connectors/ceridiandayforce-connector/user-security-authority-and-management/employeeworkassignmentmanagers.md
tags:
  - api-manager
  - reference
  - connectors
