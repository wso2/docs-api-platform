...
description: "Explains how the TOML-based deployment.toml configuration model maps to older WSO2 API Manager configuration files."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/understanding-the-new-configuration-model/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/understanding-the-new-configuration-model.md
tags:
  - api-manager
  - reference
