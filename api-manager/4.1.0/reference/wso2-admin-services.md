...
description: "Explains how to discover and invoke WSO2 admin services directly from applications and test scripts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/wso2-admin-services/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/wso2-admin-services.md
tags:
  - api-manager
  - reference
  - wso2-admin-services
