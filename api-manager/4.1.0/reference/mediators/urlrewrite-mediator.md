...
description: "Configure the URLRewrite mediator to modify and transform URL values in messages using rewrite rules."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/mediators/urlrewrite-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/mediators/urlrewrite-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! info
    The URLRewrite mediator is a [content aware](about-mediators.md#classification-of-mediators) mediator.
