...
description: "Configure the Call Template mediator to construct a sequence by passing values into a sequence template."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/mediators/call-template-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/mediators/call-template-mediator.md
tags:
  - api-manager
  - reference
  - mediators
