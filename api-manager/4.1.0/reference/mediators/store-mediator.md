...
description: "Configure the Store mediator to enqueue messages in a message store, with syntax and parameter reference."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/mediators/store-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/mediators/store-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
    The Store mediator is a [content aware](about-mediators.md#classification-of-mediators) mediator.
