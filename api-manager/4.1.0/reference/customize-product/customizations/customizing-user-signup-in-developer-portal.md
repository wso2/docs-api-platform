...
description: "Customize the fields shown on the Developer Portal self sign-up page by editing user claim attributes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/customizing-user-signup-in-developer-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/customizing-user-signup-in-developer-portal.md
tags:
  - api-manager
  - reference
  - customize-product
