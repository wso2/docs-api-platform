...
description: "Increase the default 25-task limit on pending workflow approval tasks shown in the Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/modify-workflow-approval-task-limit/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/modify-workflow-approval-task-limit.md
tags:
  - api-manager
  - reference
  - customize-product
