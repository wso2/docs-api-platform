...
description: "Override the Publisher Portal default theme by editing userThemes.js without rebuilding the source."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/overriding-the-publisher-portal-theme/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/overriding-the-publisher-portal-theme.md
tags:
  - api-manager
  - reference
  - customize-product
