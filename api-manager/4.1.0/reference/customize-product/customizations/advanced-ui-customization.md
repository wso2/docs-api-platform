...
description: "Modify the React codebase of the Developer Portal and Publisher to apply advanced UI customizations beyond CSS."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/advanced-ui-customization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/customizations/advanced-ui-customization.md
tags:
  - ui-customization
  - react
