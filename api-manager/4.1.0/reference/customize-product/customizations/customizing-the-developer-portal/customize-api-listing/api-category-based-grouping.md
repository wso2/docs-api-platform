...
- Add an API Category using the Admin REST API. (You can use the POST resource in the **API Category (Individual)** section [here](../../../../product-apis/admin-apis/admin-v3/admin-v3.md))
