...
description: "Configure the task clean up feature so deleted applications or subscriptions do not leave stale approval requests."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-workflows/cleaning-up-workflow-tasks/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-workflows/cleaning-up-workflow-tasks.md
tags:
  - api-manager
  - reference
  - customize-product
