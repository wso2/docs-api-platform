...
description: "Call back the API Manager endpoint from the BPEL engine to progress a workflow after configuration."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-workflows/invoking-the-api-manager-from-the-bpel-engine/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-workflows/invoking-the-api-manager-from-the-bpel-engine.md
tags:
  - api-manager
  - reference
  - customize-product
...
<p>WSDL Location : http://localhost:8280/services/WorkflowCallbackService?wsdl</p></td>
</tr>
<tr class="even">
<td>REST</td>
