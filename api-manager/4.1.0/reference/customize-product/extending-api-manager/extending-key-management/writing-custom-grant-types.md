...
description: "Add custom OAuth2 grant types or extend existing grant handler implementations in API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-key-management/writing-custom-grant-types/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-key-management/writing-custom-grant-types.md
tags:
  - api-manager
  - reference
  - customize-product
