...
description: "Extend the KeyManager interface to customize how API Manager interacts with an OAuth provider."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-key-management/extending-the-key-manager-interface/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/customize-product/extending-api-manager/extending-key-management/extending-the-key-manager-interface.md
tags:
  - api-manager
  - reference
  - customize-product
