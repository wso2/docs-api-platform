...
description: "Follow guidelines for naming, versioning, and designing APIs and resources when using WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/wso2-api-manager-best-practices/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/wso2-api-manager-best-practices.md
tags:
  - api-manager
  - reference
