...
description: "Understand how request handlers, mediation extensions, and sequences process messages in the API Gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/guides/message-flow-in-the-api-manager-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/guides/message-flow-in-the-api-manager-gateway.md
tags:
  - api-manager
  - reference
  - guides
