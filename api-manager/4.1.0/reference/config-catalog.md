...
description: "Reference for all deployment.toml configuration parameters and sections used to configure and tune WSO2 API Manager features."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/config-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/config-catalog.md
tags:
  - api-manager
  - reference
  - config-catalog
                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <p>
                                Configurations related to the file size limit for API creation & update via URL. Note that this configuration is available from U2 level 259
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
