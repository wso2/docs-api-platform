...
description: "Write custom Siddhi extensions using maven archetypes to implement use case specific logic not covered by built-in extensions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/streaming-connectors/writing-custom-siddhi-extensions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/streaming-connectors/writing-custom-siddhi-extensions.md
tags:
  - api-manager
  - reference
