...
description: "Install APICTL, add environments, log in, and use the command-line tool to manage APIs across API Manager environments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/apictl/wso2-api-controller/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/apictl/wso2-api-controller.md
tags:
  - api-manager
  - reference
  - apictl
