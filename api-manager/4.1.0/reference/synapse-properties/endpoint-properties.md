...
!!! Note
      1. You can also use environment variables for these parameters. For more information, see [Injecting Parameters](../../integrate/develop/injecting-parameters.md).
      2. You can use dynamic values for OAuth configurations such as XPATH, JSON expressions or vault-lookup. For more information, see [Define dynamic expressions](endpoint-properties.md#define-dynamic-expressions).
      3. You can send additional parameters as well in the OAuth request body. For more information, see [Send additional parameters in the OAuth request body](endpoint-properties.md#send-additional-parameters-in-the-oauth-request-body).
