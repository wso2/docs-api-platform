---
title: "Scheduled task properties"
description: "Reference the required and optional properties used to configure a scheduled task in the Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/synapse-properties/scheduled-task-properties/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/synapse-properties/scheduled-task-properties.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
See the topics given below for the list of properties that can be configured when you [create a Scheduled Task](../../integrate/develop/creating-artifacts/creating-scheduled-task.md).

### Required Properties

The following properties are required when [creating a scheduled task](../../integrate/develop/creating-artifacts/creating-scheduled-task.md).
      ...
      <tr class="odd">
         ...
         <td>
            <div class="content-wrapper">
                ...
                <b>Note</b>:
                <p>The <code>startOnLoad</code> attribute was introduced in MI version <strong>MI 4.1.0.175</strong>. This configuration determines the lifecycle state only during the very first deployment of the task on the WSO2MI server. For all subsequent server restarts or deployments, the Micro Integrator evaluates the persisted state in the internal registry to decide whether to start or pause the task.</p>
                <b>Syntax</b>:
                  <div class="sourceCode" id="cb1" data-syntaxhighlighter-params="brush: java; gutter: false; theme: Confluence" data-theme="Confluence" style="brush: java; gutter: false; theme: Confluence">
...
Listed below are the optional task implementation properties you can use when [creating a scheduled task](../../integrate/develop/creating-artifacts/creating-scheduled-task.md).
    ...
    <span id="cb2-24"><a href="#cb2-24"></a>   &lt;/task&gt;</span></code></pre>
      ...
      <tr class="even">
         ...
         <td>
            ...
            <strong>Note:</strong> This property is available from MI 4.1.0.145 onwards.
