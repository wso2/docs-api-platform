...
description: "Configure and inherit XML namespaces at different levels of a data service to avoid conflicting element names."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/synapse-properties/data-services/using-namespaces/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/synapse-properties/data-services/using-namespaces.md
tags:
  - api-manager
  - reference
  - synapse-properties
