...
description: "Reference for the JMS transport parameters used to configure a JMS connection in a proxy service."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/synapse-properties/transport-parameters/jms-transport-parameters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/reference/synapse-properties/transport-parameters/jms-transport-parameters.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
!!! Tip
    To define the parameters at the server level, you need to update the **JMS configurations** in the `deployment.toml` file. See the [configuration catalog](../../config-catalog.md) for details on how to apply server configurations.
