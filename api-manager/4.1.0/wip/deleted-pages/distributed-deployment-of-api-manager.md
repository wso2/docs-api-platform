...
description: "Introduces distributed deployment of WSO2 API Manager's Publisher, Developer Portal, Gateway, Key Manager, and Traffic Manager components."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/wip/deleted-pages/distributed-deployment-of-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/wip/deleted-pages/distributed-deployment-of-api-manager.md
tags:
  - api-manager
  - wip
  - deleted-pages
