...
description: "Explains how to set up and configure an embedded Apache Derby database to replace the default H2 database."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/wip/deleted-pages/changing-to-embedded-derby/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/wip/deleted-pages/changing-to-embedded-derby.md
tags:
  - api-manager
  - wip
  - deleted-pages
