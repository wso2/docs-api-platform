...
description: "Walks through creating an API from a backend implementation and publishing it using the WSO2 API Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/wip/need-to-update/create-and-publish-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/wip/need-to-update/create-and-publish-an-api.md
tags:
  - api-manager
  - wip
  - need-to-update
