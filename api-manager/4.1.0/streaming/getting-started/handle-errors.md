...
description: "Configure an error store so failed Siddhi application events can be captured, corrected, and replayed."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/streaming/getting-started/handle-errors/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/streaming/getting-started/handle-errors.md
tags:
  - api-manager
  - streaming
  - getting-started
