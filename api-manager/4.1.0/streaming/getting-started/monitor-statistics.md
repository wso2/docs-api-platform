...
description: "Set up Prometheus and Grafana dashboards to monitor CDC and file statistics of a Streaming Integrator deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/streaming/getting-started/monitor-statistics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/streaming/getting-started/monitor-statistics.md
tags:
  - api-manager
  - streaming
  - getting-started
