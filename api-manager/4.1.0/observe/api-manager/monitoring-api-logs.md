...
description: "Enables and reads lightweight API Logs at BASIC, STANDARD, or FULL levels to observe gateway request and response traffic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/api-manager/monitoring-api-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/api-manager/monitoring-api-logs.md
tags:
  - api-manager
  - observe
  - monitoring-api-logs
