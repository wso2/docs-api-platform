...
description: "Configures JMX ports and datasources, then monitors a WSO2 API Manager server using JConsole."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/api-manager/metrics/jmx-based-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/api-manager/metrics/jmx-based-monitoring.md
tags:
  - api-manager
  - observe
  - metrics
