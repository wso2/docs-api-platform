...
description: "Enables correlation logs in API Manager to trace method, external, and database calls under a shared correlation ID."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/api-manager/monitoring-correlation-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/api-manager/monitoring-correlation-logs.md
tags:
  - api-manager
  - observe
