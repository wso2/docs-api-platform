...
description: "View memory usage and latency statistics for Siddhi queries in the Streaming Integrator dashboard."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/si-observe/viewing-query-statistics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/si-observe/viewing-query-statistics.md
tags:
  - api-manager
  - observe
  - si-observe
