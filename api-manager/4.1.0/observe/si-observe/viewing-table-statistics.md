...
description: "Interpret the table statistics dashboard showing operation latency and throughput for Siddhi application tables."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/si-observe/viewing-table-statistics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/si-observe/viewing-table-statistics.md
tags:
  - api-manager
  - observe
  - si-observe
