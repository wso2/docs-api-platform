...
description: "Uses the TCPMon utility to monitor and debug TCP-based messages exchanged between a client and a back-end server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/mi-observe/tcp/message_monitoring_with_tcpmon/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/mi-observe/tcp/message_monitoring_with_tcpmon.md
tags:
  - api-manager
  - observe
  - mi-observe
...
![Client Server Communication](../../../assets/img/integrate/tcp/client-server-communication.png)
...
![Client-TCP-Server Communication](../../../assets/img/integrate/tcp/client-tcp-server-communication.png)
...
1.  [Start TCPMon](starting_tcp_mon.md) .
...
4.  Give 80 as the target port, which is the listening port of
    ...
    ![TCPMon console](../../../assets/img/integrate/tcp/tcpmon-admin-console.png)
...
7.  A new tab in TCPMon will indicate the 8081 port. You can view the
    ...
    ![TCPMon ports](../../../assets/img/integrate/tcp/tcpmon-port8081-console.png)
...
8.  The options at the bottom of the screen can be used to have the
    ...
    ![TCPMon console option](../../../assets/img/integrate/tcp/tcp-console-options.png)