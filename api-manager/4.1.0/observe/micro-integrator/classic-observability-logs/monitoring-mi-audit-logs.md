...
The log growth of Audit Logs can be managed by using the configurations that are discussed in the [Managing Log Growth](../../../administer/logging-and-monitoring/logging/managing-log-growth.md) guide.
