...
description: "Get an overview of the API Manager, Integration, and Streaming Integrator observability solutions built on logs, metrics, and tracing."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/observe-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/observe-overview.md
tags:
  - api-manager
  - observe
  - observe-overview
