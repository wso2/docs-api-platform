...
description: "Organize Grafana dashboards into folders, move dashboards between folders, and delete dashboards."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/streaming-integrator/managing-dashboards/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/observe/streaming-integrator/managing-dashboards.md
tags:
  - api-manager
  - observe
