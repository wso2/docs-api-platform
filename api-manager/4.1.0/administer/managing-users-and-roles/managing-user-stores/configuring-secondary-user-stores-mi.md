...
!!! info
    **Note** : It's mandatory to have a primary user store configured before adding secondary user stores. Refer
    [configuring an LDAP user store](../../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore.md#configuring-an-ldap-user-store)
...
1. [Download](../../../assets/attachments/secondary-userstore-templates.zip) the template files provided and change the urls and credentials accordingly.
