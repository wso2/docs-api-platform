...
description: "Learn how multitenancy isolates tenants, shares resources, and handles loading policy, restrictions, and scaling."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/multitenancy/introduction-to-multitenancy/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/multitenancy/introduction-to-multitenancy.md
tags:
  - api-manager
  - administer
  - multitenancy
