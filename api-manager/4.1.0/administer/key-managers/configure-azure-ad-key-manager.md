...
description: "Explains how to configure Azure AD as a third-party key manager in WSO2 API Manager using the Azure AD connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/key-managers/configure-azure-ad-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/key-managers/configure-azure-ad-key-manager.md
tags:
  - api-manager
  - administer
  - key-managers
