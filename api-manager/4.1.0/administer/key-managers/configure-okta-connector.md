...
description: "Explains how to configure Okta as a third-party key manager in WSO2 API Manager using the Okta OAuth Authorization Server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/key-managers/configure-okta-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/key-managers/configure-okta-connector.md
tags:
  - api-manager
  - administer
  - key-managers
