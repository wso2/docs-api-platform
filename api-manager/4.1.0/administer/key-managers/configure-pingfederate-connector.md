...
description: "Explains how to configure PingFederate as a third-party key manager in WSO2 API Manager using the PingFederate connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/key-managers/configure-pingfederate-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/key-managers/configure-pingfederate-connector.md
tags:
  - api-manager
  - administer
  - key-managers
...
4. Click **Production Keys**.
     ...
     ![PingFederate Developer Portal generate keys](../../assets/img/administer/ping-devportal-generate-keys.png)
