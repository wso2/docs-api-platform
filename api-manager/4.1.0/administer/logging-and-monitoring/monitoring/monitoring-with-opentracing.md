...
description: "Enable distributed tracing with OpenTracing using Jaeger, Zipkin, or log-based tracers to debug message paths in API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/logging-and-monitoring/monitoring/monitoring-with-opentracing/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/logging-and-monitoring/monitoring/monitoring-with-opentracing.md
tags:
  - api-manager
  - administer
