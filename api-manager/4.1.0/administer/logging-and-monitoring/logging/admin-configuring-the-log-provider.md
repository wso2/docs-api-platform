...
description: "Explains how to implement and configure the LogProvider and LogFileProvider interfaces to view and download logs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/logging-and-monitoring/logging/admin-configuring-the-log-provider/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/administer/logging-and-monitoring/logging/admin-configuring-the-log-provider.md
tags:
  - api-manager
  - administer
