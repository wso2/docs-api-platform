...
description: "Explains how to secure APIs using API keys and configure the required prerequisites in WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/learn/api-security/api-authentication/secure-apis-using-api-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/learn/api-security/api-authentication/secure-apis-using-api-keys.md
tags:
  - api-manager
  - learn
  - api-security
