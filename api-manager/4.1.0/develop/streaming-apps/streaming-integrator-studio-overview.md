...
- **On-Demand Query**
    ...
    actions you can carry out for stores, see [Store APIs](store-apis.md).
...
-   For detailed instructions to find and use a Siddhi extension via the
    Operator Finder demonstrated with an example, see [Creating a Siddhi Application](creating-a-siddhi-application.md).
