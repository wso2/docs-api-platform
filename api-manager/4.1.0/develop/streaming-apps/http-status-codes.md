...
description: "Reference the HTTP status codes returned by Streaming Integrator REST API requests for success and error cases."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/develop/streaming-apps/http-status-codes/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/develop/streaming-apps/http-status-codes.md
tags:
  - api-manager
  - develop
  - streaming-apps
