...
description: "Deploy a Siddhi application to the Streaming Integrator server, or run it in Docker and Kubernetes environments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/develop/streaming-apps/deploying-streaming-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/develop/streaming-apps/deploying-streaming-applications.md
tags:
  - api-manager
  - develop
  - streaming-apps
