...
description: "Export Siddhi applications as Docker or Kubernetes artifacts using the Streaming Integrator Tooling."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/develop/streaming-apps/exporting-siddhi-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/develop/streaming-apps/exporting-siddhi-applications.md
tags:
  - api-manager
  - develop
  - streaming-apps
