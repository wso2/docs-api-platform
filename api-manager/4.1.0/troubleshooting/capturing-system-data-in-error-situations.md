...
description: "Use the Carbon Dump tool to capture heap and thread dumps from a running Carbon instance for error analysis."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/troubleshooting/capturing-system-data-in-error-situations/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/troubleshooting/capturing-system-data-in-error-situations.md
tags:
  - api-manager
  - troubleshooting
