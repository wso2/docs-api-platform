...
description: "Enable debug logging for WebSocket API traffic to diagnose and troubleshoot issues in the WebSocket API flow."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/troubleshooting/troubleshooting-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/troubleshooting/troubleshooting-websocket-api.md
tags:
  - api-manager
  - troubleshooting
