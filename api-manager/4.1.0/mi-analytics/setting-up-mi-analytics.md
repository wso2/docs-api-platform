...
!!! info "If you do not have the integration artifacts from the service chaining tutorial"
    ...
    2.  [Open WSO2 Integration Studio](../integrate/develop/installing-wso2-integration-studio.md) and [import the pre-packaged project](../integrate/develop/importing-projects.md).
