...
description: "Set up Microgateway and APICTL, create and deploy an API project, and invoke the API using a generated key."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/publish/api-microgateway/quick-start-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/publish/api-microgateway/quick-start-guide.md
tags:
  - api-manager
  - publish
  - api-microgateway
