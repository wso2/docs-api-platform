...
description: "Explains how API Microgateway components use the xDS protocol for Adapter-to-Enforcer communication."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/publish/api-microgateway/internal-communication-protocol/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/publish/api-microgateway/internal-communication-protocol.md
tags:
  - api-manager
  - publish
  - api-microgateway
