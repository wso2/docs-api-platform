...
description: "Demonstrates a publish-subscribe use case using the MQTT transport with a WSO2 Micro Integrator proxy service."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/transport_examples/pub-sub-using-mqtt/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/transport_examples/pub-sub-using-mqtt.md
tags:
  - api-manager
  - integrate
  - examples
