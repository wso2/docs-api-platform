...
description: "Configure failover endpoints, including failover with a single address endpoint, to retry messages after connection errors."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/endpoint_examples/using-failover-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/endpoint_examples/using-failover-endpoints.md
tags:
  - api-manager
  - integrate
  - examples
...
and properties, see [Endpoint Error Handling](endpoint-error-handling.md).
...
see [Endpoint Error Handling](endpoint-error-handling.md).
