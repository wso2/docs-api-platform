...
description: "Send messages between WebSocket and HTTP clients and a WebSocket endpoint through the Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/endpoint_examples/using-websocket-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/endpoint_examples/using-websocket-endpoints.md
tags:
  - api-manager
  - integrate
  - examples
...
For sample synapse configurations, see [WebSocket Inbound](../inbound_endpoint_examples/inbound-endpoint-secured-websocket.md).
...
3. Create the [mediation sequences](../../develop/creating-artifacts/creating-reusable-sequences.md) and the [proxy service](../../develop/creating-artifacts/creating-a-proxy-service.md) with the configurations given above.
