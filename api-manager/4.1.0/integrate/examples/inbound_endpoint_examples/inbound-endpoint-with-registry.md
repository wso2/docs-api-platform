...
description: "Reference registry entries instead of inline values for inbound endpoint parameters to reuse configurations across environments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-with-registry/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-with-registry.md
tags:
  - api-manager
  - integrate
  - examples
