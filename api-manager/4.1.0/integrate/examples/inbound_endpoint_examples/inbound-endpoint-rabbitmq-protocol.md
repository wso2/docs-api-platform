...
description: "Configure a RabbitMQ inbound endpoint to bridge one-way messages from RabbitMQ to an HTTP backend."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-rabbitmq-protocol/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-rabbitmq-protocol.md
tags:
  - api-manager
  - integrate
  - examples
