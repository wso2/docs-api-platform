...
description: "Configure a WebSocket inbound endpoint with Synapse subprotocols to read and transform WebSocket frame content."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-secured-websocket/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-secured-websocket.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [mediation sequences](../../develop/creating-artifacts/creating-reusable-sequences.md) and [inbound endpoint](../../develop/creating-artifacts/creating-an-inbound-endpoint.md) with the configurations given above.
