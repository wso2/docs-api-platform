...
description: "Walks through examples of using sequence templates with the Call Template mediator in WSO2 Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/template_examples/using-sequence-templates/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/template_examples/using-sequence-templates.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy service](../../develop/creating-artifacts/creating-a-proxy-service.md) and [sequence template](../../develop/creating-artifacts/creating-sequence-templates.md) with the configurations given above.
...
1. [Set up WSO2 Integration Studio](../../develop/installing-wso2-integration-studio.md).
2. [Create an integration project](../../develop/create-integration-project.md) with an <b>ESB Configs</b> module and an <b>Composite Exporter</b>.
3. Create the [REST API](../../develop/creating-artifacts/creating-an-api.md) and [sequence template](../../develop/creating-artifacts/creating-sequence-templates.md) with the configurations given above.
4. [Deploy the artifacts](../../develop/deploy-artifacts.md) in your Micro Integrator.
