...
description: "Reuse the same mediation sequence across multiple proxy services in WSO2 Micro Integrator instead of duplicating logic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/sequence_examples/custom-sequences-with-proxy-services/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/sequence_examples/custom-sequences-with-proxy-services.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy services](../../develop/creating-artifacts/creating-a-proxy-service.md), the [mediation sequences](../../develop/creating-artifacts/creating-reusable-sequences.md), the [local entry](../../develop/creating-artifacts/registry/creating-local-registry-entries.md), and the [endpoint](../../develop/creating-artifacts/creating-endpoints.md) with the configurations given above.
