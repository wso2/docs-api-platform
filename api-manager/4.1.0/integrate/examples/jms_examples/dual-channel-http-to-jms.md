...
description: "Configure dual-channel proxy services that use JMS correlation IDs to implement synchronous HTTP-to-JMS invocations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/jms_examples/dual-channel-http-to-jms/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/jms_examples/dual-channel-http-to-jms.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy services](../../develop/creating-artifacts/creating-a-proxy-service.md) with the configurations given above.
