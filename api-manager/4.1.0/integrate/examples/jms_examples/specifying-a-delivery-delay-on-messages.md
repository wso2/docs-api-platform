...
description: "Configure a JMS producer in the Micro Integrator to delay message delivery until a specified time interval has elapsed."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/jms_examples/specifying-a-delivery-delay-on-messages/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/jms_examples/specifying-a-delivery-delay-on-messages.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy services](../../develop/creating-artifacts/creating-a-proxy-service.md), [registry artifact](../../develop/creating-artifacts/creating-registry-resources.md), [scheduled task](../../develop/creating-artifacts/creating-scheduled-task.md), and [sequences](../../develop/creating-artifacts/creating-reusable-sequences.md) with the configurations given above.
