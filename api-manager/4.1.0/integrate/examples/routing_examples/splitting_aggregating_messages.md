...
description: "Use the Iterate and Aggregate mediators in a proxy service to split a message and aggregate backend responses."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/routing_examples/splitting_aggregating_messages/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/routing_examples/splitting_aggregating_messages.md
tags:
  - api-manager
  - integrate
  - examples
