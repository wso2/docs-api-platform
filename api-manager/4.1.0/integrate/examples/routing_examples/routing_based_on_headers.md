...
description: "Configure a proxy service to route messages to different mediation sequences based on request headers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/routing_examples/routing_based_on_headers/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/routing_examples/routing_based_on_headers.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy service](../../develop/creating-artifacts/creating-a-proxy-service.md) and [mediation sequences](../../develop/creating-artifacts/creating-reusable-sequences.md) with the configurations given above.
