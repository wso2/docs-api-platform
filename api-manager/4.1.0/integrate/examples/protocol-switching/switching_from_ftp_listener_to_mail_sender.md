...
description: "Configure the Micro Integrator to pick up files from an FTP directory and send the response as an e-mail."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/protocol-switching/switching_from_ftp_listener_to_mail_sender/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/protocol-switching/switching_from_ftp_listener_to_mail_sender.md
tags:
  - api-manager
  - integrate
  - examples
...
4. Create the proxy service with the [VFS configurations parameters given above](../../../reference/config-catalog.md#vfs-transport).
5. Configure [MailTo transport sender](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports.md#configuring-the-mailto-transport).
6. [Deploy the artifacts](../../develop/deploy-artifacts.md) in your Micro Integrator and start the Micro Integrator.
