---
title: "Switching from HTTP(S) to JMS"
description: "Configure a Micro Integrator proxy service to receive HTTP(S) messages and forward them to a backend over JMS."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/protocol-switching/switching_from_https_to_jms/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/protocol-switching/switching_from_https_to_jms.md
tags:
  - api-manager
  - integrate
  - examples
...
If the previous example on [JMS to HTTP](../../../install-and-setup/setup/mi-setup/changing_default_ports.md) is also configured, it will pick the message from queue and send it to the stockquote proxy.
...
3. Add [sample_proxy_1.wsdl](https://github.com/wso2-docs/WSO2_EI/blob/master/samples-protocol-switching/sample_proxy_1.wsdl) as a [registry resource](../../develop/creating-artifacts/creating-registry-resources.md) (change the registry path of the proxy accordingly). 
...
6. [Configure MI with the selected message broker](../../../install-and-setup/setup/mi-setup/brokers/configure-with-activemq.md) and start the Micro-Integrator.
