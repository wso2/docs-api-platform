...
description: "Configure the MailTo transport to send emails from mediation sequences using global or per-message sender settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/file-processing/mailto-transport-examples/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/file-processing/mailto-transport-examples.md
tags:
  - api-manager
  - integrate
  - examples
...
1. [Set up WSO2 Integration Studio](../../develop/installing-wso2-integration-studio.md). The path to this folder is referred to as `MI_TOOLING_HOME` throughout this tutorial.
2. Open the `deployment.toml` file from the `MI_TOOLING_HOME/Contents/Eclipse/runtime/microesb/conf` directory, and [enable the MailTo transport sender](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports.md#configuring-the-mailto-transport).
4. [Create the proxy service](../../develop/creating-artifacts/creating-a-proxy-service.md) with the configurations given above.
...
When the [MailTo transport listener is enabled](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports.md#configuring-the-mailto-transport) for the Micro Integrator, you can configure your mediation sequences to send emails.
...
4. Add [sample_proxy_1.wsdl](https://github.com/wso2-docs/WSO2_EI/blob/master/samples-protocol-switching/sample_proxy_1.wsdl) as a [registry resource](../../develop/creating-artifacts/creating-registry-resources.md). Change the registry path of the proxy accordingly. 
...
6. [Deploy the artifacts](../../develop/deploy-artifacts.md) in your Micro Integrator. 
