...
description: "Explains transactions and distributed transactions, and how the Micro Integrator handles transactional operations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/working-with-transactions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/working-with-transactions.md
tags:
  - api-manager
  - integrate
  - examples
