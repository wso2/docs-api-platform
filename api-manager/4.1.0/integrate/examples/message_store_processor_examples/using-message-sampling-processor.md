...
description: "Configure a message sampling processor to forward stored messages to a backend service at intervals."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/message_store_processor_examples/using-message-sampling-processor/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/message_store_processor_examples/using-message-sampling-processor.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy service](../../develop/creating-artifacts/creating-a-proxy-service.md), [mediation sequences](../../develop/creating-artifacts/creating-reusable-sequences.md), [message store](../../develop/creating-artifacts/creating-a-message-store.md), and [message processor](../../develop/creating-artifacts/creating-a-message-processor.md) with the configurations given above.
4. [Deploy the artifacts](../../develop/deploy-artifacts.md) in your Micro Integrator.

[Configure the ActiveMQ broker](../../../install-and-setup/setup/mi-setup/brokers/configure-with-activemq.md) and set up the JMS Sender.
