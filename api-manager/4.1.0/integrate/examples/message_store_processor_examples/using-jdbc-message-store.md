...
description: "Store proxy service messages in a JDBC message store and forward them to the backend using a message processor."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/message_store_processor_examples/using-jdbc-message-store/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/examples/message_store_processor_examples/using-jdbc-message-store.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [proxy service](../../develop/creating-artifacts/creating-a-proxy-service.md), [message store](../../develop/creating-artifacts/creating-a-message-store.md), [message processor](../../develop/creating-artifacts/creating-a-message-processor.md), and [endpoint](../../develop/creating-artifacts/creating-endpoints.md) with the configurations given above.
