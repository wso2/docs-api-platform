...
description: "Change the endpoint reference of a deployed proxy service without modifying the service configuration itself."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/advanced-development/changing-the-endpoint-of-deployed-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/advanced-development/changing-the-endpoint-of-deployed-service.md
tags:
  - api-manager
  - integrate
  - develop
