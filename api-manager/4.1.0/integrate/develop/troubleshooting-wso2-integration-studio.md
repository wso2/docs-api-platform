...
description: "Troubleshoot common WSO2 Integration Studio errors such as refreshing artifacts, resetting views, and Docker image creation failures."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/troubleshooting-wso2-integration-studio/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/troubleshooting-wso2-integration-studio.md
tags:
  - api-manager
  - integrate
  - develop
