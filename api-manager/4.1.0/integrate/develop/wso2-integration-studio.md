...
-   See [Installing WSO2 Integration Studio](installing-wso2-integration-studio.md) for installation instructions.
-   See [Working with WSO2 Integration Studio](working-with-wso2-integration-studio.md) for more information on how to setup and use tooling.
-   See [Troubleshooting WSO2 Integration Studio](troubleshooting-wso2-integration-studio.md) for information on troubleshooting errors you may run into while using WSO2 Integration Studio.