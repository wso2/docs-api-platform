...
description: "Create or import a custom mediator project in WSO2 Integration Studio and deploy it as a JAR or CAR."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/customizations/creating-custom-mediators/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/customizations/creating-custom-mediators.md
tags:
  - api-manager
  - integrate
  - develop
...
1. Open <b>WSO2 Integration Studio</b> and click <b>Miscellaneous → Create Mediator Project</b> in the <b>Getting Started</b> view as shown below.
   ![new mediator project](../../../assets/img/integrate/create_project/new_mediator_project.png)
...
3. Enter a project name, package name, and class name.
   ![new mediator dialog](../../../assets/img/integrate/create_project/new_mediator_artifact_dialog.png)
