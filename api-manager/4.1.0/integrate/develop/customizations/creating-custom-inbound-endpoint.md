...
1. If you have already created an [Integration Project](../create-integration-project.md), right-click the [ESB Config module](../create-integration-project.md#esb-config-project) and go to **New → Inbound Endpoint** to open the **New Inbound Endpoint Artifact**.
