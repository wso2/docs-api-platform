...
1.  If you have already created an [ESB Config project](../create-integration-project.md#esb-config-project), right click the ESB Config project where you want to use the connector and click **Add or Remove Connector/Module**.
