...
!!!	Tip
    ...
    For more information, you can follow the steps given in [Generate Data Services](creating-data-services.md#generate-data-service-from-a-datasource).


## Examples

-	<a href="../../../../examples/data_integration/carbon-data-service/">Exposing a Carbon Datasource</a>