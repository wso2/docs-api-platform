...
description: "Generate a Docker image of a composite application project using WSO2 Integration Studio's export wizard."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/generate-docker-image/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/generate-docker-image.md
tags:
  - api-manager
  - integrate
  - develop
...
2.  In the **Generate Docker Image Wizard** that opens, select one from the following three options and proceed. 
    ...
    ![Generate docker image dialog](../../assets/img/integrate/create_project/docker_k8s_project/generate-docker-image-options.png)
    ...
    -  **Generate Docker Image with the Embedded MI**
        ...
        2.  Click **Next** and enter the following details:
            ...
            ![Create docker image dialog](../../assets/img/integrate/create_project/generate_docker_image_dialog.png) 
        ...
        3.  Click **Next**. Select the **Config** projects that you want to include in the Docker image and click **Finish**.  
            ...
            ![Create docker image](../../assets/img/integrate/create_project/select_artifact_docker.png)  
        
            Once the Docker image is successfully created, a message similar to the following appears in your screen.  

            ![Create docker image](../../assets/img/integrate/create_project/docker_image_successful.png)
