...
description: "Import an existing integration artifact into a WSO2 Integration Studio ESB project from a configuration file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/importing-artifacts/
md_url: https://wso2.com/api-platform/docs/api-manager/4.1.0/integrate/develop/importing-artifacts.md
tags:
  - api-manager
  - integrate
  - develop
