...
4.  Review the default port details for your server and click <b>Next</b>.
    ...
    !!! Note
        ...
        -   If you are already running another server on these ports, give unused ports. See [Default ports](../../install-and-setup/setup/mi-setup/changing_default_ports.md) of the Micro Integrator for more information.
