...
description: "Apply the Prompt Template mediation policy in the AI Gateway to standardize prompts sent to AI services using placeholder-driven templates."
