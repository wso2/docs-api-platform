...
Download the [sample fault sequence template](../../assets/attachments/guardrails/guardrail_fault.xml) provided by WSO2. This template includes customizable logic for formatting the error message, logging, and header propagation.
