...
description: "Configure subscription-level and backend-level rate limiting for AI APIs in WSO2 API Manager, including request-count and token-based quotas."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/ai-gateway/rate-limiting/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/ai-gateway/rate-limiting.md
tags:
  - api-manager
  - ai-gateway
  - rate-limiting
...
For more details, see [Configuring AI API Subscription Policies](../manage-apis/design/rate-limiting/rate-limiting-for-ai-apis.md)
...
For a step-by-step guide, refer to [Backend Rate Limiting for AI APIs](../manage-apis/design/rate-limiting/setting-maximum-backend-throughput-limits.md#setting-maximum-backend-throughput-limits-for-ai-apis)
