...
description: "Configure server-specific or tenant-specific custom attributes for WSO2 API Manager applications and add them to an application from the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/consume/manage-application/advanced-topics/add-custom-attributes-to-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/consume/manage-application/advanced-topics/add-custom-attributes-to-applications.md
tags:
  - api-manager
  - developer-portal
  - applications
