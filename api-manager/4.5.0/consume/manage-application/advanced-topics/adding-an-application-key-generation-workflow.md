...
description: "Attach an approval workflow to application registration so key generation requests must be approved before tokens are issued."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/consume/manage-application/advanced-topics/adding-an-application-key-generation-workflow/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/consume/manage-application/advanced-topics/adding-an-application-key-generation-workflow.md
tags:
  - api-manager
