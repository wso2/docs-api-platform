...
description: "Enable correlation logs to trace method, HTTP, and database calls under a single correlation ID, and diagnose latency bottlenecks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/monitoring/observability/logs/monitoring-correlation-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/monitoring/observability/logs/monitoring-correlation-logs.md
tags:
  - api-manager
  - observability
  - logging
...
For more instructions, see [WSO2 Devops API v0](../../../reference/product-apis/devops-apis/devops-v0/devops-v0.md#/paths/~1config~1correlation~1/get).
...
1. [Creating an API](../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md)

2. [Publish the API](../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md)

3. [Subscribe to the API](../../../consume/manage-subscription/subscribe-to-an-api.md)
