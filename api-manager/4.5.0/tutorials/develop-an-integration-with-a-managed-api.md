...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/develop-an-integration-with-a-managed-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/develop-an-integration-with-a-managed-api.md
tags:
  - api-manager
  - integration
  - service-catalog
...
5.	You can manage the API the way you want and test out the resource by adding a [Mock Implementation](../manage-apis/design/prototype-api/create-mocked-js-api.md).
...
Depoly the `HealthcareAPI` REST API in the Gateway. For more information, see [Deploy an API](../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md#deploy-an-api).
