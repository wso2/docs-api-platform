...
description: "Set up a single API Manager control plane to publish and manage APIs across the Universal, Kubernetes, and Immutable Gateways."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/single-control-plane-for-multiple-gateways/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/single-control-plane-for-multiple-gateways.md
tags:
  - api-manager
  - control-plane
  - multi-gateway
...
Create and deploy the HR System API as shown below (follow the steps in [Create a REST API from an OpenAPI Definition - WSO2 API Manager Documentation](../manage-apis/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition) for more information if needed) .
