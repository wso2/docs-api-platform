...
description: "Create a REST API in API Manager backed by an AWS Lambda endpoint: configure credentials, map function ARNs, and tune pooling."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/create-and-publish-awslambda-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/create-and-publish-awslambda-api.md
tags:
  - api-manager
  - aws-lambda
  - endpoints
...
3. Enter the API details without an endpoint URL and click **Create**.  
    ...
    [![Create a test API](../assets/img/learn/create-lambda-api-details.png)](../assets/img/learn/create-lambda-api-details.png)
...
2. Configure the resources.
    ...
    2. Add a new resource.
          ...
          [![Add a new resource](../assets/img/learn/resource-add-post-lambda.png)](../assets/img/learn/resource-add-post-lambda.png)
...
5. Click **SAVE**.
    ...
    [![Save resources](../assets/img/learn/resource-save-lambda.png)](../assets/img/learn/resource-save-lambda.png)
