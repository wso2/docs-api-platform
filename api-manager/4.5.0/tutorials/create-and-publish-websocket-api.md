...
description: "Design and publish a WebSocket API in API Manager, subscribe to it from the Developer Portal, and invoke it using wscat."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/create-and-publish-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/tutorials/create-and-publish-websocket-api.md
tags:
  - api-manager
  - websocket
  - tutorials
...
<p>For more information on WebSocket APIs, see <a href="../../manage-apis/design/create-api/create-a-websocket-api.md">Create a WebSocket API</a>.</p>
</div> 
</html>
...
5.  Optionally, enter the endpoint configurations.
     ...
     2. Click the **Endpoint Advanced Configurations** link as shown below and update the endpoint related configurations as required.
         ...
         - [Endpoint Timeouts](../manage-apis/design/endpoints/resiliency/endpoint-timeouts.md)
         - [Endpoint Suspension](../manage-apis/design/endpoints/resiliency/endpoint-suspension.md)
         - [Prevent API Suspension](../manage-apis/design/endpoints/resiliency/prevent-api-suspension.md)
...
3. Subscribe to the API.
    ...
    1. Click **KEY GENERATION WIZARD**.
         ...
         [![Key generation wizard](../assets/img/learn/websocket-api-credential-page.jpg)](../assets/img/learn/websocket-api-credential-page.jpg)

    2. Copy the authorization token that appears.

         [![Authorization token](../assets/img/learn/websocket-api-key-generation-wizard.jpg)](../assets/img/learn/websocket-api-key-generation-wizard.jpg)
