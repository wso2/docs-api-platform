...
description: "Tutorial walking through designing a Pass Through API from a SOAP/WSDL backend, publishing it, and invoking it as a REST API."
...
5.  API definition of the Created schema has been displayed at **API Definition** tab.
    ...
    [OAuthscopes](../manage-apis/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md)
            </p>
        </div></html>   
