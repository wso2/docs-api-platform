...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/advance-configurations/customizing-the-management-console/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/advance-configurations/customizing-the-management-console.md
tags:
  - api-manager
  - management-console
  - ui-customization
