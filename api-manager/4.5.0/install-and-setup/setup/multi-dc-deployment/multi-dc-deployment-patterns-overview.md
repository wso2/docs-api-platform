...
Please note the recommendations mentioned [here](../../../manage-apis/deploy-and-publish/deploy-on-gateway/api-gateway/scaling-the-gateway.md) when scaling the Gateways.
