...
description: "Set up SAML 2.0 single sign-on between WSO2 API Manager and WSO2 Identity Server for the Publisher and Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/sso/configuring-identity-server-as-external-idp-using-saml/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/sso/configuring-identity-server-as-external-idp-using-saml.md
tags:
  - api-manager
  - sso
  - saml
