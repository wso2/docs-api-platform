...
description: "Check the health of WSO2 API Manager components using port connectivity, the Version service, WebSocket endpoints, and the Gateway health-check API."
