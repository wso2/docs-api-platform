...
description: "Configure the API-M hostname in deployment.toml, update keystores and /etc/hosts, and set the internal hostname for internal calls between portals."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/deployment-best-practices/changing-the-hostname/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/deployment-best-practices/changing-the-hostname.md
tags:
  - api-manager
  - deployment
...
2.  Generate a key store, export the public certificate from the keystore, and import that certificate to the `client­-truststore.jks` file.
     ...
     For more information, see [Creating New Keystores](../../../install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores.md).
