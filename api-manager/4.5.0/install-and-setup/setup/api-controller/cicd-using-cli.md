...
description: "Build a CI/CD pipeline with apictl: initialize API projects from OpenAPI specs and export, import, and promote APIs across environments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/api-controller/cicd-using-cli/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/install-and-setup/setup/api-controller/cicd-using-cli.md
tags:
  - api-manager
  - api-controller
  - ci-cd
...
For more information on deploying an API in the WSO2 API-M, see the [Quick Start Guide](../../../get-started/api-manager-quick-start-guide.md).   
...
For this example, let us use the [Swagger Petstore - OpenAPI 3.0](https://petstore3.swagger.io/). 
  ...
  (For more information, see [Create a REST API from an Open API Definition](../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md)).
  ...
  7. [Deploy](../../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md) and [Publish](../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) the API.
...
Follow the instructions below to generate a JWT/OAuth token for testing purposes using apictl in order to invoke an API or an [API Product](../../../manage-apis/design/create-api-product/api-product-overview.md) by subscribing to it using a new application created by apictl.
...
For example, let us consider there is an [API Product](../../../manage-apis/design/create-api-product/api-product-overview.md) **PetsInfo** in the development environment with a subset of operations of **SwaggerPetstore** API.
