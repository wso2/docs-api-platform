...
description: "Answers to frequently asked questions about WSO2 API Manager covering installation, deployment, security, and troubleshooting."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/reference/faq/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/reference/faq.md
tags:
  - api-manager
  - faq
  - troubleshooting
...
WSO2 API Manager is a complete solution for creating, publishing and managing all aspects of an API and its life cycle. For more information, see the [introduction](product-apis/overview.md).
...
To set visibility of the API only to selected user roles in the server, see [API Visibility](../manage-apis/design/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal.md).
...
To configure session timeouts, see [Configuring the session time-out](../install-and-setup/install/installing-the-product/running-the-api-m.md#configuring-the-session-time-out).
...
!!!note
    This config is only available after U2 level 7 onwards.
