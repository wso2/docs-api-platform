...
description: "Directory of the REST APIs exposed by API Manager components, with a Postman collection for creating and invoking a sample API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/reference/product-apis/overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/reference/product-apis/overview.md
tags:
  - api-manager
  - rest-apis
  - product-apis
...
download="WSO2 API Manager 4.5.0 Quick Start.postman_collection.json"
