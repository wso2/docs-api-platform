                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <p>
                                Configuration used to enable or disable proxy configurations. Note that targetProxyHosts configuration is only available from U2 update level 55 onwards.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>The thread pool size of the shared EventLoopGroup used by WebsocketConnectionFactory for managing WebSocket client connections. Note that this configuration only availalbe from U2 update level 6 onwards.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
...
enable_multi_value_claim_handling = false
</code></pre>
                    </div>
                </div>
                <div class="doc-wrapper">
                    <div class="mb-config">
                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>token_exchange.enable</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                    ...
                                    <div class="param-description">
                                        <p>Enable Token Exchange grant.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>token_exchange.grant_handler</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                        ...
                                        <div class="param-default">
                                            <span class="param-default-value">Default: <code>org.wso2.carbon.identity.oauth2.grant.token.exchange.TokenExchangeGrantHandler</code></span>
                                        </div>
                                        
                                    </div>
                                    <div class="param-description">
                                        <p>Token Exchange grant implementation class.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>token_exchange.grant_validator</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                        ...
                                        <div class="param-default">
                                            <span class="param-default-value">Default: <code>org.wso2.carbon.identity.oauth2.grant.token.exchange.TokenExchangeGrantValidator</code></span>
                                        </div>
                                        
                                    </div>
                                    <div class="param-description">
                                        <p>Token Exchange grant validator implementation class.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>token_exchange.allow_refresh_tokens</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                    ...
                                    <div class="param-description">
                                        <p>Enable to allow refresh tokens for token exchange grant.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>token_exchange.iat_validity_period</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                    ...
                                    <div class="param-description">
                                        <p>The validity period for the issued at (iat) claim in token exchange. Accepts time formats like &#39;1h&#39;, &#39;30m&#39;, &#39;3600s&#39;.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>token_exchange.enable_multi_value_claim_handling</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                    ...
                                    <div class="param-description">
                                        <p>Enable multi-value claim handling for token exchange grant.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
organization_id_local_claim = "http://wso2.org/claims/organizationId"</code></pre>
                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            <code>[apim.organization_based_access_control]</code>
                            
                            <p>
                                Organization visibility related configurations.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>organization_name_local_claim</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                                    ...
                                    <div class="param-description">
                                        <p>Local claim URI used to identify user organization.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>organization_id_local_claim</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>This configuration should be used only if it is required to change the SameSite attribute of all the cookies to the configured value. Note that this configuration is available in wso2am-4.5.0 starting from update level 46 and wso2am-acp-4.5.0 starting from update level 47.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
