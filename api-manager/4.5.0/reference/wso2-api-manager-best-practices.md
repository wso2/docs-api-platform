...
description: "Guidelines for designing and deploying APIs with API Manager, covering resource naming and major, minor, and patch versioning."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/reference/wso2-api-manager-best-practices/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/reference/wso2-api-manager-best-practices.md
tags:
  - api-manager
  - api-design
  - versioning
...
-   [Create APIs](../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md) for dedicated backend services.
