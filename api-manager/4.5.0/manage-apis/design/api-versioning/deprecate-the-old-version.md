...
!!! note
    For more details on the API lifecycle stages, see [API lifecycle](../../../manage-apis/design/lifecycle-management/api-lifecycle.md).
...
2.  Click on the API that you created in the [previous tutorial](../../../manage-apis/design/api-versioning/create-a-new-api-version.md) (e.g., `PizzaShackAPI 2.0.0`).
