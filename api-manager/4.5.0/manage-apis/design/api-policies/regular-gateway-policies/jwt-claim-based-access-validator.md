...
description: "Configure the JWT Claim Based Access Validator policy to restrict access to an API resource based on a custom claim name and value in the JWT access token."
