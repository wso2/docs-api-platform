...
description: "Create common and API-specific policies in the WSO2 API Publisher, including uploading the Synapse policy template and defining attributes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-policies/create-policy/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-policies/create-policy.md
tags:
  - api-manager
  - api-policies
  - mediation
