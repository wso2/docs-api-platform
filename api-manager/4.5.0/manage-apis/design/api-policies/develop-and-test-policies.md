...
description: "Develop custom API Manager policies locally using the Micro Integrator VS Code extension, test them, and upload them to API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-policies/develop-and-test-policies/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-policies/develop-and-test-policies.md
tags:
  - api-manager
  - api-policies
  - developer-tools
...
- Familiarity with [policy creation concepts](../../../manage-apis/design/api-policies/create-policy.md)
...
2. Review the [list of unsupported mediators](../../../manage-apis/design/api-policies/create-policy.md) to ensure your policy doesn't use restricted mediators:
...
- [Create a policy](../../../manage-apis/design/api-policies/create-policy.md)
- [Attach a policy](../../../manage-apis/design/api-policies/attach-policy.md)
- [API policies overview](../../../manage-apis/design/api-policies/overview.md)