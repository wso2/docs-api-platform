...
!!! note
    You need to enable CORS globally before you enable CORS Per API. Therefore, if you have not enabled CORS globally, follow the instructions in [Enabling CORS Globally](../../../manage-apis/design/advanced-topics/enabling-cors-for-apis.md#enabling-cors-globally) before carrying out the following instructions.
...
1.  Sign in to API Publisher and [create a new API](../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md).
