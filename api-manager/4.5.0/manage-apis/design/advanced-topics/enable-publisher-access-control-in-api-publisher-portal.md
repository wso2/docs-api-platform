...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/advanced-topics/enable-publisher-access-control-in-api-publisher-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/advanced-topics/enable-publisher-access-control-in-api-publisher-portal.md
tags:
  - api-manager
  - access-control
  - api-publisher
...
- [Using the API Publisher](../../../manage-apis/design/advanced-topics/enable-publisher-access-control-in-api-publisher-portal.md#using-the-api-publisher)
- [Using the REST API](../../../manage-apis/design/advanced-topics/enable-publisher-access-control-in-api-publisher-portal.md#using-the-rest-api)
...
2.  [Create a new API](../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md). 
