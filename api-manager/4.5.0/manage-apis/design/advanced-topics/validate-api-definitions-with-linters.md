...
When you are following the [API creation steps](../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md), the linter results will be shown as below.
