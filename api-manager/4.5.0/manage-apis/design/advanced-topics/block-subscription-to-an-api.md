...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/advanced-topics/block-subscription-to-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/advanced-topics/block-subscription-to-an-api.md
tags:
  - api-manager
  - subscriptions
  - access-control
...
!!! info
    API level subscription blocking is useful to control only the subscriptions created for a specific API by a user. If you want to block all API requests from a specific application/user/specific IP address or to a specific API, you can use [request denylisting](../../../manage-apis/design/rate-limiting/access-control.md#denying-requests).
...
1.  Create two APIs.
     ...
     2.  Create two APIs and publish them to WSO2 API Developer Portal.
         ...
         <p>For more information, see [Create and Publish an API](../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md).</p>
         </div>
         </html>
