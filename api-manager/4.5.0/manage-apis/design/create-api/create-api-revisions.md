...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-api-revisions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-api-revisions.md
tags:
  - api-manager
  - api-lifecycle
  - deployment
...
[Publishing](../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) displays the 
API in the Developer Portal, and [deployment](../../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md) 
