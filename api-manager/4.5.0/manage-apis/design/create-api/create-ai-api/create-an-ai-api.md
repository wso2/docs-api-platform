...
This guide will get you started with AI API creation using WSO2 API Manager. Thus created AI API wil be deployed into the AI Gateway. Refer to [AI Gateway](../../../../ai-gateway/overview.md) to get a deeper understanding on API Manager's AI Gateway capabilities.
