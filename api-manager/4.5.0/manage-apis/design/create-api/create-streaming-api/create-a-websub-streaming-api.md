...
description: "Create a WebSub/WebHook streaming API from scratch, configure its topics, and generate a signing secret for a WebHook provider."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-streaming-api/create-a-websub-streaming-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-streaming-api/create-a-websub-streaming-api.md
tags:
  - api-manager
  - streaming-api
  - websub
...
You can create a WebSub API from scratch in WSO2 API-M and export the WebSub APIs that are created within WSO2 API-M as AsyncAPI definitions. Alternatively, you can also import [existing AsyncAPI definitions to create SSE APIs in WSO2 API-M](../create-a-streaming-api-from-an-asyncapi-definition).
