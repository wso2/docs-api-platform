---
title: "Create a WebSocket Streaming API"
description: "Create a WebSocket streaming API from scratch in WSO2 API Manager, configure its topics and endpoints, and view its generated AsyncAPI definition."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-streaming-api/create-a-websocket-streaming-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-streaming-api/create-a-websocket-streaming-api.md
tags:
  - api-manager
  - streaming-apis
  - websocket
...
You can create a WebSocket API from scratch in WSO2 API-M and export the WebSocket APIs that are created within WSO2 API-M as AsyncAPI definitions. Alternatively, you can also import [existing AsyncAPI definitions to create SSE APIs in WSO2 API-M](../create-a-streaming-api-from-an-asyncapi-definition).
...
Now, you have successfully created and configured a Streaming API. Next, let's [Publish your API](../../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md).
...
--8<-- "api-manager/4.5.0/includes/design/stream-more-links.md"