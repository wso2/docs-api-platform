...
description: "Create a REST or Streaming API by discovering an integration or streaming integration service from the Service Catalog and generating an API from it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-an-api-using-a-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-an-api-using-a-service.md
tags:
  - api-manager
  - service-catalog
  - api-creation
...
After you complete configuring the API, [Publish the API](../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md).
...
Learn more on the concepts that you need to know when creating an API:
 ...
 -   Rate Limiting:
     -   [Rate Limiting for REST APIs](../../../manage-apis/design/rate-limiting/introducing-throttling-use-cases.md)
     -   [Rate Limiting for Streaming APIs](../../../manage-apis/design/rate-limiting/rate-limiting-for-streaming-apis.md)
