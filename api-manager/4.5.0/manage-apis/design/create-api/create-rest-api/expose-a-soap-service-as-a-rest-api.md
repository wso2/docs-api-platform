...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-rest-api/expose-a-soap-service-as-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-rest-api/expose-a-soap-service-as-a-rest-api.md
tags:
  - api-manager
  - soap
  - create-api
...
5. Click **API Definition** to view the API definition of the created schema.
    ...
    [![API definition of SOAP API created by Pass-through mode](../../../../assets/img/learn/api-definition-of-soap-api-created-by-passthrough-mode.jpg)](../../../../assets/img/learn/api-definition-of-soap-api-created-by-passthrough-mode.jpg)
     ...
     see [Enforce Throttling and Resource Access Policies](../../../../manage-apis/design/rate-limiting/setting-throttling-limits.md).</p>
     </div>
     </html>

Now, the SOAP service is created and configured successfully as a RESTful API. 

For more information on API publishing, see [Publish API](../../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md).
