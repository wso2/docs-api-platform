...
description: "Use the Publisher's integrated API Console to try out a REST API's resources, generate an internal test key, and invoke operations from the Swagger UI."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-rest-api/test-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-rest-api/test-a-rest-api.md
tags:
  - api-manager
  - api-testing
  - publisher-portal
...
!!! note
    Create the `PizzaShack` REST API or an API of your choice before following the instructions below. For more information, see [Create a REST API.](../../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md).
