...
description: "Import an OpenAPI or Swagger definition into API Manager to create a REST API, using the Publisher Portal's Import OpenAPI flow with the Petstore sample."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md
tags:
  - api-manager
  - openapi
  - rest-api
...
Next, [deploy the API](../../../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md), [test the API](../../../../manage-apis/design/create-api/create-rest-api/test-a-rest-api.md), and finally [publish the API](../../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md).
