...
Now, you have successfully created and configured a REST API. Next, [deploy the API](../../../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md), [test the API](../../../../manage-apis/design/create-api/create-rest-api/test-a-rest-api.md), and finally [publish the API](../../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md).
...
-   [Rate Limiting](../../../../manage-apis/design/rate-limiting/introducing-throttling-use-cases.md)
