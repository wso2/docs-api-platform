...
description: "Create a Prototype API using an auto-generated mock JavaScript implementation based on an OpenAPI definition, customize the inline script, and invoke it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/prototype-api/create-mocked-js-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/prototype-api/create-mocked-js-api.md
tags:
  - api-manager
  - prototype-api
  - mock-implementation
...
--8<-- "api-manager/4.5.0/includes/design/invoke-prerelease-api.md"
...
3. If you have enabled security, you can either use the access token that you got from the above step or use the **GET TEST KEY** option.
    ...
    !!! note
        Skip this step if you have [disabled security for the API](../../../manage-apis/design/api-security/api-authentication/disable-security.md), and leave the **Access Token** field empty.
