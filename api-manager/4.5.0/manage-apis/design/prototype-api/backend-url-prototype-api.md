...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/prototype-api/backend-url-prototype-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/prototype-api/backend-url-prototype-api.md
tags:
  - api-manager
  - prototype-api
  - endpoints
...
- [Create any type of interface for the Prototype API](../../../manage-apis/design/design-api-overview.md#create-an-api). 
...
2. Enter the Endpoint details.
    ...
    !!! note
        For more information, see [Endpoint Types](../../../manage-apis/design/endpoints/endpoint-types.md) and the other sections related to the **Endpoints** documentation.
