...
description: "Reference of the backend endpoint types supported by API Manager, including HTTP/REST, HTTP/SOAP, failover group, load balance, and mock endpoints."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/endpoints/endpoint-types/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/endpoints/endpoint-types.md
tags:
  - api-manager
  - endpoints
  - backend-integration
