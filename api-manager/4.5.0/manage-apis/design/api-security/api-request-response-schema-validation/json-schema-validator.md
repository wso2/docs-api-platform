...
description: "Enable the JSON Schema Validator to validate request and response payloads against the API's swagger.json schema, blocking invalid ones with 400 or 500."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/api-request-response-schema-validation/json-schema-validator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/api-request-response-schema-validation/json-schema-validator.md
tags:
  - api-manager
  - api-security
  - schema-validation
