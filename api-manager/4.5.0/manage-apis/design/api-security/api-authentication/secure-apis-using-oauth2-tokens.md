...
For more information, see [OAuth2 Grant Types](../../../../manage-apis/design/api-security/oauth2/grant-types/overview.md).

## OAuth 2.0 access token types

WSO2 APIM only allows creating applications of JWT token type. See [JWT Access Tokens](../../../../manage-apis/design/api-security/oauth2/access-token-types/jwt-tokens.md).
...
2.  When [creating](../../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md) or updating an API, define the customized authorization header in the **Runtime** tab under **Develop -> API Configurations**.
