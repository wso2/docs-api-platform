---
title: "Fine-Grained Access Control with OAuth2 Scopes"
description: "Restrict access to API resources by role using shared and local OAuth2 scopes: create scopes, attach them to resources, and obtain scoped access tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md
tags:
  - api-manager
  - oauth2
  - access-control
...
2. Start creating an API as described [here](../../../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md).
...
Both [Shared Scopes](../../../../../manage-apis/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md#shared-scopes) 
and [Local Scopes](../../../../../manage-apis/design/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md#local-scopes) should be defined in same way in the OpenAPI definition as follows.
