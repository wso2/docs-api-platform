...
description: "Revoke OAuth2 access and refresh tokens using the Revoke API, and configure immediate revocation for third-party key managers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/oauth2/token-revocation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/oauth2/token-revocation.md
tags:
  - api-manager
  - oauth2
  - key-managers
...
!!! note
    You can also revoke refresh tokens. For more information, see [Revoking a refresh token](../../../../manage-apis/design/api-security/oauth2/grant-types/refresh-token-grant.md#revoking-a-refresh-token).
...
!!! info
    For more information on configuring third party key managers, see [Multiple Key Manager Support in WSO2 API Manager](../../../../administer/key-managers/overview.md#multiple-key-manager-support-in-wso2-api-manager).
