...
description: "Configure and use the JWT Bearer grant: register an external identity provider and service provider, then exchange a JWT assertion for an OAuth2 access token."
