---
title: "Securing OAuth Tokens with HMAC Validation"
description: "Prevent misuse of expired or random OAuth tokens by enhancing them with HMAC and an expiry timestamp using an Identity Server extension."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/oauth2/securing-oauth-token-with-hmac-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/api-security/oauth2/securing-oauth-token-with-hmac-validation.md
tags:
  - api-manager
  - oauth2
  - token-security
