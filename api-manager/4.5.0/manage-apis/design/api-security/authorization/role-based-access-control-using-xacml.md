...
14. Log in to the API Publisher and [create an API](../../../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md). In this sample default PizzaShack API is used.
15. [Create a new API policy](../../../../manage-apis/design/api-policies/create-policy.md) and upload the `EntitlementMediator.j2` created previously. Set **Request** under the **Applicable flows** 
16. Attach the new policy to all the resources as mentioned in [attach policy](../../../../manage-apis/design/api-policies/attach-policy.md)
