---
title: "Set Maximum Backend Throughput Limits"
description: "Configure maximum backend throughput limits to protect backend servers from overuse, including token-based backend rate limiting for AI APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/rate-limiting/setting-maximum-backend-throughput-limits/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/design/rate-limiting/setting-maximum-backend-throughput-limits.md
tags:
  - api-manager
  - rate-limiting
  - ai-apis
...
2.  Click on the API for which you want to set the maximum backend throughput.
    ...
    [![Select API](../../../assets/img/learn/select-api-with-business-info.png){: style="width:30%"}](../../../assets/img/learn/select-api-with-business-info.png)
