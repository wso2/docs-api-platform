...
For more information on how to define advanced throttling policies, see [Adding a new advanced rate limiting policy](../../../manage-apis/design/rate-limiting/adding-new-throttling-policies.md#adding-a-new-advanced-rate-limiting-policy).
