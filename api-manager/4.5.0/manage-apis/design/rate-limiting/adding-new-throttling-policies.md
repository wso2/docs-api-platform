...
4.  Fill in the details required by this form and click **Save** once you are done.
    ...
    !!! note
     ...
     | GraphQL                         | Provide the [maximum complexity](../../../manage-apis/design/rate-limiting/graphql-api/query-complexity-limitation.md) and [maximum depth values](../../../manage-apis/design/rate-limiting/graphql-api/query-depth-limitation.md) for GraphQL APIs using this policy.|
