...
description: "Overview of the Static Query Analyzer, which enforces GraphQL Max Depth and Max Complexity limits to protect backends from malicious queries."
...
The Static Query Analyzer detects complex queries based on a predefined policy and prevents them from reaching the backend. A basic outline of such a policy is shown below.
   ...
   - [Query Depth Limitation](../../../../manage-apis/design/rate-limiting/graphql-api/query-depth-limitation.md)
    
   - [Query Complexity Limitation](../../../../manage-apis/design/rate-limiting/graphql-api/query-complexity-limitation.md)
