...
description: "Configure AWS API Gateway as a federated gateway in WSO2 API Manager, then deploy, publish, and invoke the API through it."
...
2. Register a third party KM following instructions in WSO2 documentation. In this guide we will setup Auth0 as the KM following the guide [Configure Auth0 as a Key Manager](../../../../administer/key-managers/configure-auth0-connector.md).
