...
3. Update the policy name and description, then simply drag and drop the desired policies onto the respective flows to attach them.
    ...
    4. Finally, click **Save** to complete the process.
        ...
        !!!note
            All the policies listed for addition as global policies are [common policies](../../../../manage-apis/design/api-policies/create-policy.md).
...
[Attaching API Policies](../../../../manage-apis/design/api-policies/attach-policy.md)