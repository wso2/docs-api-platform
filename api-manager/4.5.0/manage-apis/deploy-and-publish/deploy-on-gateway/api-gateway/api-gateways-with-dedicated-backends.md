...
description: "Configure each API Gateway environment to proxy to its own dedicated backend using parameterized endpoint URLs resolved at Gateway startup."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/deploy-and-publish/deploy-on-gateway/api-gateway/api-gateways-with-dedicated-backends/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/manage-apis/deploy-and-publish/deploy-on-gateway/api-gateway/api-gateways-with-dedicated-backends.md
tags:
  - api-manager
  - api-gateway
  - deployment
...
3.  Save and [publish](../../../../manage-apis/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) the API.
