...
description: "Overview of primary user store types supported by API Manager: JDBC, read-only LDAP, read-write LDAP, and Active Directory."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/managing-users-and-roles/managing-user-stores/configure-primary-user-store/configuring-the-primary-user-store/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/managing-users-and-roles/managing-user-stores/configure-primary-user-store/configuring-the-primary-user-store.md
tags:
  - api-manager
  - user-management
  - user-stores
