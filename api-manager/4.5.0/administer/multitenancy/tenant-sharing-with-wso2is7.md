...
!!! Note
    **Tenant Sharing between WSO2 API Manager and WSO2 Identity Server 7.x** feature is supported from WSO2 Identity Server 7.1.0.43 update level  and WSO2 API Manager 4.5.0.46 update level onwards.
...
Please refer [this](../../administer/key-managers/configure-wso2is7-connector.md) guide to configure WSO2 IS 7.x as a Key Manager in API Manager.