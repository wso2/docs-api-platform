---
title: "Update WSO2 API Manager"
description: "Use the WSO2 Updates 2.0 tool to fetch the latest bug fixes and security fixes for WSO2 API Manager, and back up index and H2 database data before updating."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/updating-wso2-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/updating-wso2-api-manager.md
tags:
  - api-manager
  - updates
  - administration
...
!!! warning
    ...
    **Persisting WSO2CarbonDB**
    ...
    For more information on run time and configuration artifact directories of API Manager refer [Common Runtime and Configuration Artifacts](../administer/../install-and-setup/setup/reference/common-runtime-and-configuration-artifacts.md) .