...
[![Out-of-Band Configuration](../../assets/img/administer/oob-km-advanced-config.png)](../../assets/img/administer/oob-km-advanced-config.png)
...
3. Click **Provide Existing OAuth Keys**.
    ...
    [![Provide Existing OAuth Keys](../../assets/img/administer/oob-provide-existing-keys.png)](../../assets/img/administer/oob-provide-existing-keys.png)
