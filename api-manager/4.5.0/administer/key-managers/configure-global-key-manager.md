...
description: "Enable global key manager support in WSO2 API Manager so a token from the super tenant's key manager can invoke APIs across tenants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/key-managers/configure-global-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/key-managers/configure-global-key-manager.md
tags:
  - api-manager
  - key-managers
  - multitenancy
...
6. Add the Global Key Manager configurations. Refer to the [configurations](../../administer/key-managers/overview.md#configuring-key-managers-with-wso2-api-m) of the key manager that needs to be added as the global key manager
...
6. [Create an API](../../manage-apis/design/create-api/create-rest-api/create-a-rest-api.md) (Eg: SampleAPI)
...
8. [Deploy the API](../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md)
