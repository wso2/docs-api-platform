...
description: "Deploy and configure the Carbon Health Check API in WSO2 API Manager to monitor data source connections, user store status, and custom health checkers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/logging-and-monitoring/monitoring/monitoring-server-health/
md_url: https://wso2.com/api-platform/docs/api-manager/4.5.0/administer/logging-and-monitoring/monitoring/monitoring-server-health.md
tags:
  - api-manager
  - monitoring
  - health-check
...
7. Copy the `health-check-config.xml` configuration file found in the `<HEALTH_CHECK_HOME>/features/org.wso2.carbon.healthcheck.server.feature/resources` directory to your `<PRODUCT_HOME>/repository/conf/` directory.
