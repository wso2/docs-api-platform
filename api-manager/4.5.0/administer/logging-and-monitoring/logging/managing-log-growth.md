...
description: "Configure log4j2 rollover policies for Carbon and audit logs in WSO2 API Manager, covering time-based and size-based rollover and backup file limits."
...
Log growth in [Carbon Logs](../../../administer/logging-and-monitoring/logging/../../../monitoring/observability/logs/configuring-logging.md#configuring-carbon-logs) can be managed by following configurations in `<API-M_HOME>/repository/conf/log4j2.properties` file.
