...
[![Basic Architecture](../assets/img/get_started/architecture/apim-architecture-final.png)](../assets/img/get_started/architecture/apim-architecture-final.png)
...
- For information on the architecture, see [API Analytics Architecture](../monitoring/api-analytics/choreo-analytics/api-analytics-architecture.md)

- For information on working with Analytics, see the [API Analytics Getting Started Guide](../monitoring/api-analytics/choreo-analytics/getting-started-guide.md).
...
For more information, see [Working with Throttling](../manage-apis/design/rate-limiting/introducing-throttling-use-cases.md).
