...
??? note "API Governance"
    ...
    **[Learn more](../governance/overview.md)**
...
??? note "Gateway Federation And Multi-Gateway Management"
    ...
    **[Learn more](../manage-apis/deploy-and-publish/deploy-on-gateway/federated-gateways/deploy-on-aws-api-gateway.md)**
...
??? note "Multi-Model Routing Support for AI APIs"
    ...
    **[Learn more](../ai-gateway/multi-model-routing/overview.md)**
...
??? note "Generative AI Powered Design Assistant"
    ...
    **[Learn more](../manage-apis/design/create-api/create-api-with-ai.md)**
...
??? note "B2B API Management with Organization Support"
    ...
    **[Learn more](../manage-apis/design/b2b-api-management/api-consumption.md)**
...
??? note "Simplified GraphQL API Creation with Schema Introspection & URL Import"
    ...
    **[Learn more](../manage-apis/design/create-api/create-graphql-api/create-a-graphql-api-using-introspection.md)**
...
??? note "Granular Access Control for Gateway Environments"
    ...
    **[Learn more](../administer/multiple-gateways/configure-gateway-visibility.md)**
...
??? note "Enhanced WebSocket Logging for Improved Monitoring & Troubleshooting"
    ...
    **[Learn more](../monitoring/observability/logs/monitoring-websocket-logs.md)**
...
??? note "Enhanced Audit Logging for API Document Management"
    ...
    **[Learn more](../monitoring/observability/logs/monitoring-audit-logs.md)**
...
??? note "Improved Proxy Support for OAuth Endpoints"
    ...
    **[Learn more](../manage-apis/design/endpoints/endpoint-security/oauth-2.0.md#securing-an-endpoint-with-oauth-20-in-wso2-api-manager)**
...
--8<-- "api-manager/4.5.0/includes/compatibility-matrix.md"
