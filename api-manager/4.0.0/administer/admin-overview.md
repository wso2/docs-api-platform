...
description: "Links to WSO2 API Manager administration tasks: managing users and roles, secondary user stores, multitenancy, key managers, and advanced configuration."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/administer/admin-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/administer/admin-overview.md
tags:
  - api-manager
  - administer
  - admin-overview
...
- [Key Managers](key-managers/overview.md)