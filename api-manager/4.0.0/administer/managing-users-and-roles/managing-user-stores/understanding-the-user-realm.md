...
description: "Explains the user realm concept in WSO2 API Manager and the repositories and configuration files that make up the User Management module."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/administer/managing-users-and-roles/managing-user-stores/understanding-the-user-realm/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/administer/managing-users-and-roles/managing-user-stores/understanding-the-user-realm.md
tags:
  - api-manager
  - administer
