...
[![Enable Appplication Scopes for Global Key Manager](../../assets/img/administer/enable-application-scopes.png)](../../assets/img/administer/enable-application-scopes.png)
...
[![Add Appplication Scopes for Global Key Manager](../../assets/img/administer/add-application-scopes.png)](../../assets/img/administer/add-application-scopes.png)
...
!!! tip
    In order to govern, adding any scope as a application scope, application key generation workflow can be used. For more information, see [Configuring Key Generation Workflow](../../consume/manage-application/advanced-topics/adding-an-application-key-generation-workflow.md).