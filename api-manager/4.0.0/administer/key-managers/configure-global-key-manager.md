...
description: "Enable and configure a Global Key Manager so a single token can invoke cross-tenant APIs without a tenant-specific key manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/administer/key-managers/configure-global-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/administer/key-managers/configure-global-key-manager.md
tags:
  - api-manager
  - administer
  - key-managers
  - configure-global-key-manager
...
6. Add the Global Key Manager configurations. Refer to the [configurations](overview.md#configuring-key-managers-with-wso2-api-m) of the key manager that needs to be added as the global key manager
...
5. [Create an API](../../design/create-api/create-rest-api/create-a-rest-api.md) (Eg: SampleAPI)
...
7. [Deploy the API](../../deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md)

8. [Create a tenant](../multitenancy/managing-tenants.md) (Ex: abc.com)
...
11. [Create an application](../../consume/manage-application/create-application.md) (Ex: SampleApp)
...
15. Go to the Developer Portal landing page, select the SampleAPI and [Subscribe](../../consume/manage-subscription/subscribe-to-an-api.md#subscribe-to-an-existing-application) to the SampleApp
...
16. [Try Out the API](../../consume/invoke-apis/invoke-apis-using-tools/invoke-an-api-using-the-integrated-api-console.md) with the access token generated using the Global Key Manager
