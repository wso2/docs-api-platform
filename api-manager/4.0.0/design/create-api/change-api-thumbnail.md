...
description: "Change an API's thumbnail image in the Publisher by uploading a new image or designing one with the built-in thumbnail generator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/create-api/change-api-thumbnail/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/create-api/change-api-thumbnail.md
tags:
  - api-manager
  - design
  - create-api
  - change-api-thumbnail
