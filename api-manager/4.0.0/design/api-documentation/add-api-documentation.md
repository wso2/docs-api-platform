...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-documentation/add-api-documentation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-documentation/add-api-documentation.md
tags:
  - api-manager
  - design
  - api-documentation
...
2.  Click on the API (e.g., `PizzaShackAPI 1.0.0` ) for which you want to add the documentation.
    ...
    [![Select API in API Publisher](../../assets/img/learn/select-api.png){: style="width:30%"}](../../assets/img/learn/select-api.png)
...
4.  Sign in to the WSO2 Developer Portal and click on the `PizzaShackAPI` version 1.0.0 API.
     ...
     [![API in Developer Portal](../../assets/img/learn/view-docs-devportal.png){: style="width:70%"}](../../assets/img/learn/view-docs-devportal.png)
