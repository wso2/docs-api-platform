...
description: "Retrieve end-user profile information in WSO2 API Manager by requesting the openid scope, then decoding the id_token JWT or calling userinfo."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-security/openid-connect/obtaining-user-profile-information-with-openid-connect/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-security/openid-connect/obtaining-user-profile-information-with-openid-connect.md
tags:
  - api-manager
  - design
  - api-security
...
1.  Obtain a token using password grant type and `openid` scope. For more information on token generation with password grant type, see [Password Grant Type](../oauth2/grant-types/password-grant.md). The format of the curl command and a sample is given below :
