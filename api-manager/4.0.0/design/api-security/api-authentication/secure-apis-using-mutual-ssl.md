...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-security/api-authentication/secure-apis-using-mutual-ssl/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-security/api-authentication/secure-apis-using-mutual-ssl.md
tags:
  - api-manager
  - design
  - api-security
...
!!! note
     Please note that `enable_certificate_chain_validation` configuration is only available after API-M 4.0.0 U2 update level 271.
