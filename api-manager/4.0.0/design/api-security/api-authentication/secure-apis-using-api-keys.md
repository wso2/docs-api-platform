...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-security/api-authentication/secure-apis-using-api-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/api-security/api-authentication/secure-apis-using-api-keys.md
tags:
  - api-manager
  - design
  - api-security
...
--8<-- "api-manager/4.0.0/includes/design/create-publish-api.md"

### Step 2 - Generate the API Key

--8<-- "api-manager/4.0.0/includes/design/generate-api-key.md"
