...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/advanced-topics/adding-an-api-state-change-workflow-using-bps/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/advanced-topics/adding-an-api-state-change-workflow-using-bps.md
tags:
  - api-manager
  - design
  - advanced-topics
...
4.  Sign in to the API Publisher (`https://<Server Host>:9443/publisher`) and publish an API. 
     ...
     For more information, see [Create a REST API](../create-api/create-rest-api/create-a-rest-api.md) and [Publish an API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api.md). 
