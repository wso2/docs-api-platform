...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/advanced-topics/enabling-cors-for-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/advanced-topics/enabling-cors-for-apis.md
tags:
  - api-manager
  - design
  - advanced-topics
...
1.  Sign in to API Publisher and [create a new API](../create-api/create-rest-api/create-a-rest-api.md).
