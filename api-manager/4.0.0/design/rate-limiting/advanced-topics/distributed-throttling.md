...
!!! note
    If you are using custom rate limiting policies in this setup, please refer [Custom Rate Limiting with Distributed Throttling](custom-throttling.md#custom-rate-limiting-with-distributed-throttling).