...
description: "Learn how count-based and time-based rate limiting policies apply to WebSocket, WebHook, WebSub, and SSE streaming APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/rate-limiting/rate-limiting-for-streaming-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/rate-limiting/rate-limiting-for-streaming-apis.md
tags:
  - api-manager
  - design
  - rate-limiting
