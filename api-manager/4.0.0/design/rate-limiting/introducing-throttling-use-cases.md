...
description: "Learn common rate limiting use cases, such as protecting APIs from attacks, regulating traffic, and enabling monetization tiers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/rate-limiting/introducing-throttling-use-cases/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/rate-limiting/introducing-throttling-use-cases.md
tags:
  - api-manager
  - design
  - rate-limiting
