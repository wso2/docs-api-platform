...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/rate-limiting/graphql-api/query-complexity-limitation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/rate-limiting/graphql-api/query-complexity-limitation.md
tags:
  - api-manager
  - design
  - rate-limiting
...
To design a GraphQL API, see [Create a GraphQL API](../../create-api/create-a-graphql-api.md).
