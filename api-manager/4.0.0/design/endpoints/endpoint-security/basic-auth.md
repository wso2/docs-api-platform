...
description: "Secure an API endpoint with Basic Authentication by configuring a username and password sent in the authorization header."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/endpoints/endpoint-security/basic-auth/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/endpoints/endpoint-security/basic-auth.md
tags:
  - api-manager
  - design
  - endpoints
