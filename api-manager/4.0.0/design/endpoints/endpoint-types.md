...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/endpoints/endpoint-types/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/design/endpoints/endpoint-types.md
tags:
  - api-manager
  - design
  - endpoints
...
| Prototype Endpoint      | Prototype endpoint is a type of HTTP Endpoint which can be used when Prototyping an API (for promoting and testing). For instructions, see [Deploy and Test Mock APIs](../prototype-api/deploy-and-test-mock-apis.md). |
| Prototype Implementation      | **Prototype implementation** in WSO2 API Manager uses the built-in JavaScript engine of Synapse to mock the responses and can be used per HTTP resource of the API. For more information on Prototype Implementation, see [Create a Mock API with an Inline Script](../prototype-api/create-a-mock-api-with-an-inline-script.md) for more information. |
