...
-	All the ESB runtimes of WSO2 can use the same developer tool ([WSO2 Integration Studio]({BASE_URL}/api-manager/4.0.0/integrate/develop/wso2-integration-studio/)) for developing integrations. 
...
-	Ports are different in the Micro Integrator of API-M 4.0.0. Find out about [ports in the Micro Integrator]({BASE_URL}/api-manager/4.0.0/install-and-setup/setup/reference/default-product-ports/#micro-integrator-ports).
-	The Micro Integrator of API-M 4.0.0 contains changes that impact your migration process. Be sure to read the [Comparison: ESB vs the Micro Integrator]({BASE_URL}/api-manager/4.0.0/get-started/about-this-release/#compare-this-release-with-previous-esbs) before you start the migration.
