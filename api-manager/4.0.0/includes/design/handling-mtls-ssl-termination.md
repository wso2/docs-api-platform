...
[![MTLS Load Balancer]({BASE_URL}/api-manager/4.0.0/assets/img/learn/mtls-loadbalancer.png)]({BASE_URL}/api-manager/4.0.0/assets/img/learn/mtls-loadbalancer.png)
