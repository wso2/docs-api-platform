...
1.  [Create an API]({BASE_URL}/api-manager/4.0.0/design/create-api/create-rest-api/create-a-rest-api/).
2.  Click **Develop -> API Configurations -> Runtime**.
3.  Select **Mutual SSL**.

    [![Enable mutual SSL]({BASE_URL}/api-manager/4.0.0/assets/img/learn/enable-mutual-ssl.png)]({BASE_URL}/api-manager/4.0.0/assets/img/learn/enable-mutual-ssl.png)
...
5.  Provide an alias and public certificate. Select the tier that should be used to throttle out the calls using this particular client certificate and click **Upload**.
    ...
    [![Upload Certificate]({BASE_URL}/api-manager/4.0.0/assets/img/learn/upload-certificate.png)]({BASE_URL}/api-manager/4.0.0/assets/img/learn/upload-certificate.png)
