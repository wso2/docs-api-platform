...
2. Navigate to the **Deploy** section and click **Deployments**.
      ...
      [![New revision]({BASE_URL}/api-manager/4.0.0/assets/img/design/revision/deploy-first-revision.png){: style="width:80%"}]({BASE_URL}/api-manager/4.0.0/assets/img/design/revision/deploy-first-revision.png)

      The Deployments page appears as follows when you have at least one revision.

      [![Deploy new revision option]({BASE_URL}/api-manager/4.0.0/assets/img/design/revision/deploy-new-revision.png)]({BASE_URL}/api-manager/4.0.0/assets/img/design/revision/deploy-new-revision.png)
...
!!! warning
    You cannot deploy more than 5 revisions. If you want to deploy a new revision after the maximum allowed number of revisions are reached, you need to delete one of the existing revisions.
     ...
     [![Delete revision if max count is reached]({BASE_URL}/api-manager/4.0.0/assets/img/design/revision/delete-and-deploy-revision.png){: style="width:60%"}]({BASE_URL}/api-manager/4.0.0/assets/img/design/revision/delete-and-deploy-revision.png)