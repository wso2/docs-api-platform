...
4. Select **API Key** and click **Save and Deploy**.
     ...
     [![Configure API key authentication]({BASE_URL}/api-manager/4.0.0/assets/img/learn/api-key-option.png)]({BASE_URL}/api-manager/4.0.0/assets/img/learn/api-key-option.png)
