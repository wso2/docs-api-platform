...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/api-analytics/moesif-analytics/moesif-integration-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/api-analytics/moesif-analytics/moesif-integration-guide.md
tags:
  - api-manager
  - api-analytics
  - moesif-analytics
...
!!! Note
    Moesif Analytics integration is supported starting from WSO2 API Manager 4.0.0 Update Level 377 and onwards. Ensure that you are using a compatible update level of WSO2 API Manager 4.0.0.
