---
title: "ELK based analytics installation guide"
description: "Configure WSO2 API Manager to publish analytics data to an on-premises ELK stack of Filebeat, Logstash, Elasticsearch, and Kibana."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/api-analytics/on-prem/elk-installation-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/api-analytics/on-prem/elk-installation-guide.md
tags:
  - api-manager
  - api-analytics
  - on-prem
...
!!! attention "Update Level 90"
    This feature is available only as an update, after Update level 90 and further.  For more information, see [Updating WSO2 API Manager](../../administer/updating-wso2-api-manager.md).
...
5. Download the artifact file [here](../../assets/img/analytics/cloud/export.ndjson).
