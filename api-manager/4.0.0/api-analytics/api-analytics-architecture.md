...
description: "Understand the architecture of the API Analytics cloud solution, including how Gateways publish statistics to the Analytics Cloud."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/api-analytics/api-analytics-architecture/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/api-analytics/api-analytics-architecture.md
tags:
  - api-manager
  - api-analytics
