...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/using-remote-micro-integrator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/using-remote-micro-integrator.md
tags:
  - api-manager
  - integrate
  - develop
...
1.	[Download and install](../../install-and-setup/install/installing-the-product/installing-mi.md) the Micro Integrator server and on your computer. 
...
4.  Review the default port details for your server and click <b>Next</b>.
    ...
    !!! Note
        ...
        -   If you are already running another server on these ports, give unused ports. See [Default ports](../../install-and-setup/setup/deployment-best-practices/changing-the-default-ports-with-offset.md) of the Micro Integrator for more information.
