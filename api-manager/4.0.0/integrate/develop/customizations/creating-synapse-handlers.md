---
title: "Synapse handlers"
description: "Explains what a synapse handler is and how to write one to process requests in specific message flows."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/customizations/creating-synapse-handlers/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/customizations/creating-synapse-handlers.md
tags:
  - api-manager
  - integrate
  - develop
...
![Handler](../../../assets/img/integrate/synapse_handlers/handler.png)
...
![Message Flow using Handler](../../../assets/img/integrate/synapse_handlers/inflow_outflow.png)
...
![Request-Response Flow](../../../assets/img/integrate/synapse_handlers/esb-with-request-response-flow.png)
