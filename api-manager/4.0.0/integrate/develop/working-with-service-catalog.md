...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/working-with-service-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/working-with-service-catalog.md
tags:
  - api-manager
  - integrate
  - develop
...
!!! tip "Related Tutorials"
        To try out an end-to-end use case where an integration service is created and used as a managed API, see the tutorial: [Exposing an Integration Service as a Managed API](../../tutorials/integration-tutorials/service-catalog-tutorial.md).
...
!!! Tip
    ...
    -   [Developing your First Integration Service](integration-development-kickstart.md).
...
1. [Create and API ](../../design/create-api/create-an-api-using-a-service.md) using the integration service.
2. [Deploy the API](../../deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md) in the API Gateway.
3. [Publish the API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api.md) to the Developer Portal.