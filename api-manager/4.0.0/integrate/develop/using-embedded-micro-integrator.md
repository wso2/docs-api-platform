...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/using-embedded-micro-integrator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/using-embedded-micro-integrator.md
tags:
  - api-manager
  - integrate
  - develop
...
<img src="../../../assets/img/integrate/testing-integrations/show-deployed-endpoints.png" width="700">
...
!!!	Note
	...
	- [Environment variables for server Configurations](../../install-and-setup/setup/mi-setup/dynamic_server_configurations.md)
	- [Environment variables for synapse configurations](injecting-parameters.md)
...
2.  You can now go to **Run** -> **Run Configurations** in the upper menu bar of your computer:
    ...
    ![run configurations menu](../../assets/img/integrate/run-configs-menu.png)
...
3.  In the **Run Configurations** dialog box that opens, select **Micro Integrator Server 1.2.0** that is listed under **Generic Server** in the navigator:
    ...
    ![run configurations dialog box](../../assets/img/integrate/run-configs-dialog-box.png)
...
5.  Go to the **Environment** tab and click **New** to add an environment variable:
    ...
    ![run configurations environments](../../assets/img/integrate/run-configs-env.png)
...
6.  Enter the variable name and value as a key-value pair and click **OK**. In this example, let's use the server offset:
    ...
    ![run configurations environments](../../assets/img/integrate/run-configs-env-popup.png)


7.  Click **Apply** to apply the new environment variable.

    ![run configurations environments](../../assets/img/integrate/run-configs-env-apply.png)