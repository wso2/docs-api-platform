...
3.	Enter a unique name for the message store, and then select the type of message store you are creating.
	...
	-	[JMS properties](../../../reference/synapse-properties/message-stores/jms-msg-store-properties.md)
	-	[JDBC properties](../../../reference/synapse-properties/message-stores/jdbc-msg-store-properties.md)
	-	[RabbitMQ properties](../../../reference/synapse-properties/message-stores/rabbitmq-msg-store-properties.md)
	-	[Resequence properties](../../../reference/synapse-properties/message-stores/resequence-msg-store-properties.md)
	-	[WSO2 MB properties](../../../reference/synapse-properties/message-stores/wso2mb-msg-store-properties.md)
	-	[In-Memory properties](../../../reference/synapse-properties/message-stores/in-memory-msg-store-properties.md)
	-	[Custom properties](../../../reference/synapse-properties/message-stores/custom-msg-store-properties.md)
...
To add a message store to the integration sequence, use the [Store Mediator](../../../reference/mediators/store-mediator.md):
...
-   [Introduction to Message Stores and Processors](../../examples/message_store_processor_examples/intro-message-stores-processors.md)
-   [JDBC Message Store](../../examples/message_store_processor_examples/using-jdbc-message-store.md)
-   [JMS Message Store](../../examples/message_store_processor_examples/using-jms-message-stores.md)
-   [RabbitMQ Message Store](../../examples/message_store_processor_examples/using-rabbitmq-message-stores.md)
