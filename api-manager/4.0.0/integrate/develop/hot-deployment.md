...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/hot-deployment/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/develop/hot-deployment.md
tags:
  - api-manager
  - integrate
  - develop
...
See the [complete list of server configurations](../../reference/config-catalog.md#server).