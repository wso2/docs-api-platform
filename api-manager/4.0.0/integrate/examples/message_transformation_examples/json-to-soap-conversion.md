...
Let's convert JSON messages to SOAP using the [PayloadFactory mediator](../../../reference/mediators/payloadfactory-mediator.md).
...
Let's convert JSON messages to SOAP using the [XSLT mediator](../../../reference/mediators/xslt-mediator.md). The XSLT, which specifies the message conversion parameters, is stored in the product registry as a **local entry**.
