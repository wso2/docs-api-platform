...
description: "Configure a proxy service that receives HTTP(S) messages and forwards them to a backend over JMS."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_from_https_to_jms/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_from_https_to_jms.md
tags:
  - api-manager
  - integrate
  - examples
...
If the previous example on [JMS to HTTP](switching_from_jms_to_http.md) is also configured, it will pick the message from queue and send it to the stockquote proxy.
