...
description: "Configure a proxy service that receives SOAP messages over UDP and forwards them to a backend over HTTP."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_from_udp_to_https/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_from_udp_to_https.md
tags:
  - api-manager
  - integrate
  - examples
