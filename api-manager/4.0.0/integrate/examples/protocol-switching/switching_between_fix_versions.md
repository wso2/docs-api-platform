...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_between_fix_versions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_between_fix_versions.md
tags:
  - api-manager
  - integrate
  - examples
