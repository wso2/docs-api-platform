...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_from_tcp_to_https/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/protocol-switching/switching_from_tcp_to_https.md
tags:
  - api-manager
  - integrate
  - examples
...
[Enable the TCP transport](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports.md#configuring-the-tcp-transport) and start the Micro-Integrator.
