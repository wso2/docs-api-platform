...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-kafka/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-kafka.md
tags:
  - api-manager
  - integrate
  - examples
...
-   Apache Kafka inbound endpoint should be configured. The recommended version for the customized Kafka inbound endpoint is `kafka_2.12-2.2.1`. See [Configuring Kafka](../../../install-and-setup/setup/mi-setup/feature_configs/configuring-kafka.md) for more information. 
