...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/endpoint_examples/using-static-recepient-list-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/endpoint_examples/using-static-recepient-list-endpoints.md
tags:
  - api-manager
  - integrate
  - examples
