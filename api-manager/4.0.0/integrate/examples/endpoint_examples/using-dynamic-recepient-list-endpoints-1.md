...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/endpoint_examples/using-dynamic-recepient-list-endpoints-1/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/endpoint_examples/using-dynamic-recepient-list-endpoints-1.md
tags:
  - api-manager
  - integrate
  - examples
