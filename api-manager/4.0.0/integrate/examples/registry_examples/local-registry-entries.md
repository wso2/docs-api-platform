...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/registry_examples/local-registry-entries/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/registry_examples/local-registry-entries.md
tags:
  - api-manager
  - integrate
  - examples
