...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/routing_examples/splitting_aggregating_messages/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/routing_examples/splitting_aggregating_messages.md
tags:
  - api-manager
  - integrate
  - examples
