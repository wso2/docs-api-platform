...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/proxy_service_examples/publishing-a-custom-wsdl/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/proxy_service_examples/publishing-a-custom-wsdl.md
tags:
  - api-manager
  - integrate
  - examples
