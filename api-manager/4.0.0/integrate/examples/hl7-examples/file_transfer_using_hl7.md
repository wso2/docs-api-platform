...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/hl7-examples/file_transfer_using_hl7/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/hl7-examples/file_transfer_using_hl7.md
tags:
  - api-manager
  - integrate
  - examples
