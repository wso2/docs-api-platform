...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/hl7-examples/acknowledge_hl7_messages/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/hl7-examples/acknowledge_hl7_messages.md
tags:
  - api-manager
  - integrate
  - examples
...
4. [Configure the HL7 transport](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports.md#configuring-the-hl7-transport) in your Micro Integrator.
