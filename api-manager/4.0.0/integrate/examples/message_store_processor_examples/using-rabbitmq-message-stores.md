...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/message_store_processor_examples/using-rabbitmq-message-stores/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/message_store_processor_examples/using-rabbitmq-message-stores.md
tags:
  - api-manager
  - integrate
  - examples
