...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/json_examples/json-examples/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/json_examples/json-examples.md
tags:
  - api-manager
  - integrate
  - examples
