...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/rest_api_examples/handling-non-matching-resources/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/rest_api_examples/handling-non-matching-resources.md
tags:
  - api-manager
  - integrate
  - examples
...
3. Create the [rest API](../../develop/creating-artifacts/creating-an-api.md) and [mediation sequence](../../develop/creating-artifacts/creating-reusable-sequences.md) with the configurations given above.
