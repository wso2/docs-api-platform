...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/transport_examples/pub-sub-using-mqtt/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/examples/transport_examples/pub-sub-using-mqtt.md
tags:
  - api-manager
  - integrate
  - examples
