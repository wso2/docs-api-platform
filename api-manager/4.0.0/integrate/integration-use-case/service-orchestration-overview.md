...
description: "Learn how the Micro Integrator orchestrates multiple fine-grained services through service chaining and parallel invocation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/integration-use-case/service-orchestration-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/integrate/integration-use-case/service-orchestration-overview.md
tags:
  - api-manager
  - integrate
