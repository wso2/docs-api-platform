...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/develop/streaming-apps/working-with-the-design-view/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/develop/streaming-apps/working-with-the-design-view.md
tags:
  - api-manager
  - develop
  - streaming-apps
...
To save a Siddhi application that you created in the design view, you need to switch to the source view. You also need to switch to the source view to run a Siddhi application. For more information, see [Streaming Integrator Tooling Overview](streaming-integrator-studio-overview.md).
