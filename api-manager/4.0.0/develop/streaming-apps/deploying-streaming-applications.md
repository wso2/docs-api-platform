...
description: "Deploy a Siddhi application to the Streaming Integrator server, Docker, or Kubernetes after creating and testing it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/develop/streaming-apps/deploying-streaming-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/develop/streaming-apps/deploying-streaming-applications.md
tags:
  - api-manager
  - develop
  - streaming-apps
