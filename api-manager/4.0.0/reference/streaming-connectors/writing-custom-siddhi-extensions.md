...
description: "Explains how to write custom Siddhi extensions using the available Maven archetypes for each extension type."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/streaming-connectors/writing-custom-siddhi-extensions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/streaming-connectors/writing-custom-siddhi-extensions.md
tags:
  - api-manager
  - reference
