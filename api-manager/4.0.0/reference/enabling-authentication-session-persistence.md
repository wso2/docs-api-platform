...
description: "Enable authentication session persistence in API Manager to support the remember me login option."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/enabling-authentication-session-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/enabling-authentication-session-persistence.md
tags:
  - api-manager
  - reference
