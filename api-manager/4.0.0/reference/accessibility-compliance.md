...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/accessibility-compliance/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/accessibility-compliance.md
tags:
  - api-manager
  - reference
