...
description: "Recommends how client applications should handle authentication failures when the same user accesses API Manager from multiple devices at once."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/guides/accessing-api-manager-by-multiple-devices-simultaneously/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/guides/accessing-api-manager-by-multiple-devices-simultaneously.md
tags:
  - api-manager
  - reference
  - guides
