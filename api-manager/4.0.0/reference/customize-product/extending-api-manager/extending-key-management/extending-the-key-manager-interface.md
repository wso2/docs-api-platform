...
description: "Explains the KeyManager interface and how to implement a third-party Key Manager connector for API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-key-management/extending-the-key-manager-interface/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-key-management/extending-the-key-manager-interface.md
tags:
  - api-manager
  - reference
  - customize-product
