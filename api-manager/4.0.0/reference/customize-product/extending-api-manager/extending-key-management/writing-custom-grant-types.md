...
description: "Implement custom OAuth 2.0 grant types for API Manager by extending the existing grant handler classes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-key-management/writing-custom-grant-types/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-key-management/writing-custom-grant-types.md
tags:
  - api-manager
  - reference
  - customize-product
