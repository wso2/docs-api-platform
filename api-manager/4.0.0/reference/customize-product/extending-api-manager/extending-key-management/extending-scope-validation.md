...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-key-management/extending-scope-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-key-management/extending-scope-validation.md
tags:
  - api-manager
  - reference
  - customize-product
