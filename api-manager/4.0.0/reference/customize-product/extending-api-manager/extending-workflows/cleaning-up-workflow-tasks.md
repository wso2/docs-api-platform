...
description: "Use the workflow task clean up feature to remove pending approval tasks for deleted applications and subscriptions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-workflows/cleaning-up-workflow-tasks/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/extending-api-manager/extending-workflows/cleaning-up-workflow-tasks.md
tags:
  - api-manager
  - reference
  - customize-product
