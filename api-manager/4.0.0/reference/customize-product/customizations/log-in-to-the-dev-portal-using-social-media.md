...
description: "Integrate WSO2 Identity Server with Facebook authentication to log in to the Developer Portal using social media."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/customizations/log-in-to-the-dev-portal-using-social-media/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/customizations/log-in-to-the-dev-portal-using-social-media.md
tags:
  - api-manager
  - reference
  - customize-product
...
2.  Go to the **Identity** section under the **Main** tab. Click **Add** under **Identity Providers** and enter following details.
    ...
    !!! note
        To authenticate the user with **Facebook** which is an external system, we have to configure the federated authenticator. For more details, see [Federated Authentication](https://is.docs.wso2.com/en/5.10.0/get-started/quick-start-guide/#federated-authentication).
