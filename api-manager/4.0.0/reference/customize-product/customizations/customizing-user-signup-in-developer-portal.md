...
description: "Customize the mandatory and optional fields shown on the Developer Portal self-signup page."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/customizations/customizing-user-signup-in-developer-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/customize-product/customizations/customizing-user-signup-in-developer-portal.md
tags:
  - api-manager
  - reference
  - customize-product
