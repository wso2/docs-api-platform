...
description: "Reference of the operation used to retrieve an employee's labor defaults with the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-employment-information/employeelabordefaults/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-employment-information/employeelabordefaults.md
tags:
  - api-manager
  - reference
  - connectors
...
| ------------- |-------------|
|[GET Employee Labor Defaults](#retrieving-employee-labor-defaults)| Retrieve employee labor defaults. Labor defaults specify an employee default position, project, docket or other timesheet information. |

### Operation details

This section provides more details on each of the operations.

<a name="retrieving-employee-labor-defaults"></a>
