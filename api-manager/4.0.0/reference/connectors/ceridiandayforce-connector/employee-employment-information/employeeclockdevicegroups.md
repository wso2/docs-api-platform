...
description: "Reference of the operation used to retrieve an employee's clock device groups with the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-employment-information/employeeclockdevicegroups/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-employment-information/employeeclockdevicegroups.md
tags:
  - api-manager
  - reference
  - connectors
...
| ------------- |-------------|
|[GET Employee Clock Device Groups](#retrieving-employee-clock-device-groups)| Retrieve an employee's clock device groups that control access to the clocks the employee can punch on. |
