...
description: "Reference of the operations used to retrieve, create, and update an employee's onboarding policies with the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-employment-information/employeeonboardingpolicies/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-employment-information/employeeonboardingpolicies.md
tags:
  - api-manager
  - reference
  - connectors
