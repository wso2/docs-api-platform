...
description: "Retrieve, create, and update an employee's emergency contact information using the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-personal-information/employeeemergencycontacts/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/employee-personal-information/employeeemergencycontacts.md
tags:
  - api-manager
  - reference
  - connectors
