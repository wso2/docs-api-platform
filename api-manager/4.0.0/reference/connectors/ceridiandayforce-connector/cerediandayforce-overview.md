...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/cerediandayforce-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/ceridiandayforce-connector/cerediandayforce-overview.md
tags:
  - api-manager
  - reference
  - connectors
