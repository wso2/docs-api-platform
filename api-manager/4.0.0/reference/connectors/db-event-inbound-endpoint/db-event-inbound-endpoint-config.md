...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/db-event-inbound-endpoint/db-event-inbound-endpoint-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/db-event-inbound-endpoint/db-event-inbound-endpoint-config.md
tags:
  - api-manager
  - reference
  - connectors
