...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazonlambda-connector/setting-up-amazonlambda/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazonlambda-connector/setting-up-amazonlambda.md
tags:
  - api-manager
  - reference
  - connectors
