...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazonlambda-connector/amazonlambda-connector-example/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazonlambda-connector/amazonlambda-connector-example.md
tags:
  - api-manager
  - reference
  - connectors
