...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/develop-connectors/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/develop-connectors.md
tags:
  - api-manager
  - reference
  - connectors
...
Please read the [WSO2 Error Code guide](../../troubleshooting/error-handling.md). 
