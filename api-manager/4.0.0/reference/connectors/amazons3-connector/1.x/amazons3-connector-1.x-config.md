...
description: "Sign up for AWS and obtain the access key and credentials needed to use version 1.x of the Amazon S3 connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazons3-connector/1.x/amazons3-connector-1.x-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazons3-connector/1.x/amazons3-connector-1.x-config.md
tags:
  - api-manager
  - reference
  - connectors
...
## Steps to get an AWS Access Key for an IAM user account
  ...
  2. In the navigation pane, choose Users.
     ...
     <img src="../../../../../assets/img/integrate/connectors/iam-users.png" title="IAM users" width="200" alt="IAM users"/>
