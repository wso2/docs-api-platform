...
description: "Follow an example that uses the WSO2 Microsoft Azure Storage connector to create containers and upload, retrieve, and remove blobs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/microsoft-azure-storage-connector/microsoft-azure-storage-connector-example/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/microsoft-azure-storage-connector/microsoft-azure-storage-connector-example.md
tags:
  - api-manager
  - reference
  - connectors
