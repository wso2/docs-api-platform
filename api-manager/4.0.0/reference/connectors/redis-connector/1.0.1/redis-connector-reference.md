...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/redis-connector/1.0.1/redis-connector-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/redis-connector/1.0.1/redis-connector-reference.md
tags:
  - api-manager
  - reference
  - connectors
