...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/kafka-connector/3.0.x/kafka-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/kafka-connector/3.0.x/kafka-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
