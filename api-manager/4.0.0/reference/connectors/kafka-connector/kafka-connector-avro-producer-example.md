...
description: "Configure the Kafka connector to publish Apache Avro messages to a Kafka broker via a topic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/kafka-connector/kafka-connector-avro-producer-example/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/kafka-connector/kafka-connector-avro-producer-example.md
tags:
  - api-manager
  - reference
  - connectors
