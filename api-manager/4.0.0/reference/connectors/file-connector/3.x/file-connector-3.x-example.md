...
1. Right click on the created Integration Project and select, -> **New** -> **Rest API** to create the REST API. 
    <img src="../../../../assets/img/integrate/connectors/filecon-3.x/adding-an-api.png" title="Adding a Rest API" width="800" alt="Adding a Rest API"/>
...
* To customize this example for your own scenario, see [File Connector Configuration](file-connector-3.x-config.md) documentation for all operation details of the connector.