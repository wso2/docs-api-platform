...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazonsqs-connector/amazon-inbound-endpoint-1.0.x/amazonsqs-inbound-endpoint-reference-configuration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/amazonsqs-connector/amazon-inbound-endpoint-1.0.x/amazonsqs-inbound-endpoint-reference-configuration.md
tags:
  - api-manager
  - reference
  - connectors
