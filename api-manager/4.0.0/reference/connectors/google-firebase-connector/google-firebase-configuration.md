...
description: "Configure the Google Firebase connector's init operation using credentials from a Firebase service account."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/google-firebase-connector/google-firebase-configuration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/google-firebase-connector/google-firebase-configuration.md
tags:
  - api-manager
  - reference
  - connectors
