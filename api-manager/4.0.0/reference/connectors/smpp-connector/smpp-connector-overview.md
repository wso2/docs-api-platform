...
* **[SMPP Inbound Endpoint Example](smpp-connector-example.md)**: This scenario demonstrates how the SMPP inbound endpoint works as an message consumer. 

* **[SMPP Inbound Endpoint Reference](smpp-connector-config.md)**: This documentation provides a reference guide for SMPP Inbound Endpoint.
