...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/google-pubsub-connector/googlepubsub-connector-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/google-pubsub-connector/googlepubsub-connector-overview.md
tags:
  - api-manager
  - reference
  - connectors
...
<img src="../../../../assets/img/integrate/connectors/pubsub-store.png" title="Google PubSub Connector Store" width="200" alt="Google PubSub Connector Store"/>
...
* **[Google Pub/Sub Connector Example](googlepubsub-connector-example.md)**: This example demonstrates how to work with the Google Pub/Sub Connector. 
