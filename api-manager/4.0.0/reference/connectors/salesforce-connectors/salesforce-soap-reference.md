...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/salesforce-connectors/salesforce-soap-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/salesforce-connectors/salesforce-soap-reference.md
tags:
  - api-manager
  - reference
  - connectors
