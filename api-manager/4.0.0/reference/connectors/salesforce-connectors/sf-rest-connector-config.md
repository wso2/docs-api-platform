...
description: "Reference for the initialization and operations of the Salesforce REST connector v1.x using Salesforce REST API v32.0."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/salesforce-connectors/sf-rest-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/salesforce-connectors/sf-rest-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
