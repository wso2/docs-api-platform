...
description: "Reference for the servicenow.init operation and parameters used to configure the ServiceNow connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/servicenow-connector/servicenow-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/servicenow-connector/servicenow-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
