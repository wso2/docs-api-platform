...
description: "Configure Gmail Connector operations for accessing the Gmail REST API using OAuth2 authentication."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/gmail-connector/gmail-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/connectors/gmail-connector/gmail-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
