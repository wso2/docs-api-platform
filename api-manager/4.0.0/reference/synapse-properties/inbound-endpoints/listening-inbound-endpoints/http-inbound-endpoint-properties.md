...
description: "Reference for the syntax and properties used to configure an HTTP or HTTPS inbound endpoint in the Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/inbound-endpoints/listening-inbound-endpoints/http-inbound-endpoint-properties/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/inbound-endpoints/listening-inbound-endpoints/http-inbound-endpoint-properties.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
Listed below are the properties used for [creating an HTTP/HTTPS inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint.md).

### Required Properties

Listed below are the required properties when [creating an HTTP/HTTPS inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint.md).
...
Listed below are the optional properties you can configure when [creating an HTTP/HTTPS inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint.md).
