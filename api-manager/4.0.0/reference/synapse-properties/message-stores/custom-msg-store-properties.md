...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/message-stores/custom-msg-store-properties/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/message-stores/custom-msg-store-properties.md
tags:
  - api-manager
  - reference
  - synapse-properties
