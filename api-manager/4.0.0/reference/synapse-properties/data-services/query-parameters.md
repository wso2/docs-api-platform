...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/data-services/query-parameters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/data-services/query-parameters.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
!!! Info
	REST resources and Operations are used depending on whether the particular task should be invoked RESTfully, or by using SOAP. Read more about [REST resources and operations](elements-of-a-data-service.md) in data services.
