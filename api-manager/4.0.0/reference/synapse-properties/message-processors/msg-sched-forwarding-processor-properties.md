...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/message-processors/msg-sched-forwarding-processor-properties/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/synapse-properties/message-processors/msg-sched-forwarding-processor-properties.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
Following are the optional parameters you can set when [adding a Scheduled Message Forwarding Processor](../../../integrate/develop/creating-artifacts/creating-a-message-processor.md):
