...
description: "Get started with apictl, the WSO2 API Manager command-line tool used to manage APIs, API Products, and Applications across environments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/apictl/wso2-api-controller/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/apictl/wso2-api-controller.md
tags:
  - api-manager
  - reference
  - apictl
