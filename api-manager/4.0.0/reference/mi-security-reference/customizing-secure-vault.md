...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mi-security-reference/customizing-secure-vault/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mi-security-reference/customizing-secure-vault.md
tags:
  - api-manager
  - reference
