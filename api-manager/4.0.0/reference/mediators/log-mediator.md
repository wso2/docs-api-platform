...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/log-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/log-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
	The Log mediator is a [conditionally](about-mediators.md#classification-of-mediators) [content aware](about-mediators.md#classification-of-mediators) mediator.
