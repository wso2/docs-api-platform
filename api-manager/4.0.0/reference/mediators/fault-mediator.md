...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/fault-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/fault-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
For more information on faults and errors, see [Error Handling](../../troubleshooting/error-handling.md).
