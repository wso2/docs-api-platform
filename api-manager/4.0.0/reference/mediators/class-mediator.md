...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/class-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/class-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
Your class mediator might not be picked up and updated if you use an existing package when creating. For best results, use [WSO2 Integration Studio](../../integrate/develop/wso2-integration-studio.md) for debugging Class mediators.
