...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/enrich-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/enrich-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
    The Enrich mediator is a [content-aware](about-mediators.md#classification-of-mediators) mediator.
