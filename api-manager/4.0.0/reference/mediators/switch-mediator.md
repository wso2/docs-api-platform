...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/switch-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/switch-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
    The Switch mediator is a [conditionally](about-mediators.md#classification-of-mediators) [content aware](about-mediators.md#classification-of-mediators) mediator.
