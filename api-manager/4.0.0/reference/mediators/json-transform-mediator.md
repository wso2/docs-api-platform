...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/json-transform-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/json-transform-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
For instructions on adding the schema file to the Registry Resources Project, see [Creating Registry Resource](../../integrate/develop/creating-artifacts/creating-registry-resources.md).
