...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/ejb-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/ejb-mediator.md
tags:
  - api-manager
  - reference
  - mediators
