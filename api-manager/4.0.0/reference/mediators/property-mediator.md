...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/property-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/property-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
    The Property mediator is a [conditionally content aware](about-mediators.md#classification-of-mediators) mediator.
...
by using an XPath function. You can use any of the <a href="../property-reference/accessing-properties-with-xpath.md">XPath functions</a> that you use for the property <b>value</b> or property <b>expression</b>.</p>
...
<p>For names of the generic properties that come by default, see <a href="../property-reference/generic-properties/">Generic Properties</a> . You can select them from the drop-down list if you are adding the Property Mediator as shown below.</p>
...
<p>For a detailed explanation of each scope, see <a href="../property-reference/accessing-properties-with-xpath.md">Accessing Properties with XPath</a>.</p></td>
</tr>
</tbody>
</table>
