...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/xslt-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/reference/mediators/xslt-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
    The XSLT mediator is a [content aware](about-mediators.md#classification-of-mediators) mediator.
