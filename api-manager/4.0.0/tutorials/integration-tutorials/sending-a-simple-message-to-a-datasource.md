...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/integration-tutorials/sending-a-simple-message-to-a-datasource/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/integration-tutorials/sending-a-simple-message-to-a-datasource.md
tags:
  - api-manager
  - tutorials
...
1.  Open **WSO2 Integration Studio** and click **New Maven Multi Module Project** in 
    ...
    ![](../../assets/img/integrate/create_project/create_mmm_project.png)
...
4.  Click **Input Mappings** to expand the section. 
    ![](../../assets/img/integrate/tutorials/data_services/input_mapping_expanded.png)
...
2. Enter the request information as given below and click the <b>Send</b> icon (<img src="../../../assets/img/integrate/tutorials/common/play-head-icon.png" width="20">).
    ...
    <table>
     ...
     <img src="../../../assets/img/integrate/tutorials/119132155/http4e-client-data-source.png" width="800">
