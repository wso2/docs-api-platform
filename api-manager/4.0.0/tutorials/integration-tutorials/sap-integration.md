...
description: "Set up the Micro Integrator in an SAP environment with the SAP JCo library, IDoc, and BAPI adapters to integrate with SAP R/3."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/integration-tutorials/sap-integration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/integration-tutorials/sap-integration.md
tags:
  - api-manager
  - tutorials
