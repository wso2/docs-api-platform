...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/scenarios/scenario5-developer-community-feature/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/scenarios/scenario5-developer-community-feature.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
Try out the next scenario in the series, [Integrating with Data Sources](scenario6-integrating-with-data-sources.md).