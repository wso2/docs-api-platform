...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/scenarios/scenario1-create-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/scenarios/scenario1-create-rest-api.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
Try out the next scenario in the series, [Access Control](scenario2-access-control.md).