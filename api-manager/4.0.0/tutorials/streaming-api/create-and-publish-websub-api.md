...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/streaming-api/create-and-publish-websub-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/streaming-api/create-and-publish-websub-api.md
tags:
  - api-manager
  - tutorials
  - streaming-api
...
6. Generate a secret.
      ...
      1. Expand the **Subscription Configuration** section in the **Topics** page.
           ...
           [![WebSub API Runtime Configurations](../../assets/img/tutorials/streaming-api/websub-api-runtime-configurations.png)](../../assets/img/tutorials/streaming-api/websub-api-runtime-configurations.png)
...
1.  
    --8<-- "api-manager/4.0.0/includes/sign-in-devportal.md"
