...
description: "Design, publish, and invoke a Server-Sent Events streaming API in API Manager, then test it against a sample backend."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/streaming-api/create-and-publish-sse-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/tutorials/streaming-api/create-and-publish-sse-api.md
tags:
  - api-manager
  - tutorials
  - streaming-api
...
4.  Click **CREATE**. 
     ...
     [![Overview of SSE API](../../assets/img/tutorials/streaming-api/sse-api-overview.png)](../../assets/img/tutorials/streaming-api/sse-api-overview.png)
...
5. Attach business plans to the SSE API.
      ...
      2. Select **AsyncGold** and click **Save**.
           ...
           [![Subscriptions of SSE API](../../assets/img/tutorials/streaming-api/sse-api-subscriptions.png)](../../assets/img/tutorials/streaming-api/sse-api-subscriptions.png)
