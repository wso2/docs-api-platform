...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/production-deployment-guideline/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/production-deployment-guideline.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
--8<-- "api-manager/4.0.0/includes/deploy/cc-prod-guide-helm-values-yaml-tip.md"
...
FROM wso2/choreo-connect-router:1.2.0
...
```bash tab='Sample'
docker build -t myimages/choreo-connect-router:1.2.0 -f Dockerfile .
```
...
```bash tab='Sample'
docker build -t myimages/choreo-connect-adapter-petstore:1.2.0 -f Dockerfile .
```
