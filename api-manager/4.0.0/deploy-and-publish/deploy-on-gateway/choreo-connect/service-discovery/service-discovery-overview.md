...
description: "Understand how Choreo Connect integrates with the Consul service registry to automatically discover upstream service endpoints in a service mesh."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/service-discovery/service-discovery-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/service-discovery/service-discovery-overview.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
[![reference](../../../../assets/img/deploy/consul-apim.png)](../../../../assets/img/deploy/consul-apim.png)
