---
title: "Choreo Connect with Consul service mesh on Kubernetes"
description: "Configure Choreo Connect with a Consul service mesh deployed on Kubernetes for service discovery."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/service-discovery/choreo-connect-and-k8s/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/service-discovery/choreo-connect-and-k8s.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
[![service discovery](../../../../assets/img/deploy/consul-reference-k8s.png){: style="width:70%"}](../../../../assets/img/deploy/consul-reference-k8s.png)
...
2. Go to the `[adapter.consul]` section and update the configurations.
    ...
    ```
     ...
     6. [Apply the K8s artifacts for Choreo Connect](../getting-started/deploy/cc-as-a-standalone-gateway-on-kubernetes.md#step-1-setup-choreo-connect-in-kubernetes).

## Step 3 - Deploy the API

Deploy WSO2 API Manger on Kubernetes.

Use WSO2 API Manager to deploy your API as described in the [defining the endpoints](service-discovery-overview.md#defining-the-endpoints) guide.