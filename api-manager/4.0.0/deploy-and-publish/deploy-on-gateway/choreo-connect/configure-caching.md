...
description: "Configure the OAuth token cache in Choreo Connect to reduce backend signature validation calls and improve Gateway performance."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configure-caching/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configure-caching.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
