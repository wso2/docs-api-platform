...
description: "Configure gzip HTTP data compression for request and response flows in Choreo Connect to reduce payload transfer size."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/data-compression/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/data-compression.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
!!! note
    ...
    - If `Content-encoding` header is given in the request, Choreo Connect will not apply data compression during the request or response flow.
