...
description: "Understand how third-party Key Managers registered in the API Manager Admin Portal are used for JWT validation in Choreo Connect."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/third-party-key-managers/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/concepts/third-party-key-managers.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
