...
description: "Define OAuth2 scopes in an API's security scheme and assign them to operations to enforce scope validation in Choreo Connect."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authorization/scope-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authorization/scope-validation.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
