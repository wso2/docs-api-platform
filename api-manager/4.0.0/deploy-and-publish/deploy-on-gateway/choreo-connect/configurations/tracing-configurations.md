...
description: "Reference all tracing-related configuration parameters available for WSO2 Choreo Connect in the config.toml file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configurations/tracing-configurations/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configurations/tracing-configurations.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
