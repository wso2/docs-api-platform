...
description: "Review guidance on scaling WSO2 API Manager Gateways, including ratios for Key Managers, Traffic Managers, and Control Plane nodes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/scaling-the-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/scaling-the-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
For more information, see [Key cache](../../../install-and-setup/setup/advance-configurations/configuring-caching.md#api-gateway-cache) in the WSO2 API Manager documentation.
