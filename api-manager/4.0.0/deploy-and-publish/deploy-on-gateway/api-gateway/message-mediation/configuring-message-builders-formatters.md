...
description: "Reference the default message builders and formatters that the API Manager Gateway uses to process request and response payloads."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/message-mediation/configuring-message-builders-formatters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/message-mediation/configuring-message-builders-formatters.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
