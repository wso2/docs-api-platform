...
description: "Understand how the API Gateway transforms API message payloads between content types using message builders and formatters."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/message-mediation/transforming-api-message-payload/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/message-mediation/transforming-api-message-payload.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
