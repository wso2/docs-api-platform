...
description: "Configure, apply, and test the XML threat protector policy that validates XML payloads against configurable limits to block attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/threat-protectors/xml-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/threat-protectors/xml-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
