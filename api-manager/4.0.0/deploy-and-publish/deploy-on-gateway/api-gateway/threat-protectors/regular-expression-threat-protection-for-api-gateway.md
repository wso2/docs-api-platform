...
description: "Configure, apply, and test regex-based threat protection patterns that block SQL injection and other malicious API request content."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/threat-protectors/regular-expression-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/threat-protectors/regular-expression-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
4.  Select `regex_policy` from the drop-down menu for Common Policies.
    ...
    <a href="../../../../../assets/img/learn/mediation-regex-policy.png"><img src="../../../../../assets/img/learn/mediation-regex-policy.png" width="70%" alt="Select Regex policy from the drop-down menu"></a> 
