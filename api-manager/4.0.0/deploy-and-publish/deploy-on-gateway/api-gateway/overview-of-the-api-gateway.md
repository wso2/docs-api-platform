...
description: "Explains the WSO2 API Gateway architecture, message processing flow, and the security and traffic management features it supports."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/overview-of-the-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/deploy-and-publish/deploy-on-gateway/api-gateway/overview-of-the-api-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
