...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/troubleshooting/error-handling-mi/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/troubleshooting/error-handling-mi.md
tags:
  - api-manager
  - troubleshooting
  - error-handling-mi
...
This section describes the error codes for endpoint failures. For more information on handling endpoint errors, see [Endpoint Error Handling](../reference/synapse-properties/endpoint-properties.md#endpoint-error-handling-properties).
