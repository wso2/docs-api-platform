...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/user-account-management/change-dev-portal-password/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/user-account-management/change-dev-portal-password.md
tags:
  - api-manager
  - consume
