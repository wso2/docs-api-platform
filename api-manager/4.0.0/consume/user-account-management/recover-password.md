...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/user-account-management/recover-password/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/user-account-management/recover-password.md
tags:
  - api-manager
  - consume
