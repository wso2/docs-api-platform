...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/manage-subscription/advanced-topics/adding-an-api-subscription-workflow-using-bps/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/manage-subscription/advanced-topics/adding-an-api-subscription-workflow-using-bps.md
tags:
  - api-manager
  - consume
  - manage-subscription
