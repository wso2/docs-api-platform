...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/invoke-apis/invoke-apis-using-tools/try-out-using-postman/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/invoke-apis/invoke-apis-using-tools/try-out-using-postman.md
tags:
  - api-manager
  - consume
  - invoke-apis
...
!!! note "Try out using the Integrated API Console"
    If required, instead of using Postman you can try out your REST APIs using the WSO2 API Manager [Integrated API Console](invoke-an-api-using-the-integrated-api-console.md).
