...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/invoke-apis/invoke-apis-using-tools/include-additional-headers-in-the-api-console/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/invoke-apis/invoke-apis-using-tools/include-additional-headers-in-the-api-console.md
tags:
  - api-manager
  - consume
  - invoke-apis
