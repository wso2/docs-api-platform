...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/manage-application/generate-keys/generate-api-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/manage-application/generate-keys/generate-api-keys.md
tags:
  - api-manager
  - consume
  - manage-application
