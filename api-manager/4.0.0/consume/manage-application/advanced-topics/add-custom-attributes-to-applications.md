...
description: "Configure server-specific or tenant-specific custom attributes so developers can add them when creating applications in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/manage-application/advanced-topics/add-custom-attributes-to-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/consume/manage-application/advanced-topics/add-custom-attributes-to-applications.md
tags:
  - api-manager
  - consume
  - manage-application
