...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/streaming-usecase/processing-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/streaming-usecase/processing-data.md
tags:
  - api-manager
  - use-cases
  - streaming-usecase
