...
- Download and install the [siddhi-io-cdc](https://siddhi-io.github.io/siddhi-io-cdc/) extension. For instructions, see [Downloading and Installing Siddhi Connectors](../../develop/streaming-apps/installing-siddhi-extensions.md).
