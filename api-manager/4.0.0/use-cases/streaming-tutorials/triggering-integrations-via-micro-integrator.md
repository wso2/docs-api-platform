...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/streaming-tutorials/triggering-integrations-via-micro-integrator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/streaming-tutorials/triggering-integrations-via-micro-integrator.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
...
- [Start WSO2 Streaming Integrator server](../../install-and-setup/install/installing-the-product/running-the-si.md#starting-the-si-server).
