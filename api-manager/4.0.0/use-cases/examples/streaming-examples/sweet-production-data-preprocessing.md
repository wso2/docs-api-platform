...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/sweet-production-data-preprocessing/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/sweet-production-data-preprocessing.md
tags:
  - api-manager
  - use-cases
  - examples
