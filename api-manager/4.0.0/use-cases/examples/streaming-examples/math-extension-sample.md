...
description: "Configure a Siddhi application that uses the math ceil function to round production amounts up to the nearest integer."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/math-extension-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/math-extension-sample.md
tags:
  - api-manager
  - use-cases
  - examples
