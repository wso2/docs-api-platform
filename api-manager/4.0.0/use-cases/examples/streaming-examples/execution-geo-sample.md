...
description: "Example Siddhi application that retrieves longitude and latitude coordinates based on provided location details."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/execution-geo-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/execution-geo-sample.md
tags:
  - api-manager
  - use-cases
  - examples
...
2. To simulate events for the `geocodeStream` stream of the `execution-geo-sample`  Siddhi application, enter information in the **Single Simulation** tab of the event simulation panel as follows.
    ...
    ![Select Siddhi Application and Stream](../../../assets/img/streaming/execution-geo-sample/siddhi-app-and-stream.png)
...
3. Enter attribute values as follows.
    ...
    ![Attribute Values](../../../assets/img/streaming/execution-geo-sample/attribute-values.png).
