...
description: "Configure a Siddhi application that sends HL7 events in ER7 format over the MLLP protocol and logs the acknowledgement."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-hl7-in-er7-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-hl7-in-er7-format.md
tags:
  - api-manager
  - use-cases
  - examples
