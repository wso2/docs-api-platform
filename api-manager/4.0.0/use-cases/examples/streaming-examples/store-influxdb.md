...
description: "Configure a Siddhi application that inserts, searches, updates, and deletes data in an InfluxDB store."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/store-influxdb/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/store-influxdb.md
tags:
  - api-manager
  - use-cases
  - examples
