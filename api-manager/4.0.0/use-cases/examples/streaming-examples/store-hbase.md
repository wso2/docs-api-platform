...
description: "Configure a Siddhi application that performs CRUD operations on an HBase store using Siddhi queries."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/store-hbase/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/store-hbase.md
tags:
  - api-manager
  - use-cases
  - examples
