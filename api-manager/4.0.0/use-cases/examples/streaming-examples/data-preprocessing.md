...
description: "Example that receives events via TCP transport and pre-processes them using Siddhi string and time extensions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/data-preprocessing/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/data-preprocessing.md
tags:
  - api-manager
  - use-cases
  - examples
