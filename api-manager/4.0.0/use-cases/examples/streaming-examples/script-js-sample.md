...
description: "Configure a Siddhi application that uses JavaScript functions within Siddhi queries to process events."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/script-js-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/script-js-sample.md
tags:
  - api-manager
  - use-cases
  - examples
