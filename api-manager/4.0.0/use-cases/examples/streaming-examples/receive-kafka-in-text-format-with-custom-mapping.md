...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/receive-kafka-in-text-format-with-custom-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/receive-kafka-in-text-format-with-custom-mapping.md
tags:
  - api-manager
  - use-cases
  - examples
