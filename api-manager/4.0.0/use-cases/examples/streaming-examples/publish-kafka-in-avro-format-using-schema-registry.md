---
title: "Publishing avro events via Kafka"
description: "Configure a Siddhi application to send sweet production events to Kafka in Avro format using Confluent Schema Registry."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-kafka-in-avro-format-using-schema-registry/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-kafka-in-avro-format-using-schema-registry.md
tags:
  - api-manager
  - use-cases
  - examples
