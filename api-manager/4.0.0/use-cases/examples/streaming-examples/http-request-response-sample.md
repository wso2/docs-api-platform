...
description: "Configure a Siddhi application to send sweet production events over HTTP, receive the response, and process it with Siddhi."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/http-request-response-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/http-request-response-sample.md
tags:
  - api-manager
  - use-cases
  - examples
