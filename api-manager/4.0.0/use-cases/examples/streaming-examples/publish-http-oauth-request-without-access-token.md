...
description: "Configure a Siddhi application that sends HTTP events to an OAuth-protected endpoint without providing an access token."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-http-oauth-request-without-access-token/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-http-oauth-request-without-access-token.md
tags:
  - api-manager
  - use-cases
  - examples
