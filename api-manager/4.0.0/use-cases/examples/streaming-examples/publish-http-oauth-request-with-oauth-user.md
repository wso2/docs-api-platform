...
description: "Configure a Siddhi application that sends HTTP events to an OAuth-protected endpoint using the password grant type."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-http-oauth-request-with-oauth-user/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-http-oauth-request-with-oauth-user.md
tags:
  - api-manager
  - use-cases
  - examples
