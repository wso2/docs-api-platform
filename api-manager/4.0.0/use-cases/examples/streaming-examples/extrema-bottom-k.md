...
description: "Example Siddhi application that uses the siddhi-execution-extrema extension's bottomK function to count value frequency."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/extrema-bottom-k/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/extrema-bottom-k.md
tags:
  - api-manager
  - use-cases
  - examples
