---
title: "Publishing JSON events via Kafka"
description: "Configure a Siddhi application to send sweet production events over Kafka transport in JSON format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-kafka-in-json-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/use-cases/examples/streaming-examples/publish-kafka-in-json-format.md
tags:
  - api-manager
  - use-cases
  - examples
