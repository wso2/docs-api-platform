...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/observe/micro-integrator/cloud-native-observability-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/observe/micro-integrator/cloud-native-observability-overview.md
tags:
  - api-manager
  - observe
  - micro-integrator
