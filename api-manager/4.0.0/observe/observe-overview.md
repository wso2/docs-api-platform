...
description: "Links to the API Manager, Micro Integrator, and Streaming Integrator observability solutions covering logs, metrics, and tracing."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/observe/observe-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/observe/observe-overview.md
tags:
  - api-manager
  - observe
  - observe-overview
