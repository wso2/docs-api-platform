...
description: "View and filter the Grafana dashboard that shows throughput and count statistics for Siddhi streams."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/observe/si-observe/viewing-stream-statistics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/observe/si-observe/viewing-stream-statistics.md
tags:
  - api-manager
  - observe
  - si-observe
