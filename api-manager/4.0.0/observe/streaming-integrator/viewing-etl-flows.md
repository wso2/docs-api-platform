...
!!! note "Before you begin:"
    - Follow the instructions in the [getting started guide](setting-up-si-statistics-dashboards.md) to enable the WSO2 Streaming Integrator to publish statistics in the Grafana dashboard.
    - [Organize the dashboards in folders](managing-dashboards.md).
...
2. Click **WSO2 Streaming Integrator Overall Statistics** in the **Dashboards** page.
     ...
     [![Open Overall Statistics](../../assets/img/streaming/managing-wso2-dashboards/open-overall-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/open-overall-statistics-dashboard.png)
    
     The overall statistics are displayed as shown in the following example.
    
     [![Overall Statistics](../../assets/img/streaming/managing-wso2-dashboards/overall-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/overall-statistics.png)
...
3. To view the statistics specific to a Siddhi application, click on the relevant Siddhi application.
     ...
     [![Select Siddhi Application](../../assets/img/streaming/managing-wso2-dashboards/select-siddhi-applocation.png)](../../assets/img/streaming/managing-wso2-dashboards/select-siddhi-applocation.png)
     ...
     [![Application Statistics](../../assets/img/streaming/managing-wso2-dashboards/siddhi-application-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/siddhi-application-statistics.png)
...
[![CDC Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/cdc-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/cdc-statistics.png)
...
[![CDC Streaming Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/cdc-streaming-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/cdc-streaming-statistics.png)
...
[![CDC Scheduled Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/cdc-scheduled-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/cdc-scheduled-statistics.png)
...
- When the content of a file is used as input data, the file is displayed in the **Sources** section as shown in the example below.
  ...
  [![File Source Statistics](../../assets/img/streaming/managing-wso2-dashboards/source-file-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/source-file-statistics.png)
 ...
 To view statistics for a specific file, click on it. As a result, the **WSO2 Streaming Integrator - File Statistics** dashboard opens as shown in the example below.
  ...
  [![File Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/file-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/file-statistics-dashboard.png)
 ...
 When you click on the same file again, the **WSO2 Streaming Integrator - File Source Statistics** dashboard opens with more detailed information about this source file as shown in the example below. 
  ...
  [![File Source Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/file-source-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/file-source-statistics-dashboard.png)               
...
- When the content of a file is generated as an output of the Siddhi application, the file is displayed in the **Destinations** section as shown in the example below.
  ...
  [![File Sink Statistics](../../assets/img/streaming/managing-wso2-dashboards/file-sink-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/file-sink-statistics.png)
 ...
 [![File Sink Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/file-sink-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/file-sink-statistics-dashboard.png)
...
[![RDBMS Statistics](../../assets/img/streaming/managing-wso2-dashboards/rdbms-statistics.png)](../../assets/img/streaming/managing-wso2-dashboards/rdbms-statistics.png)

To view detailed statistics of a specific database, click on that database.

[![Select RDBMS](../../assets/img/streaming/managing-wso2-dashboards/select-rdbms.png)](../../assets/img/streaming/managing-wso2-dashboards/select-rdbms.png)

The **RDBMS Statistics** dashboard opens with RDBMS statistics specific to the selected database.

[![Database Statistics](../../assets/img/streaming/managing-wso2-dashboards/database-statistics.jpg)](../../assets/img/streaming/managing-wso2-dashboards/database-statistics.jpg)

To view statistics relating to a specific table, click on the relevant table name in the **RDBMS Table** table.

[![Select RDBMS Table](../../assets/img/streaming/managing-wso2-dashboards/select-rdbms-table.png)](../../assets/img/streaming/managing-wso2-dashboards/select-rdbms-table.png)

The **RDBMS Table Statistics** dashboard opens with statistics specific to the selected table.

[![RDBMS Table Statistics](../../assets/img/streaming/managing-wso2-dashboards/rdbms-table-statistics.jpg)](../../assets/img/streaming/managing-wso2-dashboards/rdbms-table-statistics.jpg)
...
<!-- [![Kafka Sources Table](../../assets/img/streaming/managing-wso2-dashboards/kafka-sources-table.png)](../../assets/img/streaming/managing-wso2-dashboards/kafka-sources-table.png)

[![Kafka Sinks Table](../../assets/img/streaming/managing-wso2-dashboards/kafka-destinations-table.png)](../../assets/img/streaming/managing-wso2-dashboards/kafka-destinations-table.png) -->
...
<!-- [![Kafka Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/kafka-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/kafka-statistics-dashboard.png) -->
...
- The **Source** section shows the overall Kafka Source metrics such as total reads, input event rate etc. It also contains a table that lists all the streams that are associated with a Kafka source. If you click on a stream, it will take you to **WSO2 Streaming Integrator Kafka Source Statistics** dashboard.
      ...
      <!-- [![Kafka Source Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/kafka-source-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/kafka-source-statistics-dashboard.png) -->
...
- The **Sink** section shows the overall Kafka Sink metrics such as total writes, output event rate, etc. It also contains a table that lists all the streams that are associated with a Kafka source. If you click on a stream, it will take you to **WSO2 Streaming Integrator Kafka Sink Statistics** dashboard.
      ...
      <!-- [![Kafka Sink Statistics Dashboard](../../assets/img/streaming/managing-wso2-dashboards/kafka-sink-statistics-dashboard.png)](../../assets/img/streaming/managing-wso2-dashboards/kafka-sink-statistics-dashboard.png) -->
