...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/mi-analytics/using-the-analytics-dashboard/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/mi-analytics/using-the-analytics-dashboard.md
tags:
  - api-manager
  - mi-analytics
...
Let's **test this solution** by running the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service.md) tutorial. When the artifacts deployed in the Micro Integrator are invoked, the statistics will be available in the portal. 

Follow the steps given below.

??? note "Step 1: Deploy integration artifacts"
    
    If you have already started the Micro Integrator server, let's deploy the artifacts. Let's use the integration artifacts from the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service.md) tutorial.
...
??? note "Step 2: Start the backend"
    ...
    Let's start the hospital service that serves as the backend to the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service.md) use case: 
...
[![Opening the Analytics dashboard for the integration component](../assets/img/integrate/mi-analytics/119132315/mi-dashboard.png)](../assets/img/integrate/mi-analytics/119132315/mi-dashboard.png)
      
### Statistics overview

View the statistics overview for all the integration artifacts that have published statistics:  

[![ESB total request count](../assets/img/integrate/mi-analytics/119132315/119132316.png)](../assets/img/integrate/mi-analytics/119132315/119132316.png)

### Transactions per second

The number of transactions handled by the Micro Integrator per second is mapped on a graph as follows.

[![ESB overall TPS](../assets/img/integrate/mi-analytics/119132315/119132326.png)](../assets/img/integrate/mi-analytics/119132315/119132326.png)
...
[![ESB overall message count](../assets/img/integrate/mi-analytics/119132315/119132325.png)](../assets/img/integrate/mi-analytics/119132315/119132325.png)

### Top APIs by request

The `HealthcareAPI` REST API is displayed under **TOP APIS BY REQUEST COUNT** as follows.  

[![Top APIs by request count](../assets/img/integrate/mi-analytics/119132315/119132324.png)](../assets/img/integrate/mi-analytics/119132315/119132324.png)
...
[![Top endpoints by request count](../assets/img/integrate/mi-analytics/119132315/119132318.png)](../assets/img/integrate/mi-analytics/119132315/119132318.png)
...
-   The **API Request Count** gadget shows the total number of
    ...
    [![Total request per API](../assets/img/integrate/mi-analytics/119132315/119132323.png)](../assets/img/integrate/mi-analytics/119132315/119132323.png)
-   The **API** **Message Count** gadget maps the number of
    ...
    [![API message count](../assets/img/integrate/mi-analytics/119132315/119132322.png)](../assets/img/integrate/mi-analytics/119132315/119132322.png)
-   The **API** **Message Latency** gadget shows the speed with
    ...
    shown below.  
    [![API message latency](../assets/img/integrate/mi-analytics/119132315/119132321.png)](../assets/img/integrate/mi-analytics/119132315/119132321.png) 
-   The **Messages** gadget lists all the messages handled by
    ...
    [![Message per API](../assets/img/integrate/mi-analytics/119132315/119132320.png)](../assets/img/integrate/mi-analytics/119132315/119132320.png)
-   The **Message Flow** gadget illustrates the order in which the
    ...
    [![Message flow per API](../assets/img/integrate/mi-analytics/119132315/119132319.png)](../assets/img/integrate/mi-analytics/119132315/119132319.png)
...
![Dashboard navigation menu](../assets/img/integrate/mi-analytics/119132315/per-endpoint-requests.png "Dashboard navigation menu")

### Message tracing

When you go to the [Analytics Portal](#step-13-start-the-analytics-portal) the message details will be logged as follows:

![Message tracing per API](../assets/img/integrate/mi-analytics/119132315/message-tracing.png "Message tracing per API")