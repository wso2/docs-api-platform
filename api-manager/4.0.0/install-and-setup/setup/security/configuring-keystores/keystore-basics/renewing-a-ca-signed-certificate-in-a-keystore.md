...
description: "Renew a CA-signed certificate in a WSO2 API Manager keystore before it expires to prevent SSL handshake failures."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/renewing-a-ca-signed-certificate-in-a-keystore/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/renewing-a-ca-signed-certificate-in-a-keystore.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
For testing purposes you can go to <https://getacert.com/getacert.html> and submit your CSR to obtain a new CA-signed certificate for free.
