...
description: "Customize the WSO2 Secure Vault implementation by changing the default Secret Repository and Secret Callback Handler."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/security/logins-and-passwords/carbon-secure-vault-implementation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/security/logins-and-passwords/carbon-secure-vault-implementation.md
tags:
  - api-manager
  - install-and-setup
  - setup
