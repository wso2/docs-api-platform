...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/reference/default-product-ports/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/reference/default-product-ports.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
Listed below are the ports used by the API-M runtime when the [port offset](../deployment-best-practices/changing-the-default-ports-with-offset.md) is 0.
