---
title: "Observability overview: classic vs. cloud native deployment"
description: "Compares the Classic and Cloud Native observability deployments available for monitoring, debugging, and tracing Micro Integrator systems."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/mi-setup/observability/observability-with-grafana-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/mi-setup/observability/observability-with-grafana-overview.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
# Enhanced Observability Overview: Classic vs. Cloud Native Deployment
