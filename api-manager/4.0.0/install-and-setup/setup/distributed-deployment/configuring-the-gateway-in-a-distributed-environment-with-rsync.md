---
title: "Configuring the gateway in a distributed setup with rsync"
description: "Configure the API Gateway in a distributed environment using rsync as the content synchronization mechanism across manager and worker nodes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/distributed-deployment/configuring-the-gateway-in-a-distributed-environment-with-rsync/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/distributed-deployment/configuring-the-gateway-in-a-distributed-environment-with-rsync.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
??? Info "Click here for information on configuring the Gateway Worker"
    ...
    4.  Configure rsync. 
        For information on configuring rsync, see [Configuring rsync for Deployment Synchronization](../mi-setup/deployment/deployment_synchronization.md#using-remote-synchronization-rsync).
