...
description: "Add a new resource to a registry collection in WSO2 API Manager by uploading a file, URL, or custom content."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/adding-a-resource/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/adding-a-resource.md
tags:
  - api-manager
  - install-and-setup
  - setup
