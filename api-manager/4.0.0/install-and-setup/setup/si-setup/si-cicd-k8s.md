...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/si-setup/si-cicd-k8s/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/si-setup/si-cicd-k8s.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
This deployment can be scaled horizontally as an [Active-Active deployment](../si-deployment/deploying-si-as-an-active-active-deployment.md). 
You can find more deployment patterns [here](../si-deployment/deployment-guide.md).
