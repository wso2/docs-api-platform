...
description: "Reference performance test results for the Streaming Integrator consuming and publishing events using Kafka."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/si-setup/performance-analysis-results/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/setup/si-setup/performance-analysis-results.md
tags:
  - api-manager
  - install-and-setup
  - setup
