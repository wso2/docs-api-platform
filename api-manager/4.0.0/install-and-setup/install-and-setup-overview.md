...
To upgrade to the current API Manager component from a previous version, see [Upgrading WSO2 API Manager](upgrading-wso2-api-manager/upgrading-api-manager.md).
