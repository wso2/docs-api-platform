...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/install/admin-product-startup-options/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/install-and-setup/install/admin-product-startup-options.md
tags:
  - api-manager
  - install-and-setup
  - install
