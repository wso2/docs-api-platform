...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/streaming/getting-started/create-the-siddhi-application/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/streaming/getting-started/create-the-siddhi-application.md
tags:
  - api-manager
  - streaming
  - getting-started
