...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/streaming/getting-started/monitor-statistics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.0.0/streaming/getting-started/monitor-statistics.md
tags:
  - api-manager
  - streaming
  - getting-started
...
7. Scroll down further to the **Destinations** section. The `file` sink in the `SweetFactoryApp` Siddhi application is displayed.
...
!!! tip "What's Next?"
    - To learn more about the key concepts of the Streaming Integrator component, see [Streaming Integrator Key Concepts](../streaming-key-concepts.md).<br/>    
