---
title: "XFF header manipulation"
description: "Understand how Choreo Connect's Router manipulates the x-forwarded-for header depending on the use_remote_address configuration setting."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/xff-header/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/xff-header.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
[![xff-scenario-1](../../../assets/img/deploy/mgw/xff-scenario-1.png)](../../../assets/img/deploy/mgw/xff-scenario-1.png)
...
[![xff-scenario-2](../../../assets/img/deploy/mgw/xff-scenario-2.png)](../../../assets/img/deploy/mgw/xff-scenario-2.png)
...
[![xff-scenario-3](../../../assets/img/deploy/mgw/xff-scenario-3.png)](../../../assets/img/deploy/mgw/xff-scenario-3.png)
...
[![xff-scenario-4](../../../assets/img/deploy/mgw/xff-scenario-4.png)](../../../assets/img/deploy/mgw/xff-scenario-4.png)