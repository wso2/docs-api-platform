...
description: "Enable or disable passing the request payload to the Enforcer so custom filters can act on API call data."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/extensions/request-payload-passing/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/extensions/request-payload-passing.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
