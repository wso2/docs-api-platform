...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/enabling-cors/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/security/enabling-cors.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
If you are following the [Deploy API via API-M](../deploy-api/deploy-rest-api-in-choreo-connect) approach, you can add **CORS** configurations for each API using the [WSO2 API-M](../../../../design/advanced-topics/enabling-cors-for-apis#EnablingCORSPerAPI).
