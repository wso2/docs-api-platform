...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/support-custom-claims-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/support-custom-claims-mapping.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
