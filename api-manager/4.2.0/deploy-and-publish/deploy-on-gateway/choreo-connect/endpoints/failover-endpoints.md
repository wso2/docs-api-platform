...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/endpoints/failover-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/endpoints/failover-endpoints.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
1.  Click **Develop -> API Configurations -> Endpoints**.
    ...
    [![Add load balance endpoints in APIM](../../../../assets/img/learn/load-balance-and-fail-over.png)](../../../../assets/img/learn/load-balance-and-fail-over.png)

    [![Add failover endpoints addition in APIM](../../../../assets/img/learn/failover-configured.png)](../../../../assets/img/learn/load-balanced-configurations.png)
...
After obtaining a valid JWT token, you can invoke the API as described in [the Choreo Connect Quick Start Guide with Docker Compose](../getting-started/quick-start-guide-docker-with-apim#step-7-invoke-the-api-from-developer-portal). 
...
After defining an API in the OpenAPI definition file, deploy it in Choreo Connect as described in the [Choreo Connect Deployed on Docker Compose with WSO2 API Controller Guide](../getting-started/deploy/cc-as-a-standalone-gateway-on-docker#step-1-download-and-setup-the-choreo-connect-distribution-and-apictl).