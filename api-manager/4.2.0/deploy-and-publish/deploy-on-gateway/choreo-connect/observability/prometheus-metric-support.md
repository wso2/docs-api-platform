...
1. Download the dashboard json files from [here](../../../../assets/attachments/cc-grafana-dashboards/choreo-connect-grafana-dashboard-json.zip).
2. Import the dashboards to Grafana.
3. Change Prometheus job name and other dashboard variables as required.

    !!! note
        Image previews of the dashboards are available [here](../../../../assets/attachments/cc-grafana-dashboards/choreo-connect-grafana-dashboard-images.zip).
