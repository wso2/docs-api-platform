...
description: "Register Choreo Connect as a native service in a Consul service mesh so it can act as a zero-trust ingress gateway for microservices."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/service-discovery/choreo-connect-and-service-mesh/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/service-discovery/choreo-connect-and-service-mesh.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
