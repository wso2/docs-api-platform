...
description: "Reference all configuration parameters available for the Choreo Connect Adapter component in the config.toml file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configurations/adapter-configurations/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/deploy-and-publish/deploy-on-gateway/choreo-connect/configurations/adapter-configurations.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>The username of the Git repository. If this is set, then you need to also set the <code>accessToken</code>.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
