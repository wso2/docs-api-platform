...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/develop/streaming-apps/installing-siddhi-extensions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/develop/streaming-apps/installing-siddhi-extensions.md
tags:
  - api-manager
  - develop
  - streaming-apps
...
!!!Tip
    The Extension Installer can install/uninstall extensions within Streaming Integrator Tooling. When deploying Siddhi applications in Streaming Integrator Server, these have to be manually done. For more information, see [Downloading and Installing Siddhi Extensions](../../reference/streaming-connectors/downloading-and-installing-siddhi-extensions).
...
When you are working with [custom extensions](../../reference/streaming-connectors/writing-custom-siddhi-extensions), and if you want a custom extension to be installable from the Extension Installer, you need to add the configuration of the extension to this configuration file.
