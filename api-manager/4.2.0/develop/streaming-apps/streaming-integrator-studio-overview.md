...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/develop/streaming-apps/streaming-integrator-studio-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/develop/streaming-apps/streaming-integrator-studio-overview.md
tags:
  - api-manager
  - develop
  - streaming-apps
...
![File menu](../../assets/img/streaming/streaming-integrator-studio-overview/file-menu.png)

-   **New**
    Click this to open a new untitled Siddhi file. For more information, see the [Creating an ETL Application via SI Tooling tutorial](../../use-cases/streaming-tutorials/creating-etl-application-via-tooling).
...
![Edit menu](../../assets/img/streaming/streaming-integrator-studio-overview/editor-menu.png)
...
![Run menu](../../assets/img/streaming/streaming-integrator-studio-overview/run-menu-option.png)
...
![Tools menu](../../assets/img/streaming/streaming-integrator-studio-overview/tools-menu.png)
...
- **Event Simulator**
    ...
    For detailed information about event simulation, see [Simulating Events](testing-a-siddhi-application#simulating-events).
...
- **Error Store Explorer**
    ...
    To understand how to save messages with errors in the error store, see [Handling Errors](../../use-cases/streaming-usecase/handling-errors).

    To try out an error handling tutorial, see [Handling Requests with Errors](../../use-cases/streaming-tutorials/handling-requests-with-errors).
...
- **Sample Event Generator**
    ...
    ![Sample event generator](../../assets/img/streaming/streaming-integrator-studio-overview/sample-event-generator.png)
...
- **On-Demand Query**
    ...
    actions you can carry out for stores, see [Store APIs](store-apis).
...
Streaming Integrator servers. For more information, see [Deploying Siddhi Applications](deploying-streaming-applications).

![Deploy menu](../../assets/img/streaming/streaming-integrator-studio-overview/deploy-menu.png)
...
![Export menu](../../assets/img/streaming/streaming-integrator-studio-overview/export-menu.png)

- **For Docker**
    This opens the **Export Siddhi Apps for Docker image** wizard. For more information, see [Running the Streaming Integrator with Docker](../../use-cases/streaming-tutorials/running-si-with-docker-and-kubernetes#running-the-streaming-integrator-with-docker).

- **For Kubernetes**
    This opens the **Export Siddhi Apps For Kubernetes CRD** wizard. For more information, see [Running the Streaming Integrator with Kubernetes](../../use-cases/streaming-tutorials/running-si-with-docker-and-kubernetes#running-the-streaming-integrator-with-kubernetes).
...
![Event Simulator](../../assets/img/streaming/streaming-integrator-studio-overview/event-simulator.png)
...
![Output Console](../../assets/img/streaming/streaming-integrator-studio-overview/output-console.png)

This provides feedback on various user activities carried out on the Streaming Integrator.

### Operator Finder

![Operator Finder](../../assets/img/streaming/streaming-integrator-studio-overview/operator-finder.png)
...
-   For detailed instructions to find and use a Siddhi extension via the
    Operator Finder demonstrated with an example, see [Creating a Siddhi Application](creating-a-siddhi-application).
...
## Toolbar
  ...
  ![Tool Bar menu](../../assets/img/streaming/streaming-integrator-studio-overview/editor-toolbar.png)
