...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/develop/streaming-apps/http-status-codes/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/develop/streaming-apps/http-status-codes.md
tags:
  - api-manager
  - develop
  - streaming-apps
