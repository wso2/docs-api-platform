---
title: "Publish consumed events as Prometheus metrics"
...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-prometheus-metrics-http-server/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-prometheus-metrics-http-server.md
tags:
  - api-manager
  - use-cases
  - examples
