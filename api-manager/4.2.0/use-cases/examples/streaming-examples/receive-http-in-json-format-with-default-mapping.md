...
description: "Configure a Siddhi application that receives JSON events over HTTP transport using default mapping and logs them."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-http-in-json-format-with-default-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-http-in-json-format-with-default-mapping.md
tags:
  - api-manager
  - use-cases
  - examples
