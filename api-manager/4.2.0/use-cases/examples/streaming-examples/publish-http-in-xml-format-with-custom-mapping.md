---
title: "Publishing custom XML events via HTTP"
description: "Configure a Siddhi application to send sweet production events over HTTP in XML format using custom mapping."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-http-in-xml-format-with-custom-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-http-in-xml-format-with-custom-mapping.md
tags:
  - api-manager
  - use-cases
  - examples
