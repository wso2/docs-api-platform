...
description: "Configure a Siddhi application to send sweet production events over TCP transport in text format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-tcp-in-text-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-tcp-in-text-format.md
tags:
  - api-manager
  - use-cases
  - examples
