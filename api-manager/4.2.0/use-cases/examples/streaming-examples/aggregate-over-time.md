...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/aggregate-over-time/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/aggregate-over-time.md
tags:
  - api-manager
  - use-cases
  - examples
