---
title: "Making predictions via a streaming perceptron model"
description: "Configure a Siddhi application that trains a streaming Perceptron model to perform binary classification."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/streaming-perceptron-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/streaming-perceptron-sample.md
tags:
  - api-manager
  - use-cases
  - examples
