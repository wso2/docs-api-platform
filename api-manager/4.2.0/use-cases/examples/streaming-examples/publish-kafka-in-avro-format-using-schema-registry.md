...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-kafka-in-avro-format-using-schema-registry/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-kafka-in-avro-format-using-schema-registry.md
tags:
  - api-manager
  - use-cases
  - examples
