...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/amazon-s3-sink-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/amazon-s3-sink-sample.md
tags:
  - api-manager
  - use-cases
  - examples
