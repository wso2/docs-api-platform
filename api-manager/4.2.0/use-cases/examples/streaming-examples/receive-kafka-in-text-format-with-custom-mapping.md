...
description: "Configure a Siddhi application that receives text events from Kafka transport using custom mapping and logs them."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-kafka-in-text-format-with-custom-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-kafka-in-text-format-with-custom-mapping.md
tags:
  - api-manager
  - use-cases
  - examples
