...
description: "Configure a Siddhi application that performs CRUD operations on a Redis store using Siddhi queries."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/store-redis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/store-redis.md
tags:
  - api-manager
  - use-cases
  - examples
