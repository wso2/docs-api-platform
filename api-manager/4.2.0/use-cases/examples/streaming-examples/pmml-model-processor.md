...
description: "Configure a Siddhi application that uses a pretrained PMML model to predict raw materials needed from production events."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/pmml-model-processor/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/pmml-model-processor.md
tags:
  - api-manager
  - use-cases
  - examples
