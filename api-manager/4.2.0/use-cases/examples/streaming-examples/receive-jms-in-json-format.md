...
description: "Configure a Siddhi application that receives JSON events over JMS transport using default mapping and logs them."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-jms-in-json-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-jms-in-json-format.md
tags:
  - api-manager
  - use-cases
  - examples
