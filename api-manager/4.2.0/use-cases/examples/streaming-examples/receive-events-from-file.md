...
description: "Configure a Siddhi application that receives events from files placed in a directory using siddhi-io-file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-events-from-file/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-events-from-file.md
tags:
  - api-manager
  - use-cases
  - examples
