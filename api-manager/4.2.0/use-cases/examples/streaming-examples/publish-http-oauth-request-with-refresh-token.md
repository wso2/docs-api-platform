---
title: "Publish HTTP events using a refresh token grant"
...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-http-oauth-request-with-refresh-token/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-http-oauth-request-with-refresh-token.md
tags:
  - api-manager
  - use-cases
  - examples
