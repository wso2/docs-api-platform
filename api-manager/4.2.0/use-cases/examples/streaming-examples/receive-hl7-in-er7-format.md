...
description: "Configure a Siddhi application that receives HL7 events in ER7 format over the MLLP protocol and logs them to the console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-hl7-in-er7-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/receive-hl7-in-er7-format.md
tags:
  - api-manager
  - use-cases
  - examples
