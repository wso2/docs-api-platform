---
title: "Publishing XML events via MQTT"
description: "Configure a Siddhi application to send sweet production events over MQTT transport in XML format and view them on a consumer."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-mqtt-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/publish-mqtt-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
