...
description: "Configure a Siddhi application that uses the StreamingML kmeans incremental function to cluster production events."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/streaming-kmeans-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/streaming-kmeans-sample.md
tags:
  - api-manager
  - use-cases
  - examples
