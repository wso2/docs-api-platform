...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/text-mapping-with-in-memory-transport/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/examples/streaming-examples/text-mapping-with-in-memory-transport.md
tags:
  - api-manager
  - use-cases
  - examples
