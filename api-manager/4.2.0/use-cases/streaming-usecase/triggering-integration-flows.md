...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/streaming-usecase/triggering-integration-flows/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/use-cases/streaming-usecase/triggering-integration-flows.md
tags:
  - api-manager
  - use-cases
  - streaming-usecase
