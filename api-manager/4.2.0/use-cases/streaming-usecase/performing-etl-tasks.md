...
WSO2 Streaming Integrator provides the Source View, Design View and the Wizard View for application design. For more information, see [Streaming Integrator Tooling Overview](../../develop/streaming-apps/streaming-integrator-studio-overview).
...
- [Performance Analysis Results - Performing ETL Tasks](../../install-and-setup/setup/si-setup/performance-analysis-results)
