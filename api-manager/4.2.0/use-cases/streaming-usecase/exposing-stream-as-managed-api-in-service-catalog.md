...
For more information, see [Generating and Viewing AsyncAPI Definitions](../../develop/streaming-apps/working-with-the-async-api-view).
...
3. Click **Deploy**. 
     ...
     For detailed instructions, see [Deploying Siddhi Applications](../../develop/streaming-apps/deploying-streaming-applications).
