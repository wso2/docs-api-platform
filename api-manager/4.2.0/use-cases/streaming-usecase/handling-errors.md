...
3. [Create a Siddhi application](../../develop/streaming-apps/creating-a-siddhi-application) as follows and [deploy it in the Streaming Integrator server](../../develop/streaming-apps/deploying-streaming-applications).
