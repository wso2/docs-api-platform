...
description: "Explains how to apply WSO2 in-place updates or WSO2 Updates 2.0 to WSO2 API Manager, including profile re-optimization and data backup steps."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/updating-wso2-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/updating-wso2-api-manager.md
tags:
  - api-manager
  - administer
...
!!! warning "Re-optimization requirement for distributed deployments"
    ...
    **Important for profiled deployments**
...
!!! warning
    ...
    **Persisting WSO2CarbonDB**
    ...
    For more information on run time and configuration artifact directories of API Manager refer [Common Runtime and Configuration Artifacts](../install-and-setup/setup/reference/common-runtime-and-configuration-artifacts) .