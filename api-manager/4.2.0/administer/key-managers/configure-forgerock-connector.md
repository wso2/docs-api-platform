...
description: "Configure ForgeRock as a third-party key manager in WSO2 API Manager using the API-M ForgeRock connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-forgerock-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-forgerock-connector.md
tags:
  - api-manager
  - administer
  - key-managers
...
- Install ForgeRock.
- [Download and install WSO2 API Manager](../../install-and-setup/install/installing-the-product/installing-api-m-runtime).
...
5. Navigate to **Root Realm** -> **Services** add Oauth2 provider as a new service as follows,
    [![ForgeRock add OAuth Provider](../../assets/img/administer/forgerock-create-oauth-provider.png)](../../assets/img/administer/forgerock-create-oauth-provider.png)
