...
description: "Configure Auth0 as a third-party key manager in WSO2 API Manager, covering Auth0 application setup and Admin Portal registration."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-auth0-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-auth0-connector.md
tags:
  - api-manager
  - administer
  - key-managers
