...
description: "Configure Azure Active Directory as a third-party key manager in WSO2 API Manager using the API-M KM Azure AD connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-azure-ad-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-azure-ad-key-manager.md
tags:
  - api-manager
  - administer
  - key-managers
