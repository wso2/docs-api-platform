...
description: "Configure WSO2 Identity Server as a key manager component for WSO2 API Manager, including deployment.toml event listener settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-wso2is-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/key-managers/configure-wso2is-connector.md
tags:
  - api-manager
  - administer
  - key-managers
...
3. Download the [WSO2 IS Connector](../../assets/attachments/administer/wso2is-extensions-1.6.8.zip).
