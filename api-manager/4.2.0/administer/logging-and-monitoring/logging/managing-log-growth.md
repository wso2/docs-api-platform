...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/logging-and-monitoring/logging/managing-log-growth/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/logging-and-monitoring/logging/managing-log-growth.md
tags:
  - api-manager
  - administer
...
Log growth in [Carbon Logs](configuring-logging#configuring-carbon-logs) can be managed by following configurations in `<API-M_HOME>/repository/conf/log4j2.properties` file.
