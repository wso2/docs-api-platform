...
description: "Describes the JMX MBeans exposed by WSO2 API Manager for monitoring connections, latency, threading, and transports via JConsole."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/logging-and-monitoring/monitoring/jmx-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/administer/logging-and-monitoring/monitoring/jmx-monitoring.md
tags:
  - api-manager
  - administer
