...
description: "Deploy a Siddhi application to a Streaming Integrator server, export it as a Docker image, or deploy it in Kubernetes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/streaming/getting-started/deploy-siddhi-application/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/streaming/getting-started/deploy-siddhi-application.md
tags:
  - api-manager
  - streaming
  - getting-started
...
The `SweetFactoryApp` that you created in [Step 2: Create the Siddhi Application](create-the-siddhi-application) is now ready to be deployed in the Streaming Integrator server, exported as a Docker image, or deployed in Kubernetes.
...
2. Click **Export** in the top menu, and then click **For Docker**.
    ...
    ![Export as Docker/Kubernetes Menu](../../assets/img/streaming/exporting-siddhi-applications/export-docker-k8s-menu.png)

    As a result, **Step 1** of the **Export Siddhi Apps for Docker image** wizard opens as follows.
    
    ![Export as Docker dialog box](../../assets/img/streaming/quick-start-guide-101/export-as-docker-dialog-box.png)
...
4. In **Step 2**, you can template values of the Siddhi Application.
    ...
    ![Template Siddhi Apps dialog box](../../assets/img/streaming/quick-start-guide-101/template-siddhi-apps-dialog-box.png)
    
    Click **Next** without templating any value of the Siddhi application.

    !!!info
        For detailed information about templating the values of a Siddhi Application, see [Exporting Siddhi Apps for Docker Image](../../develop/streaming-apps/exporting-siddhi-applications#exporting-siddhi-applications-as-a-docker-image).
    
5. In **Step 3**, you can update configurations of the Streaming Integrator.
    
    ![Update Streaming Integrator Configurations dialog box](../../assets/img/streaming/quick-start-guide-101/update-streaming-integrator-configurations-dialog-box.png)
...
6. In **Step 4**, you can provide arguments for the values that were templated in **Step 2**.
    ...
    ![Populate Arguments Template dialog box](../../assets/img/streaming/quick-start-guide-101/populate-arguments-template-dialog-box.png)
...
7. In **Step 5**, you can choose additional dependencies to be bundled. This is applicable when Sources, Sinks and etc. with additional dependencies are used in the Siddhi Application (e.g., a Kafka Source/Sink, or a MongoDB Store).
    ...
    ![Bundle Additional Dependencies dialog box](../../assets/img/streaming/quick-start-guide-101/bundle-additional-dependencies-dialog-box.png)
...
!!! tip "What's Next?"
    Now you can run the `SweetFactoryApp` in the Streaming Integrator server. To do this, proceed to [Step 4: Running the Siddhi Application](test-siddhi-application)