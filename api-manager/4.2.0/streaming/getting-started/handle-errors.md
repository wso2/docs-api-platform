...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/streaming/getting-started/handle-errors/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/streaming/getting-started/handle-errors.md
tags:
  - api-manager
  - streaming
  - getting-started
...
!!!tip "What's Next?"
    To view the statistics generated by the `SweetFactoryApp` Siddhi application, proceed to [Step 8: Monitor Statistics](monitor-statistics).
