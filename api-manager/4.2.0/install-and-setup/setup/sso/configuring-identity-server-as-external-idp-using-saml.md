...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/sso/configuring-identity-server-as-external-idp-using-saml/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/sso/configuring-identity-server-as-external-idp-using-saml.md
tags:
  - api-manager
  - install-and-setup
  - setup
