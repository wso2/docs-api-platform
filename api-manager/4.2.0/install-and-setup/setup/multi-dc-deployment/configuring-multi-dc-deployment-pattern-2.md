---
title: "Configure Multi-DC pattern 2: centralized management"
description: "Configure Multi-DC deployment Pattern 2: centralized API management with a main region and regional data planes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/multi-dc-deployment/configuring-multi-dc-deployment-pattern-2/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/multi-dc-deployment/configuring-multi-dc-deployment-pattern-2.md
tags:
  - api-manager
  - install-and-setup
  - setup
