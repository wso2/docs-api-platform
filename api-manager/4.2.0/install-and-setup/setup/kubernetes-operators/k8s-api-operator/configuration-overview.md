...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/kubernetes-operators/k8s-api-operator/configuration-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/kubernetes-operators/k8s-api-operator/configuration-overview.md
tags:
  - api-manager
  - install-and-setup
  - setup
