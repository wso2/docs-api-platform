...
description: "Replace the default H2 database with IBM DB2 for WSO2 API Manager's user management and registry data."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/setting-up-databases/changing-default-databases/changing-to-ibm-db2/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/setting-up-databases/changing-default-databases/changing-to-ibm-db2.md
tags:
  - api-manager
  - install-and-setup
  - setup
