...
description: "Best practices for backing up API Manager databases and product instances, and recommended strategies for recovering a deployment after an outage."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/deployment-best-practices/backup-recovery/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/deployment-best-practices/backup-recovery.md
tags:
  - api-manager
  - install-and-setup
  - setup
