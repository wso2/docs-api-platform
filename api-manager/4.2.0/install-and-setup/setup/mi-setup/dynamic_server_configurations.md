...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/dynamic_server_configurations/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/dynamic_server_configurations.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
[TOML-based configuration file](../../../reference/config-catalog-mi) (`deployment.toml` file). To be able to dynamically inject values, define your server configurations as environment variables or system properties. You can then separately inject configuration values to each environment.
...
Read [Injecting Synapse Parameters](../../../integrate/develop/injecting-parameters) for details.