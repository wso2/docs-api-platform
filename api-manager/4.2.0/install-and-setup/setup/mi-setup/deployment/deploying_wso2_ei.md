...
Create a simple scheduled task using WSO2 Integration Studio and deploy it in the two Micro Integrator servers. See the instructions on [creating a scheduled task](../../../../integrate/develop/creating-artifacts/creating-scheduled-task).
