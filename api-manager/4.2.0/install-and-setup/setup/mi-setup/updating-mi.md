---
title: "Updating WSO2 Micro Integrator"
description: "Learn how to update WSO2 Micro Integrator using WSO2 Updates or WSO2 Updates 2.0 to apply the latest bug and security fixes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/updating-mi/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/updating-mi.md
tags:
  - api-manager
  - install-and-setup
  - setup
