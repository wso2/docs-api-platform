...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/brokers/configure-with-wso2-mb/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/brokers/configure-with-wso2-mb.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
|---------------------------------------------------------|---------------------------------------------------------|
| [Authentication](#authentication-plain-text) | Andes Authenticator connected entities to authenticate. |
