...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/brokers/configure-with-ibm-webspheremq/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/brokers/configure-with-ibm-webspheremq.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
6.  Click **Next** and then click **Finish** to save the configuration. The queue manager will be created as shown below.  
    ![Created Queue Manager](../../../../assets/img/integrate/broker-configs/ibm-websphere-mq/119130334.jpg)
...
2.  Go to IBM WebSphere MQ, and right-click on **JMS Administered
    ...
    ![JMS Administered Objects](../../../../assets/img/integrate/broker-configs/ibm-websphere-mq/119130339.jpg)
3.  Select the **File system** option in the **Connection Details**
    ...
    **Context nickname** field. Leave the default values unchanged for
    ...
    ![New File Initial Context](../../../../assets/img/integrate/broker-configs/ibm-websphere-mq/119130338.jpg)
...
![Command Prompt](../../../../assets/img/integrate/broker-configs/ibm-websphere-mq/119130336.jpg)
...
![Publish Message to Queue](../../../../assets/img/integrate/broker-configs/ibm-websphere-mq/119130337.jpg)
