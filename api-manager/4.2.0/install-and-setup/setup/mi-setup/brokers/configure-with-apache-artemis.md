---
title: "Connecting to apache artemis"
description: "Configure WSO2 Micro Integrator to send and receive messages by connecting its JMS transport to an Apache Artemis broker."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/brokers/configure-with-apache-artemis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/brokers/configure-with-apache-artemis.md
tags:
  - api-manager
  - install-and-setup
  - setup
