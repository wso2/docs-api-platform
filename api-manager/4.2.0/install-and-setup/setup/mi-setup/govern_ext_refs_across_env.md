...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/govern_ext_refs_across_env/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/govern_ext_refs_across_env.md
tags:
  - api-manager
  - install-and-setup
  - setup
