...
description: "Set up an IBM DB2 database and required schemas for cluster coordination, user stores, and transaction counts in Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/databases/setting-up-ibm-db2/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/databases/setting-up-ibm-db2.md
tags:
  - api-manager
  - install-and-setup
  - setup
