...
description: "Set up a MySQL database and required schemas for cluster coordination, user stores, and transaction counts in Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/databases/setting-up-mysql/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/databases/setting-up-mysql.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
<table>
	...
	<tr>
		...
		<td>This script creates the database tables that are required for storing the transaction counts. This is only required if you want to <a href='../../../../../install-and-setup/setup/deployment-best-practices/monitoring-transaction-counts/'>monitor transaction counts</a> in your deployment.</td>
	</tr>
</table>
