...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/performance_tuning/rabbitmq_transport_tuning/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/performance_tuning/rabbitmq_transport_tuning.md
tags:
  - api-manager
  - install-and-setup
  - setup
