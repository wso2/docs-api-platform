...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/performance_tuning/http_transport_tuning/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/performance_tuning/http_transport_tuning.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
```
See the [descriptions](../../../../reference/config-catalog-mi) of these parameters.

## Tuning blocking invocations

The [Callout mediator](../../../../reference/mediators/callout-mediator) as well
as the [Call mediator](../../../../reference/mediators/call-mediator) in blocking
...
See the [descriptions](../../../../reference/config-catalog-mi#http-transport) of these parameters.