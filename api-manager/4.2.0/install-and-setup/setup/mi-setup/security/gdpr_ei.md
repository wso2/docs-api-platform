...
and the [service-specific log file](../../../../integrate/develop/monitoring-service-level-logs)
...
3.  Update the `           config.json          ` file (stored in the
    ...
    log files (except any [service-specific log file](../../../../integrate/develop/monitoring-service-level-logs) in the system that store the above user information. If you have
    ...
    -   **"log-file-name-regex"** : This gives the list of log files
        ...
        files of the same logs. If you have enabled a [service-specific log file](../../../../integrate/develop/monitoring-service-level-logs), **be sure to add** the file name to this list.
