...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/message_builders_formatters/message-relay/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/mi-setup/message_builders_formatters/message-relay.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
Micro Integrator does not need to work on the full message but can work on [message properties](../../../../reference/mediators/property-mediator)
