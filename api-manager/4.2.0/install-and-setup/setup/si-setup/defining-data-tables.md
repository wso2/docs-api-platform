...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/si-setup/defining-data-tables/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/si-setup/defining-data-tables.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
-   **Store-backed tables** : These are tables that are defined by you
    ...
    [Defining Tables for External Data Stores](defining-tables-for-physical-stores) .      
