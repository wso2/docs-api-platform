...
description: "Configure the Streaming Integrator to receive and publish events over transports such as Kafka before use."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/si-setup/supporting-different-transports/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/si-setup/supporting-different-transports.md
tags:
  - api-manager
  - install-and-setup
  - setup
