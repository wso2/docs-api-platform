...
as the <a target="_blank" href="../../../../install-and-setup/setup/si-deployment/deploying-si-as-minimum-ha-cluster">Minimum High Available(HA) Deployment</a>
and <a target="_blank" href="../../../../install-and-setup/setup/si-deployment/deploying-si-as-a-scalable-cluster">Scalable High Available(HA) Deployment</a>
