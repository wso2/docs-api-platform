...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/si-setup/user-management-via-the-idp-client-interface/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/setup/si-setup/user-management-via-the-idp-client-interface.md
tags:
  - api-manager
  - install-and-setup
  - setup
