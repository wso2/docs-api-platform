...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installation-options/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installation-options.md
tags:
  - api-manager
  - install-and-setup
  - install
