...
description: "Configure and run WSO2 API Manager 3.2.0 Analytics as a Windows service after checking OS compatibility."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installing-the-product/installing-api-m-analytics-as-a-windows-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installing-the-product/installing-api-m-analytics-as-a-windows-service.md
tags:
  - api-manager
  - install-and-setup
  - install
