...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installing-the-product/installing-api-m-runtime/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installing-the-product/installing-api-m-runtime.md
tags:
  - api-manager
  - install-and-setup
  - install
...
-   [Running the API-M Runtime](running-the-api-m).
