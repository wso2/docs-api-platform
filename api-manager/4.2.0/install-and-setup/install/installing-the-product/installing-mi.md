...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installing-the-product/installing-mi/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/install-and-setup/install/installing-the-product/installing-mi.md
tags:
  - api-manager
  - install-and-setup
  - install
...
-   [Running the MI Runtime](running-the-mi).
