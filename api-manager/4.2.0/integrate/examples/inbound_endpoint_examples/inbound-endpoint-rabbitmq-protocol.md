...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-rabbitmq-protocol/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/inbound_endpoint_examples/inbound-endpoint-rabbitmq-protocol.md
tags:
  - api-manager
  - integrate
  - examples
...
[Configure the RabbitMQ broker](../../../install-and-setup/setup/mi-setup/brokers/configure-with-rabbitmq).
