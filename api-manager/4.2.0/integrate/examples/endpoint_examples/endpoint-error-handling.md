...
is to send the message to a service provider (see also [Working with Mediators](../../../reference/mediators/about-mediators))
by sending the message to a listening service
[endpoint](../../../reference/synapse-properties/endpoint-properties). During this process, transport
...
In this example, the timeout value is defined using a [Property mediator](../../../reference/mediators/property-mediator) outside
