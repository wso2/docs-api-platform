...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/file-processing/mailto-transport-examples/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/file-processing/mailto-transport-examples.md
tags:
  - api-manager
  - integrate
  - examples
...
2. Open the `deployment.toml` file from the `MI_TOOLING_HOME/Contents/Eclipse/runtime/microesb/conf` directory, and [enable the MailTo transport sender](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports#configuring-the-mailto-transport).
...
When the [MailTo transport listener is enabled](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports#configuring-the-mailto-transport) for the Micro Integrator, you can configure your mediation sequences to send emails.
