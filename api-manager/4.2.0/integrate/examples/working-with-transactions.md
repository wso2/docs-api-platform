...
-   Windows, Linux or Solaris operating systems with WSO2 MI
    ...
    see [Installation Guide](../../install-and-setup/install/installing-the-product/installing-mi) .
...
-   Windows, Linux or Solaris operating systems with WSO2 MI
    installed. For instructions on downloading and installing WSO2 MI,
    see [Installation
    Guide](../../install-and-setup/install/installing-the-product/installing-mi) .
-   WSO2 MI JMS transport configured with ActiveMQ. For instructions,
    see [Configure with
