...
description: "Expose a SOAP backend service as a RESTful API by transforming REST requests into SOAP calls."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/rest_api_examples/enabling-rest-to-soap/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/rest_api_examples/enabling-rest-to-soap.md
tags:
  - api-manager
  - integrate
  - examples
