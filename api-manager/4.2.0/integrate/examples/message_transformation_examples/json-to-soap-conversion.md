...
Let's convert JSON messages to SOAP using the [PayloadFactory mediator](../../../reference/mediators/payloadfactory-mediator).
...
Let's convert JSON messages to SOAP using the [XSLT mediator](../../../reference/mediators/xslt-mediator). The XSLT, which specifies the message conversion parameters, is stored in the product registry as a **local entry**.
