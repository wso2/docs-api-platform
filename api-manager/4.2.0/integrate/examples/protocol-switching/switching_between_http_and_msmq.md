...
description: "Configure proxy services that switch messages between the HTTP and MSMQ transports during mediation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/protocol-switching/switching_between_http_and_msmq/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/protocol-switching/switching_between_http_and_msmq.md
tags:
  - api-manager
  - integrate
  - examples
