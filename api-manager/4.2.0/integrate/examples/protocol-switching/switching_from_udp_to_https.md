...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/protocol-switching/switching_from_udp_to_https/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/examples/protocol-switching/switching_from_udp_to_https.md
tags:
  - api-manager
  - integrate
  - examples
...
[Enable the UDP transport](../../../install-and-setup/setup/mi-setup/transport_configurations/configuring-transports#configuring-the-udp-transport) and start the Micro-Integrator.
