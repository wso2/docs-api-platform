...
3.  Specify values for the [required parameter](../../../reference/synapse-properties/scheduled-task-properties) for the scheduled task.
...
-   See the tutorial on [periodically executing an integration process](../../../tutorials/integration-tutorials/using-scheduled-tasks) using a scheduled task