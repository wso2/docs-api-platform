...
You will now see the mediation logic generated from the WSDL as shown below. Note that the [Switch mediator](../../../reference/mediators/switch-mediator) is added to the mediation logic and that the different operations given in the WSDL are represented as switch cases.
...
See the following links for the list of transport parameters you can use:
  ...
  - [VFS Parameters](../../../reference/synapse-properties/transport-parameters/vfs-transport-parameters)
  - [JMS Parameters](../../../reference/synapse-properties/transport-parameters/jms-transport-parameters)
  - [FIX Parameters](../../../reference/synapse-properties/transport-parameters/fix-transport-parameters)
  - [MailTo Parameters](../../../reference/synapse-properties/transport-parameters/mailto-transport-parameters)
  - [MQTT Parameters](../../../reference/synapse-properties/transport-parameters/mqtt-transport-parameters)
  - [RabbitMQ Parameters](../../../reference/synapse-properties/transport-parameters/rabbitmq-transport-parameters)

3.  See the complete list of [service-level properties and parameters](../../../reference/synapse-properties/proxy-service-properties) that you can configure.
