...
1. [Create and API ](../../design/create-api/create-an-api-using-a-service) using the integration service.
2. [Deploy the API](../../deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api) in the API Gateway.
3. [Publish the API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api) to the Developer Portal.