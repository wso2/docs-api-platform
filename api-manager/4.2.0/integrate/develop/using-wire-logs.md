...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/develop/using-wire-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/develop/using-wire-logs.md
tags:
  - api-manager
  - integrate
  - develop
...
See [Configuring Logs](../../observe/micro-integrator/classic-observability-logs/configuring-log4j2-properties#wire-logs-and-header-logs) for instructions.
