...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/develop/importing-artifacts/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/develop/importing-artifacts.md
tags:
  - api-manager
  - integrate
  - develop
...
1.  [Create an ESB project](create-integration-project).
