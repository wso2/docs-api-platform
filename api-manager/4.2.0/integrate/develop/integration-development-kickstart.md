...
We are going to use the same use case we considered in the [Quick Start Guide](../../get-started/integration-quick-start-guide). 
...
Once you have deployed the artifacts and started the Micro Integrator server, you can [install](../../install-and-setup/install/installing-the-product/installing-mi-dashboard) and [start the <b>Dashboard</b>](../../install-and-setup/install/installing-the-product/running-the-mi-dashboard) to observe details of the deployed artifacts.
