...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/develop/monitoring-service-level-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/develop/monitoring-service-level-logs.md
tags:
  - api-manager
  - integrate
  - develop
...
See the instructions on [updating the log level](../../observe/micro-integrator/classic-observability-logs/configuring-log4j2-properties#updating-the-log4j2-log-level).