...
description: "Learn how the Micro Integrator switches messages between protocols and find related protocol-switching examples."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/integration-use-case/protocol-switching-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/integration-use-case/protocol-switching-overview.md
tags:
  - api-manager
  - integrate
