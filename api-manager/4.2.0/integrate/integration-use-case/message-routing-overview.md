...
<table>
	<tr>
		...
		<td>
			...
			<ul>
				<li>
					<a href="../../../integrate/examples/message-routing/header-based-routing">Routing based on message header</a>
				</li>
				<li>
					<a href="../../../integrate/examples/message-routing/payload-based-routing">Routing based on message payload</a>
				</li>
				<li>
					<a href="../../../integrate/examples/message-routing/split-and-aggregate-responses">Splitting and aggregating response messages</a>
				</li>
			</ul>
		</td>
	-->
...
<table>
	<tr>
		...
		<td>
			...
			<ul>
				<li>
					<a href="../../../integrate/examples/message-transformations/soap-to-json-conversion">Converting SOAP Messages to JSON</a>
				</li>
				<li>
					<a href="../../../integrate/examples/message-transformations/pox-to-json-conversion">Converting POX Messages to JSON</a>
				</li>
				<li>
					<a href="../../../integrate/examples/message-transformations/json-to-soap-conversion">Converting JSON Messages to SOAP</a>
				</li>
				<li>
					<a href="../../../integrate/examples/message-transformations/csv-to-other-formats-conversion">Converting CSV Messages to Other Formats</a>
				</li>
				<li>
					<a href="../../../integrate/examples/message-transformations/csv-conversion">Converting to CSV Message Formats</a>
				</li>
			</ul>
		</td>
	-->
