...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/integration-use-case/scheduled-task-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/integrate/integration-use-case/scheduled-task-overview.md
tags:
  - api-manager
  - integrate
...
<table>
	<tr>
		<td>
			...
			<ul>
				<li>
					<a href="../../../integrate/examples/scheduled-tasks/task-scheduling-simple-trigger">Task Scheduling using a Simple Trigger</a>
				</li>
				<li>
					<a href="../../../integrate/examples/scheduled-tasks/injecting-messages-to-rest-endpoint">Injecting Message to a RESTful Endpoint</a>
				</li>
			</ul>
		</td>
	</tr>
