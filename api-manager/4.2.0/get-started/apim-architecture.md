...
For more information, see [Working with Throttling](../design/rate-limiting/introducing-throttling-use-cases).
...
The WSO2 API Manager and the Micro Integrator are coupled with [WSO2 Integration Studio](../integrate/develop/wso2-integration-studio); a comprehensive graphical integration flow designer for building integrations using a simple drag-and-drop functionality.
