...
4. (Optional) Start the Dashboard.
    ...
    1.  [Install](../install-and-setup/install/installing-the-product/installing-mi-dashboard) the MI dashboard.
    2.  [Start](../install-and-setup/install/installing-the-product/running-the-mi-dashboard) the MI dashboard.
