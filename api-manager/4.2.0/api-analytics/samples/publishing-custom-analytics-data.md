---
title: "Publish custom analytics events data"
...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/api-analytics/samples/publishing-custom-analytics-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/api-analytics/samples/publishing-custom-analytics-data.md
tags:
  - api-manager
  - api-analytics
  - samples
...
3. Enabling Logs
    ...
    To [enable trace logs](../../administer/logging-and-monitoring/logging/configuring-logging#enabling-logs-for-a-component) for the component: `org.wso2.am.analytics.publisher`, edit `log4j2.properties` file located inside `wso2am-4.2.0/repository/conf` directory. 
