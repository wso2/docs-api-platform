...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/api-analytics/samples/publishing-analytics-events-to-external-systems/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/api-analytics/samples/publishing-analytics-events-to-external-systems.md
tags:
  - api-manager
  - api-analytics
  - samples
