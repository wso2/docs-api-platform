...
description: "Invite users to a Choreo organization and assign Admin or Developer groups to control access to API Analytics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/api-analytics/choreo-analytics/role-based-access-control/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/api-analytics/choreo-analytics/role-based-access-control.md
tags:
  - api-manager
  - api-analytics
  - choreo-analytics
