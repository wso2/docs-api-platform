...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/publish/api-microgateway/quick-start-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/publish/api-microgateway/quick-start-guide.md
tags:
  - api-manager
  - publish
  - api-microgateway
