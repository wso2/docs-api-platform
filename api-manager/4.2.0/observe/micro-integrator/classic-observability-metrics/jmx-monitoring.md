...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/micro-integrator/classic-observability-metrics/jmx-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/micro-integrator/classic-observability-metrics/jmx-monitoring.md
tags:
  - api-manager
  - observe
  - micro-integrator
