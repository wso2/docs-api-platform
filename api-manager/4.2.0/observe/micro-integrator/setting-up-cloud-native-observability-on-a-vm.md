...
In a [clustered deployment](../../install-and-setup/setup/mi-setup/deployment/deploying_wso2_ei), you can add the IP address and the port of each server in the respective `prometheus.yml` file.
