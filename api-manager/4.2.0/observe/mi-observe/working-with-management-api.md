...
!!! Tip
    See [Securing the Management API](../../install-and-setup/setup/mi-setup/security/securing_management_api) for information on configuring **users**, **JWT authentication**, and other security options for the management API.
...
-	**Resource**: `/users`
	...
	**Description**: Retrieves a list of all users stored in an [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore).
...
-	**Resource**: `/users/{user_id}`
	...
	**Description**: Retrieves information related to a specified user stored in the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore).
...
-	**Resource**: `/users/pattern=”*”&role=admin`
	...
	**Description**: Retrieves information related to user names (stored in an [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore) that match a specific pattern and user role.
...
-	**Resource**: `/users`
	...
	**Description**: Adds a user to the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore). Note that only admin users can create other users with admin access.
...
-	**Resource**: `/users`
	...
	**Description**: Removes a user from the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore). Note that only admin users can remove other users with admin access.
...
-	**Resource**: `/roles`
	...
	**Description**: Retrieves a list of all roles stored in an [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore).
...
-	**Resource**: `/roles/{role_name}`
	...
	**Description**: Retrieves information related to a specified role stored in the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore).
...
-	**Resource**: `/roles`
	...
	**Description**: Adds a role to the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore).
...
-	**Resource**: `/users`
	...
	**Description**: Removes a role from the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore). 
...
-	**Resource**: `/roles`
	...
	**Description**: Assign/remove set of roles to/from a given user in the [external user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore). 
