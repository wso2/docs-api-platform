...
description: "Start the TCPMon utility from the Micro Integrator distribution on Windows, Linux, macOS, or CentOS."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/mi-observe/tcp/starting_tcp_mon/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/mi-observe/tcp/starting_tcp_mon.md
tags:
  - api-manager
  - observe
  - mi-observe
