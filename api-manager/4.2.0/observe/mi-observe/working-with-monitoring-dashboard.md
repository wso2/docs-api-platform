...
!!! tip
    ...
    ![search in monitoring dashboard](../../assets/img/integrate/monitoring-dashboard/search.png)    
...
-   <b>Manage users</b>
    ...
    This page can be accessed by users with admin rights only. You can view details of users stored in the [external user store](../../install-and-setup/setup/mi-setup/user_stores/managing_users). You can also add new users to the specified cluster/group.
...
-   [Install the Micro Integrator](../../install-and-setup/install/installing-the-product/installing-mi).
-   [Install the Micro Integrator Dashboard](../../install-and-setup/install/installing-the-product/installing-mi-dashboard).
...
2.  **Optionally**, configure the [Micro Integrator user store](../../install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore).
