...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/api-manager-analytics/general-data-protection-regulation-gdpr-for-wso2-api-manager-analytics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/api-manager-analytics/general-data-protection-regulation-gdpr-for-wso2-api-manager-analytics.md
tags:
  - api-manager
  - observe
...
For information on changing these configurations, see [Configuring the config.json file](../../install-and-setup/setup/security/general-data-protection-regulation-gdpr-for-wso2-api-manager#step-2-change-the-default-configurations-of-the-tool) in the Product Administration Guide.
