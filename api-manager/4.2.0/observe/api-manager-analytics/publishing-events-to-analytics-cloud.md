...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/api-manager-analytics/publishing-events-to-analytics-cloud/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/observe/api-manager-analytics/publishing-events-to-analytics-cloud.md
tags:
  - api-manager
  - observe
