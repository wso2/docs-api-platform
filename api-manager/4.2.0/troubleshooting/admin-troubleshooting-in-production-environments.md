...
description: "Diagnose production issues in API Manager by analyzing thread dumps and stack traces, and checking cluster health."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/troubleshooting/admin-troubleshooting-in-production-environments/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/troubleshooting/admin-troubleshooting-in-production-environments.md
tags:
  - api-manager
  - troubleshooting
