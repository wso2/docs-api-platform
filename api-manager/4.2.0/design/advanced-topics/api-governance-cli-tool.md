...
description: "Download and configure the API Governance CLI tool to validate APIs against custom rules and generate a violation report."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/advanced-topics/api-governance-cli-tool/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/advanced-topics/api-governance-cli-tool.md
tags:
  - api-manager
  - design
  - advanced-topics
...
You can download the tool for apim 4.2.0 from [here](../../assets/attachments/governance/governance.cli.4.2.0.zip).
