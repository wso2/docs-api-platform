...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/endpoints/high-availability-for-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/endpoints/high-availability-for-endpoints.md
tags:
  - api-manager
  - design
  - endpoints
...
1. When you [create an API](../create-api/create-rest-api/create-a-rest-api), to configure load balancing endpoints go to the edit view of the API, click **Endpoint** to view the Endpoint page.
...
1. When you [create an API](../create-api/create-rest-api/create-a-rest-api), to configure failover endpoints go to the edit view of the API, click **Endpoint** to view the Endpoint page.
