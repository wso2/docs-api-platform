...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/rate-limiting/adding-new-throttling-policies/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/rate-limiting/adding-new-throttling-policies.md
tags:
  - api-manager
  - design
  - rate-limiting
...
4.  Fill in the details required by this form and click **Save** once you are done.
    ...
    !!! note
     ...
     | GraphQL                         | Provide the [maximum complexity](graphql-api/query-complexity-limitation) and [maximum depth values](graphql-api/query-depth-limitation) for GraphQL APIs using this policy.|
