...
description: "Define custom rate limiting policies using Siddhi queries and key templates applied globally across all tenants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/rate-limiting/advanced-topics/custom-throttling/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/rate-limiting/advanced-topics/custom-throttling.md
tags:
  - api-manager
  - design
  - rate-limiting
