...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/rate-limiting/setting-maximum-backend-throughput-limits/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/rate-limiting/setting-maximum-backend-throughput-limits.md
tags:
  - api-manager
  - design
  - rate-limiting
