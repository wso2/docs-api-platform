...
[![Add common policy](../../../assets/img/design/api-policies/common-policy-1.png){: style="width:90%"}](../../../assets/img/design/api-policies/common-policy-1.png)

**Button to add a API specific policy**

[![Add common policy](../../../assets/img/design/api-policies/specific-policy-1.png){: style="width:90%"}](../../../assets/img/design/api-policies/specific-policy-1.png)
...
[![Custom call interceptor](../../../assets/img/design/api-policies/custom-call.png){: style="width:90%"}](../../../assets/img/design/api-policies/custom-call.png)
