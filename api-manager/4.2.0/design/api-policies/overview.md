...
description: "Understand how API policies enforce request, response, and fault flow logic at the Gateway, and how the Regular Gateway and Choreo Connect differ."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-policies/overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-policies/overview.md
tags:
  - api-manager
  - design
  - api-policies
