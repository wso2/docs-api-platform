...
3. Navigate to the Policies tab. Click on the `Add New Policy` button in order to create an API specific policy. Then you will be prompted to enter the policy    details. Fill the form uploading the above created policy definition file and save.
    ...
    [![Create Dynamic Endpoints Policy](../../../assets/img/learn/api-gateway/message-mediation/create-dynamic-endpoint-policy.png)](../../../assets/img/learn/api-gateway/message-mediation/create-dynamic-endpoint-policy.png)
...
4. You should be able to see the created policy under the Request tab of the Policy List. Drag the policy and drop it to the `Request Flow` dropzone. 
    ...
    [![Attach Dynamic Endpoints Policy](../../../assets/img/learn/api-gateway/message-mediation/attach-dynamic-endpoint-policy.png)](../../../assets/img/learn/api-gateway/message-mediation/attach-dynamic-endpoint-policy.png)
...
1. Set the Endpoint type to 'Dynamic Endpoints' from the Endpoints page and Save the API.
    [![Dynamic Endpoints](../../../assets/img/learn/api-gateway/message-mediation/dynamic-endpoints-ws.png
    )](../../../assets/img/learn/api-gateway/message-mediation/dynamic-endpoints-ws.png)
...
3. Navigate to the Policies tab. Click on the `Add New Policy` button in order to create an API specific policy. Then you will be prompted to enter the policy details. Fill the form uploading the above created policy definition file and click on Save.
    ...
    [![Create Dynamic Endpoints Policy](../../../assets/img/learn/api-gateway/message-mediation/create-dynamic-endpoint-policy-ws.png)](../../../assets/img/learn/api-gateway/message-mediation/create-dynamic-endpoint-policy-ws.png)
...
4. You should be able to see the created policy under the 'Inbound Handshake' tab of the Policy List. Drag the policy and drop it to the `Inbound Flow` dropzone. 
    ...
    [![Attach Dynamic Endpoints Policy](../../../assets/img/learn/api-gateway/message-mediation/attach-dynamic-endpoint-policy-ws.png)](../../../assets/img/learn/api-gateway/message-mediation/attach-dynamic-endpoint-policy-ws.png)
...
[![Websocket URL Mapping](../../../assets/img/learn/api-gateway/message-mediation/websocket-url-mapping.png
)](../../../assets/img/learn/api-gateway/message-mediation/websocket-url-mapping.png)
