---
title: "API revisions"
description: "Create, deploy, and restore API revisions to decouple publishing from Gateway deployment and safely roll back changes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/create-api/create-api-revisions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/create-api/create-api-revisions.md
tags:
  - api-manager
  - design
  - create-api
...
[Publishing](../../deploy-and-publish/publish-on-dev-portal/publish-an-api) displays the 
API in the Developer Portal, and [deployment](../../deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api) 
...
--8<-- "api-manager/4.2.0/includes/design/deploy-revision.md"
