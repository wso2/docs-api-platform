...
description: "Expose an existing SOAP or WSDL-based service as a REST API in the Publisher using the Pass Through option."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/create-api/create-rest-api/expose-a-soap-service-as-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/create-api/create-rest-api/expose-a-soap-service-as-a-rest-api.md
tags:
  - api-manager
  - design
  - create-api
...
For more information on API publishing, see [Publish API](../../../deploy-and-publish/publish-on-dev-portal/publish-an-api).
