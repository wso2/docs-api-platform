...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/create-api-product/api-product-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/create-api-product/api-product-overview.md
tags:
  - api-manager
  - design
  - create-api-product
