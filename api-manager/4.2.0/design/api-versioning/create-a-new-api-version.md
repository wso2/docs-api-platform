...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-versioning/create-a-new-api-version/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-versioning/create-a-new-api-version.md
tags:
  - api-manager
  - design
  - api-versioning
...
!!! note
    ...
    [Create a REST API](../create-api/create-rest-api/create-a-rest-api) section and Published in the [Publish an API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api) section.
...
1.  Sign in to the WSO2 API Publisher.
     ...
     Create and publish an API. For more information, see [Create a REST API](../create-api/create-rest-api/create-a-rest-api) and [Publish an API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api).
