...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-versioning/deprecate-the-old-version/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-versioning/deprecate-the-old-version.md
tags:
  - api-manager
  - design
  - api-versioning
...
2.  Click on the API that you created in the [previous tutorial](create-a-new-api-version) (e.g., `PizzaShackAPI 2.0.0`).
