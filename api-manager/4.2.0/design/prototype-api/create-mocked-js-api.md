...
description: "Create a prototype API with a JavaScript mock implementation auto-generated from the OpenAPI specification via the API Gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/prototype-api/create-mocked-js-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/prototype-api/create-mocked-js-api.md
tags:
  - api-manager
  - design
  - prototype-api
...
!!! note
    This is not supported when [Choreo Connect](../../deploy-and-publish/deploy-on-gateway/choreo-connect/getting-started/choreo-connect-overview) is used as the Gateway.
...
-   [Custom Properties](../create-api/adding-custom-properties-to-apis)