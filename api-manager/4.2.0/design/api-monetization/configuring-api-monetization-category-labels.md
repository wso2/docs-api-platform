...
description: "Configure Admin Console properties to display Free, Paid, or Freemium monetization category labels for APIs in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-monetization/configuring-api-monetization-category-labels/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-monetization/configuring-api-monetization-category-labels.md
tags:
  - api-manager
  - design
  - api-monetization
...
For more information on Monetization of APIs, see [Enabling Monetization of APIs-](monetizing-an-api#monetize-an-api) .