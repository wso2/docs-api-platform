...
description: "Understand how WSO2 API Manager persists JWT and opaque OAuth2 tokens, and the synchronous and asynchronous persistence approaches available."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-security/oauth2/token-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-security/oauth2/token-persistence.md
tags:
  - api-manager
  - design
  - api-security
