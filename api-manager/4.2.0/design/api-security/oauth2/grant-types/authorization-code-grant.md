...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-security/oauth2/grant-types/authorization-code-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/design/api-security/oauth2/grant-types/authorization-code-grant.md
tags:
  - api-manager
  - design
  - api-security
