...
description: "Test a SOAP-backed API in WSO2 API Manager using SOAP UI, including generating an access token and setting the authorization header."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/consume/invoke-apis/invoke-apis-using-tools/invoke-an-api-using-a-soap-client/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/consume/invoke-apis/invoke-apis-using-tools/invoke-an-api-using-a-soap-client.md
tags:
  - api-manager
  - consume
  - invoke-apis
...
2.  The API's **Overview** page opens. Select an application (e.g., `DefaultApplication` ), with an available tier and subscribe to the API.
    ...
    [![Subscribe to Phone Verification API](../../../assets/img/learn/subscribe-phone-verification.png)](../../../assets/img/learn/subscribe-phone-verification.png)
...
3.  Click the **Applications** menu, open the default application using which you subscribed to the API, and navigate to **OAuth2 Tokens** under **Production Keys**.
    ...
    [![oauth2 phone verification](../../../assets/img/learn/oauth2-phone-verification.png)](../../../assets/img/learn/oauth2-phone-verification.png)
    
4.  Scroll down and generate a production key

    [![Generate Phone Verification OAuth Key](../../../assets/img/learn/generate-keys-phone-verification.png)](../../../assets/img/learn/generate-keys-phone-verification.png)
...
7.  In the SOAP UI, right click on the **Projects** menu and create a new SOAP project.
    ...
    [![Create new SOAP UI Project](../../../assets/attachments/103332601/soap-ui-new-project.png)](../../../assets/attachments/103332601/soap-ui-new-project.png)
...
8.  Give your API's WSDL and click **OK**.
    ...
    [![SOAP UI New Project Window](../../../assets/attachments/103332601/soap-ui-project-wizard.png)](../../../assets/attachments/103332601/soap-ui-project-wizard.png)
...
9.  The WSDL defines two operations. Let's work with `CheckPhoneNumber`. Double click on `Request 1`. Then, click the **Header** tab and add an authorization header to your request by clicking on the add icon.
    ...
    [![Set Authorization Header](../../../assets/attachments/103332601/soap-ui-set-header.png)](../../../assets/attachments/103332601/soap-ui-set-header.png)

10.  Give the value of the Authorization header in the following format: `Bearer <the-access-token-you-copied-in-step4>`
    
    [![Set Bearer token](../../../assets/attachments/103332601/soap-ui-set-token.png)](../../../assets/attachments/103332601/soap-ui-set-token.png)
...
11. Add the following dummy values and submit the request.
    ...
    2.  In the SOAP request, change the parameters, which are PhoneNumber and LicenseKey.
        ...
        [![Set The Correct URL](../../../assets/attachments/103332601/soap-ui-set-path.png)](../../../assets/attachments/103332601/soap-ui-set-path.png)
    ...
    [![Make Dummy SOAP Request](../../../assets/attachments/103332601/soap-ui-dummy-request.png)](../../../assets/attachments/103332601/soap-ui-dummy-request.png)
...
12. Add the following values and submit the request:
    ...
    [![Make Valid SOAP Request](../../../assets/attachments/103332601/soap-ui-valid-request.png)](../../../assets/attachments/103332601/soap-ui-valid-request.png)
