...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/consume/manage-application/generate-keys/revoke-oauth2-application/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/consume/manage-application/generate-keys/revoke-oauth2-application.md
tags:
  - api-manager
  - consume
  - manage-application
