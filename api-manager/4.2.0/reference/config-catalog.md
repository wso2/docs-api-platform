...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/config-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/config-catalog.md
tags:
  - api-manager
  - reference
  - config-catalog
                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <p>
                                configuration used to enable or disable proxy configurations. Note that targetProxyHosts configuration is only available from U2 update level 195 onwards.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
