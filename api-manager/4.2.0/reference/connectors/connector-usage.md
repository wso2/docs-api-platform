...
2. [Create an Integration Project](../../integrate/develop/create-integration-project).
...
SaaS connectors use HTTP/HTTPS protocol to communicate. They use the WSO2 mediation engine itself. Hence [HTTP protocol related tunings](../../install-and-setup/setup/mi-setup/performance_tuning/http_transport_tuning) are applied. 
