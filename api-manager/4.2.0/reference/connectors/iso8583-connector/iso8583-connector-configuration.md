...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/iso8583-connector/iso8583-connector-configuration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/iso8583-connector/iso8583-connector-configuration.md
tags:
  - api-manager
  - reference
  - connectors
...
Now you have connected to the test server. For more information, see [ISO8583 Connector Example](iso8583-connector-example).