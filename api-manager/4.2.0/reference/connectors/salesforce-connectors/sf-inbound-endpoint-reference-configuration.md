...
description: "Reference for the configuration parameters used to set up the Salesforce inbound endpoint for streaming data."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/sf-inbound-endpoint-reference-configuration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/sf-inbound-endpoint-reference-configuration.md
tags:
  - api-manager
  - reference
  - connectors
