---
title: "SalesforceBulkV2 connector reference"
description: "Reference for the connection configuration and operations of the Salesforce Bulk V2 connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/salesforcebulk-v2-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/salesforcebulk-v2-reference.md
tags:
  - api-manager
  - reference
  - connectors
