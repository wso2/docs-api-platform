...
description: "Reference for the initialization and operation parameters of the SalesforceBulk connector for Salesforce."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/salesforcebulk-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/salesforcebulk-reference.md
tags:
  - api-manager
  - reference
  - connectors
