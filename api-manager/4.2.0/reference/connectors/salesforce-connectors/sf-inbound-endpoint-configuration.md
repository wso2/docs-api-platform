---
title: "Setting up the PushTopic in salesforce"
description: "Create and subscribe to a Salesforce PushTopic to connect the WSO2 Salesforce inbound endpoint to Salesforce."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/sf-inbound-endpoint-configuration/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/salesforce-connectors/sf-inbound-endpoint-configuration.md
tags:
  - api-manager
  - reference
  - connectors
