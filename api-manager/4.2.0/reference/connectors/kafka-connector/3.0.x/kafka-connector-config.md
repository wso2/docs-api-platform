...
description: "Configure Kafka Connector version 3.0.x operations for producing messages with or without security."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/kafka-connector/3.0.x/kafka-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/kafka-connector/3.0.x/kafka-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
