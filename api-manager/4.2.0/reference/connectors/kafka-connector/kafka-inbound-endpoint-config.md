...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/kafka-connector/kafka-inbound-endpoint-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/kafka-connector/kafka-inbound-endpoint-config.md
tags:
  - api-manager
  - reference
  - connectors
