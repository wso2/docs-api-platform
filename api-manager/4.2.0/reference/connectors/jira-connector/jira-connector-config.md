...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/jira-connector/jira-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/jira-connector/jira-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
...
**Note**: For more information on how this works in an actual scenario, see [Jira Connector Example](jira-connector-example).