---
title: "Amazon DynamoDB connector reference"
description: "Reference of the init operation and parameters used to configure the Amazon DynamoDB connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/amazondynamodb-connector/amazondynamodb-connector-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/amazondynamodb-connector/amazondynamodb-connector-reference.md
tags:
  - api-manager
  - reference
  - connectors
