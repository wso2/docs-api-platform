...
description: "Retrieve, create, and update an employee's contact information using the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-personal-information/employeecontacts/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-personal-information/employeecontacts.md
tags:
  - api-manager
  - reference
  - connectors
