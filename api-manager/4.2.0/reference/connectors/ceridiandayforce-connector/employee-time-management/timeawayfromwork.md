...
description: "Retrieve an employee's scheduled time away from work (TAFW) periods using the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-time-management/timeawayfromwork/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-time-management/timeawayfromwork.md
tags:
  - api-manager
  - reference
  - connectors
