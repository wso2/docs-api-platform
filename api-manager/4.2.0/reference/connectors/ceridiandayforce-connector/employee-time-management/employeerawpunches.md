...
description: "Retrieve and create raw clock punches for employees using the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-time-management/employeerawpunches/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-time-management/employeerawpunches.md
tags:
  - api-manager
  - reference
  - connectors
