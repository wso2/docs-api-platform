...
description: "Retrieve column metadata and filter parameter details for a specific Ceridian Dayforce report."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/reporting/reportmetadataforaspecificreport/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/reporting/reportmetadataforaspecificreport.md
tags:
  - api-manager
  - reference
  - connectors
