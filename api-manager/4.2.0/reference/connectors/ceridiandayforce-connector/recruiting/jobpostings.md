...
description: "Retrieve job postings available through the candidate portal using the GET Job Postings operation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/recruiting/jobpostings/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/recruiting/jobpostings.md
tags:
  - api-manager
  - reference
  - connectors
