...
description: "Reference of the operation used to retrieve the list of documents attached to an employee with the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-documents/listofdocuments/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee-documents/listofdocuments.md
tags:
  - api-manager
  - reference
  - connectors
