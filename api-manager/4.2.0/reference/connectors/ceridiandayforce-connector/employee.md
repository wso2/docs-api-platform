...
description: "Retrieve, create, and update employee human resources records, including hiring, using the Ceridian Dayforce connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/ceridiandayforce-connector/employee.md
tags:
  - api-manager
  - reference
  - connectors
