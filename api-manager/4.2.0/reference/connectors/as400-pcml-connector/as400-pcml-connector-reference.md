...
description: "Reference of the init operation and parameters used to configure the AS400 PCML connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/as400-pcml-connector/as400-pcml-connector-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/as400-pcml-connector/as400-pcml-connector-reference.md
tags:
  - api-manager
  - reference
  - connectors
