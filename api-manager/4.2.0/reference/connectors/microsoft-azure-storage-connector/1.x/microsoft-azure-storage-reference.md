...
description: "Configure Microsoft Azure Storage connector version 1.x operations for connecting to an Azure storage account."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/microsoft-azure-storage-connector/1.x/microsoft-azure-storage-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/microsoft-azure-storage-connector/1.x/microsoft-azure-storage-reference.md
tags:
  - api-manager
  - reference
  - connectors
