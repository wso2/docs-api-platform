...
description: "Reference of the init operation and parameters used to configure version 1.x of the Amazon S3 connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/amazons3-connector/1.x/amazons3-connector-1.x-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/amazons3-connector/1.x/amazons3-connector-1.x-reference.md
tags:
  - api-manager
  - reference
  - connectors
