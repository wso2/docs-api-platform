...
description: "Configure File Connector version 4 connections and operations for local and remote FTP, FTPS, and SFTP file systems."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/file-connector/file-connector-config/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/file-connector/file-connector-config.md
tags:
  - api-manager
  - reference
  - connectors
...
<img src="../../../../assets/img/integrate/connectors/filecon-reference-22.png" title="types of file connections" width="800" alt="types of file connections"/>
