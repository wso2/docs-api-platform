...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/documentum/documentum-reference/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/connectors/documentum/documentum-reference.md
tags:
  - api-manager
  - reference
  - connectors
