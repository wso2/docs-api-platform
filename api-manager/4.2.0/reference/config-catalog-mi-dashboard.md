...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/config-catalog-mi-dashboard/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/config-catalog-mi-dashboard.md
tags:
  - api-manager
  - reference
