...
description: "Explains how to download and install Siddhi extensions for the Streaming Integrator via the command line or manually."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/streaming-connectors/downloading-and-installing-siddhi-extensions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/streaming-connectors/downloading-and-installing-siddhi-extensions.md
tags:
  - api-manager
  - reference
...
- **Viewing the list of extensions that are currently installed**
    ...
    ![List of Installed Extensions](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/list-response.png)
...
- **Viewing the installation status of all the supported Siddhi extensions**
    ...
    ![List of installed Siddhi extensions with status](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/list-and-status-response.png)
...
- **Checking the installation status of a specific Siddhi extension**
    ...
    ![List status for specific exension](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/list-status-for-specific-extension.png)
...
![Not-installed extensions in Siddhi applications](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/not-installed-but-used-extensions.png)
...
![installed missing extension](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/installed-missing-extension-message.png)
...
![install extension log](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/install-extension-log.png)
...
![uninstall extension log](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/uninstall-extension-log.png)
...
![uninstall extension](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/uninstall-extension.png)
...
1. Open the [Siddhi Extensions page](https://store.wso2.com/store/assets/analyticsextension/list).
   ...
   ![Siddhi Extension Home Page](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/siddhi-extensions.png)

2. Click on the required extension. In this example, let's click on the **IBM MQ** extension.  
   ![Download Extension](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/download-extension.png)
...
3.  If you are not using the latest version of the Streaming Integrator, and you
    ...
    ![Version Support](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/extension-left-navigator.png)
...
4. If you need to download an older version of an extension, follow the substeps below.
   ...
   displayed within the tab.  
    ![Older Versions](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/extensions-older-versions.png)

    You are directed to the maven central page where all the available versions of the extension are listed.  
    ![All available versions](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/central-maven-repository.png)

   2. Click on the relevant version. It directs you to the download page. To download the bundle, click on it.  
    ![Download Bundle](../../assets/img/streaming/downloading-and-installing-siddhi-extensions/maven-bundle.png)
