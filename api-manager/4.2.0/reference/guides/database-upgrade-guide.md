...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/guides/database-upgrade-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/guides/database-upgrade-guide.md
tags:
  - api-manager
  - reference
  - guides
