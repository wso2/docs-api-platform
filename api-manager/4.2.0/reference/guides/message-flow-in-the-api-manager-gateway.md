...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/guides/message-flow-in-the-api-manager-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/guides/message-flow-in-the-api-manager-gateway.md
tags:
  - api-manager
  - reference
  - guides
...
Mediation extensions enable you to define custom logic that can be executed during the inflow or outflow of API requests.  To learn more about mediation extensions, see [API Policy](../../design/api-policies/overview) .
