...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/using-the-registry-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/using-the-registry-rest-api.md
tags:
  - api-manager
  - reference
