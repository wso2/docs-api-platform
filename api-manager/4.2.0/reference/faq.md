...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/faq/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/faq.md
tags:
  - api-manager
  - reference
  - faq
...
For a list of all default ports available, see [Default Ports of WSO2 Products](../install-and-setup/setup/reference/default-product-ports#api-m-ports).

### What are the technologies used underneath WSO2 API Manager?

The API Manager is built on top of [WSO2 Carbon](https://wso2.com/library/articles/2012/03/carbon-context-its-usages-wso2-products/), an OSGi based components framework for SOA. For more details, see [API Manager components](../get-started/apim-architecture).
...
For more details, see [Setting up an e-mail login](../install-and-setup/setup/security/logins-and-passwords/maintaining-logins-and-passwords#setup-an-e-mail-login).
...
To set visibility of the API only to selected user roles in the server, see [API Visibility](../design/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal).
