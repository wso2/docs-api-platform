...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/log-in-to-the-dev-portal-using-social-media/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/log-in-to-the-dev-portal-using-social-media.md
tags:
  - api-manager
  - reference
  - customize-product
