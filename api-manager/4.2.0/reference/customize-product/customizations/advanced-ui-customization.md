...
description: "Modify the React codebase of the Developer Portal and Publisher to perform advanced UI customizations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/advanced-ui-customization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/advanced-ui-customization.md
tags:
  - api-manager
  - reference
  - customize-product
