...
description: "Modify the React codebase of the Developer Portal and Publisher to add advanced UI customizations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/customizing-the-developer-portal/advanced-customization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/customizing-the-developer-portal/advanced-customization.md
tags:
  - api-manager
  - reference
  - customize-product
