...
description: "Configure reCaptcha for the Developer Portal self-registration flow to mitigate brute force attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/customizing-the-developer-portal/configuring-recaptcha-for-self-signup/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/customizations/customizing-the-developer-portal/configuring-recaptcha-for-self-signup.md
tags:
  - api-manager
  - reference
  - customize-product
...
!!! info 
    -   For more information on setting up self registration, see
        [Self-Sign-Up](enabling-or-disabling-self-signup).
...
1.  Set up reCaptcha with the WSO2 API Manager. For instructions on
    ...
    ReCaptcha](../../../../install-and-setup/setup/security/logins-and-passwords/setting-up-recaptcha).
