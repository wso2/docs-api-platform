...
description: "Configure workflow-related settings across a clustered API Manager deployment with separate Admin Portal access."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/extending-api-manager/extending-workflows/configuring-workflows-in-a-cluster/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/extending-api-manager/extending-workflows/configuring-workflows-in-a-cluster.md
tags:
  - api-manager
  - reference
  - customize-product
