...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/extending-api-manager/saml2-sso/multi-factor-authentication-mfa-for-publisher-and-developer-portals/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/extending-api-manager/saml2-sso/multi-factor-authentication-mfa-for-publisher-and-developer-portals.md
tags:
  - api-manager
  - reference
  - customize-product
...
1.  Configure Single Sign-On (SSO) with WSO2 Identity Server. 
     ...
     For more information, see [Configuring Identity Server as IDP for SSO](configuring-identity-server-as-idp-for-sso).
