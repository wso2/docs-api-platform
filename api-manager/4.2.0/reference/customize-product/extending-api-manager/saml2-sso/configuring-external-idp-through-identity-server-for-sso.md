...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/extending-api-manager/saml2-sso/configuring-external-idp-through-identity-server-for-sso/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/customize-product/extending-api-manager/saml2-sso/configuring-external-idp-through-identity-server-for-sso.md
tags:
  - api-manager
  - reference
  - customize-product
...
!!! note
    Please follow [Configuring Identity Server as IDP for SSO](configuring-identity-server-as-idp-for-sso) to configure WSO2 Identity Server.
