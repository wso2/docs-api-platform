...
description: "Reference for the SQL and data types used when defining input and output mappings in a data service."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/data-services/mapping-data-types/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/data-services/mapping-data-types.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
This section describes the data types that are used when defining [Input and Output Mappings](query-parameters) in a data service:
