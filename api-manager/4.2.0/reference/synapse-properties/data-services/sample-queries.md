...
!!! Info
    For detailed instructions on defining a data service using WSO2 Integration Studio, see [Creating a Data Service](../../../integrate/develop/creating-artifacts/data-services/creating-data-services).
