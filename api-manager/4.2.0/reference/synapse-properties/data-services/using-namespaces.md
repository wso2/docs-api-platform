...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/data-services/using-namespaces/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/data-services/using-namespaces.md
tags:
  - api-manager
  - reference
  - synapse-properties
