...
description: "Reference for the Data Services and Resource Language elements used to compose a data service, including queries and operations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/data-services/elements-of-a-data-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/data-services/elements-of-a-data-service.md
tags:
  - api-manager
  - reference
  - synapse-properties
