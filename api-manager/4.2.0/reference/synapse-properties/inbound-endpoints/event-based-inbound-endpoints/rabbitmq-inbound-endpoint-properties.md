...
The following properties are required when [creating a RabbitMQ inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint).
...
The following optional properties can be configured when [creating an RabbitMQ inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint).
