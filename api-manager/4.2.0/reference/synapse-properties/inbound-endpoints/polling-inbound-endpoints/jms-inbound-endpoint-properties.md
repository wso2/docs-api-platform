---
title: "JMS inbound"
description: "Reference for the properties required to configure a JMS inbound endpoint that receives messages from a JMS server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/inbound-endpoints/polling-inbound-endpoints/jms-inbound-endpoint-properties/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/inbound-endpoints/polling-inbound-endpoints/jms-inbound-endpoint-properties.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
Listed below are the properties used for [creating a JMS inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint).

### Required Properties

The following properties are required when [creating a JMS inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint).
...
The following optional properties can be configured when [creating a JMS inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint).
