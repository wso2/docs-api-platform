...
description: "Reference for the syntax and properties used to configure a CXF WS-RM inbound endpoint for reliable message delivery."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/inbound-endpoints/listening-inbound-endpoints/cxf-ws-rm-inbound-endpoint-properties/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/synapse-properties/inbound-endpoints/listening-inbound-endpoints/cxf-ws-rm-inbound-endpoint-properties.md
tags:
  - api-manager
  - reference
  - synapse-properties
...
The following properties can be configured when [creating a CXF WS-RM inbound endpoint](../../../../integrate/develop/creating-artifacts/creating-an-inbound-endpoint).
