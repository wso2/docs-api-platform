...
In your integration solution, the following RabbitMQ send parameters can be specified in the **Address URL** that you specify in your [Endpoint artifact](../../../integrate/develop/creating-artifacts/creating-endpoints).
