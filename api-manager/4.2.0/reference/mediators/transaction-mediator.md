...
description: "Reference for the Transaction mediator, which manages distributed transactions for its child mediators in the Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/mediators/transaction-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/mediators/transaction-mediator.md
tags:
  - api-manager
  - reference
  - mediators
...
!!! Info
	In addition to distributed transactions, the Micro Integrator also supports Java Message Service (JMS) transactions. For more information on transactions, see [Working with Transactions](../../integrate/examples/working-with-transactions).
