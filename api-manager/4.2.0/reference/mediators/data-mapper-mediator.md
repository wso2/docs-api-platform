...
[![Generated configuration files](../../assets/img/integrate/mediators/119131284/autogen_config_files.png){: style="width:50%"}](../../assets/img/integrate/mediators/119131284/autogen_config_files.png)
...
![](../../assets/img/integrate/mediators/119131284/119131286.png)
...
![](../../assets/img/integrate/mediators/119131284/119134807.png) 
...
![](../../assets/img/integrate/mediators/119131284/119134806.png) **Constant:**
defines String, number or boolean constant values.

![](../../assets/img/integrate/mediators/119131284/119134805.png) **Custom
Function:** defines custom functions to use in the mapping.

![](../../assets/img/integrate/mediators/119131284/119134804.png) **Properties:**
uses product-specific runtime variables.

![](../../assets/img/integrate/mediators/119131284/119134802.png) **Global
Variable:** instantiates global variables that you can access from
anywhere.

![](../../assets/img/integrate/mediators/119131284/119134803.png) **Compare:**
compares two inputs in the mapping.

#### Arithmetic

![](../../assets/img/integrate/mediators/119131284/119134936.png) **Add:** adds two
numbers.

![](../../assets/img/integrate/mediators/119131284/119134935.png) **Subtract:**
subtracts two or more numbers.

![](../../assets/img/integrate/mediators/119131284/119134934.png) **Multiply:**
multiplies two or more numbers.

![](../../assets/img/integrate/mediators/119131284/119134933.png) **Divide:** divides
two numbers.

![](../../assets/img/integrate/mediators/119131284/119134932.png) **Ceiling:**
derives the ceiling value of a number (closest larger integer value).

![](../../assets/img/integrate/mediators/119131284/119134931.png)**Floor:** derives
the floor value of a number (closest lower integer value).

![](../../assets/img/integrate/mediators/119131284/119134930.png) **Round:** derives
the nearest integer value.

![](../../assets/img/integrate/mediators/119131284/119134929.png) **Set Precision:**
formats a number into a specified length.

![](../../assets/img/integrate/mediators/119131284/119134928.png) **Absolute Value:**
derives the absolute value of a rational number.

![](../../assets/img/integrate/mediators/119131284/119134927.png) **Min:** derives
the minimum number from given inputs

![](../../assets/img/integrate/mediators/119131284/119134926.png) **Max:** derives
the maximum number from given inputs

#### Conditional

![](../../assets/img/integrate/mediators/119131284/119134949.png) **IfElse:** uses a
condition and selects one input from given two.

#### Boolean

![](../../assets/img/integrate/mediators/119131284/119134954.png) **AND:** performs
the boolean AND operation on inputs.

![](../../assets/img/integrate/mediators/119131284/119134953.png) **OR:** performs
the boolean OR operation on inputs.

![](../../assets/img/integrate/mediators/119131284/119134952.png) **NOT:** performs
the boolean NOT operation on inputs.

#### Type conversion

![](../../assets/img/integrate/mediators/119131284/119134964.png) **StringToNumber:**
converts a String value to number (“0” -> 0).

![](../../assets/img/integrate/mediators/119131284/119134963.png)
**StringToBoolean:** converts a String value to boolean (“true” ->
true).

![](../../assets/img/integrate/mediators/119131284/119134962.png) **ToString:**
converts a number or a boolean value to String.

#### String

![](../../assets/img/integrate/mediators/119131284/119134978.png) **Concat:**
concatenates two or more Strings.

![](../../assets/img/integrate/mediators/119131284/119134977.png) **Split:** splits a
String by a matching String value.

![](../../assets/img/integrate/mediators/119131284/119134975.png) **Uppercase:**
converts a String to uppercase letters.

![](../../assets/img/integrate/mediators/119131284/119134976.png) **Lowercase:**
converts a String to lowercase letters.

![](../../assets/img/integrate/mediators/119131284/119134974.png) **String Length:**
gets the length of the String.

![](../../assets/img/integrate/mediators/119131284/119134973.png)**StartsWith:**
checks whether a String starts with a specific value. (This is not
supported in Java 7.)

![](../../assets/img/integrate/mediators/119131284/119134972.png) **EndsWith:**
checks whether String ends with a specific value. (This is not supported
in Java 7.)

![](../../assets/img/integrate/mediators/119131284/119134971.png) **Substring:**
extracts a part of the String value.

![](../../assets/img/integrate/mediators/119131284/119134970.png) **Trim:** removes
white spaces from the beginning and end of a String.

![](../../assets/img/integrate/mediators/119131284/119134969.png) **Replace:**
replaces the first occurrence of a target String with another.

![](../../assets/img/integrate/mediators/119131284/119134968.png) **Match** – check
...
![example one Data mapper diagram](../../assets/img/integrate/mediators/119131284/ai_datamapper.png)
...
![example one Data mapper diagram](../../assets/img/integrate/mediators/119131284/119131296.png)
...
![](../../assets/img/integrate/mediators/119131284/119131295.png)
...
![](../../assets/img/integrate/mediators/119131284/119131294.png) 
...
![](../../assets/img/integrate/mediators/119131284/119131293.png)
...
![example 5 mapping](../../assets/img/integrate/mediators/119131284/119131293.png)
