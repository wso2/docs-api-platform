...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/mediators/data-mapper-json-schema-specification/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/reference/mediators/data-mapper-json-schema-specification.md
tags:
  - api-manager
  - reference
  - mediators
