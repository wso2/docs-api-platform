...
Let's **test this solution** by running the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service) tutorial. When the artifacts deployed in the Micro Integrator are invoked, the statistics will be available in the portal. 

Follow the steps given below.

??? note "Step 1: Deploy integration artifacts"
    
    If you have already started the Micro Integrator server, let's deploy the artifacts. Let's use the integration artifacts from the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service) tutorial.
...
??? note "Step 2: Start the backend"
    ...
    Let's start the hospital service that serves as the backend to the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service) use case: 
