...
??? info "More information on the system requirements"
    ...
    -   For the Micro Integrator, see the [installation prerequsites](../install-and-setup/install/installation-prerequisites).
...
-   **Download and [install the Micro Integrator](../install-and-setup/install/installing-the-product/installing-mi)**.
...
Let's use the integration artifacts from the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service) tutorial.
...
!!! info "If you do not have the integration artifacts from the service chaining tutorial"
    If you did not try the [service chaining](../tutorials/integration-tutorials/exposing-several-services-as-a-single-service) tutorial yet:
    ...
    2.  [Open WSO2 Integration Studio](../integrate/develop/installing-wso2-integration-studio) and [import the pre-packaged project](../integrate/develop/importing-projects).
