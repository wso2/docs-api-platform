---
title: "Scope mapping"
description: "Modify REST API scope-to-role mappings and map role names in WSO2 API Manager using the Admin Portal instead of editing tenant-conf.json."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/wip/scope-role-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/wip/scope-role-mapping.md
tags:
  - api-manager
  - wip
  - scope-role-mapping
