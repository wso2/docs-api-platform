...
description: "Create a REST API resource and mediation artifacts to route a client request to a backend microservice and back."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/tutorials/integration-tutorials/sending-a-simple-message-to-a-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/tutorials/integration-tutorials/sending-a-simple-message-to-a-service.md
tags:
  - api-manager
  - tutorials
...
!!! Note
    ...
    - The bottom part of the canvas is the **Fault sequence**, which allows you to configure how to handle messages when an error occurs (for more information, see [Error Handling](../../troubleshooting/error-handling-mi).
