...
6. Create a **Proxy Service** artifact.
    ...
    2.  Follow the [Using a Simple Proxy Service](../../integrate/examples/proxy_service_examples/introduction-to-proxy-services) to create the StockQuoteProxy Proxy Service.
