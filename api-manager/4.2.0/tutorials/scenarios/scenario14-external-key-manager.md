...
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/tutorials/scenarios/scenario14-external-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/tutorials/scenarios/scenario14-external-key-manager.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
This is a tutorial that is part of a series and can be used as a standalone tutorial on how to configure a Key Manager. For more details on the scenario and general prerequisites, please see [the scenario overview page](scenario-overview).
...
Look through other [available tutorials](../tutorials-overview) and look through our documentation for topics of interest.