...
description: "Create a REST API in API Manager backed by an AWS Lambda endpoint, configuring credentials and mapping function ARNs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/tutorials/create-and-publish-awslambda-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.2.0/tutorials/create-and-publish-awslambda-api.md
tags:
  - api-manager
  - tutorials
