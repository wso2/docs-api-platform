...
description: "Shows how to configure a maximum backend throughput limit to protect an API's backend from overuse."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/setting-maximum-backend-throughput-limits/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/setting-maximum-backend-throughput-limits.md
tags:
  - api-manager
  - design
  - rate-limiting
