...
description: "Restrict API access to a set of allowed IPs or deny requests from specific users using advanced rate limiting policies."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/access-control/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/access-control.md
tags:
  - api-manager
  - design
  - rate-limiting
...
3.  Click Add New Policy to add a new Rate Limit tier.
    ...
    [![Allowed IP add policy](../../assets/img/learn/allowed-ip-add-policy.png)](../../assets/img/learn/allowed-ip-add-policy.png)

4.  Fill the details as below and click **Add Conditional Group**.

    [![Allowed IP add conditional group](../../assets/img/learn/allowed-ip-add-conditional-group.png)](../../assets/img/learn/allowed-ip-add-conditional-group.png)
...
5.  Open the Conditional Group added and fill the details.
    ...
    [![New allow specific IP](../../assets/img/learn/new-allow-specific-ip.png)](../../assets/img/learn/new-allow-specific-ip.png)
    
    [![Save allow specific IP](../../assets/img/learn/save-allow-specific-ip.png)](../../assets/img/learn/save-allow-specific-ip.png)
    ...
    [![New allowed IP range](../../assets/img/learn/new-allowed-ip-range.png)](../../assets/img/learn/new-allowed-ip-range.png)
...
3.  Enable **API level** under **Operational Configuration** and select the newly created rate limiting policy.
    [![Apply allowlist to API](../../assets/img/learn/apply-allowlist-to-api.png)](../../assets/img/learn/apply-allowlist-to-api.png)
...
5.  Now login to API Developer Portal using the URL `https://localhost:9443/devportal` and invoke the API.
    ...
    [![Denied api](../../assets/img/learn/denied-api.png)](../../assets/img/learn/denied-api.png)