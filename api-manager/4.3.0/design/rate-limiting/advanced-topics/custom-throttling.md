...
description: "Write custom Siddhi queries to define dynamic rate limiting rules that apply globally across all tenants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/advanced-topics/custom-throttling/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/advanced-topics/custom-throttling.md
tags:
  - api-manager
  - design
  - rate-limiting
