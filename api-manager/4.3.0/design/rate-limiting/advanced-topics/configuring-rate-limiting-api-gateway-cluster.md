---
title: "Rate limiting for a gateway cluster"
description: "Configure a Redis cluster with asynchronous or async-sync hybrid mode to sync distributed rate limiting counters across gateway nodes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/advanced-topics/configuring-rate-limiting-api-gateway-cluster/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/advanced-topics/configuring-rate-limiting-api-gateway-cluster.md
tags:
  - api-manager
  - design
  - rate-limiting
...
with multiple Gateways. In such scenarios, for [Burst Control](../../../design/rate-limiting/setting-throttling-limits.md#burst-control) and [Backend Rate Limiting](../../../design/rate-limiting/setting-maximum-backend-throughput-limits.md) to work properly, it requires maintaining
...
Once configurations are done, you can follow the docs for [Burst Control](../../../design/rate-limiting/setting-throttling-limits.md#burst-control) and [Backend Rate Limiting](../../../design/rate-limiting/setting-maximum-backend-throughput-limits.md) and test the functionality with the Hybrid Mode enabled. 