...
description: "Explains how WSO2 API Manager rejects GraphQL queries that exceed a configured maximum complexity value."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/graphql-api/query-complexity-limitation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/graphql-api/query-complexity-limitation.md
tags:
  - api-manager
  - design
  - rate-limiting
