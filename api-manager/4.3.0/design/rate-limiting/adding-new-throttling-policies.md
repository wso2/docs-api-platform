...
description: "Add new advanced, application-level, or subscription-level rate limiting policies in the Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/adding-new-throttling-policies/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/rate-limiting/adding-new-throttling-policies.md
tags:
  - api-manager
  - design
  - rate-limiting
...
4.  Fill in the details required by this form and click **Save** once you are done.
    ...
    !!! note
     ...
     | GraphQL                         | Provide the [maximum complexity](../../design/rate-limiting/graphql-api/query-complexity-limitation.md) and [maximum depth values](../../design/rate-limiting/graphql-api/query-depth-limitation.md) for GraphQL APIs using this policy.|
