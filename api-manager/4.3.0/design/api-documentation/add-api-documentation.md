...
description: "Add in-line, URL, file, or Markdown documentation to an API using the WSO2 API Publisher's documentation types."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-documentation/add-api-documentation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-documentation/add-api-documentation.md
tags:
  - api-manager
  - design
  - api-documentation
