...
description: "Configure message builders and formatters to transform API request and response payloads between JSON and XML."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-policies/regular-gateway-policies/transforming-api-message-payload/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-policies/regular-gateway-policies/transforming-api-message-payload.md
tags:
  - api-manager
  - design
  - api-policies
...
!!! tip
    ...
    [attaching policies to API operations](../../../design/api-policies/attach-policy.md).
