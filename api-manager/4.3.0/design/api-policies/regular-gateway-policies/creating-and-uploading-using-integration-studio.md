---
title: "Creating custom mediation policies with Integration Studio"
description: "Build a custom mediation policy in WSO2 Integration Studio and deploy it to the API Gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-policies/regular-gateway-policies/creating-and-uploading-using-integration-studio/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-policies/regular-gateway-policies/creating-and-uploading-using-integration-studio.md
tags:
  - api-manager
  - design
  - api-policies
