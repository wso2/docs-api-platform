...
description: "Create a common or API-specific policy in the WSO2 API Publisher for use across operations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-policies/create-policy/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-policies/create-policy.md
tags:
  - api-manager
  - design
  - api-policies
