...
description: "Learn how pre-released (prototyped) APIs let publishers share a work-in-progress API and mock backend responses for feedback."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/prototype-api/overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/prototype-api/overview.md
tags:
  - api-manager
  - design
  - prototype-api
...
- [Mock responses based on the OpenAPI specification with API Gateway](../../design/prototype-api/create-mocked-js-api.md)    
- [Expose an existing backend implementation as a Pre-Released API](../../design/prototype-api/backend-url-prototype-api.md)