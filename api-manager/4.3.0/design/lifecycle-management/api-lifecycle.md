---
title: "API lifecycle"
description: "Learn the six default API lifecycle states and how to change the lifecycle state of an API or API product."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/lifecycle-management/api-lifecycle/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/lifecycle-management/api-lifecycle.md
tags:
  - api-manager
  - design
