...
description: "Publish a new API version and deprecate older versions while allowing existing subscribers to keep using the API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-versioning/deprecate-the-old-version/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-versioning/deprecate-the-old-version.md
tags:
  - api-manager
  - design
  - api-versioning
