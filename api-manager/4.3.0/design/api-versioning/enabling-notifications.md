...
description: "Configure email server settings and notifier classes so subscribers are notified by email when a new API version is released."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-versioning/enabling-notifications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-versioning/enabling-notifications.md
tags:
  - api-manager
  - design
  - api-versioning
