...
description: "Create a new version of a published API in the Publisher Portal to change its resources, authentication, or throttling tiers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-versioning/create-a-new-api-version/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-versioning/create-a-new-api-version.md
tags:
  - api-manager
  - design
  - api-versioning
...
authentication mechanism, resources, [throttling tiers](../../design/rate-limiting/introducing-throttling-use-cases.md), target audiences, etc. WSO2 does not recommend to modify a published API that has subscribers plugged into it.
...
!!! note
    ...
    [Create a REST API](../../design/create-api/create-rest-api/create-a-rest-api.md) section and Published in the [Publish an API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api.md) section.
...
1.  Sign in to the WSO2 API Publisher.
     ...
     Create and publish an API. For more information, see [Create a REST API](../../design/create-api/create-rest-api/create-a-rest-api.md) and [Publish an API](../../deploy-and-publish/publish-on-dev-portal/publish-an-api.md).
...
!!! note
    For API Product versioning create an API Product following [Create an API Product](../../design/create-api-product/create-api-product.md). Then follow the above steps as similar to API versioning.

!!! note
    For more details on the default version, see [Backward Compatibility](../../design/api-versioning/backward-compatibility.md) section.
...
[publish the new version and deprecate old API versions](../../design/api-versioning/deprecate-the-old-version.md).
