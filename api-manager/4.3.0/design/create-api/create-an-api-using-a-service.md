...
description: "Discover integration or streaming integration services from the service catalog and create a managed API from a service."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api/create-an-api-using-a-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api/create-an-api-using-a-service.md
tags:
  - api-manager
  - design
  - create-api
