...
description: "Generate a RESTful API definition from a backend SOAP service, including supported and unsupported WSDL/XML schema types."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api/create-rest-api/generate-rest-api-from-soap-backend/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api/create-rest-api/generate-rest-api-from-soap-backend.md
tags:
  - api-manager
  - design
  - create-api
