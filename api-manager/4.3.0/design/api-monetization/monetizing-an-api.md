...
description: "Configure a billing engine and monetize an API using the Stripe plugin for WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-monetization/monetizing-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-monetization/monetizing-an-api.md
tags:
  - api-manager
  - design
  - api-monetization
...
#### (A) - Configure the billing engine
 ...
 2.  Create and enable [connected account](https://stripe.com/docs/connect/quickstart#create-account) in Stripe.  
    ...
    <html>
        ...
        [![Enable oauth](../../assets/img/learn/monetization_enable_oauth.png){: style="width:60%"}](../../assets/img/learn/monetization_enable_oauth.png)
...
1. Connect WSO2 API Manager to the billing engine.
    ...
    2. Build the implementation of the respective monetization interface and add the JAR into the `<API-M_HOME>/repository/components/lib` directory.
        ...
        In this example scenario, you need to add [org.wso2.apim.monetization.impl-1.5.0.jar](https://github.com/wso2-extensions/wso2-am-stripe-plugin/releases/download/v1.5.0/org.wso2.apim.monetization.impl-1.5.0.jar) and [jakarta.json-api-2.1.1.jar](https://repo1.maven.org/maven2/jakarta/json/jakarta.json-api/2.1.1/jakarta.json-api-2.1.1.jar) into the latter mentioned `lib` folder because `org.wso2.apim.monetization.impl` is dependent on `jakarta.json-api`. 
...
1.  Obtain the consumer key and secret key pair by calling the dynamic client registration endpoint.  
     ...
     For more information, see [Admin REST API v4.1](../../reference/product-apis/admin-apis/admin-v4/admin-v4.md).
