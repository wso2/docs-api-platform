...
description: "Add, view, and reply to comments on an API from the Publisher Portal to build community conversations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-collaborations/comment-on-an-api-via-the-publisher/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-collaborations/comment-on-an-api-via-the-publisher.md
tags:
  - api-manager
  - design
  - api-collaborations
