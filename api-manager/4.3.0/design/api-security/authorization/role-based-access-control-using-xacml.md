...
description: "Integrate an external XACML entitlement server with API Manager to enforce role-based access control on APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/authorization/role-based-access-control-using-xacml/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/authorization/role-based-access-control-using-xacml.md
tags:
  - api-manager
  - design
  - api-security
...
14. Log in to the API Publisher and [create an API](../../../design/create-api/create-rest-api/create-a-rest-api.md). In this sample default PizzaShack API is used.
15. [Create a new API policy](../../../design/api-policies/create-policy.md) and upload the `EntitlementMediator.j2` created previously. Set **Request** under the **Applicable flows** 
16. Attach the new policy to all the resources as mentioned in [attach policy](../../../design/api-policies/attach-policy.md)
