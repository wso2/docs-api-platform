...
description: "Restrict API access to authorized user groups using OAuth2 scopes or XACML fine-grained access control."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/authorization/api-authorization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/authorization/api-authorization.md
tags:
  - api-manager
  - design
  - api-security
