...
description: "Create a read-only user with the observer role to view APIs and analytics in the Publisher Portal without edit access."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/authorization/publisher-portal-in-read-only-mode/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/authorization/publisher-portal-in-read-only-mode.md
tags:
  - api-manager
  - design
  - api-security
