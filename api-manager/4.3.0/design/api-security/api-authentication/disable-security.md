...
description: "Disable OAuth2 security for a single API resource or for all resources of an API for testing purposes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/api-authentication/disable-security/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/api-authentication/disable-security.md
tags:
  - api-manager
  - design
  - api-security
...
- [Get an internal test key from Publisher](../../../design/create-api/create-rest-api/test-a-rest-api.md)
