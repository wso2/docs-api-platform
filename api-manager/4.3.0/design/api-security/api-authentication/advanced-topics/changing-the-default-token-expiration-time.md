...
description: "Change the default validity period of application and user access tokens via identity.xml or the UI."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/api-authentication/advanced-topics/changing-the-default-token-expiration-time/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/api-authentication/advanced-topics/changing-the-default-token-expiration-time.md
tags:
  - api-manager
  - design
  - api-security
