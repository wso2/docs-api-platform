...
description: "Configure certificate bound JWT access tokens, also called holder of key tokens, to prevent token leakage."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/api-authentication/securing-apis-using-certificate-bound-access-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/api-authentication/securing-apis-using-certificate-bound-access-tokens.md
tags:
  - api-manager
  - design
  - api-security
...
2. [Create an API](../../../design/create-api/create-rest-api/create-a-rest-api.md).     
