...
description: "Skip role validation for OAuth2 scopes by allowlisting them in the deployment.toml configuration file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/oauth2-scopes/scope-whitelisting/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/oauth2-scopes/scope-whitelisting.md
tags:
  - api-manager
  - design
  - api-security
