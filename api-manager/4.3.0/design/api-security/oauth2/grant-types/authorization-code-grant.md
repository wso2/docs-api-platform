...
description: "Learn how the OAuth2 authorization code grant redirects the resource owner through an authorization server to obtain tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/authorization-code-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/authorization-code-grant.md
tags:
  - api-manager
  - design
  - api-security
