---
title: "NTLM grant"
description: "Obtain an OAuth2 access token on a Windows-hosted API Manager instance using a valid NTLM token as the authorization grant."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/ntlm-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/ntlm-grant.md
tags:
  - api-manager
  - design
  - api-security
