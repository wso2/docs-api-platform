...
description: "Use the OAuth2 refresh token grant to obtain a new access token when the current one expires or is no longer needed."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/refresh-token-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/refresh-token-grant.md
tags:
  - api-manager
  - design
  - api-security
