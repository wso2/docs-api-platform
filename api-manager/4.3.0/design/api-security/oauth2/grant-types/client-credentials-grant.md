...
description: "Use the OAuth2 client credentials grant to obtain access tokens for protected resources scoped to the client application."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/client-credentials-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/grant-types/client-credentials-grant.md
tags:
  - api-manager
  - design
  - api-security
