...
description: "Enable encryption of OAuth2 access tokens, refresh tokens, and other keys using the primary keystore before database storage."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/encrypting-oauth2-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/encrypting-oauth2-tokens.md
tags:
  - api-manager
  - design
  - api-security
