...
description: "Revoke OAuth2 access and refresh tokens by calling the token revocation API endpoint with the required parameters."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/token-revocation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/token-revocation.md
tags:
  - api-manager
  - design
  - api-security
