...
description: "Compare JWT and opaque OAuth2 token persistence approaches in API Manager, including synchronous, asynchronous, and recovery flows."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/token-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/token-persistence.md
tags:
  - api-manager
  - design
  - api-security
...
- If you are enabling this feature in an existing or migrating setup,
      - The token type of all the existing applications should be changed to JWT (including the system applications; publisher, developer portal and admin portal). 
         - Follow [Update token type of an Application from OAUTH to JWT](../../../reference/product-apis/devportal-apis/devportal-v3/devportal-v3.md#tag/Applications/paths/~1applications~1%7BapplicationId%7D/put) to update the existing developer portal applications' token types.
