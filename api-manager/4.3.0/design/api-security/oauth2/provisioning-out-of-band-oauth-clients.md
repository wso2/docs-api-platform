...
description: "Associate an OAuth2 client created outside the Developer Portal with an application by provisioning it as an out-of-band client."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/provisioning-out-of-band-oauth-clients/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/provisioning-out-of-band-oauth-clients.md
tags:
  - api-manager
  - design
  - api-security
