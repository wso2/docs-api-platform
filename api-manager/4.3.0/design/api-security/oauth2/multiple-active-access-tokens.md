...
description: "Configure WSO2 API Manager to allow multiple active OAuth2 access tokens for the same consumer key, user, and scope."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/multiple-active-access-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/oauth2/multiple-active-access-tokens.md
tags:
  - api-manager
  - design
  - api-security
