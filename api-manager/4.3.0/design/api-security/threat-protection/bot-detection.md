---
title: "Bot detection"
description: "Understand how the API Gateway's bot detection mechanism logs unauthenticated traffic to help identify port-scanning and bot attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/threat-protection/bot-detection/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/threat-protection/bot-detection.md
tags:
  - api-manager
  - design
  - api-security
