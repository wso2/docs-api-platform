...
description: "Apply and test regex-based threat protection to block SQL, XPath, and script injection attacks at the API Gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/threat-protection/gateway-threat-protectors/regular-expression-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/api-security/threat-protection/gateway-threat-protectors/regular-expression-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - design
  - api-security
