...
description: "Understand how the gateway suspends an API endpoint for 30 seconds when the backend cannot be reached."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/endpoints/resiliency/endpoint-suspension/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/endpoints/resiliency/endpoint-suspension.md
tags:
  - api-manager
  - design
  - endpoints
