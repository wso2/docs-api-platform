...
description: "Configure load balancing and failover groups of endpoints to achieve high availability for API backends."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/endpoints/high-availability-for-endpoints/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/endpoints/high-availability-for-endpoints.md
tags:
  - api-manager
  - design
  - endpoints
...
1. When you [create an API](../../design/create-api/create-rest-api/create-a-rest-api.md), to configure load balancing endpoints go to the edit view of the API, click **Endpoint** to view the Endpoint page.
...
1. When you [create an API](../../design/create-api/create-rest-api/create-a-rest-api.md), to configure failover endpoints go to the edit view of the API, click **Endpoint** to view the Endpoint page.
