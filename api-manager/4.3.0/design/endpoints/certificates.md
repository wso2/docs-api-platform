...
description: "Upload a self-signed backend certificate to an API endpoint through the Publisher without restarting the server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/endpoints/certificates/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/endpoints/certificates.md
tags:
  - api-manager
  - design
  - endpoints
...
2. [Create a new API](../../design/create-api/create-rest-api/create-a-rest-api.md) or click on an existing API.
