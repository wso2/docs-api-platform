...
description: "Learn how API Products bundle resources from multiple APIs into a single consumable interface for subscribers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api-product/api-product-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api-product/api-product-overview.md
tags:
  - api-manager
  - design
  - create-api-product
