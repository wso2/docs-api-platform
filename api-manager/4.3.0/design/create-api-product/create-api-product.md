...
description: "Create an API Product that combines resources from the Customer Info and Leasing APIs, then deploy and publish it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api-product/create-api-product/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/create-api-product/create-api-product.md
tags:
  - api-manager
  - design
  - create-api-product
...
the attached OpenAPI definition (a.k.a Swagger definition) files](../../design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md).
...
9.  [Deploy the API Product](../../deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md).
...
!!! note
    To learn about API Product versioning refer [Create a New API Version](../../design/api-versioning/create-a-new-api-version.md).