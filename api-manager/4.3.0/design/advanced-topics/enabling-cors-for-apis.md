...
description: "Enable Cross-Origin Resource Sharing globally or per API by configuring deployment.toml or the API runtime settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/advanced-topics/enabling-cors-for-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/design/advanced-topics/enabling-cors-for-apis.md
tags:
  - api-manager
  - design
  - advanced-topics
