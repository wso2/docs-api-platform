...
description: "Explains how to generate, edit, and view AsyncAPI definitions for WebSocket, webhook, and SSE sources in the Async API view."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/working-with-the-async-api-view/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/working-with-the-async-api-view.md
tags:
  - api-manager
  - develop
  - streaming-apps
