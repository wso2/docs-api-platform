...
description: "Documents the REST API operations for adding permission strings and checking role-based permission grants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/permission-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/permission-apis.md
tags:
  - api-manager
  - develop
  - streaming-apps
