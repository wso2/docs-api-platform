...
description: "Lists the REST API categories supported for WSO2 Streaming Integrator, including Siddhi, permission, and business rule APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/rest-api-guide-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/rest-api-guide-overview.md
tags:
  - api-manager
  - develop
  - streaming-apps
...
- [**Siddhi Application Management APIs**](../../develop/streaming-apps/siddhi-application-management-apis.md)
...
- [**Permission APIs**](../../develop/streaming-apps/permission-apis.md)
...
- [**Business Rules APIs**](../../develop/streaming-apps/business-rules-apis.md)
...
- [**Store APIs**](../../develop/streaming-apps/store-apis.md)

    This category includes a single API that allows you to perform CRUD operations for your data stores.

- [**Healthcheck APIs**](../../develop/streaming-apps/healthcheck-apis.md)
