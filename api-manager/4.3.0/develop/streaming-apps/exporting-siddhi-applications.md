...
2. Create the required Siddhi files. The rest of the documentation assumes that you have one or more Siddhi applications to be exported as a Docker image. For more information, see [Creating a Siddhi Application](../../develop/streaming-apps/creating-a-siddhi-application.md).
...
3. Click **Export** menu option and then click **For Docker**.
    ...
    ![Export Siddhi App for Docker image dialog](../../assets/img/streaming/exporting-siddhi-applications/export-docker-1.png)
...
2. Create the required Siddhi files. The rest of the documentation assumes that you have one or more Siddhi applications to be exported as a Kubernetes artifact. For more information, see [Creating a Siddhi Application](../../develop/streaming-apps/creating-a-siddhi-application.md).
