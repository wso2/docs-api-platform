...
- **On-Demand Query**
    ...
    actions you can carry out for stores, see [Store APIs](../../develop/streaming-apps/store-apis.md).
...
Streaming Integrator servers. For more information, see [Deploying Siddhi Applications](../../develop/streaming-apps/deploying-streaming-applications.md).
...
- **For Docker**
    This opens the **Export Siddhi Apps for Docker image** wizard. For more information, see [Running the Streaming Integrator with Docker](../../use-cases/streaming-tutorials/running-si-with-docker-and-kubernetes.md#running-the-streaming-integrator-with-docker).

- **For Kubernetes**
    This opens the **Export Siddhi Apps For Kubernetes CRD** wizard. For more information, see [Running the Streaming Integrator with Kubernetes](../../use-cases/streaming-tutorials/running-si-with-docker-and-kubernetes.md#running-the-streaming-integrator-with-kubernetes).
...
-   For detailed instructions to find and use a Siddhi extension via the
    Operator Finder demonstrated with an example, see [Creating a Siddhi Application](../../develop/streaming-apps/creating-a-siddhi-application.md).
