...
description: "Shows how to find, install, and uninstall Siddhi extensions using the Extension Installer in Streaming Integrator Tooling."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/installing-siddhi-extensions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/installing-siddhi-extensions.md
tags:
  - api-manager
  - develop
  - streaming-apps
...
!!!Tip
    The Extension Installer can install/uninstall extensions within Streaming Integrator Tooling. When deploying Siddhi applications in Streaming Integrator Server, these have to be manually done. For more information, see [Downloading and Installing Siddhi Extensions](../../reference/streaming-connectors/downloading-and-installing-siddhi-extensions.md).
...
2. Click **Tools** menu option, and then click **Extension Installer**.
    ...
    [![Extension Installer](../../assets/img/streaming/streaming-integrator-studio-overview/extension-installer.png){: style="width:60%"}](../../assets/img/streaming/streaming-integrator-studio-overview/extension-installer.png)
...
2. Once the installation is complete, restart Streaming Integrator Tooling.
    ...
    [![Status Change as Installed](../../assets/img/streaming/installing-siddhi-extensions/installed-status.png){: style="width:60%"}](../../assets/img/streaming/installing-siddhi-extensions/installed-status.png)
...
1. To uninstall an extension, click **UnInstall** for it.
    ...
    [![Installed Extension](../../assets/img/streaming/installing-siddhi-extensions/an-installed-extension.png){: style="width:60%"}](../../assets/img/streaming/installing-siddhi-extensions/an-installed-extension.png)
...
2. If the extension you are uninstalling has shared dependencies with one or more other extensions, a message appears with information as shown in the example below.
    ...
    [![Shared Dependencies Exist Dialog Box](../../assets/img/streaming/installing-siddhi-extensions/shared-dependencies-exist-dialog-box.png){: style="width:80%"}](../../assets/img/streaming/installing-siddhi-extensions/shared-dependencies-exist-dialog-box.png)
...
[![Manually Installable Dependencies Available for Extension](../../assets/img/streaming/installing-siddhi-extensions/manually-installable-dependencies-available.png){: style="width:60%"}](../../assets/img/streaming/installing-siddhi-extensions/manually-installable-dependencies-available.png)

Click this information to open a dialog box as shown below with information about the dependency.
    
[![Manually Installable Dependency Instructions](../../assets/img/streaming/installing-siddhi-extensions/manually-installable-instructions.png){: style="width:80%"}](../../assets/img/streaming/installing-siddhi-extensions/manually-installable-instructions.png)
...
When you are working with [custom extensions](../../reference/streaming-connectors/writing-custom-siddhi-extensions.md), and if you want a custom extension to be installable from the Extension Installer, you need to add the configuration of the extension to this configuration file.
