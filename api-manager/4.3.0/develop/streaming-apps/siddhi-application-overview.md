...
description: "Explains the format and structure of a Siddhi application file used for streaming integration logic."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/siddhi-application-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/develop/streaming-apps/siddhi-application-overview.md
tags:
  - api-manager
  - develop
  - streaming-apps
