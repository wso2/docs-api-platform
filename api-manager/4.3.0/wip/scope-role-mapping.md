---
title: "Scope mapping"
description: "Shows how to modify REST API scope-to-role mappings and rename roles using the Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/wip/scope-role-mapping/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/wip/scope-role-mapping.md
tags:
  - api-manager
  - wip
  - scope-role-mapping
