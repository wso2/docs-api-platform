...
description: "Subscribe to an API, generate an OAuth2 key, and invoke it using a SOAP client such as SOAP UI."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/invoke-apis/invoke-apis-using-tools/invoke-an-api-using-a-soap-client/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/invoke-apis/invoke-apis-using-tools/invoke-an-api-using-a-soap-client.md
tags:
  - api-manager
  - consume
  - invoke-apis
