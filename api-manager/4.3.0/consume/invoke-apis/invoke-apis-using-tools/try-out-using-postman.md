...
description: "Download a Postman collection for an OpenAPI definition from the Developer Portal and test the REST API in Postman."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/invoke-apis/invoke-apis-using-tools/try-out-using-postman/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/invoke-apis/invoke-apis-using-tools/try-out-using-postman.md
tags:
  - api-manager
  - consume
  - invoke-apis
