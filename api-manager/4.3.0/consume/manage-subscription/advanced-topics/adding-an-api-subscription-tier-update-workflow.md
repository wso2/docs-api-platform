...
description: "Enable an approval workflow executor so an admin must approve API subscription tier change requests."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/manage-subscription/advanced-topics/adding-an-api-subscription-tier-update-workflow/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/manage-subscription/advanced-topics/adding-an-api-subscription-tier-update-workflow.md
tags:
  - api-manager
  - consume
  - manage-subscription
