...
description: "Change the browser language for the API Publisher and Developer Portal, and add support for new languages."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/customizations/adding-internationalization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/consume/customizations/adding-internationalization.md
tags:
  - api-manager
  - consume
  - customizations
...
!!! info
    ...
    !!! tip
        Learn more about [Tenant theming](../../consume/customizations/../../reference/customize-product/customizations/customizing-the-developer-portal/overriding-developer-portal-theme.md#uploading-devportal-theme-via-the-admin-portal-tenants-only).
