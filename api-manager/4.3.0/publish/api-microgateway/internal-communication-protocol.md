...
description: "Explains the xDS-based gRPC protocol WSO2 API Microgateway uses for communication between the Adapter and Enforcer."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/publish/api-microgateway/internal-communication-protocol/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/publish/api-microgateway/internal-communication-protocol.md
tags:
  - api-manager
  - publish
  - api-microgateway
