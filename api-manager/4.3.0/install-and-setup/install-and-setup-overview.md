...
description: "Outlines installation and setup topics for the API Manager, Micro Integrator, and Streaming Integrator components."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install-and-setup-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install-and-setup-overview.md
tags:
  - api-manager
  - install-and-setup
