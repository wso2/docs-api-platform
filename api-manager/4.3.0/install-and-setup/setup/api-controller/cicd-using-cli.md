...
description: "Build a CI/CD pipeline for APIs using apictl and the CLI, covering environment setup, API creation, export, and promotion."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/cicd-using-cli/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/cicd-using-cli.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
!!! More
    Next let us use the above knowledge to create a [Jenkins CI/CD Pipeline with WSO2 API Management for a Dev First Approach](../../../install-and-setup/setup/api-controller/building-jenkins-ci-cd-pipeline.md).