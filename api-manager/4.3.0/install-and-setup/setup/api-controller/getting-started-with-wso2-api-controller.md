...
description: "Download, initialize, and configure apictl, including global flags, version checks, and proxy environment variables."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/getting-started-with-wso2-api-controller/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/getting-started-with-wso2-api-controller.md
tags:
  - api-manager
  - install-and-setup
  - setup
