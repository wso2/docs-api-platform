...
description: "Learn how apictl automates promoting APIs between environments in a CI/CD pipeline for WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/ci-cd-with-wso2-api-management/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/ci-cd-with-wso2-api-management.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
-   [Building a CI/CD Pipeline for APIs using Jenkins](../../../install-and-setup/setup/api-controller/building-jenkins-ci-cd-pipeline.md)