...
description: "Generate a deployment directory and configure an apictl parameters file for environment-specific API details."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/advanced-topics/configuring-environment-specific-parameters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/api-controller/advanced-topics/configuring-environment-specific-parameters.md
tags:
  - api-manager
  - install-and-setup
  - setup
