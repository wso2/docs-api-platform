...
description: "Review API Manager performance test results for GraphQL APIs across varying query operation counts and concurrent users."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/deployment-best-practices/performance-tests-results-graphql/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/deployment-best-practices/performance-tests-results-graphql.md
tags:
  - api-manager
  - install-and-setup
  - setup
