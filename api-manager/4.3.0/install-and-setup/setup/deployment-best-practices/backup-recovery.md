...
description: "Identify what to back up in a WSO2 API Manager deployment and plan recovery time and point objectives."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/deployment-best-practices/backup-recovery/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/deployment-best-practices/backup-recovery.md
tags:
  - api-manager
  - install-and-setup
  - setup
