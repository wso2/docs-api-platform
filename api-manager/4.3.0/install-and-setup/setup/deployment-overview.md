...
description: "Compare API Manager deployment patterns, from standard HA to fully distributed clusters, based on expected workload."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/deployment-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/deployment-overview.md
tags:
  - api-manager
  - install-and-setup
  - setup
