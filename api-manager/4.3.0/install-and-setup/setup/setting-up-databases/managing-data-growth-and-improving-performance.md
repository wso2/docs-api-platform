...
description: "Configure regular and deep cleanup of tokens, sessions, and registry data to control database growth and performance."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/setting-up-databases/managing-data-growth-and-improving-performance/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/setting-up-databases/managing-data-growth-and-improving-performance.md
tags:
  - api-manager
  - install-and-setup
  - setup
