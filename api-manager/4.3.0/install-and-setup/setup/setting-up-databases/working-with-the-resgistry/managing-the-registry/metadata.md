---
title: "Metadata"
description: "View resource metadata and manage revisions using the Create Checkpoint and View Versions options in the registry."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/metadata/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/metadata.md
tags:
  - api-manager
  - install-and-setup
  - setup
