...
description: "Connect Okta as a third-party SAML identity provider to WSO2 API Manager for single sign-on."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/sso/okta-as-an-external-idp-using-saml/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/sso/okta-as-an-external-idp-using-saml.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
2. Download the latest WSO2 API Manager distribution from [https://wso2.com/api-management/](https://wso2.com/api-management/)
...
2.  Go to **Applications** -> **Add Application**.
    [![Add new Okta SAML application](../../../assets/img/learn/okta-saml-add-app.png)](../../../assets/img/learn/okta-saml-add-app.png)

3.  Click **Create New Application**.
    [![Create new Okta SAML application](../../../assets/img/learn/okta-saml-create-new-app.png)](../../../assets/img/learn/okta-saml-create-new-app.png)

4.  Select **Web** as the **Platform**. Select **SAML 2.0** as the sign-on method.
    [![Create a new application integration](../../../assets/img/learn/okta-saml-create-saml-app.png)](../../../assets/img/learn/okta-saml-create-saml-app.png)

5.  Enter the **General Settings** as shown in the images below.
    [![Enter application name](../../../assets/img/learn/okta-saml-create-saml-app-name.png)](../../../assets/img/learn/okta-saml-create-saml-app-name.png)
    
    [![Enter application details](../../../assets/img/learn/okta-saml-create-saml-app-details.png)](../../../assets/img/learn/okta-saml-create-saml-app-details.png)
...
6.  Inside the SAML app you created go to **Sign On** and click **View Setup Instructions**.
    ...
    [![View Setup Instructions](../../../assets/img/learn/okta-saml-create-new-app-config1.png)](../../../assets/img/learn/okta-saml-create-new-app-config1.png)
    ...
    1.  Scroll up to the **Provide the following IDP metadata to your SP provider** section. Copy and save the details given to a XML file.
        ...
        [![Copy and save xml](../../../assets/img/learn/okta-saml-create-new-app-config2.png)](../../../assets/img/learn/okta-saml-create-new-app-config2.png)

    2.  Go to **Assignments** -> **Assign**. Click **Assign to People** and assign your current user.

        [![Assign your current user](../../../assets/img/learn/okta-saml-create-new-app-assign.png)](../../../assets/img/learn/okta-saml-create-new-app-assign.png)
...
8.  Follow these steps to add a new attribute to the default user profile of Okta to represent the user role. 
    ...
    1.  Navigate to **Users** -> **Profile Editor** and click the pencil icon to edit the default profile.
        ...
        [![Edit the default profile in the Profile Editor](../../../assets/img/learn/okta-add-new-attribute.png)](../../../assets/img/learn/okta-add-new-attribute.png)
