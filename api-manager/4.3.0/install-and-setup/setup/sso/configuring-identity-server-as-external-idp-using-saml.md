...
description: "Configure SAML 2.0 single sign-on across the API Publisher and Developer Portal using WSO2 Identity Server as the identity provider."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/sso/configuring-identity-server-as-external-idp-using-saml/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/sso/configuring-identity-server-as-external-idp-using-saml.md
tags:
  - api-manager
  - install-and-setup
  - setup
