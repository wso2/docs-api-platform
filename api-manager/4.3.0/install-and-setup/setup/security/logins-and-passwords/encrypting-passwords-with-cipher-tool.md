...
description: "Use the Cipher Tool to encrypt plain text passwords in configuration files, either automatically or manually."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/logins-and-passwords/encrypting-passwords-with-cipher-tool/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/logins-and-passwords/encrypting-passwords-with-cipher-tool.md
tags:
  - api-manager
  - install-and-setup
  - setup
