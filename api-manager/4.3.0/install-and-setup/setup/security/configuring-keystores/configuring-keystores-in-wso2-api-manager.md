...
description: "Explains the primary, secondary, and internal keystores used in WSO2 API Manager and how to configure them."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/configuring-keystores/configuring-keystores-in-wso2-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/configuring-keystores/configuring-keystores-in-wso2-api-manager.md
tags:
  - api-manager
  - install-and-setup
  - setup
