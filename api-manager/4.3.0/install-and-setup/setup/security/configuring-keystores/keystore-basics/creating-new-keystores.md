...
description: "Create new keystores for WSO2 API Manager using an existing certificate or by generating a new certificate."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores.md
tags:
  - api-manager
  - install-and-setup
  - setup
