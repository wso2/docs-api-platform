...
description: "Enable the Java Security Manager and sign JARs to enforce Java security policies for WSO2 products."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/enabling-java-security-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/security/enabling-java-security-manager.md
tags:
  - api-manager
  - install-and-setup
  - setup
