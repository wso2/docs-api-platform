...
description: "List the default ports used by each WSO2 API Manager runtime component when the port offset is set to 0."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/reference/default-product-ports/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/reference/default-product-ports.md
tags:
  - api-manager
  - install-and-setup
  - setup
