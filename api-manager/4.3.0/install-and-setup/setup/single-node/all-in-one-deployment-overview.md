...
description: "Compare single node and active-active all-in-one deployment options for WSO2 API Manager setups."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/single-node/all-in-one-deployment-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/single-node/all-in-one-deployment-overview.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
!!! info
    For more information on manually configuring a single node API-M production server, see [Configuring a Single Node](../../../install-and-setup/setup/single-node/configuring-a-single-node.md).
...
<a href="../../../../assets/img/setup-and-install/active-active-apim-deployment.png"><img src="../../../../assets/img/setup-and-install/active-active-apim-deployment.png" alt="active-active apim deployment" width="60%"></a>
...
!!! info
    For more information on manually configuring active-active API-M production servers, see [Configuring an Active-Active Deployment](../../../install-and-setup/setup/single-node/configuring-an-active-active-deployment.md).