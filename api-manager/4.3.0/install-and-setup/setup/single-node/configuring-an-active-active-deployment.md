...
description: "Configure WSO2 API Manager as an active-active deployment with two all-in-one nodes for high availability."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/single-node/configuring-an-active-active-deployment/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/single-node/configuring-an-active-active-deployment.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
Follow the steps in [Configuring the Proxy Server and the Load Balancer](../../../install-and-setup/setup/setting-up-proxy-server-and-the-load-balancer/configuring-the-proxy-server-and-the-load-balancer.md) to configure the load balancer/reverse proxy which is fronting the API-M nodes
...
information on default databases and changing them into RDBMS databases, see [Working with Databases](../../../install-and-setup/setup/setting-up-databases/overview.md).
...
!!! info
    ...
    in [step 1](../../../install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores.md).
