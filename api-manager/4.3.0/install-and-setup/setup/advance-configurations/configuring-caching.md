...
description: "Configure API Gateway and Key Manager caching, timeouts, and cache clearing behavior in deployment.toml."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/advance-configurations/configuring-caching/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/advance-configurations/configuring-caching.md
tags:
  - api-manager
  - install-and-setup
  - setup
