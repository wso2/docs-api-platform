...
description: "Switch the WSO2 API Manager crypto provider between Bouncy Castle and the FIPS-compliant Bouncy Castle FIPS provider."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/advance-configurations/configuring-the-crypto-provider/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/advance-configurations/configuring-the-crypto-provider.md
tags:
  - api-manager
  - install-and-setup
  - setup
