---
title: "Deploying SI as a minimum HA cluster in AWS ECS"
description: "Deploy WSO2 Streaming Integrator as a minimum high availability cluster on AWS ECS with active and passive nodes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-deployment/deploying-si-as-minimum-ha-cluster-in-aws-ecs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-deployment/deploying-si-as-minimum-ha-cluster-in-aws-ecs.md
tags:
  - api-manager
  - install-and-setup
  - setup
