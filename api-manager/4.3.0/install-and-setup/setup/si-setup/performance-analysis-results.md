...
description: "Review performance test results for WSO2 Streaming Integrator when consuming events via Kafka and HTTP sources."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-setup/performance-analysis-results/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-setup/performance-analysis-results.md
tags:
  - api-manager
  - install-and-setup
  - setup
