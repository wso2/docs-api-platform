...
description: "Configure data sources for the Streaming Integrator server and tooling runtimes for supported database types."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-setup/configuring-data-sources/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-setup/configuring-data-sources.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
!!!info
    ...
    `<SI_HOME>|<SI_TOOLING_HOME>/lib` directory. For detailed instructions,see [Adding Third Party Non OSGi Libraries](../../../install-and-setup/setup/si-setup/adding-third-party-non-osgi-libraries.md).
...
???info "Oracle"
    ...
    instructions, see [Adding Third Party Non OSGi Libraries](../../../install-and-setup/setup/si-setup/adding-third-party-non-osgi-libraries.md).
