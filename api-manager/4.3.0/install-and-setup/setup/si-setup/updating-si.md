...
description: "Learn how WSO2 Updates and the in-place update tool keep WSO2 Streaming Integrator patched with the latest fixes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-setup/updating-si/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/setup/si-setup/updating-si.md
tags:
  - api-manager
  - install-and-setup
  - setup
