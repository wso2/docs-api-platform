...
description: "Shows how to deploy WSO2 API Manager on Kubernetes using Helm resources and configure traffic routing."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install/deploying-api-manager-with-kubernetes-or-openshift-resources/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install/deploying-api-manager-with-kubernetes-or-openshift-resources.md
tags:
  - api-manager
  - install-and-setup
  - install
...
4.  Access Management Console.
    ...
    1.  Obtain the external IP (`EXTERNAL-IP`) depending on your traffic routing method.
        ...
        If you are using legacy Ingress:
        ...
        <RELEASE_NAME>-am-all-in-one-am-gateway-ingress     nginx   gw.wso2.com          <ADDRESS> 80, 443   8s

        <RELEASE_NAME>-am-all-in-one-am-ingress             nginx   am.wso2.com          <ADDRESS> 80, 443   8s

        <RELEASE_NAME>-am-all-in-one-am-websocket-ingress   nginx   websocket.wso2.com   <ADDRESS> 80, 443   8s

        <RELEASE_NAME>-am-all-in-one-am-websub-ingress      nginx   websub.wso2.com      <ADDRESS> 80, 443   8s
        ```
