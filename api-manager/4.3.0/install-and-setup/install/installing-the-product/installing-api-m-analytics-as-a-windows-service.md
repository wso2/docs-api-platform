...
description: "Shows how to set up API Manager Analytics 3.2.0 as a Windows service using the YAJSW wrapper."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install/installing-the-product/installing-api-m-analytics-as-a-windows-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install/installing-the-product/installing-api-m-analytics-as-a-windows-service.md
tags:
  - api-manager
  - install-and-setup
  - install
