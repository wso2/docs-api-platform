...
description: "Set up the YAJSW wrapper configuration file to install and run WSO2 API Manager as a Windows service."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install/installing-the-product/installing-api-m-as-a-windows-service/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/install-and-setup/install/installing-the-product/installing-api-m-as-a-windows-service.md
tags:
  - api-manager
  - install-and-setup
  - install
