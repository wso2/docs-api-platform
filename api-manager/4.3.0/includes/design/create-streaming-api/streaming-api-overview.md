...
The [Streaming Integrator component]({BASE_URL}/api-manager/4.3.0/streaming/streaming-overview/) in WSO2 API Manager (WSO2 API-M) supports Streaming APIs via the following main protocols, which are compatible with HTTP.

- **[WebSocket]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-websocket-streaming-api/)**
- **[WebSub (WebHook)]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-websub-streaming-api/)**
- **[Server Sent Events (SSE)]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-sse-streaming-api/)**
...
When you create a WebSocket API, WebSub API/ WebHook API, or SSE API, it links an existing streaming backend API implementation to the <a href="{BASE_URL}/api-manager/4.3.0/get-started/apim-architecture/#api-publisher">API Publisher,</a> so that you can manage and monitor your [API's lifecycle]({BASE_URL}/api-manager/4.3.0/design/lifecycle-management/api-lifecycle/), documentation, security, community, and subscriptions. 

You can define Streaming APIs using [AsyncAPI](https://www.asyncapi.com/) definitions. Therefore, alternatively, you can also **[create a Streaming API, which supports any one of the above protocols, using an AsyncAPI definition.]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-streaming-api-from-an-asyncapi-definition/)**
...
- Create a Streaming API:
     - [Create a WebSocket API]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-websocket-streaming-api/)
     - [WebSub (WebHook)]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-websub-streaming-api/)
     - [Server Sent Events (SSE)]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-sse-streaming-api/)
     - [Create a Streaming API from an AsyncAPI Definition]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/create-a-streaming-api-from-an-asyncapi-definition/)
- [Test a WebSub/WebHook API]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/create-streaming-api/test-a-websub-api/)
- [Learn how to expose a stream as a managed API]({BASE_URL}/api-manager/4.3.0/use-cases/streaming-usecase/exposing-stream-as-managed-api-in-service-catalog/).
- [Learn how you can use a third-party Streaming Provider as opposed to WSO2 Streaming Integrator, which is used by default, to create a Streaming API]({BASE_URL}/api-manager/4.3.0/get-started/streaming-quick-start-guide/).