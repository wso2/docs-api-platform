...
4.  Click **CREATE**.
     ...
     [![Overview of WebSub API]({BASE_URL}/api-manager/4.3.0/assets/img/tutorials/streaming-api/websub-api-overview.png)]({BASE_URL}/api-manager/4.3.0/assets/img/tutorials/streaming-api/websub-api-overview.png)
...
2. Modify the topics as follows and click **Save** to update them.
    ...
    1. Optionally, click delete, as shown below, to delete an existing topic.
        ...
        <a href="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-delete-default-topic.png"><img src="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-delete-default-topic.png" width="80%" alt="WebSub API Delete Existing Topic"></a>

    2. Select **sub** under **Types**, enter the **Topic Name**, and click **+** as shown below, to add a new topic.

         <a href="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-add-topic.png"><img src="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-add-topic.png" width="80%" alt="WebSub API Add Topic"></a>

         The newly added topic is displayed as follows.

         <a href="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-api-newly-added-topic.png"><img src="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-api-newly-added-topic.png" width="80%" alt="WebSub API Newly Added Topic"></a>
...
The AsyncAPI definition of the streaming API, which you just created, appears.
   ...
   <a href="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-api-asyncapi.png"><img src="{BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-api-asyncapi.png" width="80%" alt="WebHook API AsyncAPI Definition"></a>
...
1. Click **Runtime** under **API Configurations**.
    ...
    [![WebSub API Runtime Configurations Page]({BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-api-runtime-configurations.png)]({BASE_URL}/api-manager/4.3.0/assets/img/design/create-api/streaming-api/websub-api-runtime-configurations.png)
...
4. Click **Generate**, which will generate a secret.
     ...
     <a href="{BASE_URL}/api-manager/4.3.0/assets/img/tutorials/streaming-api/websub-api-generate-secret.png"><img src="{BASE_URL}/api-manager/4.3.0/assets/img/tutorials/streaming-api/websub-api-generate-secret.png" width="80%" alt="WebSub API Generate Secret"></a>
...
Learn more by trying out an end-to-end tutorial on <a href="{BASE_URL}/api-manager/4.3.0/tutorials/streaming-api/create-and-publish-websub-api/">Creating and Publishing a WebSub API</a>, which uses the default Streaming Provider that works with WSO2 API Manager, namely the WSO2 Streaming Integrator.
