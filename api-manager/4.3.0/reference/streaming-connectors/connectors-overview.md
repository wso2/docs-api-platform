...
description: "Describes the Siddhi extension architecture, extension namespaces, syntax, and the extension types supported by Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/streaming-connectors/connectors-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/streaming-connectors/connectors-overview.md
tags:
  - api-manager
  - reference
...
- For instructions to download and install a Siddhi extension, see [Downloading and Installing Siddhi Extensions](../../reference/streaming-connectors/downloading-and-installing-siddhi-extensions.md).
- If you want to install/uninstall one or more Siddhi extensions in Streaming Integrator Tooling, see [Installing Siddhi Extensions](../../develop/streaming-apps/installing-siddhi-extensions.md).