...
description: "Explains how to override default system parameter values for Siddhi extensions in the deployment.yaml configuration file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/streaming-connectors/configuring-system-parameters-for-siddhi-extensions/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/streaming-connectors/configuring-system-parameters-for-siddhi-extensions.md
tags:
  - api-manager
  - reference
