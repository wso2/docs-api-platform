---
title: "FAQ"
description: "Answers frequently asked questions about WSO2 API Manager licensing, support, ports, protocols, and deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/faq/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/faq.md
tags:
  - api-manager
  - reference
  - faq
...
See [Deploying WSO2 API Manager](../install-and-setup/setup/deployment-overview.md).
...
To set visibility of the API only to selected user roles in the server, see [API Visibility](../design/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal.md).
...
!!!note
    This config is only available after U2 level 59 onwards.
