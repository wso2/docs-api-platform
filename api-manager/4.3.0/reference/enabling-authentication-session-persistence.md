...
description: "Enable and configure authentication session persistence so remember-me sessions survive in API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/enabling-authentication-session-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/enabling-authentication-session-persistence.md
tags:
  - api-manager
  - reference
