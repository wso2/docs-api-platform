...
description: "Describes the directory structure shared by all Carbon-based WSO2 products, including API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/directory-structure-of-wso2-products/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/directory-structure-of-wso2-products.md
tags:
  - api-manager
  - reference
  - guides
