...
description: "Explains the handlers, mediation extensions, and sequences that process requests in the API Manager Gateway."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/message-flow-in-the-api-manager-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/message-flow-in-the-api-manager-gateway.md
tags:
  - api-manager
  - reference
  - guides
