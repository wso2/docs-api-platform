...
description: "Follow the general steps for upgrading a Carbon 4.4.6-based product database and configuration to Carbon 4.4.7."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/database-upgrade-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/database-upgrade-guide.md
tags:
  - api-manager
  - reference
  - guides
