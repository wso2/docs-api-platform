...
description: "Explains how to configure client applications to handle authentication when multiple devices access API Manager at once."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/accessing-api-manager-by-multiple-devices-simultaneously/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/guides/accessing-api-manager-by-multiple-devices-simultaneously.md
tags:
  - api-manager
  - reference
  - guides
