...
description: "Explains the TOML based configuration model in WSO2 API Manager and how it maps to the deployment.toml file and j2 templates."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/understanding-the-new-configuration-model/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/understanding-the-new-configuration-model.md
tags:
  - api-manager
  - reference
