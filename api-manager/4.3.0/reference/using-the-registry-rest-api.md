...
description: "Explains how to deploy and use the registry REST API to perform CRUD operations on WSO2 API Manager registry resources."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/using-the-registry-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/using-the-registry-rest-api.md
tags:
  - api-manager
  - reference
...
1.  Download the [registry REST API webapp](../assets/attachments/resource.war).
