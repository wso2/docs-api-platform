...
description: "Learn how the API Manager Developer Portal complies with WCAG 2.1 Level A and AA accessibility guidelines."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/accessibility-compliance/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/accessibility-compliance.md
tags:
  - api-manager
  - reference
