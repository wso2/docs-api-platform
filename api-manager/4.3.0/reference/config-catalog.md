...
description: "Reference catalog of configuration parameters and sections available in the API Manager deployment.toml file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/config-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/config-catalog.md
tags:
  - api-manager
  - reference
  - config-catalog
...
enable_revoke_token_cleanup = true
 ...
 RSA/ECB/OAEPwithSHA1andMGF1PaddingIf FALSE - Setting Up OAuth Token Encryption | Extension Points for OAuth - IS Docs</p>
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>Configuration used to disable the revoke token cleanup functionality. If set to false, revoked tokens will not be cleaned up. Note that this configuration is supported from update level 60 onwards.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
