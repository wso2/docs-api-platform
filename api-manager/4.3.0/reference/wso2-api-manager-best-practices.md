...
description: "Lists recommended practices for naming APIs, versioning APIs, and designing resources when working with WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/wso2-api-manager-best-practices/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/wso2-api-manager-best-practices.md
tags:
  - api-manager
  - reference
