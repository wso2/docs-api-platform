...
description: "Lists the vendor specific OpenAPI extensions, such as x-auth-type and x-throttling-tier, supported by WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/vendor-extensions-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/vendor-extensions-catalog.md
tags:
  - api-manager
  - reference
