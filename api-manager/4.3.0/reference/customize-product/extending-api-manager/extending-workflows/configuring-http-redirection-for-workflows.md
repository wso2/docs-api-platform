...
description: "Configure a custom workflow extension to redirect subscribers to a third-party entity such as a payment collection page."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/extending-api-manager/extending-workflows/configuring-http-redirection-for-workflows/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/extending-api-manager/extending-workflows/configuring-http-redirection-for-workflows.md
tags:
  - api-manager
  - reference
  - customize-product
