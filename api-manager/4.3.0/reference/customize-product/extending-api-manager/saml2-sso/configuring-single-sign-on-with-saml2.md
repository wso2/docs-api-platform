...
description: "Explains how SAML2 single sign-on works in API Manager and links to the SSO configuration guides for Identity Server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/extending-api-manager/saml2-sso/configuring-single-sign-on-with-saml2/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/extending-api-manager/saml2-sso/configuring-single-sign-on-with-saml2.md
tags:
  - api-manager
  - reference
  - customize-product
