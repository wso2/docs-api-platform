...
description: "Write a custom Spectral linting rule to enforce API definition standards, such as validating a corporate contact email pattern."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/customizations/define-custom-linters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/customizations/define-custom-linters.md
tags:
  - api-manager
  - reference
  - customize-product
