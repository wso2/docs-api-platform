...
description: "Attach a custom workflow to the user signup operation using the Enterprise Integrator or Business Process Server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/customizations/adding-a-user-signup-workflow-using-bps/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/customizations/adding-a-user-signup-workflow-using-bps.md
tags:
  - api-manager
  - reference
  - customize-product
...
!!! note
    You can either use the **Enterprise Integrator(EI)** or the **Business Process Server(BPS)** for the business process tasks with API Manager during the Workflow configuration process.
...
!!! note
    Follow this sub section, only if you will be using the **Enterprise Integrator(EI)** for the business process tasks. If not please refer the sub section for [Configuring the Business Process Server](#configuring-the-business-process-server).
