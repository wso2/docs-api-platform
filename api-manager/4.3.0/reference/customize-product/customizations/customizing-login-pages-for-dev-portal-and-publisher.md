...
description: "Customize SAML2 SSO, OAuth, and OpenID login pages for the Developer Portal and Publisher authentication endpoint."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/customizations/customizing-login-pages-for-dev-portal-and-publisher/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/reference/customize-product/customizations/customizing-login-pages-for-dev-portal-and-publisher.md
tags:
  - api-manager
  - reference
  - customize-product
