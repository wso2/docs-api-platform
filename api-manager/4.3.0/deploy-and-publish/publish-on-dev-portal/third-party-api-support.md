...
description: "Publish and manage third-party APIs deployed on external gateways that are advertised but not proxied by WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/publish-on-dev-portal/third-party-api-support/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/publish-on-dev-portal/third-party-api-support.md
tags:
  - api-manager
  - deploy-and-publish
