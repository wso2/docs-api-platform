...
description: "Configure and publish an API to external Developer Portals of other tenants to advertise it to a wider community."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/publish-on-dev-portal/publish-to-multiple-external-api-stores/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/publish-on-dev-portal/publish-to-multiple-external-api-stores.md
tags:
  - api-manager
  - deploy-and-publish
