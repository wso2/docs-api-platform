...
description: "Import an API from AWS API Gateway into WSO2 API Manager using apictl so it can be published on the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/publish-on-dev-portal/publish-aws-apis-in-the-dev-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/publish-on-dev-portal/publish-aws-apis-in-the-dev-portal.md
tags:
  - api-manager
  - deploy-and-publish
