...
description: "Pass end-user attributes to the backend as a JWT, configure Base64URL encoding, and validate the JWT using JWKS."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/passing-enduser-attributes-to-the-backend-via-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/passing-enduser-attributes-to-the-backend-via-api-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
...
--8<-- "api-manager/4.3.0/includes/deploy/backend-jwt-intro.md"
...
--8<-- "api-manager/4.3.0/includes/deploy/backend-jwt-note.md"
...
--8<-- "api-manager/4.3.0/includes/deploy/backend-jwt-gw-note.md"
