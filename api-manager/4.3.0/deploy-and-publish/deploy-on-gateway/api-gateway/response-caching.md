...
description: "Enable response caching for an API in the Publisher to reduce redundant backend processing and improve performance."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/response-caching/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/response-caching.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
