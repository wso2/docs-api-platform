...
description: "Plan Gateway and Traffic Manager capacity, key caching, and clustering ratios to scale API traffic effectively."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/scaling-the-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/scaling-the-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
