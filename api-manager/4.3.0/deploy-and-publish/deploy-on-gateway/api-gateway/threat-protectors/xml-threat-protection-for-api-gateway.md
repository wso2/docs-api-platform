...
description: "Configure the XML threat protector's validator sequence to limit XML payload depth and elements against attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/threat-protectors/xml-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/threat-protectors/xml-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
