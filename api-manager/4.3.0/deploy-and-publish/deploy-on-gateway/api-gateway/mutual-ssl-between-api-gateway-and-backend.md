...
description: "Enable mutual SSL between the API Gateway and backend by exchanging and importing certificates into each truststore."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/mutual-ssl-between-api-gateway-and-backend/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/deploy-and-publish/deploy-on-gateway/api-gateway/mutual-ssl-between-api-gateway-and-backend.md
tags:
  - api-manager
  - deploy-and-publish
  - deploy-on-gateway
