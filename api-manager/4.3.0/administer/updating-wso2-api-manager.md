...
description: "Update WSO2 API Manager using WSO2 Updates or in-place updates, and re-optimize profiles in distributed deployments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/updating-wso2-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/updating-wso2-api-manager.md
tags:
  - api-manager
  - administer
