...
description: "Reference the JMX MBeans available for monitoring connections, latency, threading, and transports in API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/logging-and-monitoring/monitoring/jmx-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/logging-and-monitoring/monitoring/jmx-monitoring.md
tags:
  - api-manager
  - administer
