...
description: "Configure distributed tracing for API Manager using OpenTracing with Jaeger, Zipkin, or log-based tracers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/logging-and-monitoring/monitoring/monitoring-with-opentracing/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/logging-and-monitoring/monitoring/monitoring-with-opentracing.md
tags:
  - api-manager
  - administer
