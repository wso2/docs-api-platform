...
description: "Learn what a user store is and the read/write and read-only modes it can operate in within API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/managing-users-and-roles/managing-user-stores/introduction-to-userstores/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/managing-users-and-roles/managing-user-stores/introduction-to-userstores.md
tags:
  - api-manager
  - administer
