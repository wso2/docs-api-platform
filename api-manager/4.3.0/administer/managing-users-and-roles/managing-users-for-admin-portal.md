...
description: "Create a restricted role and permission mapping so a user can access only the Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/managing-users-and-roles/managing-users-for-admin-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/managing-users-and-roles/managing-users-for-admin-portal.md
tags:
  - api-manager
  - administer
