...
description: "Configure PingFederate as a third-party key manager using the WSO2 API-M PingFederate connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-pingfederate-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-pingfederate-connector.md
tags:
  - api-manager
  - administer
  - key-managers
