...
description: "Configure Okta as a third-party key manager to manage the OAuth clients and tokens used by API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-okta-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-okta-connector.md
tags:
  - api-manager
  - administer
  - key-managers
