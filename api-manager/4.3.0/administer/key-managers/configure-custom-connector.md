...
description: "Write, deploy, and register a custom key manager connector to integrate an external OAuth authorization server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-custom-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-custom-connector.md
tags:
  - api-manager
  - administer
  - key-managers
