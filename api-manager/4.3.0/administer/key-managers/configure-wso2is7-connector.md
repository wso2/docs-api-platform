...
description: "Configure WSO2 Identity Server 7.x as a third-party key manager, including its known limitations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-wso2is7-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-wso2is7-connector.md
tags:
  - api-manager
  - administer
  - key-managers
  - configure-wso2is7-connector
