...
description: "Configure Auth0 as a third-party key manager to manage the OAuth clients and tokens used by WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-auth0-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-auth0-connector.md
tags:
  - api-manager
  - administer
  - key-managers
