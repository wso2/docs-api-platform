...
description: "Configure ForgeRock as a third-party key manager using the WSO2 API-M ForgeRock connector."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-forgerock-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/key-managers/configure-forgerock-connector.md
tags:
  - api-manager
  - administer
  - key-managers
