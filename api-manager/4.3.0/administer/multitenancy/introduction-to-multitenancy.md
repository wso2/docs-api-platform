...
description: "Learn how multitenancy isolates tenants sharing a single WSO2 API Manager server and how tenant idle timeout works."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/multitenancy/introduction-to-multitenancy/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/multitenancy/introduction-to-multitenancy.md
tags:
  - api-manager
  - administer
  - multitenancy
