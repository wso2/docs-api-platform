...
description: "Add, view, and manage tenants in the WSO2 API Manager management console, including required registration fields."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/multitenancy/managing-tenants/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/administer/multitenancy/managing-tenants.md
tags:
  - api-manager
  - administer
  - multitenancy
