...
description: "Configure and use audit logs to trace user actions and system changes in WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager/monitoring-audit-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager/monitoring-audit-logs.md
tags:
  - api-manager
  - observe
