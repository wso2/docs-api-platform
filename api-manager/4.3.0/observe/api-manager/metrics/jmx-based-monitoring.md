...
description: "Configure and disable JMX ports to monitor WSO2 API Manager MBeans with tools such as JConsole."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager/metrics/jmx-based-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager/metrics/jmx-based-monitoring.md
tags:
  - api-manager
  - observe
  - metrics
