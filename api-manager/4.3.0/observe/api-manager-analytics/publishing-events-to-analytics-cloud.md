...
description: "Configure WSO2 API Manager to publish analytics events to the analytics cloud for viewing in a hosted dashboard."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager-analytics/publishing-events-to-analytics-cloud/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager-analytics/publishing-events-to-analytics-cloud.md
tags:
  - api-manager
  - observe
