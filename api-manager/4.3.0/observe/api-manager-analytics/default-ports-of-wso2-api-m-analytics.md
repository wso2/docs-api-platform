...
description: "Reference the default Thrift, REST, HTTPS, and dashboard ports used by WSO2 API-M Analytics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager-analytics/default-ports-of-wso2-api-m-analytics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/api-manager-analytics/default-ports-of-wso2-api-m-analytics.md
tags:
  - api-manager
  - observe
