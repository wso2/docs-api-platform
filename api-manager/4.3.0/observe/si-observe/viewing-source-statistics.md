...
description: "View the source statistics dashboard showing source mapper latency and throughput in the Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/si-observe/viewing-source-statistics/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/si-observe/viewing-source-statistics.md
tags:
  - api-manager
  - observe
  - si-observe
