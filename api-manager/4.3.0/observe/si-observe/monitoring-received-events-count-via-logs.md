...
description: "Configure the Streaming Integrator to log the total count of received events at a specified time interval."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/si-observe/monitoring-received-events-count-via-logs/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/observe/si-observe/monitoring-received-events-count-via-logs.md
tags:
  - api-manager
  - observe
  - si-observe
