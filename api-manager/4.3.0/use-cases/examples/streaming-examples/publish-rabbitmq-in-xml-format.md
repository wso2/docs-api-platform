---
title: "Publishing XML events via RabbitMQ"
description: "Configure Streaming Integrator to publish events over RabbitMQ transport in XML format and view them on a RabbitMQ consumer."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-rabbitmq-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-rabbitmq-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
