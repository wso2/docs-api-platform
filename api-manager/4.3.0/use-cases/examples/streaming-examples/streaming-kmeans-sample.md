...
description: "Use the streamingml kmeans incremental function to cluster events in a Siddhi application."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/streaming-kmeans-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/streaming-kmeans-sample.md
tags:
  - api-manager
  - use-cases
  - examples
