---
title: "Publishing Key-value events via JMS"
description: "Configure Streaming Integrator to publish events over JMS transport in key-value format using ActiveMQ."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-jms-in-keyvalue-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-jms-in-keyvalue-format.md
tags:
  - api-manager
  - use-cases
  - examples
