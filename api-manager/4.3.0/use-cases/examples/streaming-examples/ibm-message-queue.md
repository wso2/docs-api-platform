...
description: "Configure a Siddhi application to consume events from an IBM MQ queue and publish messages to it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/ibm-message-queue/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/ibm-message-queue.md
tags:
  - api-manager
  - use-cases
  - examples
