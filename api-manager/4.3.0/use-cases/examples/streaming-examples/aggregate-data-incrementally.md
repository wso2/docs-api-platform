...
description: "Run a Siddhi sample that calculates running statistics on raw material purchase data incrementally."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/aggregate-data-incrementally/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/aggregate-data-incrementally.md
tags:
  - api-manager
  - use-cases
  - examples
