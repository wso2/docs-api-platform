...
description: "Configure WSO2 Streaming Integrator to receive HL7 events converted to custom XML messages over the MLLP protocol."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/receive-hl7-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/receive-hl7-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
