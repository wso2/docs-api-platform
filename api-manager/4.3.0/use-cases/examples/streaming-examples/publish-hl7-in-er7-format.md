...
description: "Configure Streaming Integrator Tooling to send and receive HL7 events in ER7 format over MLLP."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-hl7-in-er7-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-hl7-in-er7-format.md
tags:
  - api-manager
  - use-cases
  - examples
