---
title: "Publishing XML events via HTTP"
description: "Configure Streaming Integrator Tooling to send production events via HTTP transport in default XML format."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-http-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-http-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
