...
description: "Configure Streaming Integrator to publish events over JMS transport in XML format using ActiveMQ."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-jms-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-jms-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
