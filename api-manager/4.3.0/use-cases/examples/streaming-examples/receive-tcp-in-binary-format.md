---
title: "Receiving binary events via TCP"
description: "Configure WSO2 Streaming Integrator to receive binary-format events over TCP transport and log low-production alerts."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/receive-tcp-in-binary-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/receive-tcp-in-binary-format.md
tags:
  - api-manager
  - use-cases
  - examples
