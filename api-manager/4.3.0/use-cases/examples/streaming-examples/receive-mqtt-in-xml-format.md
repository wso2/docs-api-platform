...
description: "Configure WSO2 Streaming Integrator to receive XML events over MQTT transport using a mosquitto broker."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/receive-mqtt-in-xml-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/receive-mqtt-in-xml-format.md
tags:
  - api-manager
  - use-cases
  - examples
