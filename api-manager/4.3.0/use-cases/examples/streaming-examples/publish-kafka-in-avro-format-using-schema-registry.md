...
description: "Configure Streaming Integrator to publish events over Kafka transport in Avro format using Confluent Schema Registry."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-kafka-in-avro-format-using-schema-registry/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-kafka-in-avro-format-using-schema-registry.md
tags:
  - api-manager
  - use-cases
  - examples
