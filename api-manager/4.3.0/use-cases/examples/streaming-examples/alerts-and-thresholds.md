...
description: "Run a Siddhi sample that sends an email alert when a transaction value exceeds a defined threshold."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/alerts-and-thresholds/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/alerts-and-thresholds.md
tags:
  - api-manager
  - use-cases
  - examples
...
2. To simulate events for the `TransactionStream` stream of the `AlertsAndThresholds`  Siddhi application, enter information in the **Single Simulation** tab of the event simulation panel as follows.
    ...
    ![Select Siddhi Application and Stream](../../../assets/img/streaming/alerts-and-thresholds-sample/alerts-and-thresholds-siddhi-app-stream.png)
...
3. Enter values for the attributes as follows:
    ...
    ![Enter Attribute Values](../../../assets/img/streaming/alerts-and-thresholds-sample/alerts-and-thresholds-single-simulation.png)
