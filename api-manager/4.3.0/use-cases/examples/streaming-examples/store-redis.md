...
description: "Perform CRUD operations on a Redis store using Siddhi queries, simulating events with an event simulator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/store-redis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/store-redis.md
tags:
  - api-manager
  - use-cases
  - examples
