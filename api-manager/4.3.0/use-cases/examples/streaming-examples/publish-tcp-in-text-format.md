---
title: "Publishing text events via TCP"
description: "Configure Streaming Integrator to publish events over TCP transport in text format and view the output on the console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-tcp-in-text-format/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-tcp-in-text-format.md
tags:
  - api-manager
  - use-cases
  - examples
