---
title: "Publish HTTP events via OAuth without an access token"
description: "Configure Streaming Integrator to send HTTP events to an OAuth-protected endpoint without supplying an access token."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-http-oauth-request-without-access-token/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/examples/streaming-examples/publish-http-oauth-request-without-access-token.md
tags:
  - api-manager
  - use-cases
  - examples
