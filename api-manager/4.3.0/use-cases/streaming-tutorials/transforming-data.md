...
description: "Transform streaming data from one format to another, such as converting CSV records to JSON, using the Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/streaming-tutorials/transforming-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/streaming-tutorials/transforming-data.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
...
10. Open the `Users/foo/output.json`. It contains the output events in JSON format as shown in the following extract.
    ...
    ![Converted JSON Events](../../assets/img/streaming/transforming-data-tutorial/json-events-extract.png)
...
8. Open the `Users/foo/flightdetails.json` file. The events you generated by issuing CURL commands are saved in JSON format as follows:
    ...
    ![Output JSON Events in Converted Format](../../assets/img/streaming/transforming-data-tutorial/converted-json-events-extract.png)
