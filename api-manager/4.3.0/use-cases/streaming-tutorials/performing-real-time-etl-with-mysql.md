...
description: "Perform real-time change data capture from a MySQL database using listening and polling modes in the Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/streaming-tutorials/performing-real-time-etl-with-mysql/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/streaming-tutorials/performing-real-time-etl-with-mysql.md
tags:
  - api-manager
  - use-cases
  - streaming-tutorials
