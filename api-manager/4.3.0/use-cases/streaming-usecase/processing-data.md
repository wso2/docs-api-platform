...
- [**Cleansing**](../../use-cases/streaming-usecase/cleansing-data.md)
...
- [**Transforming**](../../use-cases/streaming-usecase/transforming-data.md)
...
- [**Enriching**](../../use-cases/streaming-usecase/enriching-data.md)

    Joining streams of data with each other as well as static data (such as tables) to enrich the data
    
- [**Summarizing**](../../use-cases/streaming-usecase/summarizing-data.md)
...
- [**Correlating**](../../use-cases/streaming-usecase/correlating-data.md)
