...
description: "Explains how WSO2 Streaming Integrator receives data in transit from data publishers and messaging systems."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/streaming-usecase/receiving-data-in-transit/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/use-cases/streaming-usecase/receiving-data-in-transit.md
tags:
  - api-manager
  - use-cases
  - streaming-usecase
