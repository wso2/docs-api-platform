...
![Performing ETL in Real Time](../../assets/img/streaming/performing-etl-operations/performing-etl-in-real-time.png)
...
![Integrating Heterogeneous Data Sources](../../assets/img/streaming/performing-etl-operations/integrating-heterogeneous-data-sources.png)
...
You can set up the pre-configured dashboards in Grafana. For instructions to set up these dashboards and visualize your ETL statistics, see [Monitoring ETL Statistics with Grafana](../../observe/streaming-integrator/viewing-etl-flows.md).
...
- [Performance Analysis Results - Performing ETL Tasks](../../install-and-setup/setup/si-setup/performance-analysis-results.md#performing-etl-tasks)
