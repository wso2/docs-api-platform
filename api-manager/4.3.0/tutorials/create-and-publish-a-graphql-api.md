...
description: "Design, deploy, publish, and invoke a GraphQL API using the API Publisher and Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/create-and-publish-a-graphql-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/create-and-publish-a-graphql-api.md
tags:
  - api-manager
  - tutorials
