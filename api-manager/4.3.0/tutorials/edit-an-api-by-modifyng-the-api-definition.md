...
description: "Add interactive documentation to an API by directly editing its Swagger definition in the API Publisher UI."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/edit-an-api-by-modifyng-the-api-definition/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/edit-an-api-by-modifyng-the-api-definition.md
tags:
  - api-manager
  - tutorials
...
!!! note
    This tutorial uses the `PizzaShack` API created in [Create a REST API](../design/create-api/create-rest-api/create-a-rest-api.md) section and Published in the [Publish an API](../deploy-and-publish/publish-on-dev-portal/publish-an-api.md) section.
...
8.  Change the title of the API.
    ...
    1.  Click **Edit Source**, and add the following code in the Swagger UI.
        ...
        ![](../assets/img/learn/tutorials/pizza-shack-api-change-api-title.png)
...
10. Complete the rest of the API creation process.
    For more information, see step 7 onwards under [Create a REST API](../design/create-api/create-rest-api/create-a-rest-api.md) section and Published in the [Publish an API](../deploy-and-publish/publish-on-dev-portal/publish-an-api.md) section.
