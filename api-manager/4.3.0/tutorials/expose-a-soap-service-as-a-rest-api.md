...
description: "Design, publish, and invoke a SOAP backend service as a REST API using the Pass Through option."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/expose-a-soap-service-as-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/expose-a-soap-service-as-a-rest-api.md
tags:
  - api-manager
  - tutorials
