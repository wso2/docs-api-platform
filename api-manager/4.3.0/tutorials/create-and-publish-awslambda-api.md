...
description: "Create a REST API with an AWS Lambda endpoint and configure AWS credentials and STS AssumeRole for invocation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/create-and-publish-awslambda-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/create-and-publish-awslambda-api.md
tags:
  - api-manager
  - tutorials
