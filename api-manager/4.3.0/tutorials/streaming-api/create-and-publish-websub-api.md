...
description: "Design, publish, and configure a WebSub/WebHook API that notifies subscribers when GitHub issues are created."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/streaming-api/create-and-publish-websub-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/streaming-api/create-and-publish-websub-api.md
tags:
  - api-manager
  - tutorials
  - streaming-api
