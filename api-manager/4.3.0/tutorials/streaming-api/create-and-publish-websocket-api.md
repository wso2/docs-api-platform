...
description: "Design, publish, and invoke a WebSocket API to build a command line based chat application."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/streaming-api/create-and-publish-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/streaming-api/create-and-publish-websocket-api.md
tags:
  - api-manager
  - tutorials
  - streaming-api
...
invoke the [WebSocket API](../../use-cases/streaming-usecase/create-streaming-api/create-a-websocket-streaming-api.md) using the **wscat** WebSocket client.
...
4.  Click **CREATE**. 
     ...
     [![Overview of WebSocket API](../../assets/img/tutorials/streaming-api/websocket-api-overview.png)](../../assets/img/tutorials/streaming-api/websocket-api-overview.png)
...
6. Add topics to the WebSocket API.
     ...
     4. Expand each topic, provide URL Mappings as follows, and click **Save**.
          ...
          [![Add URL Mappings to WebSocket API Topics](../../assets/img/tutorials/streaming-api/websocket-api-topic-url-mapping.png)](../../assets/img/tutorials/streaming-api/websocket-api-topic-url-mapping.png)
...
6. Attach business plans to your WebSocket API.
     ...
     2. Select **AsyncGold** and click on **Save**.
           ...
           [![Subscriptions of WebSocket API](../../assets/img/tutorials/streaming-api/websocket-api-subscriptions.png)](../../assets/img/tutorials/streaming-api/websocket-api-subscriptions.png)
...
If you require more detailed logs in the WebSocket API flow in order to troubleshoot and debug an error in your scenario, see [Troubleshooting WebSocket APIs](../../troubleshooting/troubleshooting-websocket-api.md).