...
description: "Integrate with a third-party service using a Micro Integrator connector and an inbound endpoint for file processing."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario13-integrate-with-connectors/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario13-integrate-with-connectors.md
tags:
  - api-manager
  - tutorials
  - scenarios
