...
description: "Create a REST API in API Manager by importing an OpenAPI definition for an existing backend."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario1-create-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario1-create-rest-api.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
2. Select **Import Open API** option under **REST API** section
    ...
    ![Create API](../../assets/img/tutorials/scenarios/create-api-oas-def.png)
