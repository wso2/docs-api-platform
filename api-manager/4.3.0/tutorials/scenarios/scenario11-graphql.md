...
description: "Create, publish, and subscribe to a GraphQL API in API Manager by importing a GraphQL SDL schema."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario11-graphql/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario11-graphql.md
tags:
  - api-manager
  - tutorials
  - scenarios
