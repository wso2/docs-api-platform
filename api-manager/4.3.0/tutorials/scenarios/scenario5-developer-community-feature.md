...
description: "Explore Developer Portal features such as SDK generation, documentation, and ratings that support the developer community."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario5-developer-community-feature/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario5-developer-community-feature.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
You could generate client side SDKs for different programming languages. You could find more information on this in our [official documentation](../../consume/generating-sdks/write-a-client-application-using-the-sdk.md).  We have provided a sample Java program created using the Java SDK downloaded from the **QuantisTrainAPI**.
