...
description: "Expose a database as a REST API using WSO2 Micro Integrator data services and API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario6-integrating-with-data-sources/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario6-integrating-with-data-sources.md
tags:
  - api-manager
  - tutorials
  - scenarios
