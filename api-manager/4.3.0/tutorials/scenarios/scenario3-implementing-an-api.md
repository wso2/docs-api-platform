...
description: "Aggregate data from multiple backend services into a single API using WSO2 Micro Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario3-implementing-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario3-implementing-an-api.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
Try out the next scenario in the series, [Signing up a New User](../../tutorials/scenarios/scenario4-user-signup-approval-flow.md).