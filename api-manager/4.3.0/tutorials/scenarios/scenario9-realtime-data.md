...
description: "Stream real-time train location data to clients using a WebSocket API and Streaming Integrator."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario9-realtime-data/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario9-realtime-data.md
tags:
  - api-manager
  - tutorials
  - scenarios
