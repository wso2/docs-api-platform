...
description: "Send event notifications to subscribers using WebHooks instead of having them poll the API for updates."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario10-notifications-webhooks/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario10-notifications-webhooks.md
tags:
  - api-manager
  - tutorials
  - scenarios
