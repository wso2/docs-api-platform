...
description: "Configure Keycloak as an external key manager so API Manager issues tokens using an existing identity provider."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario14-external-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/tutorials/scenarios/scenario14-external-key-manager.md
tags:
  - api-manager
  - tutorials
  - scenarios
