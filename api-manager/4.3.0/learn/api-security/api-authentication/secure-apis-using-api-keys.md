...
description: "Secure an API with API keys, a JWT-based application security scheme validated by the Gateway without contacting the Key Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/learn/api-security/api-authentication/secure-apis-using-api-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/learn/api-security/api-authentication/secure-apis-using-api-keys.md
tags:
  - api-manager
  - learn
  - api-security
...
<<<<<<< HEAD
You can also configure and use a custom Keystore in API Manager to sign the API Keys. Given below is a sample TOML configuration to configure a custom Keystore in the API Manager server. For more information, refer the [Configuration Catalog](../../../reference/config-catalog.md) for more details.
=======
...
>>>>>>> 4cc235f87... Update en/docs/learn/api-security/api-authentication/secure-apis-using-api-keys.md
