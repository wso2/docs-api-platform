...
description: "Configure WSO2 API Manager to publish analytics logs that Datadog collects and processes into dashboards."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/api-analytics/on-prem/datadog-installation-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/api-analytics/on-prem/datadog-installation-guide.md
tags:
  - api-manager
  - api-analytics
  - on-prem
