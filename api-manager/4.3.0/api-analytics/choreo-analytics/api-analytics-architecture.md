...
description: "Explains the architecture of WSO2 API Manager Analytics, where gateways publish statistics to the Analytics Cloud."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/api-analytics/choreo-analytics/api-analytics-architecture/
md_url: https://wso2.com/api-platform/docs/api-manager/4.3.0/api-analytics/choreo-analytics/api-analytics-architecture.md
tags:
  - api-manager
  - api-analytics
  - choreo-analytics
