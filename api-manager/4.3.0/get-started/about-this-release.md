...
??? note "AI-powered API Chat for testing APIs using Natural Language"
    ...
    **[Learn more](../consume/invoke-apis/invoke-apis-using-tools/test-apis-with-apichat.md)**
...
??? note "AI-powered API Marketplace Assistant"
    ...
    **[Learn more](../consume/discover-apis/marketplace-assistant.md)**
...
??? note "Ephemeral Access Tokens Support"
    ...
    **[Learn more](../design/api-security/oauth2/token-persistence.md)**
...
??? note "Advanced Runtime Diagnostics"
    ...
    **[Learn more](../troubleshooting/utilizing-runtime-diagnostic-tool.md)**
...
??? note "Gateway Specific Global Level Policies"
    ...
    **[Learn more](../deploy-and-publish/deploy-on-gateway/api-gateway/gateway-policies.md)**
...
??? note "Support Azure AD as a third-party Key Manager"
    ...
    **[Learn more](../administer/key-managers/configure-azure-ad-key-manager.md)**
...
??? note "Role based access control for Admin Portal"
    ...
    **[Learn more](../administer/role-based-access-control.md)**
...
??? note "Key Manager visibility support in Developer portal"
    ...
    **[Learn more](../administer/key-managers/overview.md#role-based-key-manager-restriction)**
...
??? note "Approval workflow for deploying a revision"
    ...
    **[Learn more](../deploy-and-publish/deploy-on-gateway/deploy-api/revision-deployment-workflow.md)**
...
??? note "Enhanced API tiles to support optional properties like business-related information"
    ...
    **[Learn more](../deploy-and-publish/publish-on-dev-portal/publish-an-api.md)**
...
??? note "Application level policies with burst control support"
    ...
    **[Learn more](../design/rate-limiting/setting-throttling-limits.md#burst-control_1)**
...
??? note "Distributed backend throttling mechanism, a shared counter-based algorithm to efficiently manage API traffic"
    ...
    **[Learn more](../design/rate-limiting/advanced-topics/configuring-rate-limiting-api-gateway-cluster.md#2-async-sync-hybrid-mode)**
...
??? note "JWKS endpoint support, enabling seamless validation of backend access tokens send by API gateway"
    ...
    **[Learn more](../deploy-and-publish/deploy-on-gateway/api-gateway/passing-enduser-attributes-to-the-backend-via-api-gateway.md#validating-backend-jwt-using-jwks-endpoint)**
...
??? note "Support configuring resource attributes for OpenTelemetry connection"
    ...
    **[Learn more](../observe/api-manager/traces/monitoring-with-opentelemetry.md)**
...
??? note "Configurable Crypto Provider support"
    ...
    **[Learn more](../install-and-setup/setup/advance-configurations/configuring-the-crypto-provider.md)**
...
??? note "Global Key Manager support"
    ...
    **[Learn more](../administer/key-managers/configure-global-key-manager.md)**
...
??? note "Allow changing the owner of an API"
    ...
    **[Learn more](../consume/manage-application/advanced-topics/changing-the-provider-of-an-api.md)**
...
??? note "Support defining a custom API-Key header name at API level"
    ...
    **[Learn more](../includes/design/create-publish-api.md)**  
