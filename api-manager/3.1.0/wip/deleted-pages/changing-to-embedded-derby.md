...
description: "Set up an embedded Apache Derby database to replace the default H2 database in a WSO2 product."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/wip/deleted-pages/changing-to-embedded-derby/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/wip/deleted-pages/changing-to-embedded-derby.md
tags:
  - api-manager
  - wip
  - deleted-pages
