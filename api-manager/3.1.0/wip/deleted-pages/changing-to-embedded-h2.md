...
description: "Set up and configure an embedded H2 database and drivers to replace the default database in a WSO2 product."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/wip/deleted-pages/changing-to-embedded-h2/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/wip/deleted-pages/changing-to-embedded-h2.md
tags:
  - api-manager
  - wip
  - deleted-pages
