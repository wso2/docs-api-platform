...
description: "Capture heap and thread dumps with the Carbon Dump tool to diagnose resource exhaustion errors in API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/troubleshooting/capturing-system-data-in-error-situations/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/troubleshooting/capturing-system-data-in-error-situations.md
tags:
  - carbon-dump
  - heap-dump
