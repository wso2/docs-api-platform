...
description: "Design, publish, and invoke a SOAP-backed service as a RESTful API using the Pass Through option."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/tutorials/expose-a-soap-service-as-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/tutorials/expose-a-soap-service-as-a-rest-api.md
tags:
  - api-manager
  - learn
  - tutorials
