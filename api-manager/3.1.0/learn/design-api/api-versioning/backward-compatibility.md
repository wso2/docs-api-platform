...
description: "Understand default API versions and backward compatibility requirements when routing requests across versions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/api-versioning/backward-compatibility/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/api-versioning/backward-compatibility.md
tags:
  - api-manager
  - learn
  - design-api
