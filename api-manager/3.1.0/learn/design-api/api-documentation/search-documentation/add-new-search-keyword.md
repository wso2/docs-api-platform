...
description: "Write and register a custom Apache Solr indexer to search additional document types in API documentation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/api-documentation/search-documentation/add-new-search-keyword/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/api-documentation/search-documentation/add-new-search-keyword.md
tags:
  - api-manager
  - learn
  - design-api
...
3.  Add the `custom_indexer` element in the `<API-M_HOME>/repository/conf/deployment.toml` file with the new indexer as shown below.
    ...
    | `profiles`| [API-M profiles](../../../../install-and-setup/setup/distributed-deployment/product-profiles.md) in which the indexer is available. |
