...
description: "Add inline, URL, file, or Markdown documentation to an API in the Publisher, then view it as a subscriber in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/api-documentation/add-api-documentation/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/api-documentation/add-api-documentation.md
tags:
  - api-manager
  - learn
  - design-api
