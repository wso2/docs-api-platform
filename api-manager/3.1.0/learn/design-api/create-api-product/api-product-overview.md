...
description: "Learn how API Products bundle resources from multiple REST APIs into a single interface for subscribers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/create-api-product/api-product-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/create-api-product/api-product-overview.md
tags:
  - api-manager
  - learn
  - design-api
