...
description: "Design a WebSocket API in the API Publisher to expose a WebSocket backend with OAuth security, throttling, and analytics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/create-api/create-a-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/design-api/create-api/create-a-websocket-api.md
tags:
  - api-manager
  - learn
  - design-api
...
<p>Learn more by trying out the tutorial on <a href="../../../../learn/tutorials/create-and-publish-websocket-api">Creating and Publishing a WebSocket API</a>.</p>
</div>
