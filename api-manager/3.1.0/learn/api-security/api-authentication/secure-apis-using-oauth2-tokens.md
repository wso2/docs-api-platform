...
description: "Secure APIs with OAuth2 access tokens, understand token types, and customize the authorization header at tenant or API level."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/api-authentication/secure-apis-using-oauth2-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/api-authentication/secure-apis-using-oauth2-tokens.md
tags:
  - api-manager
  - learn
  - api-security
...
OAuth 2.0 access tokens come in two different flavors
   ...
   - [JWT Access Tokens](../oauth2/access-token-types/jwt-tokens.md)
    
   - [Opaque Access Tokens](../oauth2/access-token-types/opaque-tokens.md)
