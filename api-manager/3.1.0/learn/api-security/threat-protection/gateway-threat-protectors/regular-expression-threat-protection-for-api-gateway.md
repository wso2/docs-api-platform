...
description: "Configure and apply pre-defined regex patterns to block SQL injection and other gateway attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/threat-protection/gateway-threat-protectors/regular-expression-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/threat-protection/gateway-threat-protectors/regular-expression-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-security
