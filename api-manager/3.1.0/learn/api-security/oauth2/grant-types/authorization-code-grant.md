...
description: "Use the OAuth2 authorization code grant flow to obtain access tokens through a redirection-based authorization exchange."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/authorization-code-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/authorization-code-grant.md
tags:
  - api-manager
  - learn
  - api-security
