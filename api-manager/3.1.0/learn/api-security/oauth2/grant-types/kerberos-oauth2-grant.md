...
description: "Exchange a Kerberos service ticket for an OAuth2 access token using the Kerberos OAuth2 grant type."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/kerberos-oauth2-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/kerberos-oauth2-grant.md
tags:
  - api-manager
  - learn
  - api-security
