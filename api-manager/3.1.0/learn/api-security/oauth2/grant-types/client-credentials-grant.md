...
description: "Obtain OAuth2 access tokens using the client credentials grant type by authenticating with client key and secret."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/client-credentials-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/client-credentials-grant.md
tags:
  - api-manager
  - learn
  - api-security
