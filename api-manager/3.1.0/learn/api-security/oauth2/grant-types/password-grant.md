...
description: "Obtain OAuth2 access tokens using the resource owner password credentials grant and its prerequisites."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/password-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/grant-types/password-grant.md
tags:
  - api-manager
  - learn
  - api-security
...
-   A valid user account in the API Developer Portal. You can self sign up if it is [enabled by an admin](../../../../develop/customizations/customizing-the-developer-portal/enabling-or-disabling-self-signup.md).
...
-   A running API Gateway instance (typically an API Manager instance should be running). For instructions on API Gateway, see [Components](../../../../getting-started/overview.md#api-gateway).
