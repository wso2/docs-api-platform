...
description: "Encrypt OAuth2 access tokens, refresh tokens, and consumer secrets in the database using the primary keystore."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/encrypting-oauth2-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/encrypting-oauth2-tokens.md
tags:
  - api-manager
  - learn
  - api-security
