...
description: "Secure OAuth tokens with HMAC validation to prevent misuse of expired or randomly generated tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/securing-oauth-token-with-hmac-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/securing-oauth-token-with-hmac-validation.md
tags:
  - api-manager
  - learn
  - api-security
