...
description: "Create and apply OAuth2 scopes to API resources to enforce fine-grained, role-based access control."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/oauth2/oauth2-scopes/fine-grained-access-control-with-oauth-scopes.md
tags:
  - api-manager
  - learn
  - api-security
...
3. Navigate to Scope section and click on create scope button.
    ...
    <a href="../../../../../assets/img/learn/start-creating-scope.png" ><img src="../../../../../assets/img/learn/start-creating-scope.png" alt="Start Creating a Scope" 
