...
description: "Obtain user profile information with OpenID Connect by decoding the id_token or calling the userinfo endpoint."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/openid-connect/obtaining-user-profile-information-with-openid-connect/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-security/openid-connect/obtaining-user-profile-information-with-openid-connect.md
tags:
  - api-manager
  - learn
  - api-security
