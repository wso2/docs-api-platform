...
description: "Reference the default Thrift, Siddhi Store, MSF4J, and dashboard ports used by WSO2 API-M Analytics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/analytics/default-ports-of-wso2-api-m-analytics/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/analytics/default-ports-of-wso2-api-m-analytics.md
tags:
  - api-manager
  - learn
  - analytics
