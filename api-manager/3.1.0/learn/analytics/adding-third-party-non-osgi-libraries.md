...
description: "Convert non-OSGi third-party JAR files into OSGi bundles for use with API Manager Analytics."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/analytics/adding-third-party-non-osgi-libraries/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/analytics/adding-third-party-non-osgi-libraries.md
tags:
  - api-manager
  - learn
  - analytics
