...
description: "Configure API Manager to send runtime API invocation statistics to Google Analytics for tracking and reporting."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/analytics/integrating-with-google-analytics/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/analytics/integrating-with-google-analytics.md
tags:
  - api-manager
  - learn
  - analytics
