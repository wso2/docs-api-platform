...
description: "Create a Microgateway label and assign it to APIs to group them for a WSO2 API Microgateway distribution."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-microgateway/grouping-apis-with-labels/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-microgateway/grouping-apis-with-labels.md
tags:
  - api-manager
  - learn
  - api-microgateway
