...
description: "Create an application in the Developer Portal, set its token type and quota, and subscribe it to APIs you want to consume."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/create-application/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/create-application.md
tags:
  - api-manager
  - learn
  - consume-api
