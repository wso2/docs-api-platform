...
description: "Use OAuth2 device scopes to obtain a unique access token for each device sharing an application."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/generate-keys/obtain-access-token/access-tokens-per-device/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/generate-keys/obtain-access-token/access-tokens-per-device.md
tags:
  - api-manager
  - learn
  - consume-api
