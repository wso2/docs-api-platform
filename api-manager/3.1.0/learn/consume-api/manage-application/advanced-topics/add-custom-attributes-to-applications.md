...
description: "Configure server-specific or tenant-specific custom attributes and add them to a new application."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/advanced-topics/add-custom-attributes-to-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/advanced-topics/add-custom-attributes-to-applications.md
tags:
  - api-manager
  - learn
  - consume-api
