...
description: "Attach a custom workflow to production and sandbox key generation for application registration."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/advanced-topics/adding-an-application-key-generation-workflow/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/consume-api/manage-application/advanced-topics/adding-an-application-key-generation-workflow.md
tags:
  - api-manager
  - learn
  - consume-api
    ...
    **Before you begin**, if you have changed the API Manager's default user and role, make sure you do the following changes:
    ...
    1.  Change the credentials of the workflow configurations in the registry resource `_system/governance/apimgt/applicationdata/workflow-extensions.xml`.
        ...
        d. Click **Edit as text** to open the `workflow-extensions.xml` file.
          ...
          [![Edit view of workflow-extensions file](../../../../assets/img/learn/application-registration-wf-config.png)](../../../../assets/img/learn/application-registration-wf-config.png)
    ...
    2.  Point the database that has the API Manager user permissions to EI.
        ...
        !!! note
            MySQL is used to configure the datasources in this documentation. You can configure this based on the database that you are using. For more information, see the [Working with Database](../../../../install-and-setup/setup/setting-up-databases/overview.md).
...
7.  Click **Main** --> **Processes** --> **Add** --> **BPEL** and upload the `<API-M_HOME>/business-processes/application-registration/BPEL/ApplicationRegistrationWorkflowProcess_1.0.0.zip` file to EI. This is the business process archive file.
     ...
     [![Upload BPEL package](../../../../assets/img/learn/add-registration-wf-bpel.png)](../../../../assets/img/learn/add-registration-wf-bpel.png)
...
8.  Click **Main** --> **Processes** --> **Human Tasks** --> **Add** and upload the `<APIM_HOME>/business-processes/application-registration/HumanTask/ApplicationRegistrationTask-1.0.0.zip` file to EI.    
     ...
     [![Add the human task archived file](../../../../assets/img/learn/add-registration-wf-humantask.png)](../../../../assets/img/learn/add-application-wf-humantask.png)
...
4.  Click **Applications**, **Production Keys**, and **Generate Keys**.
     ...
     [ ![Generate keys for an application](../../../../assets/img/learn/add-registration-wf-generate-keys.png) ](../../../../assets/img/learn/add-registration-wf-generate-keys.png)
...
7. Click **Approve** and **Complete** to complete the task.
    ...
    [![](../../../../assets/img/learn/add-registration-wf-approval.png)](../../../../assets/img/learn/add-registration-wf-approval.png)
