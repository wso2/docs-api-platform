...
description: "Deploy microservices as managed APIs in Kubernetes using the API operator, with links to setup and Operator Hub install steps."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/kubernetes-operators/k8s-api-operator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/kubernetes-operators/k8s-api-operator.md
tags:
  - api-manager
  - learn
...
![With and without K8s API Operator](../../assets/img/learn/kubernetes-operators/with-and-withou-k8s-api-operator.png)
