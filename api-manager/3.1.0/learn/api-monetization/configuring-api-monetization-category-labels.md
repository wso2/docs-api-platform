...
description: "Enable API monetization category labels so APIs display as Free, Paid, or Freemium in the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-monetization/configuring-api-monetization-category-labels/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-monetization/configuring-api-monetization-category-labels.md
tags:
  - api-manager
  - learn
  - api-monetization
