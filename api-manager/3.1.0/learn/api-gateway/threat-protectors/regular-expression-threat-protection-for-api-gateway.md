...
description: "Configure regular expression patterns on the API Gateway to detect and block SQL injection and other payload attacks."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-gateway/threat-protectors/regular-expression-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-gateway/threat-protectors/regular-expression-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
