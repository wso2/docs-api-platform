...
description: "Inject dynamic values from environment variables into API Controller project files using apictl commands."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-controller/advanced-topics/using-dynamic-data-in-api-controller-projects/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-controller/advanced-topics/using-dynamic-data-in-api-controller-projects.md
tags:
  - api-manager
  - learn
  - api-controller
...
To allow easily configuring environment-specific details, by default, the CTL supports an additional parameter file named `api_params.yaml`. For more information on using an environment parameter file, see [Configuring Environment Specific Parameters](configuring-environment-specific-parameters.md). 
