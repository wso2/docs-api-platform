...
description: "Configure environment-specific endpoint parameters for apictl projects using the api_params.yaml file structure."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-controller/advanced-topics/configuring-environment-specific-parameters/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-controller/advanced-topics/configuring-environment-specific-parameters.md
tags:
  - api-manager
  - learn
  - api-controller
