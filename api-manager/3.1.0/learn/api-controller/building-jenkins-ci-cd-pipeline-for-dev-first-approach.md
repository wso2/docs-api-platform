...
description: "Build a Jenkins CI/CD pipeline that tests and deploys APIs to WSO2 API Manager using a developer-first approach."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-controller/building-jenkins-ci-cd-pipeline-for-dev-first-approach/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/api-controller/building-jenkins-ci-cd-pipeline-for-dev-first-approach.md
tags:
  - api-manager
  - learn
  - api-controller
