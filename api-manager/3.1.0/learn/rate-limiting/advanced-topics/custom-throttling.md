...
description: "Define custom throttling policies with Siddhi queries and key templates applied globally across tenants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/rate-limiting/advanced-topics/custom-throttling/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/rate-limiting/advanced-topics/custom-throttling.md
tags:
  - api-manager
  - learn
  - rate-limiting
