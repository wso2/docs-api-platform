...
description: "Verify how the API Gateway enforces throttling and resource access policies on a subscribed API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/rate-limiting/enforce-throttling-and-resource-access-policies/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/learn/rate-limiting/enforce-throttling-and-resource-access-policies.md
tags:
  - api-manager
  - learn
  - rate-limiting
...
!!! note
    ...
    **Before you begin** , follow the [Create and Publish an API](../../wip/need-to-update/create-and-publish-an-api.md) to create and publish the `PhoneVerification` API and then the [Subscribe to an API](../consume-api/manage-subscription/subscribe-to-an-api.md) to subscribe to the API using the `Bronze` throttling tier.
...
4.  Expand the GET method and click Try it out. Provide the required parameters and click **Execute** to invoke the API. For example,
    ...
    [![](../../assets/img/learn/learn-throttling-error-response.png)](../../assets/img/learn/learn-throttling-error-response.png)