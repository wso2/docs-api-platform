...
4.  To add throttling limits with different parameters to the conditions below, click **Add Conditional Group**.
    ...
    ![conditional groups](../../assets/img/learn/conditional-groups.png)
...
3.  To add a new tier, click **Add New Policy**.
    ![Add a new application policy](../../assets/img/learn/add-new-application-policy.png)
4.  Fill in the required details and click **Save**.
    ![Save application policy](../../assets/img/learn/save-application-policy.png)
...
3.  To add a new tier, click **Add New Policy**.
    ![Add new subscription policy](../../assets/img/learn/add-new-subscription-policy.png)
...
4.  Fill in the details required by this form and click **Save** once you are done.
    ...
    ![Save the subscription policy](../../assets/img/learn/save-subscription-policy.png)
