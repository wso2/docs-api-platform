...
description: "Reference the configuration parameters available in the deployment.toml file used to tune API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/config-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/config-catalog.md
tags:
  - api-manager
  - reference
  - config-catalog
...
Note that this should be the fully-qualified class name.</p>
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>You can define the custom claim retriever implementation by adding the following 
...
preserveMultipartPartContentTransferEncoding = true</code></pre>
                    </div>
                </div>
                <div class="doc-wrapper">
                    <div class="mb-config">
