---
title: "API Manager best practices"
description: "Lists guidelines for naming APIs and resources and applying semantic versioning when designing APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/wso2-api-manager-best-practices/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/wso2-api-manager-best-practices.md
tags:
  - api-manager
  - reference
