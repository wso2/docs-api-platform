...
description: "Describes the folders and files that make up the directory structure of Carbon-based WSO2 products."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/guides/directory-structure-of-wso2-products/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/guides/directory-structure-of-wso2-products.md
tags:
  - api-manager
  - reference
  - guides
