...
description: "Demonstrates how to configure application and subscription throttling policies to rate limit API calls."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/samples/api-rate-limiting-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/reference/samples/api-rate-limiting-sample.md
tags:
  - api-manager
  - reference
  - samples
