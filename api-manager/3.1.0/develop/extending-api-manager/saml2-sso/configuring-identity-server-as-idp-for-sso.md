...
description: "Configure WSO2 Identity Server as the SAML2 SSO identity provider for the API Publisher and Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/extending-api-manager/saml2-sso/configuring-identity-server-as-idp-for-sso/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/extending-api-manager/saml2-sso/configuring-identity-server-as-idp-for-sso.md
tags:
  - api-manager
  - develop
...
3.  Click **Main**, **Identity**, and then click **Add** under the **Service Providers** menu.
     ...
     [![add-sp](../../../assets/img/learn/extensions/saml2-sso/add-sp.png)](../../../assets/img/learn/extensions/saml2-sso/add-sp.png)
  
4.  Enter a Service Provider name and click **Register**.

     The detailed configuration page appears.

     [![sp-name](../../../assets/img/learn/extensions/saml2-sso/sp-name.png)](../../../assets/img/learn/extensions/saml2-sso/sp-name.png)
    ...
    <a href="../../../../assets/img/learn/extensions/saml2-sso/saas.png"><img src="../../../../assets/img/learn/extensions/saml2-sso/saas.png"></a>
...
5.  Expand the **Inbound Authentication Configuration** section, then expand the **SAML2 Web SSO Configuration** section, and click **Configure**.
     ...
     [![inbound-authentication-config](../../../assets/img/learn/extensions/saml2-sso/inbound-authentication-config.png)](../../../assets/img/learn/extensions/saml2-sso/inbound-authentication-config.png)
    ...
    !!! note "Enable a tenant-specific SSO for the Publisher and Developer Portal"
        ...
        [![enable-tenant-domain](../../../assets/img/learn/extensions/saml2-sso/enable-tenant-domain.png)](../../../assets/img/learn/extensions/saml2-sso/enable-tenant-domain.png)
...
6.  Register the API Publisher as the SSO service provider. 
    ...
    **Example**
    ...
    [![sample-sp](../../../assets/img/learn/extensions/saml2-sso/sample-sp.png)](../../../assets/img/learn/extensions/saml2-sso/sample-sp.png)
...
3.  Click **Main**, **Identity**, and then click **Add** under the **Identity Providers** menu.
     ...
     <a href="../../../../assets/img/learn/extensions/saml2-sso/add-idp.png"><img src="../../../../assets/img/learn/extensions/saml2-sso/add-idp.png" width="300"></a>
...
5. Define the Federated authenticator.
    ...
    1. Expand the **Federated authenticators** section, then expand the **SAML2 Web SSO Configurations** section and define the Federated authenticator as follows:
         ...
         [![federated-auth](../../../assets/img/learn/extensions/saml2-sso/federated-auth.png)](../../../assets/img/learn/extensions/saml2-sso/federated-auth.png)
...
2.  List the service providers and click the edit option that corresponds to the API Publisher.
    ...
    [![listed-sp](../../../assets/img/learn/extensions/saml2-sso/listed-sp.png)](../../../assets/img/learn/extensions/saml2-sso/listed-sp.png)
...
4.  Access the Publisher.
    ...
    [![login-page](../../../assets/img/learn/extensions/saml2-sso/login-page.png)](../../../assets/img/learn/extensions/saml2-sso/login-page.png)
