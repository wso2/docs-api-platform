...
description: "Write a custom workflow executor that redirects subscribers to a third-party entity, such as for payment collection."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/extending-api-manager/extending-workflows/configuring-http-redirection-for-workflows/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/extending-api-manager/extending-workflows/configuring-http-redirection-for-workflows.md
tags:
  - api-manager
  - develop
...
The API Manager can be invoked from a third party entity through the [update workflow status method](../../product-apis/admin-apis/admin-v0.16/admin-v0.16.md#tag/Workflows-(Individual)/paths/~1workflows~1update-workflow-status/post). Refer the [Admin REST APIs](../../product-apis/admin-apis/admin-v0.16/admin-v0.16.md#tag/Workflows-(Individual)/paths/~1workflows~1update-workflow-status/post) to learn how to invoke it.  Note that the Admin REST API resources require authentication before invocation.