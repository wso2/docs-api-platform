...
description: "Configure workflow endpoints, ports, and callback services across nodes in a clustered API Manager deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/extending-api-manager/extending-workflows/configuring-workflows-in-a-cluster/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/extending-api-manager/extending-workflows/configuring-workflows-in-a-cluster.md
tags:
  - api-manager
  - develop
