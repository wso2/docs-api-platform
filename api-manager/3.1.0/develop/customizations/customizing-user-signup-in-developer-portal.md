...
description: "Add or modify Developer Portal sign-up fields via claims and configure consent purposes for user registration."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/customizations/customizing-user-signup-in-developer-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/customizations/customizing-user-signup-in-developer-portal.md
tags:
  - api-manager
  - develop
  - customizations
