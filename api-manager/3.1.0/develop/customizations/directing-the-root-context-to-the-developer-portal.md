...
description: "Change the root context bundle configuration so it directs to the Developer Portal instead of the Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/customizations/directing-the-root-context-to-the-developer-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/customizations/directing-the-root-context-to-the-developer-portal.md
tags:
  - api-manager
  - develop
  - customizations
