...
description: "Enable and configure session data persistence in identity.xml for the remember-me login option."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/enabling-authentication-session-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/enabling-authentication-session-persistence.md
tags:
  - api-manager
  - develop
