...
description: "Explains how to discover WSDLs and invoke WSO2 admin services directly from your applications."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/wso2-admin-services/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/develop/wso2-admin-services.md
tags:
  - api-manager
  - develop
  - wso2-admin-services
