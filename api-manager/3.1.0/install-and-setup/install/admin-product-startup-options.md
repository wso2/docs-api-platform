...
description: "Lists the startup options and system properties available when starting a WSO2 API Manager server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/install/admin-product-startup-options/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/install/admin-product-startup-options.md
tags:
  - api-manager
  - install-and-setup
  - install
