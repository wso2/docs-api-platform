...
3.  Edit the created Service Provider:
    ...
    2.  Register the Service Provider.
        ...
        ??? Info "Enable a tenant-specific SSO for the Publisher and Developer Portal"
            ...
            [![Enable tenant domain in local sub identifier](../../../assets/img/setup-and-install/enable-tenant-domain-in-local-sub-identifier.png)](../../../assets/img/setup-and-install/enable-tenant-domain-in-local-sub-identifier.png)
