...
description: "Configure the hostname and management hostname of WSO2 API Manager for a production environment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/deployment-best-practices/changing-the-hostname/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/deployment-best-practices/changing-the-hostname.md
tags:
  - api-manager
  - install-and-setup
  - setup
