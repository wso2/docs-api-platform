...
[![Performance result graph - throughtput](../../../assets/img/setup-and-install/performance-result-graph-throughput-0ms-1kib.png)](../../../assets/img/setup-and-install/performance-result-graph-throughput-0ms-1kib.png)
...
[![Performance result graph - response time](../../../assets/img/setup-and-install/performance-result-graph-response-time-0ms-1kib.png)](../../../assets/img/setup-and-install/performance-result-graph-response-time-0ms-1kib.png)
...
[![Performance result graph - response time percentiles](../../../assets/img/setup-and-install/performance-result-graph-precentiles-0ms-1kib.png)](../../../assets/img/setup-and-install/performance-result-graph-precentiles-0ms-1kib.png)
...
[![Performance result graph - response time gc throughput](../../../assets/img/setup-and-install/performance-result-graph-gc-throughput-0ms.png)](../../../assets/img/setup-and-install/performance-result-graph-gc-throughput-0ms.png)
...
[![Performance result graph - througput vs concurrency](../../../assets/img/setup-and-install/performance-result-graph-throughput-concurrent-users.png)](../../../assets/img/setup-and-install/performance-result-graph-throughput-concurrent-users.png)

#### Throughput (requests/sec) vs message size (Bytes)
[![Performance result graph - througput vs message size](../../../assets/img/setup-and-install/performance-result-graph-throughput-message-size.png)](../../../assets/img/setup-and-install/performance-result-graph-throughput-message-size.png)

### Average response time comparison

#### Average response time (ms) vs concurrent users
[![Performance result graph - response time vs concurrency](../../../assets/img/setup-and-install/performance-result-graph-response-time-concurrent-users.png)](../../../assets/img/setup-and-install/performance-result-graph-response-time-concurrent-users.png)

#### Average response time (ms) vs message size (Bytes)
[![Performance result graph - response time vs message size](../../../assets/img/setup-and-install/performance-result-graph-response-time-message-size.png)](../../../assets/img/setup-and-install/performance-result-graph-response-time-message-size.png)