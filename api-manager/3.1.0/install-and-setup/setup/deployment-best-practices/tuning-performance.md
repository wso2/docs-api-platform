...
description: "Tune OS, JVM, Carbon, and API Manager settings, including timeouts and thread pools, to improve gateway and key manager performance."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/deployment-best-practices/tuning-performance/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/deployment-best-practices/tuning-performance.md
tags:
  - api-manager
  - install-and-setup
  - setup
