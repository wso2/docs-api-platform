...
description: "Reference the persistent runtime and configuration artifacts used in WSO2 API Manager and API Manager Analytics deployments."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/reference/common-runtime-and-configuration-artifacts/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/reference/common-runtime-and-configuration-artifacts.md
tags:
  - api-manager
  - install-and-setup
  - setup
