...
description: "Disable weak ciphers and change the server name in HTTP response headers to secure WSO2 API Manager transport."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/configuring-transport-level-security/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/configuring-transport-level-security.md
tags:
  - api-manager
  - install-and-setup
  - setup
