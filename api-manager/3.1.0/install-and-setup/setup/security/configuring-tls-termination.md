...
description: "Configure a load balancer for TLS termination and enable Tomcat RemoteIpValve for Carbon servers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/configuring-tls-termination/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/configuring-tls-termination.md
tags:
  - api-manager
  - install-and-setup
  - setup
