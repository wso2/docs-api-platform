...
description: "Encrypt plain text passwords in configuration files using the built-in Cipher Tool, automatically or manually."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/logins-and-passwords/encrypting-passwords-with-cipher-tool/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/logins-and-passwords/encrypting-passwords-with-cipher-tool.md
tags:
  - api-manager
  - install-and-setup
  - setup
