...
description: "Create new keystores for WSO2 API Manager using an existing CA-signed certificate or a newly generated one."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores.md
tags:
  - api-manager
  - install-and-setup
  - setup
