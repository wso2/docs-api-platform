...
description: "Customize the WSO2 API Manager Management Console by editing Carbon UI and product-specific style and image JAR files."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/advance-configurations/customizing-the-management-console/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/install-and-setup/setup/advance-configurations/customizing-the-management-console.md
tags:
  - api-manager
  - install-and-setup
  - setup
