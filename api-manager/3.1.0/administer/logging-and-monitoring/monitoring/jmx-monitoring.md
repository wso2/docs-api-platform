...
description: "Review the API Manager specific JMX MBeans for connections, latency, threading, and transports."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/logging-and-monitoring/monitoring/jmx-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/logging-and-monitoring/monitoring/jmx-monitoring.md
tags:
  - api-manager
  - administer
