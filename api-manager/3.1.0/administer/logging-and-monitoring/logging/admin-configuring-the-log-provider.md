...
description: "Implement the LogProvider and LogFileProvider interfaces to plug a custom log provider into a Carbon product."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/logging-and-monitoring/logging/admin-configuring-the-log-provider/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/logging-and-monitoring/logging/admin-configuring-the-log-provider.md
tags:
  - api-manager
  - administer
