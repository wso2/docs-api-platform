...
description: "Understand super tenant and tenant level role-based permissions and the default users, roles, and permissions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-permissions/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-permissions.md
tags:
  - api-manager
  - administer
