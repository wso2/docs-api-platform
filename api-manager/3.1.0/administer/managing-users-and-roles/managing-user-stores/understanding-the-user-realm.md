...
description: "Understand the user realm concept and the repositories and configuration files that make up user management."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-user-stores/understanding-the-user-realm/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-user-stores/understanding-the-user-realm.md
tags:
  - api-manager
  - administer
