...
description: "Configure the admin user and role that manages all users, roles, and permissions in the system."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-user-stores/configuring-the-system-administrator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-user-stores/configuring-the-system-administrator.md
tags:
  - api-manager
  - administer
