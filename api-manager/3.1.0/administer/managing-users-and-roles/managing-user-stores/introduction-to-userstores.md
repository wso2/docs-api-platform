...
description: "Learn what a user store is and the read/write and read-only modes supported by WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-user-stores/introduction-to-userstores/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-user-stores/introduction-to-userstores.md
tags:
  - api-manager
  - administer
