...
description: "Add users, assign roles, and grant access to the Admin Dashboard using the management console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-users/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/managing-users-and-roles/managing-users.md
tags:
  - api-manager
  - administer
