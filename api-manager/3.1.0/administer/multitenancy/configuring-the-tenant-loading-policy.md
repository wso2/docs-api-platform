...
description: "Configure lazy or eager loading of tenants in WSO2 API Manager and set the tenant idle timeout for lazy loading."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/multitenancy/configuring-the-tenant-loading-policy/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/multitenancy/configuring-the-tenant-loading-policy.md
tags:
  - api-manager
  - administer
  - multitenancy
