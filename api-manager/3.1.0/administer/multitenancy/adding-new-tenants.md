...
description: "Add a new tenant through the management console or manage existing tenants using the TenantMgtAdminService admin service."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/multitenancy/adding-new-tenants/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/multitenancy/adding-new-tenants.md
tags:
  - api-manager
  - administer
  - multitenancy
