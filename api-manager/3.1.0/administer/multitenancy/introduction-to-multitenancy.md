...
description: "Learn how multitenancy isolates tenants, shares server resources, and handles request dispatching in WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/multitenancy/introduction-to-multitenancy/
md_url: https://wso2.com/api-platform/docs/api-manager/3.1.0/administer/multitenancy/introduction-to-multitenancy.md
tags:
  - api-manager
  - administer
  - multitenancy
