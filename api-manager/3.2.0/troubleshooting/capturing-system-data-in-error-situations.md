...
description: "Use Carbon Dump to collect heap and thread dumps from a running Carbon instance when an error or resource exhaustion occurs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/troubleshooting/capturing-system-data-in-error-situations/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/troubleshooting/capturing-system-data-in-error-situations.md
tags:
  - api-manager
  - troubleshooting
