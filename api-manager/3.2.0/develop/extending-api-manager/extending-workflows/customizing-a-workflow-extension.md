...
description: "Override the execute and complete methods of the WorkflowExecutor abstract class to customize a default workflow extension."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/extending-api-manager/extending-workflows/customizing-a-workflow-extension/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/extending-api-manager/extending-workflows/customizing-a-workflow-extension.md
tags:
  - api-manager
  - develop
