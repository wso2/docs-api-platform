...
description: "Call the API Manager callback endpoints from the BPEL engine once workflow configuration is complete, using basic authentication."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/extending-api-manager/extending-workflows/invoking-the-api-manager-from-the-bpel-engine/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/extending-api-manager/extending-workflows/invoking-the-api-manager-from-the-bpel-engine.md
tags:
  - api-manager
  - develop
...
<tr class="even">
<td>REST</td>
<td><a href="https://localhost:9443/api/am/admin/v1/workflows/update-workflow-status" class="uri">https://localhost:9443/api/am/admin/v1/workflows/update-workflow-status</a></td>
</tr>
</tbody>
</table>
...
```
   curl -H "Authorization:Basic YWRtaW46YWRtaW4=" -X POST https://localhost:9443/api/am/admin/v1/workflows/update-workflow-status -d 'workflowReference=b530be39-9174-43b3-acb3-2603a223b094&status=APPROVED&description=DESCRIPTION'
```
