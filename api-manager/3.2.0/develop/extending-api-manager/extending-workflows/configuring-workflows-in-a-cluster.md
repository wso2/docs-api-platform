...
description: "Apply workflow configurations in a clustered API Manager where the Developer Portal, Publisher, Gateway, and Key Manager run separately."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/extending-api-manager/extending-workflows/configuring-workflows-in-a-cluster/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/extending-api-manager/extending-workflows/configuring-workflows-in-a-cluster.md
tags:
  - api-manager
  - develop
