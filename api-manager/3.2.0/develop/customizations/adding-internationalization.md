...
description: "Localize the API Publisher and Developer Portal: add a language, find the keys to translate, change UI direction, and enable the switch."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/customizations/adding-internationalization/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/customizations/adding-internationalization.md
tags:
  - api-manager
  - develop
  - customizations
