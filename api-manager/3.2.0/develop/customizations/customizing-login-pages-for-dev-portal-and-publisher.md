...
description: "Customize the SAML2 SSO, OAuth, and OpenID login pages for the Developer Portal and Publisher in the authenticationendpoint webapp."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/customizations/customizing-login-pages-for-dev-portal-and-publisher/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/customizations/customizing-login-pages-for-dev-portal-and-publisher.md
tags:
  - api-manager
  - develop
  - customizations
  - customizing-login-pages-for-dev-portal-and-publisher
...
3. Customize those copied files with your content.
    ...
    !!! note "Tenant-wise theming"
        ...
        1. Create a folder called **themes** inside the `<APIM-HOME>/repository/deployment/server/webapps/authenticationendpoint/` directory or the `<APIM-HOME>/repository/deployment/server/webapps/accountrecoveryendpoint/` directory and add the custom copied files you created in this step.
