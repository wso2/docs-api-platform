...
description: "Where the WSO2 product source code and build scripts live on GitHub, and how to clone the repositories to build from source."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/working-with-the-source-code/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/working-with-the-source-code.md
tags:
  - api-manager
  - develop
