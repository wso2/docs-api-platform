...
description: "Fetch API-M Analytics data from the Siddhi aggregation tables with a cURL command, and construct the Siddhi query that retrieves records."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/analytics-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/analytics-rest-api.md
tags:
  - api-manager
  - develop
  - analytics-rest-api
...
The available aggregation tables in WSO2 API-M Analytics and its schema listed [here](../learn/analytics/analytics-event-streams-and-aggregations.md#api-manager-aggregate-tables). 
