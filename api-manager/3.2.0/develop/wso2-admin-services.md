...
description: "Discover the SOAP admin services in WSO2 products, invoke one as an authenticated user, and generate the client stubs for them."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/wso2-admin-services/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/develop/wso2-admin-services.md
tags:
  - api-manager
  - develop
  - wso2-admin-services
