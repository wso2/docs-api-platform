...
description: "The options available when starting a WSO2 product, and the system properties you can pass to the startup scripts in the bin directory."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/install/admin-product-startup-options/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/install/admin-product-startup-options.md
tags:
  - api-manager
  - install-and-setup
  - install
