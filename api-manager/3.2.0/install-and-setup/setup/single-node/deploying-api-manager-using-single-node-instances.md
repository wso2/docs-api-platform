...
description: "The single node and active-active options for small to medium scale API management, instead of a fully distributed deployment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/single-node/deploying-api-manager-using-single-node-instances/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/single-node/deploying-api-manager-using-single-node-instances.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
<a name="DeployingAPIManagerusingSingleNodeInstances-Active/activedeployment"></a>
