...
description: "Access WSO2 API Manager through a custom proxy path behind a reverse proxy, updating the product and web application configurations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/setting-up-proxy-server-and-the-load-balancer/adding-a-custom-proxy-path/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/setting-up-proxy-server-and-the-load-balancer/adding-a-custom-proxy-path.md
tags:
  - api-manager
  - install-and-setup
  - setup
