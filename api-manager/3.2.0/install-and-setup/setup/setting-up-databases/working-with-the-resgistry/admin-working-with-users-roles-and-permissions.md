...
description: "How user management works in a WSO2 product: the users who can access it, the roles they hold, and the permissions each role grants."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/admin-working-with-users-roles-and-permissions/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/admin-working-with-users-roles-and-permissions.md
tags:
  - api-manager
  - install-and-setup
  - setup
