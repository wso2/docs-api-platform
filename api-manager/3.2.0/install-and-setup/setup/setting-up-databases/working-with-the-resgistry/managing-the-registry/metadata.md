---
title: "Metadata"
description: "The properties shown in the registry Metadata panel for a resource or collection, and how to create a checkpoint and view versions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/metadata/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/setting-up-databases/working-with-the-resgistry/managing-the-registry/metadata.md
tags:
  - api-manager
  - install-and-setup
  - setup
