...
description: "Enable password recovery, configure account locking by failed logins or by an administrator, and set password policies for the portals."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/security/user-account-management/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/security/user-account-management.md
tags:
  - api-manager
  - install-and-setup
  - setup
