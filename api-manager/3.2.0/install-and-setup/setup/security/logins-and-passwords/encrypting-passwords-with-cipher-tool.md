...
description: "Encrypt plain text passwords in WSO2 configuration files with the Cipher Tool, using the automated or manual process, and change them later."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/security/logins-and-passwords/encrypting-passwords-with-cipher-tool/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/security/logins-and-passwords/encrypting-passwords-with-cipher-tool.md
tags:
  - api-manager
  - install-and-setup
  - setup
