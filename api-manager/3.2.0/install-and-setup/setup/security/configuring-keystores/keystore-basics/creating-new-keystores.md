...
description: "Create a keystore for WSO2 API Manager from an existing or new certificate, and add CA-signed certificates to the keystore and truststore."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/security/configuring-keystores/keystore-basics/creating-new-keystores.md
tags:
  - api-manager
  - install-and-setup
  - setup
