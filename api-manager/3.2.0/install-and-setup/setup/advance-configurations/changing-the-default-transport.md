...
description: "Change the default PassThrough transport in WSO2 API Manager, and set the transport receiver, sender, and connection throttling parameters."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/advance-configurations/changing-the-default-transport/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/advance-configurations/changing-the-default-transport.md
tags:
  - api-manager
  - install-and-setup
  - setup
