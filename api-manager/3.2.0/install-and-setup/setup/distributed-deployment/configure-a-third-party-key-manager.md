...
description: "Point WSO2 API Manager at a third-party Key Manager for client, security, and access token operations, and fetch subscription metadata."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/distributed-deployment/configure-a-third-party-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/install-and-setup/setup/distributed-deployment/configure-a-third-party-key-manager.md
tags:
  - api-manager
  - install-and-setup
  - setup
...
Therefore when required to validate a token, the API Gateway uses the in-memory data store and validates the token details. For more information, see [Key Manager](../../../getting-started/basic-architecture.md#key-manager).
