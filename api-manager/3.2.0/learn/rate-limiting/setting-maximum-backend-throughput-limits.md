...
description: "Limit the total number of calls an API is allowed to make to its backend, independently of the other throttling levels."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/setting-maximum-backend-throughput-limits/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/setting-maximum-backend-throughput-limits.md
tags:
  - api-manager
  - learn
  - rate-limiting
