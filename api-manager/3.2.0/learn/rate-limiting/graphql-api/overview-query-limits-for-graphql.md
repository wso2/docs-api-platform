...
description: "Why GraphQL queries need rate limiting, and how the static query analyser guards the service against expensive client queries."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/graphql-api/overview-query-limits-for-graphql/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/graphql-api/overview-query-limits-for-graphql.md
tags:
  - api-manager
  - learn
  - rate-limiting
...
The Static Query Analyser detects complex queries based on a predefined policy and prevents them from reaching the backend. A basic outline of such a policy is shown below.
   ...
   - [Query Depth Limitation](query-depth-limitation.md)
    
   - [Query Complexity Limitation](query-complexity-limitation.md)
