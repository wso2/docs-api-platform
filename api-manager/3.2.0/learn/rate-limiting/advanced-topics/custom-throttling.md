---
title: "Custom throttling"
description: "Define custom throttling rules that apply globally across tenants, using attributes such as resourceKey, userId, apiContext, and clientIp."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/advanced-topics/custom-throttling/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/advanced-topics/custom-throttling.md
tags:
  - api-manager
  - learn
  - rate-limiting
