...
description: "Restrict API requests to a set of trusted IP addresses, or deny requests from specific IPs, using the Advanced Rate Limiting feature."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/access-control/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/rate-limiting/access-control.md
tags:
  - api-manager
  - learn
  - rate-limiting
...
3.  Click Add New Policy to add a new Rate Limit tier.
    ...
    ![Advanced Rate Limit policy](../../assets/img/learn/allowed-ip-add-policy.png)

4.  Fill the details as below and click **Add Conditional Group**.

    ![Advanced Rate Limit policy](../../assets/img/learn/allowed-ip-add-conditional-group.png)
...
5.  Open the Conditional Group added and fill the details.
    ...
    ![Advanced Rate Limit policy](../../assets/img/learn/new-allow-specific-ip.png)
    
    ![Advanced Rate Limit policy](../../assets/img/learn/save-allow-specific-ip.png)
    ...
    ![Advanced Rate Limit policy](../../assets/img/learn/new-allowed-ip-range.png)
...
3.  Enable **API level** under **Operational Configuration** and select the newly created Throttling policy.
    ![Advanced Rate Limit policy](../../assets/img/learn/apply-allowlist-to-api.png)
...
2.  Click **Deny Policies** under the **Rate Limiting Policies** section and click **Add Policy**.
    ...
    ![Advanced Rate Limit policy](../../assets/img/learn/add-denied-policy.png)

Select the item to deny, enter a value and click **Deny**.

![Advanced Rate Limit policy](../../assets/img/learn/select-denied-condition.png)
<div class="admonition info">
    <p class="admonition-title">Note</p>
...
![Advanced Rate Limit policy](../../assets/img/learn/denied-condition-status.png)
...
3.  Select **API Context** and provide the Context of PhoneVerification API with version as the **Value.**
    ...
    ![Advanced Rate Limit policy](../../assets/img/learn/select-context-deny.png)

4.  Click **Deny.**
5.  Now login to API Developer Portal using the URL `https://localhost:9443/devportal` and invoke the API.
    You will see the following response.

    ![Advanced Rate Limit policy](../../assets/img/learn/denied-api.png)