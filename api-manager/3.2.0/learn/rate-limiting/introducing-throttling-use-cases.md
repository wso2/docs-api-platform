...
![](../../assets/img/learn/new-header-condition-regex.png)
##### JWT claims
...
![](../../assets/img/learn/new-jwt-condition-regex.png)
##### Query parameters
...
![](../../assets/img/learn/new-advanced-throttling-query-conidtion.png)

Eg : 'sales' category can be allocated with more requests than 'hr' category

For more information on how to define advanced throttling policies, see [Adding a new advanced rate limiting policy](adding-new-throttling-policies.md#adding-a-new-advanced-throttling-policy).
