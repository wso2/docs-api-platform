...
description: "Configure multiple API Gateway environments that publish to a single Developer Portal, to distribute the Gateway load."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/publish-api/publish-through-multiple-api-gateways/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/publish-api/publish-through-multiple-api-gateways.md
tags:
  - api-manager
  - learn
  - design-api
