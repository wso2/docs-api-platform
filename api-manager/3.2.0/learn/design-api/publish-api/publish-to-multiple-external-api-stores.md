...
description: "Publish an API to the Developer Portals of other tenants, so subscribers outside your tenant domain can discover and use it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/publish-api/publish-to-multiple-external-api-stores/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/publish-api/publish-to-multiple-external-api-stores.md
tags:
  - api-manager
  - learn
  - design-api
...
5.  Navigate to  **Main > Resources > Browse**.
    ...
    ![Menu option to navigate to the Browse option](../../../assets/img/learn/navigate-main-resources.png)
