...
description: "Control the production and sandbox endpoint timeouts through the Advanced Endpoint Configurations in the API Publisher."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/endpoints/resiliency/endpoint-timeouts/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/endpoints/resiliency/endpoint-timeouts.md
tags:
  - api-manager
  - learn
  - design-api
