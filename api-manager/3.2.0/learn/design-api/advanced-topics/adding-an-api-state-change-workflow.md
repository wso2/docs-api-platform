...
description: "Engage the approval workflow executor so API lifecycle state changes must be approved, with the advanced configurations available."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/advanced-topics/adding-an-api-state-change-workflow/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/advanced-topics/adding-an-api-state-change-workflow.md
tags:
  - api-manager
  - learn
  - design-api
