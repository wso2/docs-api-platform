...
description: "Enable Cross-Origin Resource Sharing globally, per API, or for the OAuth token related APIs in WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/advanced-topics/enabling-cors-for-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/advanced-topics/enabling-cors-for-apis.md
tags:
  - api-manager
  - learn
  - design-api
...
3.  Enable the switch under **CORS Configuration** to enable CORS for the API.
     ...
     [![../../..}/assets/img/learn/enable-cors.png](../../../assets/img/learn/enable-cors.png)](../../../assets/img/learn/enable-cors.png)
