...
description: "What an API Product is: a bundle of resources from several APIs exposed as one interface that subscribers consume separately."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/create-api-product/api-product-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/create-api-product/api-product-overview.md
tags:
  - api-manager
  - learn
  - design-api
