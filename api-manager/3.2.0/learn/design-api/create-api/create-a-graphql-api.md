...
description: "Design a GraphQL API from an SDL schema, and set authorization, security, and rate limiting for its operations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/create-api/create-a-graphql-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/create-api/create-a-graphql-api.md
tags:
  - api-manager
  - learn
  - design-api
