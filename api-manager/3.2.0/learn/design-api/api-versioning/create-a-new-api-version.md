...
description: "Create a new version of an API when its behavior, authentication, resources, or throttling tiers change, instead of editing it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/api-versioning/create-a-new-api-version/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/api-versioning/create-a-new-api-version.md
tags:
  - api-manager
  - learn
  - design-api
...
authentication mechanism, resources, [throttling tiers](../../rate-limiting/introducing-throttling-use-cases.md), target audiences, etc. WSO2 does not recommend to modify a published API that has subscribers plugged into it.
...
!!! note
    ...
    [Create a REST API](../create-api/create-a-rest-api.md) section and Published in the [Publish an API](../publish-api/publish-an-api.md) section.
...
1.  Sign in to the WSO2 API Publisher.
     ...
     Create and publish an API. For more information, see [Create a REST API](../create-api/create-a-rest-api.md) and [Publish an API](../publish-api/publish-an-api.md).
