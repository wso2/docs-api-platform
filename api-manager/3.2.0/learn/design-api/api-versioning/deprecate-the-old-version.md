...
description: "Publish a new API version and deprecate the old ones, while the existing subscribers migrate to the latest version."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/api-versioning/deprecate-the-old-version/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/api-versioning/deprecate-the-old-version.md
tags:
  - api-manager
  - learn
  - design-api
