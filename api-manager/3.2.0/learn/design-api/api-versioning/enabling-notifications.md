...
description: "Enable email notifications so that existing subscribers are told when a new version of an API becomes available."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/api-versioning/enabling-notifications/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/api-versioning/enabling-notifications.md
tags:
  - api-manager
  - learn
  - design-api
