---
title: "API lifecycle"
description: "The states in the default API lifecycle, from created through published to retired, and how an API moves between them."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/lifecycle-management/api-lifecycle/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/design-api/lifecycle-management/api-lifecycle.md
tags:
  - api-manager
  - learn
  - design-api
