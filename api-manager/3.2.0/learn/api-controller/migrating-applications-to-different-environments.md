...
description: "Export and import applications between API Manager environments with apictl, in single-tenant and multi-tenant setups."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-controller/migrating-applications-to-different-environments/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-controller/migrating-applications-to-different-environments.md
tags:
  - api-manager
  - learn
  - api-controller
