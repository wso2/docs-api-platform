...
!!! info
    - To learn about using API Controller to deploy API Projects using a Git repository to different environments, refer the section [CI/CD with WSO2 API Manager](../ci-cd-with-wso2-api-management.md).