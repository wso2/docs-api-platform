...
description: "Enable monetization category labels so throttling tiers defined in the Admin Portal can be marked as free or paid billing plans."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-monetization/configuring-api-monetization-category-labels/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-monetization/configuring-api-monetization-category-labels.md
tags:
  - api-manager
  - learn
  - api-monetization
