...
description: "Configure custom application attributes at server or tenant level, then create an application with those attributes set."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/consume-api/manage-application/advanced-topics/add-custom-attributes-to-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/consume-api/manage-application/advanced-topics/add-custom-attributes-to-applications.md
tags:
  - api-manager
  - learn
  - consume-api
