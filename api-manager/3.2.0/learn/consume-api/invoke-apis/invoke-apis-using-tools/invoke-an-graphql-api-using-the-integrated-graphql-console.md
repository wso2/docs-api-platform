...
description: "Invoke GraphQL query and subscription operations from the integrated GraphiQL console in WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/consume-api/invoke-apis/invoke-apis-using-tools/invoke-an-graphql-api-using-the-integrated-graphql-console/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/consume-api/invoke-apis/invoke-apis-using-tools/invoke-an-graphql-api-using-the-integrated-graphql-console.md
tags:
  - api-manager
  - learn
  - consume-api
...
6. Click **Test** under the **operations** section.
    ...
    [![Test GraphQL API](../../../../assets/img/learn/graphql-console-test-button.png)](../../../../assets/img/learn/graphql-console-test-button.png)
...
4.  Go back to the Developer Portal browser page.
     ...
     [![Response Event of GraphQL Subscription](../../../../assets/img/learn/try-out-sub-event.png)](../../../../assets/img/learn/try-out-sub-event.png)
