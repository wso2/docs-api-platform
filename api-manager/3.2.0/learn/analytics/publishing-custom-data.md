...
description: "Publish custom attributes about an API call to the Analytics Server by engaging a mediation sequence on the request or response path."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/publishing-custom-data/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/publishing-custom-data.md
tags:
  - api-manager
  - learn
  - analytics
