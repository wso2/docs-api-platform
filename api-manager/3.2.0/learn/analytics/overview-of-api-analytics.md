...
<table>
<tr>
<th colspan="2"><b><a href="../viewing-api-statistics/business-analytics-dashboard/">Business Analytics Dashboard</a></b></th>
...
<td colspan="2">For more details, see the <a href="../viewing-api-statistics/business-analytics-dashboard/">Business Analytics</a> section.
</td>
</tr>
</table>
...
<table>
<tr>
<th colspan="2"><b><a href="../viewing-api-statistics/application-analytics-dashboard/">Application Analytics Dashboard</a></b></th>
...
<td colspan="2">For more details, see the <a href="../viewing-api-statistics/application-analytics-dashboard/">Application Analytics</a> section.
</td>
</tr>
</table>
...
<table>
<tr>
<th colspan="2"><b><a href="../viewing-api-statistics/api-analytics-dashboard/">API Analytics Dashboard</a></b></th>
...
<td colspan="2">For more details, see the <a href="../viewing-api-statistics/api-analytics-dashboard/">API Analytics</a> section.
</td>
</tr>
</table>
...
<table>
<tr>
<th colspan="2"><b><a href="../viewing-api-statistics/monitoring-dashboard/">Monitoring Dashboard</a></b></th>
...
<td>Currently, the <code>internal/analytics</code> role is needed to view this dashboard. However, a different role can be assigned by editing role mappings as described in <a href="../managing-dashboard-permissions/">Managing Analytics Dashboard Permissions</a>.
</td>
</tr>
<tr>

<td colspan="2">For more details, see the <a href="../viewing-api-statistics/monitoring-dashboard/">Monitoring Dashboard</a> section.
</td>
</tr>
</table>
...
<table>
<tr>
<th colspan="2"><b><a href="../monthly-api-usage-report/">Reports Dashboard</a></b></th>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>You can customize the format and structure of this dashboard as explained in the <a href="../monthly-api-usage-report/#customizing-the-report">Monthly API Usage Report</a> section.</p>
...
<td colspan="2">For more details, see the <a href="../monthly-api-usage-report/">Monthly API Usage Report</a> section.
</td>
</tr>
</table>
...
Apart from the latter mentioned default dashboards, the users can create custom dashboards based on their specific requirements as explained in **[Customizing Analytics Dashboards](customizing-analytics-dashboards.md)**.