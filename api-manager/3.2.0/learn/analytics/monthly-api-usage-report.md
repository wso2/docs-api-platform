...
description: "Generate a PDF report of monthly API usage from the Reports dashboard, for sending analytics data to stakeholders."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/monthly-api-usage-report/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/monthly-api-usage-report.md
tags:
  - api-manager
  - learn
  - analytics
...
![APIM Analytics Reports Dashboard](../../assets/img/learn/apim-analytics-reports-dashboards-highlight.png)
...
![API Usage Summary Widget](../../assets/img/learn/apim-analytics-api-usage-summary-widget.png)
...
![Monthly Usage Summary](../../assets/img/learn/api-manager-analytics-monthly-usage-summary.png)
