...
description: "Convert third-party JAR files into OSGi bundles so they can be added to the OSGi-based API Manager Analytics distribution."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/adding-third-party-non-osgi-libraries/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/adding-third-party-non-osgi-libraries.md
tags:
  - api-manager
  - learn
  - analytics
