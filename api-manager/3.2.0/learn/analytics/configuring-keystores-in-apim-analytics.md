...
description: "Configure the keystores used by the WSO2 API-M Analytics dashboard and worker profiles for authentication and data encryption."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/configuring-keystores-in-apim-analytics/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/configuring-keystores-in-apim-analytics.md
tags:
  - api-manager
  - learn
  - analytics
