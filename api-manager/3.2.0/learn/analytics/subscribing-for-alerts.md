...
description: "Subscribe to and unsubscribe from analytics alerts as a system administrator or as an API publisher or subscriber."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/subscribing-for-alerts/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/analytics/subscribing-for-alerts.md
tags:
  - api-manager
  - learn
  - analytics
