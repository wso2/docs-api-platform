...
description: "Design, publish, and invoke a GraphQL API in WSO2 API Manager, trying out both query and subscription operations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/tutorials/create-and-publish-a-graphql-api/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/tutorials/create-and-publish-a-graphql-api.md
tags:
  - api-manager
  - learn
  - tutorials
...
<p>For more information on GraphQL APIs, see <a href="../../design-api/create-api/create-a-graphql-api/">Create a GraphQL API</a>.</p>
</div> 
</html>
...
5. Try out the operations.
    1. Click **TEST** to navigate to the developer console.
         ...
         [![StarWars Developer Console ](../../assets/img/learn/star-wars-developer-console.png)](../../assets/img/learn/star-wars-developer-console.png)
...
3. Click **Execute**. 
    ...
    [![Response of GraphQL Subscription](../../assets/img/learn/graphql-sub-init-response.png)](../../assets/img/learn/graphql-sub-init-response.png)
