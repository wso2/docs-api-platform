...
description: "Enable the JSON Schema Validator so API requests and responses are checked against the schema defined in the swagger.json file."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/api-request-response-schema-validation/json-schema-validator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/api-request-response-schema-validation/json-schema-validator.md
tags:
  - api-manager
  - learn
  - api-security
...
The following is an invalid request based on the [Petstore API](https://github.com/OAI/OpenAPI-Specification/blob/3.1.1/examples/v2.0/json/petstore.json).
...
The following is a sample request from the client based on the [Petstore API](https://github.com/OAI/OpenAPI-Specification/blob/3.1.1/examples/v2.0/json/petstore.json).
