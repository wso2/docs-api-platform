...
description: "Allow more than one active access token per consumer key, user, and scope combination, for both JWT and opaque tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/multiple-active-access-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/multiple-active-access-tokens.md
tags:
  - api-manager
  - learn
  - api-security
