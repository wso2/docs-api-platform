...
description: "When to use the client credentials grant, where the authorization scope is limited to resources belonging to the client itself."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/client-credentials-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/client-credentials-grant.md
tags:
  - api-manager
  - learn
  - api-security
