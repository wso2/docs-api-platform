...
description: "How the authorization code grant works, and how to invoke the Token API to exchange an authorization code for an access token."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/authorization-code-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/authorization-code-grant.md
tags:
  - api-manager
  - learn
  - api-security
...
9.  Provide the following information in the redirected page and click **Get Access token**.
    ...
    [![](../../../../assets/img/learn/oauth-authorization-code-accesstoken.png)](../../../../assets/img/learn/oauth-authorization-code-accesstoken.png)
