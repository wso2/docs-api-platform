...
description: "Exchange a Kerberos ticket for an OAuth2 access token, and configure the Kerberos grant with Identity Server as Key Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/kerberos-oauth2-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/kerberos-oauth2-grant.md
tags:
  - api-manager
  - learn
  - api-security
    ...
    3.  Add a new Service Provider and configure OAuth2 for your client
        ...
        ??? note "Click for instructions to configure OAuth2"
            ...
            3.  Click **Add**. The following information is added to your
                service provider.
                [![OAuth SP clientid clientsecret](../../../../assets/img/learn/learnoauth-sp-clientid-clientsecret.png)](../../../../assets/img/learn/oauth-sp-clientid-clientsecret.png)
