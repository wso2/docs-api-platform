...
description: "Use a refresh token to obtain a new access token without user interaction, and revoke a refresh token when it is no longer needed."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/refresh-token-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/grant-types/refresh-token-grant.md
tags:
  - api-manager
  - learn
  - api-security
