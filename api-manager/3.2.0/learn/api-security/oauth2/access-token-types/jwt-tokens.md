...
description: "Use self-contained signed JWT access tokens as API credentials: create a JWT based application, generate a token, and invoke the API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/access-token-types/jwt-tokens/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/oauth2/access-token-types/jwt-tokens.md
tags:
  - api-manager
  - learn
  - api-security
...
3. Enter the application details. Let's create an application with the following details.
   <html>
      ...
      [![Create new application](../../../../assets/img/learn/api-security/oauth2/access-token-types/add-new-application.png)](../../../../assets/img/learn/api-security/oauth2/access-token-types/add-new-application.png)
...
4. Click **Subscribe**.
      ...
      [![Subscribe to the API](../../../../assets/img/learn/api-security/oauth2/access-token-types/subscribe-to-api.png)](../../../../assets/img/learn/api-security/oauth2/access-token-types/subscribe-to-api.png)
