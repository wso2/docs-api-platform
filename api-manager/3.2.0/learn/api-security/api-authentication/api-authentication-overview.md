---
title: "Overview"
description: "The authentication mechanisms WSO2 API Manager offers to protect an API from unidentified or anonymous access."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/api-authentication/api-authentication-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-security/api-authentication/api-authentication-overview.md
tags:
  - api-manager
  - learn
  - api-security
