...
description: "Apply the JSON threat protector to validate request bodies against configured limits, and test it against a sample payload attack."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/threat-protectors/json-threat-protection-for-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/threat-protectors/json-threat-protection-for-api-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
