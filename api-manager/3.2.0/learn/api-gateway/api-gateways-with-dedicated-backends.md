...
description: "Use parameterized endpoints so each Gateway environment points at its own dedicated backend, rather than one static endpoint."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/api-gateways-with-dedicated-backends/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/api-gateways-with-dedicated-backends.md
tags:
  - api-manager
  - learn
  - api-gateway
