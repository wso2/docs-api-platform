...
description: "Secure the connection between the API Gateway and your backend with mutual SSL, exporting certificates and enabling dynamic SSL."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/mutual-ssl-between-api-gateway-and-backend/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/mutual-ssl-between-api-gateway-and-backend.md
tags:
  - api-manager
  - learn
  - api-gateway
