...
description: "Write a class mediator that extends AbstractMediator and implements mediate() to customize the mediation flow of an API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/message-mediation/adding-a-class-mediator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/message-mediation/adding-a-class-mediator.md
tags:
  - api-manager
  - learn
  - api-gateway
