...
description: "The default message builders and formatters in the API Gateway, how to change them, and how to plug in custom implementations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/message-mediation/configuring-message-builders-formatters/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/message-mediation/configuring-message-builders-formatters.md
tags:
  - api-manager
  - learn
  - api-gateway
