...
description: "Design a custom mediation policy in WSO2 Integration Studio, store it in the registry, and deploy it to the Gateway for your APIs."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/message-mediation/creating-and-uploading-using-integration-studio/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/message-mediation/creating-and-uploading-using-integration-studio.md
tags:
  - api-manager
  - learn
  - api-gateway
...
4. Click **ESB Project -> Create New** to create a new ESB solution project.
     ...
     [![Integration Project](../../../assets/img/learn/api-gateway/message-mediation/integration-project.png)](../../../assets/img/learn/api-gateway/message-mediation/integration-project.png)

5. Enter the **Project Name** as `TestProject` and click **Finish**. 

     You will be redirected to the following page.
  
     [![Composite App POM](../../../assets/img/learn/api-gateway/message-mediation/composite-app-pom.png)](../../../assets/img/learn/api-gateway/message-mediation/composite-app-pom.png)
...
window.
     ...
     [![Sequences](../../../assets/img/learn/api-gateway/message-mediation/sequences.png)](../../../assets/img/learn/api-gateway/message-mediation/sequences.png)
...
7. Right-click on the **sequences** directory and go to **New -> Sequence** to create a new sequence.  
     ...
     [![Create a new sequence](../../../assets/img/learn/api-gateway/message-mediation/create-new-sequence.png)](../../../assets/img/learn/api-gateway/message-mediation/create-new-sequence.png)

8. Create a new sequence, provide the sequence name as `newSequence`, and click **Finish**.
  
     [![Create a new sequence](../../../assets/img/learn/api-gateway/message-mediation/create-new-sequence-2.png)](../../../assets/img/learn/api-gateway/message-mediation/create-new-sequence-2.png)
...
9. Drag and drop a **Log Mediator** from the **Mediators** section, to your sequence and **Save** the `newSequence.xml` file.
     ...
     [![New sequence XML](../../../assets/img/learn/api-gateway/message-mediation/newsequence-xml.png)](../../../assets/img/learn/api-gateway/message-mediation/newsequence-xml.png)

10. Right-click on the created mediator, click **Show Properties View**, and enter the following values in the **Log Mediator**.
    
     `Log Level:  Full`
    
     [![Add sequence properties](../../../assets/img/learn/api-gateway/message-mediation/add-sequence-properties.png)](../../../assets/img/learn/api-gateway/message-mediation/add-sequence-properties.png)
...
11. Right-click on the sequence file (`newSequence.xml`), and go to **WSO2 registry -> Check in to WSO2 Registry**. 
     ...
     [![checkin to register](../../../assets/img/learn/api-gateway/message-mediation/check-in-to-reg.png)](../../../assets/img/learn/api-gateway/message-mediation/check-in-to-reg.png)
