...
description: "What the API Gateway does with incoming service calls and token requests, and how to reach it from the Management Console."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/overview-of-the-api-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/learn/api-gateway/overview-of-the-api-gateway.md
tags:
  - api-manager
  - learn
  - api-gateway
