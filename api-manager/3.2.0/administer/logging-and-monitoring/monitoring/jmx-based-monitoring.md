...
description: "Configure JMX ports and datasource JMX in WSO2 API Manager, then monitor the server with JConsole using the ServerAdmin MBeans."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/monitoring/jmx-based-monitoring/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/monitoring/jmx-based-monitoring.md
tags:
  - api-manager
  - administer
