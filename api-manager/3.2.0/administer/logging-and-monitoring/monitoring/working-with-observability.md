...
description: "Enable correlation logging in WSO2 API Manager and read the method call, external call, and transport level logs it produces."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/monitoring/working-with-observability/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/monitoring/working-with-observability.md
tags:
  - api-manager
  - administer
...
To enable lightweight observability add the following config before the `org.wso2.carbon.bootstrap.Bootstrap $` line in
the startup scripts.
```
...
1. [Creating an API](../../../learn/design-api/create-api/create-a-rest-api.md)

2. [Publish the API](../../../learn/design-api/publish-api/publish-an-api.md)

3. [Subscribe to the API](../../../learn/consume-api/manage-subscription/subscribe-to-an-api.md)
