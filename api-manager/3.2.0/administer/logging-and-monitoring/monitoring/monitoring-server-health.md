...
description: "Deploy and configure the Carbon health checker in WSO2 API Manager, then invoke the health check API to report server status."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/monitoring/monitoring-server-health/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/monitoring/monitoring-server-health.md
tags:
  - api-manager
  - administer
