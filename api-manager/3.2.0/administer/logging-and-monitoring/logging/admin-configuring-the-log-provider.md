...
description: "Implement the LogProvider and LogFileProvider interfaces and plug a custom log provider into Carbon to read logs from your own store."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/logging/admin-configuring-the-log-provider/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/logging-and-monitoring/logging/admin-configuring-the-log-provider.md
tags:
  - api-manager
  - administer
