...
description: "Configure Keycloak as a third-party Key Manager using the WSO2 API-M Keycloak Connector, and generate application keys against it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/key-managers/configure-keycloak-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/key-managers/configure-keycloak-connector.md
tags:
  - api-manager
  - administer
  - key-managers
...
!!! info
    For more information, see the [Getting Started Guide, which is under the official Keycloak documentation](https://www.keycloak.org/guides).
...
3. Click **Clients** and create a client with the following information.
    ...
    [![Keycloak add client](../../assets/img/administer/keycloak-add-client.png)](../../assets/img/administer/keycloak-add-client.png)
...
2. Export the certificate in `application.keystore`.
    ...
    !!! tip
        For information on [Enabling SSL/HTTPS for the Keycloak Server](https://www.keycloak.org/server/enabletls), see the Keycloak official documentation. 
...
5. Add a Key Manager.
    ...
    3. Add the following configuration to add a new Key Manager.
         ...
         [![Add Key Cloak configurations](../../assets/img/administer/keycloak-endpoints.png)](../../assets/img/administer/keycloak-endpoints.png)
...
4. Click **Sandbox Keys**.
     ...
     [![Keycloak Developer Portal generate keys](../../assets/img/administer/keycloak-devportal-generate-keys.png)](../../assets/img/administer/keycloak-devportal-generate-keys.png)
