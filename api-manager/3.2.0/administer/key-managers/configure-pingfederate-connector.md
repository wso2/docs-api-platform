...
description: "Configure PingFederate as a third-party Key Manager using the WSO2 API-M PingFederate Connector, and generate keys against it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/key-managers/configure-pingfederate-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/key-managers/configure-pingfederate-connector.md
tags:
  - api-manager
  - administer
  - key-managers
  - configure-pingfederate-connector
...
2. Click **OAuth Clients** and create a client with the following information in order to introspect the tokens.
    ...
    [![PingFederate - add client](../../assets/img/administer/pingfederate-client-create-1.png)](../../assets/img/administer/pingfederate-client-create-1.png)

    [![PingFederate - add client](../../assets/img/administer/pingfederate-client-create-2.png)](../../assets/img/administer/pingfederate-client-create-2.png)

3. Generate and store the Client Secret.

     [![PingFederate client secret](../../assets/img/administer/pingfederate-client-secret.png)](../../assets/img/administer/pingfederate-client-secret.png)
...
1. Import the PingFederate certificate into the WSO2 API Manager truststore.
    ...
    1. The default PingFederate keystore can found under the **Certificate & Key Management** section on the **SSL Server Certificates** page.
         ...
         [![SSL Server Certificate](../../assets/img/administer/ping-federate-ssl-certificate.png)](../../assets/img/administer/ping-federate-ssl-certificate.png)

    2. Export the certificate from SSL server certificates.

         [![SSL Server Certificate Import](../../assets/img/administer/ping-federate-ssl-certificate-export.png)](../../assets/img/administer/ping-federate-ssl-certificate-export.png)
...
3. Add a Key Manager.
    ...
    3. Add the following configuration to add a new Key Manager.
         ...
         [![Add PingFederate configurations](../../assets/img/administer/pingfederate-endpoints.png)](../../assets/img/administer/pingfederate-endpoints.png)
...
4. Click **Production Keys**.
     ...
     [![PingFederate Developer Portal generate keys](../../assets/img/administer/ping-devportal-generate-keys.png)](../../assets/img/administer/ping-devportal-generate-keys.png)
