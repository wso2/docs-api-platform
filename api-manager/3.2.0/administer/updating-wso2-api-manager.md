...
description: "Use the WSO2 Update Manager and the in-place updates tool to fetch product updates, merge configurations, and restore from backup."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/updating-wso2-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/updating-wso2-api-manager.md
tags:
  - api-manager
  - administer
