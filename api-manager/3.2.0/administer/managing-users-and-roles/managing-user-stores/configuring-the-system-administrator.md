...
description: "Set the admin user for a WSO2 API Manager deployment, and update the administrator when the primary user store is read-only or read-write."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/managing-users-and-roles/managing-user-stores/configuring-the-system-administrator/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/administer/managing-users-and-roles/managing-user-stores/configuring-the-system-administrator.md
tags:
  - api-manager
  - administer
