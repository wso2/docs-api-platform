...
description: "Replace the embedded H2 database with IBM Informix for user management and registry data, including drivers and the datasource."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/wip/deleted-pages/changing-to-ibm-informix/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/wip/deleted-pages/changing-to-ibm-informix.md
tags:
  - api-manager
  - wip
  - deleted-pages
