...
description: "How the five main WSO2 API Manager components are deployed separately in production, rather than as one all-in-one instance."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/wip/deleted-pages/distributed-deployment-of-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/wip/deleted-pages/distributed-deployment-of-api-manager.md
tags:
  - api-manager
  - wip
  - deleted-pages
