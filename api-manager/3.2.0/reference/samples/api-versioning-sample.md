...
Users can configure to get notifications for the newly created API. For more details, see [Enabling Notifications](../../learn/design-api/api-versioning/enabling-notifications.md).
