...
description: "A sample scenario showing how to optimize API output for different clients, such as a mobile device consuming the same API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/samples/api-development-sample/development-of-developer-optimized-apis-sample/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/samples/api-development-sample/development-of-developer-optimized-apis-sample.md
tags:
  - api-manager
  - reference
  - samples
