...
description: "Every configuration parameter used in the WSO2 API Manager deployment.toml file, covering server, super admin, and database settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/config-catalog/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/config-catalog.md
tags:
  - api-manager
  - reference
  - config-catalog
                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>The thread pool size of the shared EventLoopGroup used by WebsocketConnectionFactory for managing WebSocket client connections. Note that this configuration only available from U2 level 427 onwards.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <p>
                                This includes synapse configurations.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
                                <div class="param-name">
                                  <span class="param-name-wrap"> <code>ws.transport.subprotocol.negotiate</code> </span>
                                </div>
                                <div class="param-info">
                                    <div>
                                        <p>
