...
description: "The directory structure inherited by all Carbon based WSO2 products, and what each folder under PRODUCT_HOME contains."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/guides/directory-structure-of-wso2-products/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/guides/directory-structure-of-wso2-products.md
tags:
  - api-manager
  - reference
  - guides
