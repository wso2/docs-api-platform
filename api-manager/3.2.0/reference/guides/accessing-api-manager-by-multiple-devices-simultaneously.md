...
description: "Handle access tokens when one user reaches API Manager from several devices, so logging out on one does not revoke the others."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/guides/accessing-api-manager-by-multiple-devices-simultaneously/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/guides/accessing-api-manager-by-multiple-devices-simultaneously.md
tags:
  - api-manager
  - reference
  - guides
