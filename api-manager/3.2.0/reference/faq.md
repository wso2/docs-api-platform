---
title: "FAQ"
description: "Answers to common questions about WSO2 API Manager, covering the product, installation, deployment, functionality, and security."
canonical_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/faq/
md_url: https://wso2.com/api-platform/docs/api-manager/3.2.0/reference/faq.md
tags:
  - api-manager
  - reference
  - faq
...
For a list of all default ports available, see [Default Ports of WSO2 Products](../install-and-setup/setup/reference/default-product-ports.md#wso2-api-manager-ports).

### What are the technologies used underneath WSO2 API Manager?

The API Manager is built on top of WSO2 Carbon, an OSGi based components framework for SOA. For more details, see [API Manager components](../getting-started/key-concepts.md).
