...
<div class="homePage">
    ...
    <div class="section02">
        ...
        <div class="linkWrapper">
            ...
            <div class="linkSet2 last" onclick="location.href='get-started/streaming-quick-start-guide/';">
    ...
    <div class="section03">
        ...
        <div class="linkSet2 last" onclick="location.href='get-started/apim-architecture/';">
            <h3>Architecture</h3>
            <p>
    ...
    <div class="section05">
        ...
        <div class="linkWrapper">
            ...
            <div class="linkSet2 last" onclick="location.href='install-and-setup/install-and-setup-overview/#deploying_1';">
                ...
                <a href='install-and-setup/install-and-setup-overview/#deploying_1'><h4>Deploy the Streaming Integrator Runtime</h4></a>
            </div>
        </div>
    </div>
</div>