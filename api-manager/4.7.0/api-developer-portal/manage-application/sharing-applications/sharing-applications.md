---
title: "Share Applications Across Users"
description: "Enable application sharing so users within the same organization group can view shared applications and subscriptions across the group."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-developer-portal/manage-application/sharing-applications/sharing-applications/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-developer-portal/manage-application/sharing-applications/sharing-applications.md
tags:
  - api-manager
  - developer-portal
  - applications
...
2. Click **Create Account**.
     ...
     [![Create Account in Developer Portal](../../../assets/img/learn/application-sharing-signup.png)](../../../assets/img/learn/application-sharing-signup.png)
...
3.  Sign up to the API Developer Portal as two different users (e.g., user1, user2) belonging to the same organization.
    ...
    [![Application Sharing Username](../../../assets/img/learn/application-sharing-username.png)](../../../assets/img/learn/application-sharing-username.png)

    - Provide the user details and click **REGISTER**.
     
    [![Application Sharing Signup Form](../../../assets/img/learn/application-sharing-signup-form.png)](../../../assets/img/learn/application-sharing-signup-form.png)
