---
title: "Change the Provider of an API"
description: "Transfer ownership of an API to another user by updating the API provider field in the Admin Portal, granting edit and delete access."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-developer-portal/manage-application/advanced-topics/changing-the-provider-of-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-developer-portal/manage-application/advanced-topics/changing-the-provider-of-an-api.md
tags:
  - api-manager
  - admin-portal
...
4.  Change the owner/provider of the api.
    ...
    3.  Search for the apis that you want to change and click **Edit**.
        [![Search for the api](../../../assets/img/learn/changing-api-provider-search.png)](../../../assets/img/learn/changing-api-provider-search.png)
    ...
    4.  Update the **Provider** field with the new provider's username (Chris).
        ...
        [![Api page with the new ownership](../../../assets/img/learn/changing-api-provider.png)](../../../assets/img/learn/changing-api-provider.png)   

        Now, when Kim or Chris signs in to the publisher Portal, the provider name is changed to Chris.
        [![Kim Application List](../../../assets/img/learn/api-chris.png)](../../../assets/img/learn/api-chris.png)