...
description: "The Gateway forwards end-user claims to backends through a signed backend JWT header; change its encoding, validate it, and control its expiry."
