...
description: "Configure isolated Classic Gateway instances per tenant using tenant_loading in deployment.toml for traffic isolation and dedicated resources."
