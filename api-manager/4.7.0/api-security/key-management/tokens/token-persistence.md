...
description: "Understand how WSO2 API Manager persists JWT and opaque OAuth2 tokens, including persistence optimization for JWTs and recovery from constraint violations."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/tokens/token-persistence/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/tokens/token-persistence.md
tags:
  - api-manager
  - oauth2
  - jwt
...
!!! note
    JWT token persistence is optimized by default in WSO2 API Manager which means JWT tokens are not persisted in the database.
...
- If you are using a customized JWT token issuer to support the additional system claims, make sure your custom JWTTokenIssuer is extending `org.wso2.is.key.manager.tokenpersistence.issuer.ExtendedJWTTokenIssuer` class.
...
[![Asynchronous token persistence](../../../assets/img/learn/asynchronous-token-generation.png)](../../../assets/img/learn/synchronous-token-persistence.png)
