...
description: "Use HMAC validation extensions in WSO2 API Manager and WSO2 Identity Server to prevent misuse of expired or randomly generated OAuth tokens."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/tokens/securing-oauth-token-with-hmac-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/tokens/securing-oauth-token-with-hmac-validation.md
tags:
  - api-manager
  - oauth2
  - security
