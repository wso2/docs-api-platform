...
description: "Configure WSO2 Identity Server versions before 7.x as a third-party Key Manager in WSO2 API Manager, including deployment.toml settings and connectors."
...
!!! info
    This document provides instructions on configuring **WSO2 Identity Server versions before 7.x** as a Key Manager. If you are using **WSO2 Identity Server 7.x**, see [Configure WSO2 IS Key Manager](configure-wso2is7-connector.md).
...
3. Download the [WSO2 IS Connector](../../../assets/attachments/administer/wso2is-extensions-1.8.8.zip).
