...
description: "Enable a Global Key Manager in WSO2 API Manager so one token can invoke APIs across tenants, with a walkthrough of cross-tenant subscriptions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/third-party-key-managers/configure-global-key-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/third-party-key-managers/configure-global-key-manager.md
tags:
  - api-manager
  - key-managers
  - multitenancy
...
6. Add the Global Key Manager configurations. Refer to the [configurations](overview.md#supported-third-party-key-managers) of the key manager that needs to be added as the global key manager
