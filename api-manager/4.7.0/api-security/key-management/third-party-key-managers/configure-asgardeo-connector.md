...
2. Create an OAuth Application that will act as the management client for WSO2 API Manager. 
    ...
    1. Navigate to **Applications** → **`+ New Application`**
        ...
        [![asgardeo new application](../../../assets/img/administer/asgardeo-newapplication.png)](../../../assets/img/administer/asgardeo-newapplication.png)
    ...
    2. **Create** a **Standard-Based Application** with the following Name and Protocol.
        ...
        [![asgardeo select application](../../../assets/img/administer/asgardeo-select-application.png)](../../../assets/img/administer/asgardeo-select-application.png)

        [![asgardeo application details](../../../assets/img/administer/asgardeo-application-details.png)](../../../assets/img/administer/asgardeo-application-details.png)

    3. In the page that follows, make note of the **Client ID** and **Client secret** found under **Protocol**.

        [![asgardeo note client id secret](../../../assets/img/administer/asgardeo-protocol-id-secret.png)](../../../assets/img/administer/asgardeo-protocol-id-secret.png) 
...
3. Authorize the Management OAuth Application to use the required Management APIs.
    ...
    1. Navigate to  **API Authorization** → **`+ Authorize API resource`** in the created application.
        ...
        [![asgardeo application api authorization](../../../assets/img/administer/asgardeo-application-api-authorization.png)](../../../assets/img/administer/asgardeo-application-api-authorization.png)
    ...
    2. In the popped-up window, select the Management API **`OAuth DCR API`** as the **API Resource**, **`Select All`** for **Authorized Scopes**, and click on **Finish**.  
        ...
        [![asgardeo authorize dcr api](../../../assets/img/administer/asgardeo-authorize-dcr-api.png)](../../../assets/img/administer/asgardeo-authorize-dcr-api.png)
...
4. Create an API Resource that serves as a global container for the scopes defined in WSO2 API Manager.
    1. Navigate to **Resources** → **API Resources** → **`+ New API Resource`**
        ...
        [![asgardeo new api resource](../../../assets/img/administer/asgardeo-new-api-resource.png)](../../../assets/img/administer/asgardeo-new-api-resource.png)
    ...
    2. Enter a unique **Identifier** and **Display Name** (Example shown below). Click on **Next**.
        ...
        [![asgardeo create api resource](../../../assets/img/administer/asgardeo-create-api-resource.png)](../../../assets/img/administer/asgardeo-create-api-resource.png)
    ...
    4. On the **Authorization** page that appears next, click on **Create** ensuring that **Requires authorization** is enabled. 
        ...
        [![asgardeo authorize api resource](../../../assets/img/administer/asgardeo-authorize-api-resource.png)](../../../assets/img/administer/asgardeo-authorize-api-resource.png)
...
2. Add Asgardeo as a Key Manager
    1. Navigate to **Key Managers** → **`Add Key Manager`**.
        ...
        [![asgardeo new key manager](../../../assets/img/administer/asgardeo-new-key-manager.png)](../../../assets/img/administer/asgardeo-new-key-manager.png)
    ...
    2. Under **General Details** and **Key Manager Type**, provide the following:
        ...
        [![asgardeo general details](../../../assets/img/administer/asgardeo-general-details.png)](../../../assets/img/administer/asgardeo-general-details.png)
    ...
    3. Under **Key Manager Endpoints**,
        ...
        [![asgardeo endpoint details](../../../assets/img/administer/asgardeo-endpoint-details.png)](../../../assets/img/administer/asgardeo-endpoint-details.png)
