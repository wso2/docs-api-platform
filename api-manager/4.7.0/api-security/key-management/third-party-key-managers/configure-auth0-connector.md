---
title: "Configure Auth0 as a Third-Party Key Manager"
description: "Integrate Auth0 as a third-party Key Manager in WSO2 API Manager, covering Auth0 API setup, Admin Portal registration, and application key generation."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/third-party-key-managers/configure-auth0-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/key-management/third-party-key-managers/configure-auth0-connector.md
tags:
  - api-manager
  - key-managers
  - oauth2
...
1. Create an Auth0 account.
     ...
     [![auth0 dashboard](../../../assets/img/administer/auth0-dashboard.png)](../../../assets/img/administer/auth0-dashboard.png)

2. Create an application to use the management API.

     [![auth0 management api](../../../assets/img/administer/auth0-management-api.png)](../../../assets/img/administer/auth0-management-api.png)

     [![auth0 new application](../../../assets/img/administer/auth0-new-application.png)](../../../assets/img/administer/auth0-new-application.png)
...
3. Allow that application to use the management API.
     ...
     [![auth0 permission to use app](../../../assets/img/administer/auth0-permission-to-use-app.png)](../../../assets/img/administer/auth0-permission-to-use-app.png)

4. Navigate to the **APIs** section and create a custom API.

     [![auth0 create custom api](../../../assets/img/administer/auth0-create-custom-api.png)](../../../assets/img/administer/auth0-create-custom-api.png)

     <a name="step1-4"></a>

5. Navigate to the **Permissions** tab in the custom API and create a new scope named `default` for the API.

     [![auth0 create scope](../../../assets/img/administer/auth0-create-scope.png)](../../../assets/img/administer/auth0-create-scope.png)
...
3. Add a new Key Manager.
     ...
     [![auth0 add app admin](../../../assets/img/administer/auth0-add-app-admin.png)](../../../assets/img/administer/auth0-add-app-admin.png)

    1. Select the Key manager type as Auth0 and provide the relevant details in the fields accordingly.

        [![auth0 km type](../../../assets/img/administer/auth0-km-type.png)](../../../assets/img/administer/auth0-km-type.png)
        ...
        !!! info
         ...
         [![auth0 endpoints](../../../assets/img/administer/auth0-endpoints.png)](../../../assets/img/administer/auth0-endpoints.png)
     ...
     2. Set the grant types which are allowed in Auth0.
         ...
         [![auth0 grant types](../../../assets/img/administer/auth0-grant-types.png)](../../../assets/img/administer/auth0-grant-types.png)
     ...
     3. Enter the client ID and client secret of the application that was created to invoke the Manage API.
         ...
         [![auth0 connector configs](../../../assets/img/administer/auth0-connector-configs.png)](../../../assets/img/administer/auth0-connector-configs.png)
...
3. Create a new application.
     ...
     [![auth0 dev app create](../../../assets/img/administer/auth0-dev-app-create.png)](../../../assets/img/administer/auth0-dev-app-create.png)

2. Click either "production" or "sandbox", select `Auth0`, and fill in the relevant information.
    
     [![auth0 app creation form](../../../assets/img/administer/auth0-app-creation-form.png)](../../../assets/img/administer/auth0-app-creation-form.png)
    ...
    !!! note
     ...
     [![auth0 resource api](../../../assets/img/administer/auth0-resource-api.png)](../../../assets/img/administer/auth0-resource-api.png)

     After the keys are generated, it will reflect in the UI.
    
     [![auth0 created app](../../../assets/img/administer/auth0-created-app.png)](../../../assets/img/administer/auth0-created-app.png)
    
3. Click **Generate Keys**.
    
     [![auth0 success](../../../assets/img/administer/auth0-success.png)](../../../assets/img/administer/auth0-success.png)
