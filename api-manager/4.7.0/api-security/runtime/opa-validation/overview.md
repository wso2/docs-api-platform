---
title: "Validate API Requests with Open Policy Agent (OPA)"
description: "Validate API requests with Open Policy Agent (OPA) by attaching the OPA policy in the Publisher Portal and configuring server and rule settings."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/runtime/opa-validation/overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/runtime/opa-validation/overview.md
tags:
  - api-manager
  - api-security
  - api-gateway
...
!!! note
    If required, you can have your own **Response Validation Implementation** by implementing the interface **OPARequestGenerator**. For more information, see [Custom OPA Policy with Custom Request Generator](#customize-the-opa-request-payload-and-response-validation).
