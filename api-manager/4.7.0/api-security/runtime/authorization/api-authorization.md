...
description: "Overview of fine-grained API access control mechanisms in WSO2 API Manager, including OAuth2 scopes, application scopes, and XACML-based access control."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/runtime/authorization/api-authorization/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/runtime/authorization/api-authorization.md
tags:
  - api-manager
  - access-control
  - oauth2
