...
description: "Browse the authentication mechanisms WSO2 API Manager offers to secure APIs, including OAuth2, API keys, Mutual SSL, Basic Authentication, and Key Managers."
...
- [Securing APIs using OAuth2 Access Tokens](secure-apis-using-oauth2-tokens.md)
    ...
    - [JWT (Self Contained) Access Tokens](../../key-management/tokens/jwt-tokens.md)
...
[Configuring Key Managers](../../key-management/third-party-key-managers/overview.md).
