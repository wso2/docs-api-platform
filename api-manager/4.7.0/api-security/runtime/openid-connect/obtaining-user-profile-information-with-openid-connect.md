...
description: "Obtain user profile information with OpenID Connect by requesting the openid scope, then decoding the id_token JWT or calling the userinfo endpoint."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/runtime/openid-connect/obtaining-user-profile-information-with-openid-connect/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-security/runtime/openid-connect/obtaining-user-profile-information-with-openid-connect.md
tags:
  - api-manager
  - oauth2
  - sso
...
1.  Obtain a token using password grant type and `openid` scope. For more information on token generation with password grant type, see [Password Grant Type](../../key-management/authentication/grant-types/password-grant.md). The format of the curl command and a sample is given below :
