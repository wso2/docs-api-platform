...
description: "Use Micro Integrator to aggregate data from multiple backends with different protocols into one API response, published to the Service Catalog."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/tutorials/scenarios/scenario3-implementing-an-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/tutorials/scenarios/scenario3-implementing-an-api.md
tags:
  - api-manager
  - micro-integrator
  - service-catalog
...
Try out the next scenario in the series, [Signing up a New User](scenario4-user-signup-approval-flow.md).