...
Deploy the `HealthcareAPI` REST API in the Gateway. For more information, see [Deploy an API](../api-design-manage/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md#deploy-an-api).
