...
description: "Design, publish, and invoke a WebSocket-based chat API, including configuring channels and testing bidirectional messaging with wscat."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/tutorials/streaming-api/create-and-publish-websocket-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/tutorials/streaming-api/create-and-publish-websocket-api.md
tags:
  - api-manager
  - websocket
  - streaming-api
...
6. Add topics to the WebSocket API.
     ...
     3. Add the following operations one by one. 
          ...
          <img src="../../../assets/img/tutorials/streaming-api/websocket-api-v3-add-topics.png" width="80%" alt="Add Topics to WebSocket API">
     ...
     4. Expand each topic, provide URL Mappings as follows, and click **Save**.
          ...
          [![Add URL Mappings to WebSocket API Topics](../../assets/img/tutorials/streaming-api/websocket-api-v3-topic-url-mapping.png)](../../assets/img/tutorials/streaming-api/websocket-api-v3-topic-url-mapping.png)
