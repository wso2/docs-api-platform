---
title: "Configure ELK-Based Analytics for API Manager"
description: "Set up an on-premise ELK analytics solution for WSO2 API Manager, installing Filebeat, Logstash, Elasticsearch, and Kibana with SSO security."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/monitoring/api-analytics/on-prem/elk-installation-guide/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/monitoring/api-analytics/on-prem/elk-installation-guide.md
tags:
  - api-manager
  - analytics
  - logging
...
<a href="../../../../assets/img/analytics/cloud/mcp-analytics-1.png"><img src="../../../../assets/img/analytics/cloud/mcp-analytics-1.png" width="70%" alt=""></a>

<a href="../../../../assets/img/analytics/cloud/mcp-analytics-2.png"><img src="../../../../assets/img/analytics/cloud/mcp-analytics-2.png" width="70%" alt=""></a>
