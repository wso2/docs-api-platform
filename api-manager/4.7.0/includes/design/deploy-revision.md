...
2. Navigate to the **Deploy** section and click **Deployments**.
      ...
      [![New revision]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/deploy-first-revision.png){: style="width:80%"}]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/deploy-first-revision.png)

      The Deployments page appears as follows when you have at least one revision.

      [![Deploy new revision option]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/deploy-new-revision.png)]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/deploy-new-revision.png)
    !!! note
...
3. Click **Deploy New Revision**.
    ...
    !!! warning
        ...
        [![Delete revision if max count is reached]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/delete-and-deploy-revision.png){: style="width:60%"}]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/delete-and-deploy-revision.png)
...
!!! note
    ...
    [![Deployment status acknowledgement]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/revision-deployment-acknowledgement.png)]({BASE_URL}/api-manager/4.7.0/assets/img/design/revision/revision-deployment-acknowledgement.png)