---
title: "Run the WSO2 API Manager Runtime"
description: "Start and stop the WSO2 API Manager server, sign in to the Management Console, Publisher, and Developer Portal, and troubleshoot startup errors."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/install-and-setup/install/installing-the-product/running-the-api-m/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/install-and-setup/install/installing-the-product/running-the-api-m.md
tags:
  - api-manager
  - installation
  - troubleshooting
...
[Download and install](installing-api-m-runtime.md) the API Manager server.
...
!!! Info  
    ...
    - [Securing API-M Web Portals](../../setup/security/securing-api-m-web-portals.md)
