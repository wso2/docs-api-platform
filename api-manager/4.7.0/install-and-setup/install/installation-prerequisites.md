...
description: "Check the environment, system, and database requirements for installing WSO2 API Manager, including supported OS, JDKs, and sizing recommendations."
...
<ul>
<li>
<p>Install a JDK version that is <a href="../../../reference/product-compatibility.md#tested-jdks">compatible with this product version</a>.</p>
</li>
...
<a href="../../../reference/product-compatibility.md#wso2-product-compatibility-matrix">Compatibility of WSO2 Products</a>.</p></li>
<li><p>
