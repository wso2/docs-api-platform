---
title: "Upgrade WSO2 API Manager to 4.7.0"
description: "Understand why and when to upgrade WSO2 API Manager to 4.7.0, and how to get started with a seamless upgrade through WSO2 Support."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/install-and-setup/upgrading-wso2-api-manager/upgrading-api-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/install-and-setup/upgrading-wso2-api-manager/upgrading-api-manager.md
tags:
  - api-manager
  - installation
...
Over the course of its lifetime, WSO2 API Manager has changed significantly. To learn what’s new in the WSO2 API Manager 4.7.0 release, see the [About this Release page](../../get-started/about-this-release.md).
...
!!! note
    From WSO2 API Manager 4.5.0 onwards, we no longer support API-M profiles such as, `-Dprofile=control-plane`, `-Dprofile=gateway-worker` and `-Dprofile=traffic-manager`. Instead, we now have separate distributions namely, **WSO2 API Control Plane**, **WSO2 Classic Gateway (Universal)** and **WSO2 Traffic Manager** components. For more information please refer the **Key Changes** section in the [About this Release](../../get-started/about-this-release.md) page.
