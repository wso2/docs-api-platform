...
description: "Configure an existing read-only LDAP directory as the primary user store in WSO2 API Manager, including connection settings and administrator setup."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/install-and-setup/setup/configure-userstores/configure-primary-user-store/configuring-a-read-only-ldap-user-store/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/install-and-setup/setup/configure-userstores/configure-primary-user-store/configuring-a-read-only-ldap-user-store.md
tags:
  - api-manager
  - user-stores
  - configuration
...
```
For information about the system administrator user, see [Configuring the System Administrator](../../../../reference/config-catalog.md#super-admin-configurations) , and for information on how keystores are used in WSO2 products, see [Creating New Keystores](../../security/configuring-keystores/keystore-basics/creating-new-keystores.md) .
