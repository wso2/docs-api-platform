...
description: "Plan backups and recovery for a WSO2 API Manager deployment, covering database and instance backups and recovery based on RTO and backup frequency."
