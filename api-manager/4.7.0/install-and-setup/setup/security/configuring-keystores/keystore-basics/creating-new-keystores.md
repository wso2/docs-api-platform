...
For information on the concepts of keystores and about how keystores are used in WSO2 API Manager, see [About Keystores and Truststores](about-keystores-and-truststores.md).
