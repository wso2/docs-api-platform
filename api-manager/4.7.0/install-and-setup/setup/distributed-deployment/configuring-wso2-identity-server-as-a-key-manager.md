...
!!! warning
    WSO2 Identity Server 7.x **cannot** be set up as a Resident Key Manager. It can only be set up as a [Third-party Key Manager](configure-a-third-party-key-manager.md). See [Configure WSO2 IS Key Manager](../../../api-security/key-management/third-party-key-managers/configure-wso2is7-connector.md) for instructions on configuring WSO2 Identity Server 7.x as a Third-party Key Manager.
...
1. Download the [WSO2 IS Connector](../../../assets/attachments/administer/wso2is-extensions-1.8.8.zip).
