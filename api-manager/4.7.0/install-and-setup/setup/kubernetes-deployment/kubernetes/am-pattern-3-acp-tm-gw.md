...
description: "Deploy WSO2 API Manager on Kubernetes with dedicated, independently scalable nodes for the Control Plane, Traffic Manager, and Classic Gateway."
