...
description: "Replace the default embedded H2 database with Microsoft SQL Server in WSO2 API Manager, including database setup, JDBC drivers, and schema scripts."
