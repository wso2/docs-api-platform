...
description: "Manually configure and deploy WSO2 API Manager as a single standalone all-in-one instance, including SSL, load balancer, and database setup."
...
For more information on generating and configuring the key, see [Configuring Encryption Key](../security/encryption/symmetric-encryption.md#generate-a-secret-key).
