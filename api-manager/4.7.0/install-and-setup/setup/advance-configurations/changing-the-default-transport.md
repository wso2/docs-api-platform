...
description: "Configure the HTTP PassThrough transport used by WSO2 API Manager in deployment.toml, including receiver and sender parameters and connection throttling."
