...
description: "Customize the WSO2 API Manager Management Console UI by editing the Carbon UI JAR and product-specific styles JAR for layout, CSS, and images."
