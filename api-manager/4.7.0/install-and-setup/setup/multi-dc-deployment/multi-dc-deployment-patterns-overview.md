...
description: "An overview of WSO2 API Manager's multi-datacenter deployment patterns and guidance on choosing between them for your deployment."
...
Each setup includes Classic Gateway instances, Publisher/Store components, Key Manager instances and any other relevant components.
...
Please refer to the [documentation](configuring-multi-dc-deployment-pattern-1.md) for detailed information on configuring pattern 1.
...
Please refer to the [documentation](configuring-multi-dc-deployment-pattern-2.md) for detailed information on configuring pattern 2.
