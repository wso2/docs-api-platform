...
Follow the guideline [here](../distributed-deployment/deploying-wso2-api-m-in-a-distributed-setup.md#configure-the-gateway-nodes) to configure the Gateway of the sub-region to connect with the Control Plane of the main region and the traffic manager of the sub-region. Take a note of the hostnames given below when configuring the Gateway node.
...
Follow the guideline [here](../distributed-deployment/deploying-wso2-api-m-in-a-distributed-setup.md#configure-the-traffic-manager-nodes) to configure the Traffic Manager of the sub-region to connect with the Control Plane of the main region. Take a note of the hostnames given below when configuring the Gateway node.
