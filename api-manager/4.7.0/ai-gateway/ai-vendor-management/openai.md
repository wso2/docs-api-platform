---
title: "Configure OpenAI as an AI Service Provider"
description: "Configure OpenAI as a default AI Service Provider, including editable model lists and model-based load balancing and failover."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/ai-gateway/ai-vendor-management/openai/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/ai-gateway/ai-vendor-management/openai.md
tags:
  - api-manager
  - ai-gateway
...
[![OpenAI Configuration](../../assets/img/learn/ai-gateway/openai-config.png){: style="width:90%"}](../../assets/img/learn/ai-gateway/openai-config.png)
