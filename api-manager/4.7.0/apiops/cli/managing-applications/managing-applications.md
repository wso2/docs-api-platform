...
description: "Use apictl commands to list and delete Applications in a WSO2 API Manager environment, and see how the --owner flag behaves across registration types."
