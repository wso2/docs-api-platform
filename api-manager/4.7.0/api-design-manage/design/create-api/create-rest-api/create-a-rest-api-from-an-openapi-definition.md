...
description: "Import an OpenAPI definition to create a REST API, then configure its resources, security, endpoints, and business plans using the Petstore sample."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md
tags:
  - api-manager
  - openapi
  - api-design
...
2. Click **Create API** and then click **Import OpenAPI**.
    ...
    [![Create an API](../../../../assets/img/get_started/design-new-rest-api.png)](../../../../assets/img/get_started/design-new-rest-api.png)
