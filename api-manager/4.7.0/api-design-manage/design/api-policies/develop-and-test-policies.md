...
- Familiarity with [policy creation concepts](create-policy.md)
...
2. Review the [list of unsupported mediators](create-policy.md) to ensure your policy doesn't use restricted mediators:
...
- [Create a policy](create-policy.md)
- [Attach a policy](attach-policy.md)
- [API policies overview](overview.md)