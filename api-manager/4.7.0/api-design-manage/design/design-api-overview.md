...
description: "An overview of the API design phase: create REST, GraphQL, and Streaming APIs, secure and document them, test them, and manage revisions."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/design-api-overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/design-api-overview.md
tags:
  - api-manager
  - api-design
...
- [Create a REST API through the API Publisher](create-api/create-rest-api/create-a-rest-api.md) - You can directly create your API in the API Publisher by linking to your existing backend API implementation.
- [Create a REST API from an OpenAPI Definition](create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md) - An OpenAPI definition is a format that describes REST APIs. You can create a REST API based on this definition.
...
Due to the expanding consumer base, the application developers have to focus on limiting the API access in order to make sure that only the authorized parties have access to the respective resources/services. Please refer to [an overview of Authorization in API Manager](../../api-security/runtime/authorization/api-authorization.md) for more information.
