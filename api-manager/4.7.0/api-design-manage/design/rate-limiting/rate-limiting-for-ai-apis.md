...
description: "Configure token-based rate limiting policies for AI APIs, covering request, total, prompt, and completion token counts through the Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/rate-limiting/rate-limiting-for-ai-apis/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/rate-limiting/rate-limiting-for-ai-apis.md
tags:
  - api-manager
  - ai-apis
  - rate-limiting
...
4.  Fill in the details required by this form and click **Save** once you are done.
     ...
     | Unit Time                       | Time within which the number of requests given in the previous field is allowed to the API. This can be defined in the desired time unit.                  |
