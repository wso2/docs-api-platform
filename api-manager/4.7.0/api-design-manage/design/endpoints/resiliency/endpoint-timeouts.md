---
title: "Configure Endpoint Timeouts and Suspension"
description: "Configure advanced endpoint settings in the Publisher for suspension error codes and durations, timeout retries, and connection timeout behavior."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/endpoints/resiliency/endpoint-timeouts/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/endpoints/resiliency/endpoint-timeouts.md
tags:
  - api-manager
  - resiliency
  - endpoints
