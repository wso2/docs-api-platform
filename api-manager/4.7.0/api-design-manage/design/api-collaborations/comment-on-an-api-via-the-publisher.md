...
description: "Add and reply to comments on an API through the Publisher Portal to build a community around the API and collaborate with API consumers and other publishers."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/api-collaborations/comment-on-an-api-via-the-publisher/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/api-design-manage/design/api-collaborations/comment-on-an-api-via-the-publisher.md
tags:
  - api-manager
  - publisher-portal
  - developer-portal
