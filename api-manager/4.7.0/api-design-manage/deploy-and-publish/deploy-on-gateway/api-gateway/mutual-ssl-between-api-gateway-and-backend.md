...
description: "Configure mutual SSL between the Classic Gateway and a backend service by exchanging certificates and enabling SSL profiles."
...
## Test Mutual SSL between Classic Gateway and backend
