...
description: "Enable or disable Developer Portal self-registration for a tenant using identity provider settings and the SelfSignUp advanced configuration."
