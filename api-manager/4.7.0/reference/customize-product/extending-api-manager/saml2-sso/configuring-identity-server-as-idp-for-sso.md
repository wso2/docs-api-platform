---
title: "Configure Identity Server as IdP for SAML2 SSO"
description: "Set up SAML 2.0 Single Sign-On across the Publisher and Developer Portal using WSO2 Identity Server, including JIT provisioning."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/reference/customize-product/extending-api-manager/saml2-sso/configuring-identity-server-as-idp-for-sso/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/reference/customize-product/extending-api-manager/saml2-sso/configuring-identity-server-as-idp-for-sso.md
tags:
  - api-manager
  - sso
  - saml2
...
5. Click and expand the **Claim Configuration** section.
    ...
    [![IS SAML SSO Claim Configurations](../../../../assets/img/learn/extensions/saml2-sso/is-saml-sso-claim-configs.png)](../../../../assets/img/learn/extensions/saml2-sso/is-saml-sso-claim-configs.png)
...
5.  Click and expand the **Claim Configuration** section, and click and expand **Basic Claim Configuration**.
    ...
    [![SAML SSO APIM CLAIM CONFIGURATIONS](../../../../assets/img/learn/extensions/saml2-sso/is-saml-sso-apim-claim-configs.png)](../../../../assets/img/learn/extensions/saml2-sso/is-saml-sso-apim-claim-configs.png)
...
6.  Click and expand the **Role Configuration** section.
    ...
    [![SAML SSO APIM ROLE CONFIGURATIONS](../../../../assets/img/learn/extensions/saml2-sso/is-saml-sso-apim-role-configs.png)](../../../../assets/img/learn/extensions/saml2-sso/is-saml-sso-apim-role-configs.png)
