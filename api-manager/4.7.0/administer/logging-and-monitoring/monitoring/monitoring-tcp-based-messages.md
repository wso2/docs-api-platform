---
title: "Monitoring TCP-based Messages with TCPMon"
description: "Use the TCPMon utility bundled with WSO2 API Manager to monitor TCP-based messages and debug web service requests."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/administer/logging-and-monitoring/monitoring/monitoring-tcp-based-messages/
md_url: https://wso2.com/api-platform/docs/api-manager/4.7.0/administer/logging-and-monitoring/monitoring/monitoring-tcp-based-messages.md
tags:
  - api-manager
  - observability
  - monitoring
