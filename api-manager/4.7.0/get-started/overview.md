...
description: "Overview of WSO2 API Manager's core capabilities: API design, AI Gateway and MCP Gateway features, security, the Developer Portal, and analytics."
...
> **[Learn about Classic API Gateway](../api-gateway/overview-of-the-api-gateway.md)**
...
- Get started quickly with the [Quick Start Guide](api-manager-quick-start-guide.md)
- Understand the [architecture and key concepts](apim-architecture.md)
- Explore [what's new in this release](about-this-release.md)
