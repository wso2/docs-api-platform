...
description: "Upload, inspect, and delete backend certificates for an API endpoint from the Publisher Portal without restarting the WSO2 API Manager server."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/endpoints/certificates/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/endpoints/certificates.md
tags:
  - api-manager
  - api-design-manage
  - design
