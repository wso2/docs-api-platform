---
title: "Validating API definitions against custom linter rules"
description: "Add custom linter rules in the Admin Portal and read the validation results shown when creating, importing, or editing an API definition."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/advanced-topics/validate-api-definitions-with-linters/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/advanced-topics/validate-api-definitions-with-linters.md
tags:
  - api-manager
  - api-design-manage
  - design
...
4. Add the new rule under “LinterCustomRules -> rules” as below.
    ...
    [![Linter results](../../../assets/img/design/create-api/linter-observe/linters1.png)](../../../assets/img/design/create-api/linter-observe/linters1.png)
...
When you are following the [API creation steps](../../../api-design-manage/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md), the linter results will be shown as below.

[![Linter results](../../../assets/img/design/create-api/linter-observe/linters2.png)](../../../assets/img/design/create-api/linter-observe/linters2.png)
...
6. The linter results will be shown as indicated below.
    ...
    [![Linter results](../../../assets/img/design/create-api/linter-observe/linters3.png)](../../../assets/img/design/create-api/linter-observe/linters3.png)
...
8. Then click on **Import Content** in the editor to import the API definition.
    ...
    [![Linter results](../../../assets/img/design/create-api/linter-observe/linters4.png)](../../../assets/img/design/create-api/linter-observe/linters4.png)
...
4. Click on **Edit** from the toolbar.
    ...
    [![Linter results](../../../assets/img/design/create-api/linter-observe/linters5.png)](../../../assets/img/design/create-api/linter-observe/linters5.png)
...
6. You will see the linter error corresponding to the new rule you enforced.
    ...
    [![Linter results](../../../assets/img/design/create-api/linter-observe/linters6.png)](../../../assets/img/design/create-api/linter-observe/linters6.png) 