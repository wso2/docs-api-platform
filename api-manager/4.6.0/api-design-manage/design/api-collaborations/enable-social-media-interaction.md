...
description: "Show Facebook, Twitter, and Reddit sharing links for APIs on the Developer Portal, and add GitHub and Slack channel URLs to an API."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/api-collaborations/enable-social-media-interaction/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/api-collaborations/enable-social-media-interaction.md
tags:
  - api-manager
  - api-design-manage
  - design
...
3. Click **Basic info**.
    ...
    [![Basic info link](../../../assets/img/design/community-features/publisher-community-link-basic-info.png)](../../../assets/img/design/community-features/publisher-community-link-basic-info.png)

4. Provide your GitHub and Slack channel URL in the respective input fields and click **Save**

    [![GitHub and Slack channel URL](../../../assets/img/design/community-features/publisher-slack-urls.png)](../../../assets/img/design/community-features/publisher-slack-urls.png)
