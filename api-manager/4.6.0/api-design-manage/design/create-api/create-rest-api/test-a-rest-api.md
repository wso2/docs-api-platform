...
description: "Test a REST API in the Publisher Portal with the integrated API Console: generate an internal key, try out resources, and inspect the responses."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/create-api/create-rest-api/test-a-rest-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/design/create-api/create-rest-api/test-a-rest-api.md
tags:
  - api-manager
  - api-design-manage
  - design
...
!!! note
    Create the `PizzaShack` REST API or an API of your choice before following the instructions below. For more information, see [Create a REST API.](../../../../api-design-manage/design/create-api/create-rest-api/create-a-rest-api.md).
...
5.  Expand the **GET**  method, click **Try it out**, and click **Execute**.
    ...
    [![Publisher test console](../../../../assets/img/design/create-api/test-api/publisher-testconsole-swaggerui.png)](../../../../assets/img/design/create-api/test-api/publisher-testconsole-swaggerui.png)