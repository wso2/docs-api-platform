...
description: "Cache API responses at the Universal Gateway with a timeout value, tune the cache mediator properties, and invalidate cached responses remotely."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/deploy-and-publish/deploy-on-gateway/api-gateway/response-caching/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-design-manage/deploy-and-publish/deploy-on-gateway/api-gateway/response-caching.md
tags:
  - api-manager
  - api-design-manage
  - deploy-and-publish
