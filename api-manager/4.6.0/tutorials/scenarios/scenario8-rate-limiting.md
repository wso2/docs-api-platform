...
description: "Protect a backend limited to 1000 TPS by applying a subscription rate limiting policy and a maximum backend throughput limit."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/tutorials/scenarios/scenario8-rate-limiting/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/tutorials/scenarios/scenario8-rate-limiting.md
tags:
  - api-manager
  - tutorials
  - scenarios
...
This is a tutorial that is part of a series and can be used as a standalone tutorial on how to set up rate limiting for an API. For more details on the scenario and general prerequisites, please see [the scenario overview page](../../tutorials/scenarios/scenario-overview.md).
...
2. Navigate to **Rate Limiting Policies → Subscription** Policies and create a new policy. The following is a sample policy.
    ...
    ![Sample policy](../../assets/img/tutorials/scenarios/sample-policy.png)
...
4. Apply the policy to the **PassengerInfoAPI** and save the API.
    ...
    ![Apply policy](../../assets/img/tutorials/scenarios/apply-policy.png)
...
6. Subscribe to the API using this policy and invoke the API using the generated token. 
    ...
    ![Subscribe](../../assets/img/tutorials/scenarios/subscribe-policy-api.png)

    ![Invoke](../../assets/img/tutorials/scenarios/invoke-policy-api.png)

7. When you request more than 10 times you will get a throttled-out message.

    ![Throttle out](../../assets/img/tutorials/scenarios/throttleout-api.png)
...
2. Under the **Backend** section, you could define the maximum TPS for the backend. For this demo, to see the results quickly, lets set it to 1 TPS and save the API
    ...
    ![Maximum throughput](../../assets/img/tutorials/scenarios/max-throughput.png)
...
![Backend throttled out](../../assets/img/tutorials/scenarios/throttleout-backend.png)
...
Try out the next scenario in the series, [Realtime Data with WebSocket API](../../tutorials/scenarios/scenario9-realtime-data.md).