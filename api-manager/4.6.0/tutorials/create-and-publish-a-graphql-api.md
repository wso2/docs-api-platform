...
description: "Design, deploy, publish, and invoke a GraphQL API in WSO2 API Manager using a GraphQL SDL schema and the Developer Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/tutorials/create-and-publish-a-graphql-api/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/tutorials/create-and-publish-a-graphql-api.md
tags:
  - api-manager
  - tutorials
...
<p>For more information on GraphQL APIs, see <a href="../../api-design-manage/design/create-api/create-a-graphql-api/">Create a GraphQL API</a>.</p>
</div> 
...
2. Click on the GraphQL API.
      ...
      [![StarWarsAPI API overview](../assets/img/tutorials/create-and-publish-a-graphql-api/api-overview.png)](../assets/img/tutorials/create-and-publish-a-graphql-api/api-overview.png)
...
3. Subscribe to the API.
    ...
    1. Click **TRY OUT**.
         ...
         [![Try Out Wizard and Popup](../assets/img/tutorials/create-and-publish-a-graphql-api/try-out-graphql-popup.png)](../assets/img/tutorials/create-and-publish-a-graphql-api/try-out-graphql-popup.png)
...
<li><p>If you are going to invoke MUTATION Operation, you should start the payload with the keyword 'mutation'.</p></li></ul>
 ...
 1. Enter the following sample payload as the StarWarsAPI request. Then click on execute button as follows.
      ...
      [![Execute GraphQL Query](../assets/img/tutorials/create-and-publish-a-graphql-api/graphql-console-execute-query.png)](../assets/img/tutorials/create-and-publish-a-graphql-api/graphql-console-execute-query.png)
...
3. Click **Execute**. 
    ...
    [![Response of GraphQL Subscription Init](../assets/img/tutorials/create-and-publish-a-graphql-api/graphql-sub-init-response.png)](../assets/img/tutorials/create-and-publish-a-graphql-api/graphql-sub-init-response.png)
...
5. Now go back to the Developer Portal browser page.
    ...
    [![Response Event of GraphQL Subscription](../assets/img/tutorials/create-and-publish-a-graphql-api/try-out-sub-event.png)](../assets/img/tutorials/create-and-publish-a-graphql-api/try-out-sub-event.png)
