...
description: "Add resources and interactive documentation to an API by editing its OpenAPI definition in the Publisher Portal Swagger editor."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/tutorials/edit-an-api-by-modifyng-the-api-definition/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/tutorials/edit-an-api-by-modifyng-the-api-definition.md
tags:
  - api-manager
  - tutorials
...
!!! note
    This tutorial uses the `PizzaShack` API created in [Create a REST API](../api-design-manage/design/create-api/create-rest-api/create-a-rest-api.md) section and Published in the [Publish an API](../api-design-manage/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) section.
...
1.  Sign in to the API Publisher and click **Create API** and then select **REST API** from the home screen and then click **Start From Scratch**. `https://<hostname>:9443/publisher`
    ...
    ![create_a_rest_api](../assets/img/get_started/design-new-rest-api.png)
...
3.  In the **Create an API** page, give an API name, a context a version and the endpoint as follows and click **Create**. 
    ...
    ![create_an_API](../assets/img/learn/tutorials/create-a-rest-api-pizzashack.png)

    The **Overview** of the created API will be displayed. 

    ![create_a_rest_api](../assets/img/learn/overviewpage-rest-api.png)


4. Click on **API definition** to view the API Definition in the swagger UI.
    The Swagger UI opens.
    ![](../assets/img/learn/tutorials/rest-api-definition-pizzashack.png)
...
5. Add the following GET and PUT method for the API.
    ...
    3. Click **Update Content**.
       ...
       **Resources** tab along with the parameters defined. 
       ![](../assets/img/learn/tutorials/create-rest-api-pizzashack-resources.png)
        ...
        !!! info
            Troubleshooting:
               If you get an error after adding the API definition in the Swagger UI, first check the indentation of the code that you added, which defines the API, because Swagger throw errors if the indention is not correct.
                ![](../assets/img/learn/tutorials/rest-api-definition-pizzashack-indentation.png)
       ...
       6. Add a summary and description for the GET method.
           ...
           1.  Click **Edit Source** and add the following code, which defines a summary and description, to the GET method.
               ...
               ![](../assets/img/learn/tutorials/pizzashack-api-get-summary-and-descrption.png)
           ...
           2.  Click **Apply Changes**.
                  ...
                  ![](../assets/img/learn/tutorials/pizza-shack-api-get-summary-and-description-updated.png)
...
7. Complete the rest of the API creation process.
    For more information, see step 7 onwards under [Create a REST API](../api-design-manage/design/create-api/create-rest-api/create-a-rest-api.md) section and Published in the [Publish an API](../api-design-manage/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) section.
...
9. Click **Try Out**.
    ...
    ![](../assets/img/learn/tutorials/pizza-shack-api-get-dev-portal.png)
    ![](../assets/img/learn/tutorials/pizza-shack-api-put-dev-portal.png)
