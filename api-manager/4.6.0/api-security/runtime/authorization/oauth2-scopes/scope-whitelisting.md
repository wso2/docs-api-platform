...
description: "Allowlist scopes such as openid or device_ in deployment.toml so WSO2 API Manager issues tokens for them without validating user roles."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-security/runtime/authorization/oauth2-scopes/scope-whitelisting/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-security/runtime/authorization/oauth2-scopes/scope-whitelisting.md
tags:
  - api-manager
  - api-security
  - runtime
