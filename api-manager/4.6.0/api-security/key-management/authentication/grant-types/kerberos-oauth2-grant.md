...
description: "Exchange a Kerberos service ticket for an OAuth2 access token in WSO2 API Manager, with WSO2 Identity Server acting as the Key Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-security/key-management/authentication/grant-types/kerberos-oauth2-grant/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-security/key-management/authentication/grant-types/kerberos-oauth2-grant.md
tags:
  - api-manager
  - api-security
  - key-management
