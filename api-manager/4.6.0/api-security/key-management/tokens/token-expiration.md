...
For more information about changing the default token expiration time, see [Changing the Default Token Expiration Time](../../../api-developer-portal/manage-application/generate-keys/obtain-access-token/changing-the-default-token-expiration-time.md).
