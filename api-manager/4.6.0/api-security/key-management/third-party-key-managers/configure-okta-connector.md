...
description: "Configure Okta as a third-party Key Manager in WSO2 API Manager: set up the Okta authorization server, register the connector, and generate keys."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-security/key-management/third-party-key-managers/configure-okta-connector/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-security/key-management/third-party-key-managers/configure-okta-connector.md
tags:
  - api-manager
  - api-security
  - key-management
...
1. Navigate to the [Okta sign up page](https://developer.okta.com/signup/) and singup to **Workforce Identity Cloud**. We have created an account in **Developer Edition** for this.
     ...
     [![Okta signup](../../../assets/img/administer/okta-signup.png)](../../../assets/img/administer/okta-signup.png)
...
2. Obtain the authorization server ID.
    ...
    2. Create a new authorization server.
         ...
         [![Okta authorization server](../../../assets/img/administer/okta-authorization-server.png)](../../../assets/img/administer/okta-authorization-server.png)
    ...
    3. Add a default scope. 
         ...
         3. Select **Default Scope**.
             ...
             [![Okta default scope](../../../assets/img/administer/okta-default-scope.png)](../../../assets/img/administer/okta-default-scope.png)
...
3. Get the API key.
    ...
    3. Copy the token value and keep it for future use.
         ...
         [![Okta token](../../../assets/img/administer/okta-token.png)](../../../assets/img/administer/okta-token.png)
...
4. Create access policies.
    ...
    4. Enter the required information.
        ...
        [![Okta access policy](../../../assets/img/administer/okta-access-policy.png)](../../../assets/img/administer/okta-access-policy.png)
...
5. Create Rules for the Access Policy.
     ...
     3. Select the name of an access policy, and click **Add Rule**.
         ...
         [![Okta rule](../../../assets/img/administer/okta-rule.png)](../../../assets/img/administer/okta-rule.png)
...
6. Create an OAuth application to get the credentials to access the introspect API:
    ...
    2. Click **API Services** and then click **Next**.
         ...
         [![okta add application introduction](../../../assets/img/administer/okta-add-application-intro.png)](../../../assets/img/administer/okta-add-application-intro.png)
...
7. Note down the Authorization server's settings.
    ...
    3. Note down the settings related to the Authorization server.
     ...
     [![Okta authorization server settings](../../../assets/img/administer/okta-authorization-server-settings.png)](../../../assets/img/administer/okta-authorization-server-settings.png)
...
3. Add a new Key Manager.
     ...
     2. Add the following Key Manager configurations.
           ...
           [![Okta Configuration](../../../assets/img/administer/okta-admin-configuration.png)](../../../assets/img/administer/okta-admin-configuration.png)
...
4. Click **Sandbox Keys**.
     ...
     [![Okta Developer Portal generate keys](../../../assets/img/administer/okta-devportal-generate-keys.png)](../../../assets/img/administer/okta-devportal-generate-keys.png)
