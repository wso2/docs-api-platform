---
title: "Managing users for the Admin Portal"
description: "Create a role, set its permissions, and add a user so they can sign in to the WSO2 API Manager Admin Portal."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/managing-users-and-roles/managing-users-for-admin-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/managing-users-and-roles/managing-users-for-admin-portal.md
tags:
  - api-manager
  - administer
  - admin-portal
