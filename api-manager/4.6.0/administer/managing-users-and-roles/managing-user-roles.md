...
description: "Create user roles in WSO2 API Manager, add scope assignments to them, and edit or delete roles as your permissions model changes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/managing-users-and-roles/managing-user-roles/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/managing-users-and-roles/managing-user-roles.md
tags:
  - api-manager
  - administer
  - user-management
