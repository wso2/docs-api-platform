...
description: "Change where WSO2 API Manager stores users, roles, and permissions by configuring the authorization manager away from the default database."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/managing-users-and-roles/managing-user-stores/configuring-the-authorization-manager/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/managing-users-and-roles/managing-user-stores/configuring-the-authorization-manager.md
tags:
  - api-manager
  - administer
  - user-store
