...
description: "Use the TCPMon utility to view and monitor messages passed along a TCP conversation when debugging WSO2 API Manager."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/logging-and-monitoring/monitoring/monitoring-tcp-based-messages/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/administer/logging-and-monitoring/monitoring/monitoring-tcp-based-messages.md
tags:
  - api-manager
  - administer
  - monitoring
