---
title: "JWT claim based access validator"
description: "Restrict access to an API resource with the JWT claim based access validator policy, matching a custom claim value directly or against a regex."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/policies/jwt-claim-based-access-validator/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/policies/jwt-claim-based-access-validator.md
tags:
  - api-manager
  - api-gateway
  - policies
...
2.  Under the **Policy List** that appear on the right side of the screen, look for the **JWT claim based access validator** policy from the `Request` tab.
    ...
    [![JWT claim based access validator](../../assets/img/design/api-policies/jwt-claim-based-access-validation-policy.png)](../../assets/img/design/api-policies/jwt-claim-based-access-validation-policy.png)
...
3.  Drag and drop the **JWT claim based access validator** policy from the policy list to the request flow of any desired API operation. In the below screenshot, the policy was dropped to the `/order POST` operation.
    ...
    [![JWT claim based access validator](../../assets/img/design/api-policies/configure-jwt-claim-based-access-validation-policy.png)](../../assets/img/design/api-policies/configure-jwt-claim-based-access-validation-policy.png)

4.  Finally, scroll down and click on the **Save** button in order to apply the attached policies to the API.

    [![JWT claim based access validator](../../assets/img/design/api-policies/save-attached-policies.png)](../../assets/img/design/api-policies/save-attached-policies.png)
