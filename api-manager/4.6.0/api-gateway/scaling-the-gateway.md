...
description: "Sizing guidance for Universal Gateway deployments, with recommended Gateway ratios for Key Managers, Traffic Managers, and Control Plane nodes."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/scaling-the-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/scaling-the-gateway.md
tags:
  - api-manager
  - api-gateway
  - scaling-the-gateway
