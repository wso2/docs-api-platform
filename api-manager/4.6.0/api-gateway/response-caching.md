...
description: "Turn on response caching for an API in the Publisher Portal, tune the cache mediator properties, and invalidate cached responses over JMX."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/response-caching/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/response-caching.md
tags:
  - api-manager
  - api-gateway
  - response-caching
