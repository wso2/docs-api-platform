...
description: "Point each Universal Gateway at its own backend by defining parameterized endpoint URLs that resolve to a host and port at gateway startup."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/api-gateways-with-dedicated-backends/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-gateway/api-gateways-with-dedicated-backends.md
tags:
  - api-manager
  - api-gateway
...
3.  Save and [publish](../api-design-manage/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) the API.
