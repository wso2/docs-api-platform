...
description: "How a request travels through the API Manager Gateway: the handler chain, mediation extensions, and the in and out sequences."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/guides/message-flow-in-the-api-manager-gateway/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/guides/message-flow-in-the-api-manager-gateway.md
tags:
  - api-manager
  - reference
  - guides
