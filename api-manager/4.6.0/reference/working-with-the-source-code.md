...
description: "Where the WSO2 API Manager source code and build scripts live on GitHub, and how to build a customized product with Maven."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/working-with-the-source-code/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/working-with-the-source-code.md
tags:
  - api-manager
  - reference
