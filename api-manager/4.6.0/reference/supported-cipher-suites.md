...
description: "Cipher suites that are secure and functional for TLS 1.2 and TLS 1.3 in WSO2 API Manager, and the weaker suites to avoid."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/supported-cipher-suites/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/supported-cipher-suites.md
tags:
  - api-manager
  - reference
