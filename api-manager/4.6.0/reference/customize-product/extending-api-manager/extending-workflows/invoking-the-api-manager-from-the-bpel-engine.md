...
description: "SOAP and REST callback endpoints, payloads, and credentials that a BPEL engine uses to resume a WSO2 API Manager workflow."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/customize-product/extending-api-manager/extending-workflows/invoking-the-api-manager-from-the-bpel-engine/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/customize-product/extending-api-manager/extending-workflows/invoking-the-api-manager-from-the-bpel-engine.md
tags:
  - api-manager
  - reference
  - customize-product
