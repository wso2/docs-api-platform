...
description: "Use cleanUpPendingTask and a BPEL cancel event so approval tasks disappear from the Admin Portal when users delete their requests."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/customize-product/extending-api-manager/extending-workflows/cleaning-up-workflow-tasks/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/customize-product/extending-api-manager/extending-workflows/cleaning-up-workflow-tasks.md
tags:
  - api-manager
  - reference
  - customize-product
