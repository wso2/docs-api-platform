...
description: "Skip role validation for OAuth scopes in WSO2 API Manager so tokens are issued on the requested scope alone, and when to do it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/customize-product/extending-api-manager/extending-key-management/extending-scope-validation/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/customize-product/extending-api-manager/extending-key-management/extending-scope-validation.md
tags:
  - api-manager
  - reference
  - customize-product
