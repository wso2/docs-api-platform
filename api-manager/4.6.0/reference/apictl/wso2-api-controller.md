...
description: "Install and initialize the WSO2 API Controller (apictl), and look up every apictl command, global flag, and usage example."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/apictl/wso2-api-controller/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/apictl/wso2-api-controller.md
tags:
  - api-manager
  - reference
  - apictl
