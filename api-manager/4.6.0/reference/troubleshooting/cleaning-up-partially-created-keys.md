...
description: "Remove stale application key data left in WSO2 API Manager when OAuth application creation or deletion completes only partially."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/troubleshooting/cleaning-up-partially-created-keys/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/reference/troubleshooting/cleaning-up-partially-created-keys.md
tags:
  - api-manager
  - reference
  - troubleshooting
