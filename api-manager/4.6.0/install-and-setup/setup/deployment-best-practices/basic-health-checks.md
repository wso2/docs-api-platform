...
description: "Check the health of WSO2 API Manager nodes by connecting to component ports and calling the Version service with a cURL request."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/install-and-setup/setup/deployment-best-practices/basic-health-checks/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/install-and-setup/setup/deployment-best-practices/basic-health-checks.md
tags:
  - api-manager
  - install-and-setup
  - setup
