...
description: "Create an application in the WSO2 API Manager Developer Portal to hold API subscriptions, and choose the token quota it operates under."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-developer-portal/manage-application/create-application/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-developer-portal/manage-application/create-application.md
tags:
  - api-manager
...
WSO2 API Manager comes with a pre-created default application, which allows unlimited access by default. Default application creation can be disabled by adding the configuration `"DisableDefaultApplicationCreation" : true` in to the `Advanced Configurations` under `Settings` of the `admin` portal. You can also [create](#create-a-new-application) your own.
