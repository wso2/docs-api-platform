...
description: "Generate and download a client-side SDK for a subscribed API from the Developer Portal, and configure which languages SDK generation supports."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-developer-portal/generating-sdks/generate-sdks-in-dev-portal/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/api-developer-portal/generating-sdks/generate-sdks-in-dev-portal.md
tags:
  - api-manager
