...
description: "Prompt management in WSO2 AI Gateway: standardize AI interactions with the Prompt Template and Prompt Decorator policies at the AI API level."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/ai-gateway/prompt-management/overview/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/ai-gateway/prompt-management/overview.md
tags:
  - api-manager
  - ai-gateway
  - prompt-management
