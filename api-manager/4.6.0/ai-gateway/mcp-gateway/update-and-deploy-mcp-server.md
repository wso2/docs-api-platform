---
title: "Updating tools and deploying the MCP server"
description: "Rename, describe, and add tools on an MCP server, then deploy it to a gateway, test it in the MCP Playground, and publish it."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/ai-gateway/mcp-gateway/update-and-deploy-mcp-server/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/ai-gateway/mcp-gateway/update-and-deploy-mcp-server.md
tags:
  - api-manager
  - ai-gateway
  - mcp-gateway
  - update-and-deploy-mcp-server
...
1. In the left navigation menu, go to **API Configurations** → **Tools**.
   ...
   [![MCP Tools](../../assets/img/mcp-gateway/mcp-tools.png){: style="width:90%"}](../../assets/img/mcp-gateway/mcp-tools.png)
...
[![MCP Server Deploy](../../assets/img/mcp-gateway/mcp-server-deploy.png){: style="width:90%"}](../../assets/img/mcp-gateway/mcp-server-deploy.png)
...
#### Testing Steps
   ...
   3. Interact with the available tools:
      ...
      * Validate that descriptions guide the correct usage.
      ...
      [![MCP Inspector](../../assets/img/mcp-gateway/mcp-inspector-publisher.png){: style="width:90%"}](../../assets/img/mcp-gateway/mcp-inspector-publisher.png)
...
#### Publishing Steps
   ...
   [![MCP Server Lifecycles](../../assets/img/mcp-gateway/mcp-lifecycles.png){: style="width:90%"}](../../assets/img/mcp-gateway/mcp-lifecycles.png)
