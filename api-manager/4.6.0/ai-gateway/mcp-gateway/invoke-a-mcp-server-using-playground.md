...
3. Click **Try Out** in MCP Server Overview tab and go to **Test** → **MCP Playground**
    ...
    [![MCP Playground Menu](../../assets/img/mcp-gateway/mcp-playground-menu.png)](../../assets/img/mcp-gateway/mcp-playground-menu.png)
...
4. Enter the copied access token in the **Token** field or click `Configuration` button on the MCP Playground and if a test key is not populated, click on **GET TEST KEY**.
    ...
    [![MCP PLayground Configuration Button](../../assets/img/mcp-gateway/mcp-playground-config-btn.png)](../../assets/img/mcp-gateway/mcp-playground-config-btn.png)

    [![Get Test Key for MCP Playground](../../assets/img/mcp-gateway/mcp-playground-get-test-key.png)](../../assets/img/mcp-gateway/mcp-playground-get-test-key.png)

5. Click on **Connect** to connect with your deployed MCP Server.

    [![Connect to MCP Server in Playground](../../assets/img/mcp-gateway/mcp-playground-connect.png)](../../assets/img/mcp-gateway/mcp-playground-connect.png)
...
6. Expand a method and enter the values to test. Click on the execute button to invoke the tool.
    ...
    [![Execute tool in MCP Playground](../../assets/img/mcp-gateway/mcp-playground-devportal.png)](../../assets/img/mcp-gateway/mcp-playground-devportal.png)
