...
description: "Initialize an API project from scratch or from an OpenAPI definition with apictl init, then import it to a WSO2 API Manager environment."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/apiops/cli/managing-apis-api-products/importing-apis-via-dev-first-approach/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/apiops/cli/managing-apis-api-products/importing-apis-via-dev-first-approach.md
tags:
  - api-manager
  - apiops
  - cli
