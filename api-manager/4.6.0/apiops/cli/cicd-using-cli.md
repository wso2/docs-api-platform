...
For this example, let us use the [Swagger Petstore - OpenAPI 3.0](https://petstore3.swagger.io/). 
  ...
  (For more information, see [Create a REST API from an Open API Definition](../../api-design-manage/design/create-api/create-rest-api/create-a-rest-api-from-an-openapi-definition.md)).
  ...
  7. [Deploy](../../api-design-manage/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api.md) and [Publish](../../api-design-manage/deploy-and-publish/publish-on-dev-portal/publish-an-api.md) the API.
...
1.  Sign in to the WSO2 API-M in the lower environment via the apictl.
    ...
    !!! tip
        A user with `Internal/devops` role or `admin` role are allowed to export APIs. To create a custom user who can export APIs, refer [Steps to Create a Custom User who can Perform API Controller Operations](advanced-topics/creating-custom-users-to-perform-api-controller-operations.md).
...
Create two (2) repositories in your Version Control System. You can give any names to these repositories, but in this example we will be naming those as **Source** and **Deployment**. Note that, **Deployment** repository is only needed if you want to [Configure Environment Specific Parameters](advanced-topics/configuring-environment-specific-parameters.md).
...
Follow the instructions below to generate a JWT/OAuth token for testing purposes using apictl in order to invoke an API or an [API Product](../../api-design-manage/design/create-api-product/api-product-overview.md) by subscribing to it using a new application created by apictl.
...
For example, let us consider there is an [API Product](../../api-design-manage/design/create-api-product/api-product-overview.md) **PetsInfo** in the development environment with a subset of operations of **SwaggerPetstore** API.
