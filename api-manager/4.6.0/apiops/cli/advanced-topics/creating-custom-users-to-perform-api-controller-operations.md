...
description: "Assign the Internal/devops role, or build a custom role from the minimal scopes that each apictl operation requires, and create the user."
canonical_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/apiops/cli/advanced-topics/creating-custom-users-to-perform-api-controller-operations/
md_url: https://wso2.com/api-platform/docs/api-manager/4.6.0/apiops/cli/advanced-topics/creating-custom-users-to-perform-api-controller-operations.md
tags:
  - api-manager
  - apiops
  - cli
