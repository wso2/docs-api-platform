...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/next/setup/health-checks/
md_url: https://wso2.com/api-platform/docs/api-gateway/next/setup/health-checks.md
tags:
  - api-gateway
  - health-check
  - deployment
