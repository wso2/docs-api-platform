...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/next/deployment/production-deployment/deploy-and-verify/
md_url: https://wso2.com/api-platform/docs/api-gateway/next/deployment/production-deployment/deploy-and-verify.md
tags:
  - api-gateway
  - deployment
  - helm
