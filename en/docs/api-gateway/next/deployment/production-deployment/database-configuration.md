...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/next/deployment/production-deployment/database-configuration/
md_url: https://wso2.com/api-platform/docs/api-gateway/next/deployment/production-deployment/database-configuration.md
tags:
  - api-gateway
  - deployment
  - postgresql
