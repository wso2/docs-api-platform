...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.1.0/setup/upstream-timeouts/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.1.0/setup/upstream-timeouts.md
tags:
  - api-gateway
  - configuration
  - networking
