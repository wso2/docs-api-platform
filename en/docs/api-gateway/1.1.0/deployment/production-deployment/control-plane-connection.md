...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.1.0/deployment/production-deployment/control-plane-connection/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.1.0/deployment/production-deployment/control-plane-connection.md
tags:
  - api-gateway
  - deployment
  - control-plane
