...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.0.0/deployment/high-availability-production-deployment/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.0.0/deployment/high-availability-production-deployment.md
tags:
  - api-gateway
  - deployment
  - kubernetes
