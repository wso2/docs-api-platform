...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/deployment/deployment-modes/immutable-gateway/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/deployment/deployment-modes/immutable-gateway.md
tags:
  - api-gateway
  - deployment
  - gitops
...
Ensure the controller's mounted `config.toml` sets `[immutable_gateway] enabled = true` (see [Configuration](#configuration)).
