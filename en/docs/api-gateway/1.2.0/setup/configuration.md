...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/setup/configuration/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/setup/configuration.md
tags:
  - api-gateway
  - configuration
  - interpolation
