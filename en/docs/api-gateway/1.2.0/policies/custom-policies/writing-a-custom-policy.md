...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/policies/custom-policies/writing-a-custom-policy/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/policies/custom-policies/writing-a-custom-policy.md
tags:
  - api-gateway
  - policies
  - custom-policies
...
- [Building the Gateway with Custom Policies](building-gateway-with-custom-policies.md): Build a gateway image that includes your custom policy
