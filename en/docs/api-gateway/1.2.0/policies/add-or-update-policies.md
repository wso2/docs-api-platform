...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/policies/add-or-update-policies/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/policies/add-or-update-policies.md
tags:
  - api-gateway
  - policies
  - cli
