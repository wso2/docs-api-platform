...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/observability/metrics/prometheus-queries/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/observability/metrics/prometheus-queries.md
tags:
  - api-gateway
  - observability
  - metrics
