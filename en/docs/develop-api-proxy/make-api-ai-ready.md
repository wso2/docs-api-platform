...
![Publish API dialog with Display Name, Production Endpoint, and Make this API discoverable by AI agents toggle](../assets/img/develop-api-proxy/publish-with-ai-visibility.png)
