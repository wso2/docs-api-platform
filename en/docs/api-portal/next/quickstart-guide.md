...
The following commands use version `1.0.0`. Substitute the API Portal and MCP Hub release version you want to run in the download URL, the archive name, and the directory name.
...
- To route MCP traffic through a gateway, with authentication and access control, see the [MCP proxy documentation](../../ai-gateway/next/gateway-artifacts/mcp-proxy.md).
