...
canonical_url: https://wso2.com/api-platform/docs/api-portal/next/admin-settings/manage-labels/
md_url: https://wso2.com/api-platform/docs/api-portal/next/admin-settings/manage-labels.md
tags:
  - cloud
  - api-portal
  - labels
