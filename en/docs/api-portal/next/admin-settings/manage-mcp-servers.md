...
canonical_url: https://wso2.com/api-platform/docs/api-portal/next/admin-settings/manage-mcp-servers/
md_url: https://wso2.com/api-platform/docs/api-portal/next/admin-settings/manage-mcp-servers.md
tags:
  - cloud
  - api-portal
  - mcp
