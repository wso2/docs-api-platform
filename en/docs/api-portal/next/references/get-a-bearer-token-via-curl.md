...
canonical_url: https://wso2.com/api-platform/docs/api-portal/next/references/get-a-bearer-token-via-curl/
md_url: https://wso2.com/api-platform/docs/api-portal/next/references/get-a-bearer-token-via-curl.md
tags:
  - cloud
  - api-portal
  - authentication
