...
canonical_url: https://wso2.com/api-platform/docs/api-portal/next/deployment/database-configuration/
md_url: https://wso2.com/api-platform/docs/api-portal/next/deployment/database-configuration.md
tags:
  - cloud
  - api-portal
  - deployment
