...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/references/webhook-event-catalog/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/references/webhook-event-catalog.md
tags:
  - cloud
  - api-portal
  - webhooks
