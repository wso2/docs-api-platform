...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/llm-instructions/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/llm-instructions.md
tags:
  - cloud
  - api-portal
  - ai-discovery
