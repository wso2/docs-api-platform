...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/organization-settings/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/organization-settings.md
tags:
  - cloud
  - api-portal
  - organization
