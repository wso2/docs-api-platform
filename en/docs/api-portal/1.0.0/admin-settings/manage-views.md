...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/manage-views/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/manage-views.md
tags:
  - cloud
  - api-portal
  - views
