...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/design-mode/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/design-mode.md
tags:
  - cloud
  - api-portal
  - theming
