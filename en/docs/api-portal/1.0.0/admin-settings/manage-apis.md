...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/manage-apis/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/admin-settings/manage-apis.md
tags:
  - cloud
  - api-portal
  - publish-apis
