...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/consume-an-api/api-key/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/consume-an-api/api-key.md
tags:
  - cloud
  - api-portal
  - authentication
