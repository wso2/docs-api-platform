...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/consume-an-api/manage-applications/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/consume-an-api/manage-applications.md
tags:
  - cloud
  - api-portal
  - applications
