...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/rest-api/mcp-server-keys/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/rest-api/mcp-server-keys.md
tags:
  - cloud
  - api-portal
  - rest-api
