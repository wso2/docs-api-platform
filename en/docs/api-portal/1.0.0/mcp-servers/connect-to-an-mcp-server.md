...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/mcp-servers/connect-to-an-mcp-server/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/mcp-servers/connect-to-an-mcp-server.md
tags:
  - cloud
  - api-portal
  - mcp
