...
canonical_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/setting-up/artifact-types/
md_url: https://wso2.com/api-platform/docs/api-portal/1.0.0/setting-up/artifact-types.md
tags:
  - cloud
  - api-portal
  - configuration
