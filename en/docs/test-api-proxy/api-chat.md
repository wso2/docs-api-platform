...
![API Chat pane showing natural language query result with sequentially executed API responses](../assets/img/test-api-proxy/api-chat-result.png){.cInlineImage-full}
