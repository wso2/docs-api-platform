...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/deployment/production-deployment/control-plane-connection/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/deployment/production-deployment/control-plane-connection.md
tags:
  - ai-gateway
  - production
  - control-plane
