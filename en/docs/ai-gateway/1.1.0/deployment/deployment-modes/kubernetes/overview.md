...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/deployment/deployment-modes/kubernetes/overview/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/deployment/deployment-modes/kubernetes/overview.md
tags:
  - ai-gateway
  - kubernetes
  - deployment
