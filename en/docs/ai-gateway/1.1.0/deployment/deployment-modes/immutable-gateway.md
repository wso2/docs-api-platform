...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/deployment/deployment-modes/immutable-gateway/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/deployment/deployment-modes/immutable-gateway.md
tags:
  - ai-gateway
  - deployment
  - gitops
...
Use `| redact` for sensitive values to hide them from config dumps. A `| default "value"` pipe is available for fallback values. See [Gateway Artifact Templating](../../../../api-gateway/1.1.0/setup/artifact-templating.md) for the full function reference.
