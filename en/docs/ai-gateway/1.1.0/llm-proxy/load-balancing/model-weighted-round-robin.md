...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/llm-proxy/load-balancing/model-weighted-round-robin/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/llm-proxy/load-balancing/model-weighted-round-robin.md
tags:
  - ai-gateway
  - llm
  - load-balancing
