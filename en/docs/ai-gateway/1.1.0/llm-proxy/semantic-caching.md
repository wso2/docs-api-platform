...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/llm-proxy/semantic-caching/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/llm-proxy/semantic-caching.md
tags:
  - ai-gateway
  - llm
  - caching
