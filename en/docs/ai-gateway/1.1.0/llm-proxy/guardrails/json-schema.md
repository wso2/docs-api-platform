...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/llm-proxy/guardrails/json-schema/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.1.0/llm-proxy/guardrails/json-schema.md
tags:
  - ai-gateway
  - guardrails
  - policies
