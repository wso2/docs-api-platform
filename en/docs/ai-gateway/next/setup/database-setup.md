...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/setup/database-setup/
md_url: https://wso2.com/api-platform/docs/ai-gateway/setup/database-setup.md
tags:
  - ai-gateway
  - configuration
  - postgresql
...
[← Configuration & Interpolation](./configuration.md)
