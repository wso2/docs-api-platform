...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/next/gateway-artifacts/llm-proxy/
md_url: https://wso2.com/api-platform/docs/ai-gateway/next/gateway-artifacts/llm-proxy.md
tags:
  - ai-gateway
  - llm-proxy
  - llm
