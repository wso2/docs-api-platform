...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/next/analytics/analytics-header-filter/
md_url: https://wso2.com/api-platform/docs/ai-gateway/next/analytics/analytics-header-filter.md
tags:
  - ai-gateway
  - analytics
  - policies
