...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/next/routing/multi-model-routing/
md_url: https://wso2.com/api-platform/docs/ai-gateway/next/routing/multi-model-routing.md
tags:
  - ai-gateway
  - routing
  - load-balancing
