...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/setup-and-deployment/kubernetes/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/setup-and-deployment/kubernetes.md
tags:
  - ai-gateway
  - kubernetes
  - deployment
