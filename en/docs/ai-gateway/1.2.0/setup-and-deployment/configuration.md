...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/setup-and-deployment/configuration/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/setup-and-deployment/configuration.md
tags:
  - api-gateway
  - configuration
  - interpolation
