...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/gateway-artifacts/mcp-proxy/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/gateway-artifacts/mcp-proxy.md
tags:
  - ai-gateway
  - mcp
  - mcp-proxy
