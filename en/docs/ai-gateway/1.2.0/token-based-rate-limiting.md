...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/token-based-rate-limiting/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/token-based-rate-limiting.md
tags:
  - ai-gateway
  - rate-limiting
