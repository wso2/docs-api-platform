...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/routing/multi-provider-routing/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.2.0/routing/multi-provider-routing.md
tags:
  - ai-gateway
  - llm
  - routing
