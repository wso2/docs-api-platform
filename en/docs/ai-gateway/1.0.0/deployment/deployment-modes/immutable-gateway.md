...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/deployment/deployment-modes/immutable-gateway/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/deployment/deployment-modes/immutable-gateway.md
tags:
  - ai-gateway
  - deployment
  - gitops
