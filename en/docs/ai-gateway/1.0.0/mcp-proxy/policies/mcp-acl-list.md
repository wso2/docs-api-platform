...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/mcp-proxy/policies/mcp-acl-list/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/mcp-proxy/policies/mcp-acl-list.md
tags:
  - ai-gateway
  - mcp
  - policies
