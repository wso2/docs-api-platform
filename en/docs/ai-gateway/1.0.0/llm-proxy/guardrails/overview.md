...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/llm-proxy/guardrails/overview/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/llm-proxy/guardrails/overview.md
tags:
  - ai-gateway
  - guardrails
  - llm-proxy
...
Guardrails use the same underlying policy engine as [API Gateway policies](../../../../../api-gateway/1.0.0/policies/overview.md). Each guardrail declares which execution phases it participates in, and the engine calls the appropriate hook for each phase.
