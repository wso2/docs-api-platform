...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/llm-proxy/prompt-management/prompt-template/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/llm-proxy/prompt-management/prompt-template.md
tags:
  - ai-gateway
  - llm
  - prompt-management
