...
5. Click **Manage IdP Group Mapping**.
   ![Groups tab listing Admin, API Publisher, API Subscriber, and Developer roles with Manage IdP Group Mapping button](../../assets/img/administer/settings/group-mapping.png)
