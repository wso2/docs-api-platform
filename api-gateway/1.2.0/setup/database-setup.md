...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/setup/database-setup/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.2.0/setup/database-setup.md
tags:
  - api-gateway
  - configuration
  - postgresql
