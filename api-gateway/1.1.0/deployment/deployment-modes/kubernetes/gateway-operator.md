...
canonical_url: https://wso2.com/api-platform/docs/api-gateway/1.1.0/deployment/deployment-modes/kubernetes/gateway-operator/
md_url: https://wso2.com/api-platform/docs/api-gateway/1.1.0/deployment/deployment-modes/kubernetes/gateway-operator.md
tags:
  - api-gateway
  - kubernetes
  - deployment
