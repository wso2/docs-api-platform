...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/deployment/deployment-modes/kubernetes/kubernetes-standalone/
md_url: https://wso2.com/api-platform/docs/ai-gateway/1.0.0/deployment/deployment-modes/kubernetes/kubernetes-standalone.md
tags:
  - ai-gateway
  - kubernetes
  - deployment
