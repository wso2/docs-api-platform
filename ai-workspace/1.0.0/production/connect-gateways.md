...
canonical_url: https://wso2.com/api-platform/docs/ai-workspace/1.0.0/production/connect-gateways/
md_url: https://wso2.com/api-platform/docs/ai-workspace/1.0.0/production/connect-gateways.md
tags:
  - ai-workspace
  - production
  - ai-gateway
